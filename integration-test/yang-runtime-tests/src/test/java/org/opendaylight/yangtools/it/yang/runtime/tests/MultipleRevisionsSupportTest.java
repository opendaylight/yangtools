...
public class MultipleRevisionsSupportTest {
    ...
    private void verifyBindingDifference(SchemaContext schemaContext, YangModuleInfo oldModule,
    ...
    private void verifySchemaDifference(SchemaContext context, YangModuleInfo topologyOldModule, YangModuleInfo topologyNewModule) {
    ...
    private static final Iterable<? extends InputStream> toInputStreams(Set<YangModuleInfo> moduleInfos) throws Exception {
