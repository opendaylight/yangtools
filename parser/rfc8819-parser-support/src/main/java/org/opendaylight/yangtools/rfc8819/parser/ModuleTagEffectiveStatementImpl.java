...
final class ModuleTagEffectiveStatementImpl extends AbstractEffectiveUnknownSchmemaNode<Tag, ModuleTagStatement>
    ...
    @Override
    public @NonNull ModuleTagEffectiveStatement asEffectiveStatement() {
        return this;
    }
}
