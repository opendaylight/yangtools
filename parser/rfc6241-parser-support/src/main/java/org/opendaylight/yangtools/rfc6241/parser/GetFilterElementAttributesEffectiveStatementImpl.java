...
final class GetFilterElementAttributesEffectiveStatementImpl
        extends WithSubstatements<Empty, @NonNull GetFilterElementAttributesStatement>
        implements GetFilterElementAttributesEffectiveStatement {
    GetFilterElementAttributesEffectiveStatementImpl(final @NonNull GetFilterElementAttributesStatement declared,
