...
final class OidEffectiveStatementImpl extends WithSubstatements<ObjectIdentifier, @NonNull OidStatement>
        implements OidEffectiveStatement {
    OidEffectiveStatementImpl(final @NonNull OidStatement declared,
