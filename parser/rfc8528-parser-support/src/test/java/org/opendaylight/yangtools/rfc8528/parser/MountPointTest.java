        ...
        final var context = reactor.newBuild()
            .addLibSources(
                YangStatementStreamSource.create(
                    new ResourceYangTextSource(MountPointTest.class, "/ietf-inet-types@2013-07-15.yang")),
                YangStatementStreamSource.create(
                    new ResourceYangTextSource(MountPointTest.class, "/ietf-yang-schema-mount@2019-01-14.yang")),
                YangStatementStreamSource.create(
                    new ResourceYangTextSource(MountPointTest.class, "/ietf-yang-types@2013-07-15.yang")))
            .addSources(
                YangStatementStreamSource.create(new ResourceYangTextSource(MountPointTest.class, "/example-grp.yang")),
                YangStatementStreamSource.create(
                    new ResourceYangTextSource(MountPointTest.class, "/example-uses.yang")))
            .buildEffective();
