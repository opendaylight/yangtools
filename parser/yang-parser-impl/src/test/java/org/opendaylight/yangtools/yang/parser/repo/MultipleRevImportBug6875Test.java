...
public class MultipleRevImportBug6875Test extends AbstractSchemaRepositoryTest {
    ...
    public void testYang11() throws Exception {
        ...
        final var foo = immediateProvider("/rfc7950/bug6875/yang1-1/foo.yang");
        final var bar1 = immediateProvider("/rfc7950/bug6875/yang1-1/bar@1999-01-01.yang");
        final var bar2 = immediateProvider("/rfc7950/bug6875/yang1-1/bar@2017-02-06.yang");
        final var bar3 = immediateProvider("/rfc7950/bug6875/yang1-1/bar@1970-01-01.yang");
    ...
    public void testYang10() throws Exception {
        ...
        final var foo = immediateProvider("/rfc7950/bug6875/yang1-0/foo.yang");
        final var bar1 = immediateProvider("/rfc7950/bug6875/yang1-0/bar@1999-01-01.yang");
        final var bar2 = immediateProvider("/rfc7950/bug6875/yang1-0/bar@2017-02-06.yang");
