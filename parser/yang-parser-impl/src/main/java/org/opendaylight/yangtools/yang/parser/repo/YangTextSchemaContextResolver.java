...
public final class YangTextSchemaContextResolver implements AutoCloseable, SchemaSourceProvider<YangTextSchemaSource> {
    ...
    private final SupportedFeatureSet supportedFeatures = new SupportedFeatureSet();
    ...
    public @NonNull Registration registerSupportedFeatures(QNameModule module, Set<QName> features) {
        synchronized (this) {
            version = new Object();
            supportedFeatures.add(module, features);
        }
        return new AbstractRegistration() {
            @Override
            protected void removeRegistration() {
                version = new Object();
                supportedFeatures.remove(module, features);
            }
        };
    }
    ...
    private static SchemaContextFactoryConfiguration config(final StatementParserMode statementParserMode,
        ...
        return SchemaContextFactoryConfiguration.builder().setStatementParserMode(statementParserMode)
                .setSupportedFeatures(supportedFeatures.getImmutableCopy())
                .build();
    }
}
