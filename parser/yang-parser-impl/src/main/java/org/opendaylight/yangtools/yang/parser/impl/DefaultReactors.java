...
import org.opendaylight.yangtools.rfc8791.parser.IetfDataStructureSupport;
...
public final class DefaultReactors {
    ...
    private static @NonNull CustomCrossSourceStatementReactorBuilder addExtensions(
        ...
        return builder
            ...
            .addStatementSupport(ModelProcessingPhase.FULL_DECLARATION, new MountStatementSupport(config))
            ...
            .addAllSupports(ModelProcessingPhase.FULL_DECLARATION, IetfDataStructureSupport.createBundle(config))
