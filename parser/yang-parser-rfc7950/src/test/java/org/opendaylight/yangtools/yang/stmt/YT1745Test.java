...
class YT1745Test extends AbstractYangTest {
    ...
    void effectiveConfigInInputOutputNotification() {
        ...
        assertThat(inOne.asEffectiveStatement().effectiveSubstatements()).hasSize(1);
        ...
        assertThat(inTwo.asEffectiveStatement().effectiveSubstatements()).hasSize(1);
        ...
        assertThat(inThree.asEffectiveStatement().effectiveSubstatements()).hasSize(1);
        ...
        assertThat(outOne.asEffectiveStatement().effectiveSubstatements()).hasSize(1);
        ...
        assertThat(outTwo.asEffectiveStatement().effectiveSubstatements()).hasSize(1);
        ...
        assertThat(outThree.asEffectiveStatement().effectiveSubstatements()).hasSize(1);
