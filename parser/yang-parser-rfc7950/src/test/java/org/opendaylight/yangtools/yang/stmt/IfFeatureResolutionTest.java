...
class IfFeatureResolutionTest {
    @Test
    void testSomeFeaturesSupported() throws Exception {
    ...
    @Test
    void testAllFeaturesSupported() throws Exception {
        final var schemaContext = StmtTestUtils.parseYangSources("/if-feature-resolution-test",
            YangParserConfiguration.DEFAULT);
    ...
    @Test
    void testNoFeaturesSupported() throws Exception {
        final var schemaContext = StmtTestUtils.parseYangSources("/if-feature-resolution-test",
