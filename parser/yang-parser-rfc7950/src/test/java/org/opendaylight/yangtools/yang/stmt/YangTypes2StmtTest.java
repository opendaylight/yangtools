...
class YangTypes2StmtTest extends AbstractYangTest {
    ...
    void readAndParseYangFileTest() {
        ...
        final DecimalTypeDefinition lfDecimalNodeType =
            assertInstanceOf(DecimalTypeDefinition.class, lfDecimalNode.typeDefinition());
