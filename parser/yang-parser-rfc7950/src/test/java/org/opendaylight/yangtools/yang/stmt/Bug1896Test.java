...
class Bug1896Test {
    ...
    void testUnusedLibrarySubmoduleCrashes() throws Exception {
        ...
        reactor.addSource(StmtTestUtils.sourceForResource("/bugs/bug1896/bar.yang"));

        // 2. Add the module and submodule as UNUSED library sources
        reactor.addLibSource(
            StmtTestUtils.sourceForResource("/bugs/bug1896/foo.yang"));
        reactor.addLibSource(
            StmtTestUtils.sourceForResource("/bugs/bug1896/foo-sub.yang"));
