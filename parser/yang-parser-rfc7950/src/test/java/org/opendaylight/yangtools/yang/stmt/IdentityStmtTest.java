...
class IdentityStmtTest extends AbstractYangTest {
    ...
    void selfReferencingIdentityThroughChaining() {
        assertInferenceExceptionMessage("/identity/illegal-chained-identity-test.yang")
    ...
    void chainedIdentityTest() {
        ...
        var testModule = result.findModules("legal-chained-identity-test").iterator().next();
        ...
        var identity = identitiesIterator.next();
