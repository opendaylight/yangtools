...
class Bug6180Test {
    ...
    private static void verifyDoubleQuotesExpression(final SchemaContext schemaContext) {
        ...
        final ContainerSchemaNode bar = assertInstanceOf(ContainerSchemaNode.class, dataNodeBar);
        ...
        final List<PatternConstraint> patternConstraints = assertInstanceOf(StringTypeDefinition.class, type)
