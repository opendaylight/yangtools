...
public class YT1339Test {
    ...
    public void testInclude() {
        ...
        assertEquals("", assertLinkageException("old-sub"));
        // ... and a YANG version 1 module MUST NOT include a YANG version 1.1 submodule
        assertEquals("", assertLinkageException("new-sub"));
    }
    ...
    public void testImportNewByRev() throws Exception {
        ...
        assertEquals("", assertLinkageException("import-rev"));
        assertEquals("", assertLinkageException("import-rev-sub"));
    }
    ...
    private static String assertLinkageException(final String subdir) {
