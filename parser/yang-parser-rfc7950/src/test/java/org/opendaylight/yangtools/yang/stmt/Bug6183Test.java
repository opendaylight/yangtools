...
public class Bug6183Test extends AbstractYangTest {
    ...
    public void assertSchemaContext(final EffectiveModelContext context) {
        ...
        final CaseSchemaNode implCase = myChoice.findCase(foo("implicit-case-container")).orElseThrow();
        final CaseSchemaNode declCaseOne = myChoice.findCase(foo("declared-case-one")).orElseThrow();
        final CaseSchemaNode secondImplCase = myChoice.findCase(foo("second-implicit-case-container")).orElseThrow();
        final CaseSchemaNode declCaseTwo = myChoice.findCase(foo("declared-case-two")).orElseThrow();
