...
public class Mdsal713IsAugmentingTest {
    ...
    public void testIsAugmentingForShorthandCase() throws Exception {
        ...
        final var augModule = schemaContext.findModule("augment-base", Revision.of("2023-06-06")).orElseThrow();

        final var topCont = (DataNodeContainer) baseModule.dataChildByName(QName.create(baseModule.getQNameModule(), "top"));
