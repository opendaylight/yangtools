...
public class IOSupportTest {
    private static IRSchemaSource FOO;

    @BeforeClass
    public static void beforeClass() throws YangSyntaxErrorException, IOException {
        FOO = TextToIRTransformer.transformText(YangTextSchemaSource.forResource("/bugs/YT1089/foo.yang"));
    }
