...
public class Bug6887Test extends AbstractYangTest {
    ...
    public void testRestrictedEnumeration() {
        final SchemaContext schemaContext = assertEffectiveModel("/rfc7950/bug6887/foo.yang");
    ...
    public void testRestrictedBits() {
        final SchemaContext schemaContext = assertEffectiveModel("/rfc7950/bug6887/bar.yang");
