...
class Bug6887Test extends AbstractYangTest {
    ...
    void testRestrictedEnumeration() {
        ...
        var enumerationType = assertInstanceOf(EnumTypeDefinition.class, myEnumerationLeaf.typeDefinition());
        ...
        enumerationType = assertInstanceOf(EnumTypeDefinition.class, myEnumerationLeaf2.typeDefinition());
        enums = enumerationType.getValues();
        assertEquals(3, enums.size());
        assertContainsEnums(enums, yellowEnum, redEnum, blackEnum);
    }
    ...
    void testRestrictedBits() {
        ...
        var bitsType = assertInstanceOf(BitsTypeDefinition.class, myBitsLeaf.typeDefinition());
        ...
        bitsType = (BitsTypeDefinition) myBitsLeaf2.typeDefinition();
        bits = bitsType.getBits();
        assertEquals(3, bits.size());
        bitB = createBit("bit-b", 2);
        bitC = createBit("bit-c", 3);
