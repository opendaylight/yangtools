...
public class Bug6887Test extends AbstractYangTest {
    ...
    public void testRestrictedEnumeration() {
        ...
        final var myEnumerationLeaf = (LeafSchemaNode) foo.getDataChildByName(
                QName.create(foo.getQNameModule(), "my-enumeration-leaf"));

        var enumerationType = (EnumTypeDefinition) myEnumerationLeaf.getType();
        ...
        final var myEnumerationLeaf2 = (LeafSchemaNode) foo.getDataChildByName(
    ...
    public void testRestrictedBits() {
        ...
        final var myBitsLeaf = (LeafSchemaNode) bar.getDataChildByName(
                QName.create(bar.getQNameModule(), "my-bits-leaf"));

        var bitsType = (BitsTypeDefinition) myBitsLeaf.getType();
        ...
        final var myBitsLeaf2 = (LeafSchemaNode) bar.getDataChildByName(
