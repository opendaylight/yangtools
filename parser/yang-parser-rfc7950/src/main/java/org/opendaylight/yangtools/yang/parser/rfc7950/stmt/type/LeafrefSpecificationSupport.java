...
final class LeafrefSpecificationSupport extends AbstractTypeSupport.Specific<LeafrefSpecification> {
    ...
    private LeafrefSpecificationSupport(final YangParserConfiguration config, final SubstatementValidator validator) {
        super(config, validator, LeafrefSpecification.class);
    }
    ...
    @Override
    TypeEffectiveStatement createEffectiveImpl(final Current<QName, LeafrefSpecification> stmt,
