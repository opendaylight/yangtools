...
public final class YangIRSourceInfoExtractor {
     ...
     * @deprecated Use {@link YangIRSource#extractSourceInfo()} instead.
     */
    @Deprecated(since = "14.0.22", forRemoval = true)
     ...
     * @return {@link SourceInfo}
     * @throws IllegalArgumentException If the root statement is not a valid YANG module/submodule
     * @deprecated Use {@link SourceInfoExtractors#forIR(IRStatement, SourceIdentifier)} or
     *             {@link YangIRSource#extractSourceInfo()} instead.
     */
    @Deprecated(since = "14.0.22", forRemoval = true)
     ...
     * @deprecated Use {@link TextToIRTransformer#transformText(YangTextSource)} and
     *             {@link YangIRSource#extractSourceInfo()} instead.
     */
    @Deprecated(since = "14.0.22", forRemoval = true)
