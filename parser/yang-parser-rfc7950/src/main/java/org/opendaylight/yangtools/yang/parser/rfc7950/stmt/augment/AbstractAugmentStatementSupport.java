...
abstract class AbstractAugmentStatementSupport
    ...
    protected final AugmentEffectiveStatement createEffective(
        ...
        final ImmutableList<? extends EffectiveStatement<?, ?>> wrapped = implicitDef == null ? substatements
            : substatements.stream().map(implicitDef::wrapWithImplicit).collect(ImmutableList.toImmutableList());
