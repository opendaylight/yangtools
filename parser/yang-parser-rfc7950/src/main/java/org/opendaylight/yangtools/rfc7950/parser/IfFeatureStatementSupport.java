...
public final class IfFeatureStatementSupport
    ...
    @Override
    public IfFeatureExpr parseArgumentValue(final CommonStmtCtx stmt, final IdentifierBinding binding,
            final String rawArgument) {
        return argumentParser.parseArgument(stmt, binding, rawArgument);
    }
