...
final class OpenConfigRegexpPosixStatementImpl extends WithSubstatements implements OpenConfigRegexpPosixStatement {
    OpenConfigRegexpPosixStatementImpl(final ImmutableList<? extends DeclaredStatement<?>> substatements) {
        super(substatements);
    }
}