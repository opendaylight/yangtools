...
public final class YangSourceInfoExtractor extends SourceInfoExtractor<IRStatement> {

    public YangSourceInfoExtractor(final IRStatement root, final SourceIdentifier rootIdentifier) {
    ...
    public static SourceInfo forIR(final IRStatement root, final SourceIdentifier rootIdentifier) {
        return new YangSourceInfoExtractor(root, rootIdentifier).getSourceInfo();
    }
