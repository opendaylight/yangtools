...
public final class MaxElementsStatementSupport
    ...
    @Override
    public MaxElementsArgument parseArgumentValue(final CommonStmtCtx stmt, final IdentifierBinding binding,
            final String rawArgument) {
        try {
            return MaxElementsArgument.parse(rawArgument).intern();
        } catch (ParseException e) {
            throw new SourceException(stmt, e, "Invalid max-elements argument \"%s\" at offset %s: %s", rawArgument,
