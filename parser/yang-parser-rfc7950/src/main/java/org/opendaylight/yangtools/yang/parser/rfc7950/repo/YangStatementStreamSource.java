...
public final class YangStatementStreamSource extends AbstractSimpleIdentifiable<SourceIdentifier>
    ...
    @Override
    public void writeRoot(final @NonNull StatementWriter writer, final @NonNull QNameToStatementDefinition stmtDef,
        ...
        final QName defQname = def.statementName();
    ...
    @NonNull IRStatement rootStatement() {
