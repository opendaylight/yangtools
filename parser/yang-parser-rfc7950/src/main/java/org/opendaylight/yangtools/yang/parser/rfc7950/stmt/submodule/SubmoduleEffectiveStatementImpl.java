...
final class SubmoduleEffectiveStatementImpl
    ...
    SubmoduleEffectiveStatementImpl(final Current<Unqualified, SubmoduleStatement> stmt,
        ...
        final var belongsToModuleQName = stmt.namespaceItem(ParserNamespaces.BELONGSTO_PREFIX_TO_QNAME_MODULE,
            findBelongsTo(stmt, substatements).prefixStatement().argument());
