...
public final class UsesStatementSupport
    ...
    private static QNameModule getNewQNameModule(final StmtContext<?, ?, ?> targetCtx,
        ...
        final var targetArgument = targetCtx.argument();
        if (targetArgument instanceof QName && stmtContext.argument() instanceof QName) {
            return ((QName) targetArgument).getModule();
        }
