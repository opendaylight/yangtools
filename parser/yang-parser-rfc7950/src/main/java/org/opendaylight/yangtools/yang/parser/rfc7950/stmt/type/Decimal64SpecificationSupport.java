...
final class Decimal64SpecificationSupport extends AbstractTypeSupport.Specific<Decimal64Specification> {
    ...
    Decimal64SpecificationSupport(final YangParserConfiguration config) {
        super(config, SUBSTATEMENT_VALIDATOR, Decimal64Specification.class);
    }
    ...
    @Override
    TypeEffectiveStatement createEffectiveImpl(final Current<QName, Decimal64Specification> stmt,
