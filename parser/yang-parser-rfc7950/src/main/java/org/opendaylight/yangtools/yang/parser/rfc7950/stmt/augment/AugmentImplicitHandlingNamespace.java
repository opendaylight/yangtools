 ...
 */
@Beta
public interface AugmentImplicitHandlingNamespace extends ParserNamespace<Empty, ImplicitParentSupport> {
    NamespaceBehaviour<Empty, ImplicitParentSupport, @NonNull AugmentImplicitHandlingNamespace>
