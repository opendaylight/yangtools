...
public final class RFC7950Reactors {
    ...
    private static final StatementSupportBundle INIT_BUNDLE = StatementSupportBundle.builder(SUPPORTED_VERSIONS)
        .addSupport(ValidationBundlesNamespace.INSTANCE)
        .addSupport(SupportedFeaturesNamespace.INSTANCE)
        .addSupport(ModulesDeviatedByModules.INSTANCE)
        .build();
    ...
    private static StatementSupportBundle preLinkageBundle(final YangParserConfiguration config) {
        return StatementSupportBundle.derivedFrom(INIT_BUNDLE)
            ...
            .addSupport(ModuleNameToNamespace.INSTANCE)
            .addSupport(PreLinkageModuleNamespace.INSTANCE)
            .addSupport(ImpPrefixToNamespace.INSTANCE)
            .addSupport(ModuleCtxToModuleQName.INSTANCE)
            .addSupport(QNameModuleNamespace.INSTANCE)
            .addSupport(ImportedVersionNamespace.INSTANCE)
            .build();
    }
    ...
    private static StatementSupportBundle linkageBundle(final StatementSupportBundle preLinkageBundle,
        ...
        return StatementSupportBundle.derivedFrom(preLinkageBundle)
            ...
            .addSupport(ModuleNamespace.INSTANCE)
            .addSupport(ModuleNamespaceForBelongsTo.INSTANCE)
            .addSupport(SubmoduleNamespace.INSTANCE)
            .addSupport(NamespaceToModule.INSTANCE)
            .addSupport(ModuleNameToModuleQName.INSTANCE)
            .addSupport(ModuleCtxToSourceIdentifier.INSTANCE)
            .addSupport(ModuleQNameToModuleName.INSTANCE)
            .addSupport(PrefixToModule.INSTANCE)
            .addSupport(ImportedModuleContext.INSTANCE)
            .addSupport(IncludedModuleContext.INSTANCE)
            .addSupport(IncludedSubmoduleNameToModuleCtx.INSTANCE)
            .addSupport(ImportPrefixToModuleCtx.INSTANCE)
            .addSupport(BelongsToPrefixToModuleCtx.INSTANCE)
            .addSupport(ModuleQNameToPrefix.INSTANCE)
            .addSupport(BelongsToPrefixToModuleName.INSTANCE)
            .build();
    }
    ...
    private static StatementSupportBundle stmtDefBundle(final StatementSupportBundle linkageBundle,
        ...
        return StatementSupportBundle.derivedFrom(linkageBundle)
            ...
            .addSupport(ExtensionNamespace.INSTANCE)
            .addSupport(new TypedefStatementSupport(config))
            .addSupport(TypeNamespace.INSTANCE)
            ...
            .addSupport(BaseTypeNamespace.INSTANCE)
            ...
            .addSupport(ConfigListWarningNamespace.INSTANCE)
            ...
            .addSupport(StatementDefinitionNamespace.INSTANCE)
            .build();
    }
    ...
    private static @NonNull StatementSupportBundle fullDeclarationBundle(final StatementSupportBundle stmtDefBundle,
        ...
        return StatementSupportBundle.derivedFrom(stmtDefBundle)
            ...
            .addSupport(FeatureNamespace.INSTANCE)
            ...
            .addSupport(GroupingNamespace.INSTANCE)
            .addSupport(SourceGroupingNamespace.INSTANCE)
            ...
            .addSupport(AugmentImplicitHandlingNamespace.INSTANCE)
            ...
            .addSupport(RefineTargetNamespace.INSTANCE)
            ...
            .addSupport(YangNamespaceContextNamespace.INSTANCE)
            .build();
    }
}
