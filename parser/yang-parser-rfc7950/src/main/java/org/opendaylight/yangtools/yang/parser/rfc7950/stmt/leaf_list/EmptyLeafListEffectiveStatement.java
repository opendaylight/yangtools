...
final class EmptyLeafListEffectiveStatement extends AbstractLeafListEffectiveStatement {
    EmptyLeafListEffectiveStatement(final LeafListStatement declared, final QName qname, final int flags,
            final ImmutableList<? extends EffectiveStatement<?, ?>> substatements) {
        super(declared, qname, flags, substatements);
    }

    EmptyLeafListEffectiveStatement(final EmptyLeafListEffectiveStatement original, final QName qname,
            final int flags) {
