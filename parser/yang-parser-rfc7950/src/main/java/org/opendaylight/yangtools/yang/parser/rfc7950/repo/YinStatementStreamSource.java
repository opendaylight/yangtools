...
public final class YinStatementStreamSource extends AbstractSimpleIdentifiable<SourceIdentifier>
    ...
    private YinStatementStreamSource(final @NonNull SourceIdentifier sourceId, final @NonNull Node root,
            final @NonNull SourceRefProvider refProvider, final @NonNull SourceInfo sourceInfo) {
        super(sourceId);
