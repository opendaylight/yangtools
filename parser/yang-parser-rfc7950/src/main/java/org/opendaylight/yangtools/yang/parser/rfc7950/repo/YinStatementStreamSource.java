...
public final class YinStatementStreamSource extends AbstractSimpleIdentifiable<SourceIdentifier>
     ...
     */
    private void skipRootAndWalkTree(final @NonNull StatementWriter writer,
            final @NonNull QNameToStatementDefinition stmtDef) {
    ...
    private static int getSubstatementsCount(final @NonNull Node parent) {
        int count = 0;
    ...
    @Override
    public void writeRoot(final @NonNull StatementWriter writer, final @NonNull QNameToStatementDefinition stmtDefs,
