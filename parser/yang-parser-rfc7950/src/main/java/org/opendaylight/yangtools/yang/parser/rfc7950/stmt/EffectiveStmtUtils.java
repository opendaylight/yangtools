...
public final class EffectiveStmtUtils {
    ...
    @NonNullByDefault
    public static @Nullable ElementCountMatcher elementCountMatcherOf(final CommonStmtCtx ctx,
            final ImmutableList<? extends EffectiveStatement<?, ?>> substatements) {
        final var minStmt = AbstractStatementSupport.findFirstStatement(substatements,
            MinElementsEffectiveStatement.class);
        final var maxStmt = AbstractStatementSupport.findFirstStatement(substatements,
            MaxElementsEffectiveStatement.class);
        // FIXME: should report mismatch
        return ElementCountMatcher.ofNullable(minStmt == null ? null : minStmt.argument(),
            maxStmt == null ? null : maxStmt.argument());
    }
