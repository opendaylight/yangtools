...
final class AugmentEffectiveStructureStatementImpl
        ...
        implements AugmentStructureEffectiveStatement, AugmentStructureSchemaNode,
                   CopyableMixin<AugmentStructureArgument, AugmentStructureStatement>,
                   UnknownSchemaNodeMixin<AugmentStructureArgument, AugmentStructureStatement>,
                   DataNodeContainerMixin<AugmentStructureArgument, AugmentStructureStatement>,
                   MustConstraintMixin<AugmentStructureArgument, AugmentStructureStatement> {
