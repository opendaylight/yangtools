...
public final class Rfc8791ParserExtension extends AbstractParserExtension {
    ...
    public Rfc8791ParserExtension() {
        super(AugmentStructureStatement.DEF, StructureStatement.DEF);
    }
    ...
    public StatementSupportBundle configureBundle(final YangParserConfiguration config) {
        return StatementSupportBundle.builder(StatementSupportBundle.VERSIONS_RFC7950)
            .addSupport(StructureStatementSupport.BEHAVIOUR)
            .addSupport(StructureStatementSupport.rfc6020(config), StructureStatementSupport.rfc7950(config))
            .addSupport(AugmentStructureStatementSupport.rfc6020(config),
                AugmentStructureStatementSupport.rfc7950(config))
            .build();
    }
}
