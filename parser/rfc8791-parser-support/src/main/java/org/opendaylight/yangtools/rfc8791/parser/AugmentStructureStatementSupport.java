...
public final class AugmentStructureStatementSupport
    ...
    private AugmentStructureStatementSupport(final YangParserConfiguration config,
        ...
        super(AugmentStructureStatement.DEF, StatementPolicy.reject(), SubtreePolicy.structure(), config, validator);
    }
    ...
    static AugmentStructureStatementSupport rfc6020(final YangParserConfiguration config) {
        return new AugmentStructureStatementSupport(config,
            SubstatementValidator.builder(AugmentStructureStatement.DEF)
    ...
    @Override
    public AugmentStructureArgument parseArgumentValue(final CommonStmtCtx stmt, final IdentifierBinding binding,
            final String rawArgument) {
        final var steps = binding.parseAbsoluteSchemaNodeid(stmt, rawArgument).getNodeIdentifiers();
    ...
    protected AugmentStructureEffectiveStatement createEffective(
        ...
        return new AugmentStructureEffectiveStatementImpl(stmt, substatements);
    }
}
