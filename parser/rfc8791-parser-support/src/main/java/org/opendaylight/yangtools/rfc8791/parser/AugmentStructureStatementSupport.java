...
public final class AugmentStructureStatementSupport
    ...
    @Override
    protected @NonNull AugmentStructureStatement createDeclared(final BoundStmtCtx<AugmentStructureArgument> ctx,
            final ImmutableList<DeclaredStatement<?>> substatements) {
        return new AugmentStructureStatementImpl(ctx, substatements);
    }

    @Override
    protected @NonNull AugmentStructureStatement attachDeclarationReference(@NonNull
    final AugmentStructureStatement stmt,
            @NonNull
    ...
    @Override
    public void onStatementAdded(final StmtContext.@NonNull Mutable<AugmentStructureArgument, AugmentStructureStatement,
