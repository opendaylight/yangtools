        ...
        final var context = reactor.newBuild()
            .addSources(
                YangStatementStreamSource.create(
                    new ResourceYangTextSource(AnnotationTest.class, "/ietf-yang-metadata@2016-08-05.yang")),
                YangStatementStreamSource.create(
                    new ResourceYangTextSource(AnnotationTest.class, "/example-last-modified.yang")))
            .buildEffective();
