...
/**
 * Specialization of {@link AbstractStatementSupport} for {@link QName} statement arguments.
 *
...
public abstract class AbstractQNameStatementSupport<D extends DeclaredStatement<QName>,
    ...
    protected AbstractQNameStatementSupport(final StatementDefinition<QName, D, E> publicDefinition,
    ...
    @Override
    public final QName adaptArgumentValue(final StmtContext<QName, ?, ?> ctx, final QNameModule targetModule) {
