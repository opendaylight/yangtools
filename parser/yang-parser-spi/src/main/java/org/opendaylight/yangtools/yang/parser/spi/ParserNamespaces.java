...
public final class ParserNamespaces {
    ...
    /**
     * DTO containing all the linkage information of a module/submodule.
     */
    public static final @NonNull ParserNamespace<Empty, ResolvedSourceInfo> RESOLVED_INFO =
        new ParserNamespace<>("resolved-info");
