...
public final class ImportPrefixToModuleCtx extends ParserNamespace<String, StmtContext<?, ?, ?>> {
    ...
    public static final @NonNull NamespaceBehaviour<String, StmtContext<?, ?, ?>, @NonNull ImportPrefixToModuleCtx>
        BEHAVIOUR = NamespaceBehaviour.rootStatementLocal(ImportPrefixToModuleCtx.class);
