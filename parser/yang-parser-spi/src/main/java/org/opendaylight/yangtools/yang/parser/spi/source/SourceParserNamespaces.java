...
public final class SourceParserNamespaces {
    ...
    public static final @NonNull StatementNamespace<Unqualified, ModuleStatement, ModuleEffectiveStatement>
        MODULE_FOR_BELONGSTO = new StatementNamespace<>();
    ...
    public static final @NonNull ParserNamespace<Empty, Set<QName>> SUPPORTED_FEATURES = new ParserNamespace<>();
     ...
     * @see PrefixResolver
     */
    public static final @NonNull ParserNamespace<String, QNameModule> PREFIX_TO_MODULE = new ParserNamespace<>();
