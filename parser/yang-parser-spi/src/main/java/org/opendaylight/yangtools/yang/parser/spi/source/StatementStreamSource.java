 ...
 * This step is used to prepare root statements for the linkage resolution</li>
 * <li>
...
public interface StatementStreamSource extends Identifiable<SourceIdentifier> {
     ...
     */
    void writeRoot(@NonNull StatementWriter writer, @NonNull QNameToStatementDefinition stmtDef,
            @NonNull YangVersion version);
    ...
    /**
     * Get the {@link SourceInfo} from this source.
     */
