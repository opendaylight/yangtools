...
public abstract class NamespaceBehaviour<K, V> {
    ...
    public static <K, V> @NonNull NamespaceBehaviour<K, V> global(final ParserNamespace<K, V> namespace) {
        return new GlobalBehavior<>(namespace);
    }
    ...
    public static <K, V> @NonNull NamespaceBehaviour<K, V> sourceLocal(final ParserNamespace<K, V> namespace) {
        return new SourceBehavior<>(namespace);
    }
    ...
    private static final class GlobalBehavior<K, V> extends AbstractSpecific<K, V> {
        GlobalBehavior(final ParserNamespace<K, V> namespace) {
            super(namespace);
        }
    ...
    private static final class SourceBehavior<K, V> extends AbstractSpecific<K, V> {
        SourceBehavior(final ParserNamespace<K, V> namespace) {
            super(namespace);
        }
