...
public abstract class NamespaceBehaviour<K, V> {
     ...
     * behaviour stores and loads all values from closest {@link NamespaceStorage} ancestor with level
    ...
    private static final class GlobalStorage<K, V> extends AbstractSpecific<K, V> {
        GlobalStorage(final ParserNamespace<K, V> namespace) {
            super(namespace);
        }
