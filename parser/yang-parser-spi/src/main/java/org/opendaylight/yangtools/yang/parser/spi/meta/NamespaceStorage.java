...
public interface NamespaceStorage {
    ...
    interface AccessibleSources extends NamespaceStorage {
        ...
        @Override
        default <K, V> V putToLocalStorage(final UserNamespace<K, V> type, final K key, final V value) {
            throw new UnsupportedOperationException();
        }

        @Override
        default <K, V> V putToLocalStorageIfAbsent(final UserNamespace<K, V> type, final K key,
                final V value) {
            throw new UnsupportedOperationException();
        }
    }
     ...
     */
    <K, V> @Nullable V putToLocalStorage(UserNamespace<K, V> type, K key, V value);
     ...
     * @throws UnsupportedOperationException if {@code type} is a read-only namespace
     */
    <K, V> @Nullable V putToLocalStorageIfAbsent(UserNamespace<K, V> type, K key, V value);
}
