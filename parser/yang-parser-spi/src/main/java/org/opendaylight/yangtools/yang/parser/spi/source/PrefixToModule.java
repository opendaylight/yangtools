...
public final class PrefixToModule extends ParserNamespace<String, QNameModule> {
    public static final @NonNull PrefixToModule NS = new PrefixToModule();
    public static final @NonNull NamespaceBehaviour<String, QNameModule, @NonNull PrefixToModule> BEHAVIOUR =
