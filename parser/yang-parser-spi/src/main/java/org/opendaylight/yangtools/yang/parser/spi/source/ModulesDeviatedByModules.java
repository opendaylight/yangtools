...
public final class ModulesDeviatedByModules extends ParserNamespace<Empty, SetMultimap<QNameModule, QNameModule>> {
    public static final @NonNull ModulesDeviatedByModules NS = new ModulesDeviatedByModules();
    public static final @NonNull NamespaceBehaviour<Empty, SetMultimap<QNameModule, QNameModule>,
        @NonNull ModulesDeviatedByModules> BEHAVIOUR = NamespaceBehaviour.global(ModulesDeviatedByModules.class);
