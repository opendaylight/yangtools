...
public abstract class AbstractInternedStringStatementSupport<D extends DeclaredStatement<String>,
    ...
    protected AbstractInternedStringStatementSupport(final StatementDefinition<String, D, E> publicDefinition,
    ...
    @Override
    public final String parseArgumentValue(final CommonStmtCtx stmt, final IdentifierBinding binding,
