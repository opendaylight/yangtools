...
public interface QNameModuleResolver {
     ...
     */
    @Nullable QNameModule getByNamespace(XMLNamespace namespace);
     ...
     * @throws IllegalArgumentException if the input string is not valid URI
     */
    default @Nullable QNameModule getByNamespace(final String namespace) {
        return getByNamespace(XMLNamespace.of(namespace));
    }
}
