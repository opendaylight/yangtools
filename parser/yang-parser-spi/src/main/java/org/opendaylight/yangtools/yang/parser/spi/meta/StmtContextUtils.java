...
public final class StmtContextUtils {
    ...
    public static @Nullable QNameModule getModuleQNameByPrefix(final @NonNull RootStmtContext<?, ?, ?> ctx,
        ...
        if (ctx.producesDeclared(SubmoduleStatement.class)) {
            verify(resolvedInfo.belongsTo().prefix().equals(prefix), "The specified prefix %s does "
                + "not match an imported or belongs-to prefix of module %s", prefix, resolvedInfo.sourceId());
