...
public record ResolvedSourceInfo(
    ...
    public record ResolvedInclude(@NonNull SourceIdentifier includeId, @NonNull QNameModule includeModuleQname) {
    ...
    public record ResolvedImport(@NonNull String prefix, @NonNull ResolvedSourceInfo importedModule) {
