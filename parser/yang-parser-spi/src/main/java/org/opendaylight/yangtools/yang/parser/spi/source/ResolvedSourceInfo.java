...
public record ResolvedSourceInfo(
     ...
     */
    public @NonNull Map<String, QNameModule> mapAccessibleModulesToPrefixes() {
        final var allPrefixed = new HashMap<String, QNameModule>();
     ...
     */
    public @Nullable ResolvedImport getImportByPrefix(final String findPrefix) {
