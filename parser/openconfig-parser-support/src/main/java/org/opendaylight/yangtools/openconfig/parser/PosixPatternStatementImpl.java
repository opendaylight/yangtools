...
final class PosixPatternStatementImpl extends WithSubstatements implements OpenConfigPosixPatternStatement {
    PosixPatternStatementImpl(final String rawArgument,
