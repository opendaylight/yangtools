...
import org.opendaylight.yangtools.openconfig.parser.OpenConfigParserExtension;
...
class DaggerTestComponentTest {
    ...
    void extensionsAreAvailable() {
        ...
        assertThat(extensions).hasAtLeastOneElementOfType(OpenConfigParserExtension.class);
    }
}
