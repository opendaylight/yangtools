...
final class InstanceTargetEffectiveStatementImpl extends WithSubstatements<String, @NonNull InstanceTargetStatement>
        implements InstanceTargetEffectiveStatement {
    InstanceTargetEffectiveStatementImpl(final @NonNull InstanceTargetStatement declared,
