...
final class AugmentIdentifierEffectiveStatementImpl
        extends WithSubstatements<Unqualified, @NonNull AugmentIdentifierStatement>
        implements AugmentIdentifierEffectiveStatement {
    AugmentIdentifierEffectiveStatementImpl(final @NonNull AugmentIdentifierStatement declared,
