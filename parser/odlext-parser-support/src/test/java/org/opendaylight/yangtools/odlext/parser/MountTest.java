...
class MountTest {
    ...
    void test() throws Exception {
        ...
        final var foo = reactor.newBuild()
            .addSource(YangStatementStreamSource.create(new ResourceYangTextSource(MountTest.class, "/yang-ext.yang")))
            .addSource(YangStatementStreamSource.create(new ResourceYangTextSource(MountTest.class, "/mount.yang")))
            .buildEffective()
            .getModuleStatements()
            .get(FOO);
