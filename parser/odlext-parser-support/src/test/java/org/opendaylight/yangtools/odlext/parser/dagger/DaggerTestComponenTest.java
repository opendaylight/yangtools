...
class DaggerTestComponenTest {
    @Test
    void extensionsAreAvailable() {
        final var component = DaggerTestComponent.create();
        final var extensions = component.extensions();
        assertThat(extensions).hasSize(2);
        assertThat(extensions).hasAtLeastOneElementOfType(OdlCodegenParserExtension.class);
        assertThat(extensions).hasAtLeastOneElementOfType(YangExtParserExtension.class);
    }
}
