...
public final class YangDataStatementSupport
    ...
    private record YangDataName(QNameModule module, String name) {
        YangDataName {
    ...
    private static final @NonNull ParserNamespace<YangDataName,
        StmtContext<String, YangDataStatement, YangDataEffectiveStatement>> NAMESPACE =
        new ParserNamespace<>("yang-data");
    public static final @NonNull NamespaceBehaviour<YangDataName,
        StmtContext<String, YangDataStatement, YangDataEffectiveStatement>> BEHAVIOUR =
    ...
    @Override
    public void onStatementAdded(final Mutable<String, YangDataStatement, YangDataEffectiveStatement> stmt) {
        ...
        final var name = new YangDataName(StmtContextUtils.getModuleQName(stmt.getRoot()), stmt.argument());
        final var prev = parent.namespaceItem(NAMESPACE, name);
        if (prev != null) {
            throw new SourceException(stmt,
                "Error in module '%s': cannot add '%s, already declared at %s", stmt.getRoot().rawArgument(), name,
                prev.sourceReference());
        }
