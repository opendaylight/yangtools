...
@NonNullByDefault
class ReactorNamespaceBindingTest {
    ...
    void toStringOrdersNamespaces() {
        final var binding = new ReactorNamespaceBinding(CURRENT, Map.of(FOO, FOONS, BAR, BARNS, BAZ, BAZNS));
        assertEquals("""
            ReactorNamespaceBinding{currentModule=currentns@2026-01-11, prefixToModule={bar=bar, baz=baz@2025-01-11, \
