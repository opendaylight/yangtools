...
sealed class UndeclaredStmtCtx<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    UndeclaredStmtCtx(final StatementContextBase<?, ?, ?> parent, final StatementSupport<A, D, E> support,
        ...
        this.argument = argument != null ? argument
            : definition().argumentFactory().parseArgumentValue(this, identifierBinding(), null);
    }
    ...
    UndeclaredStmtCtx(final StatementContextBase<?, ?, ?> parent, final StatementSupport<A, D, E> support,
        ...
        this.parent = requireNonNull(parent);
        initParent(parent);
        argument = definition().argumentFactory().parseArgumentValue(this, identifierBinding(), rawArgument);
    }
