...
public final class SourceLinkageResolver {
    ...
    List<ResolvedSource> resolveInvolvedSources() {
        ...
        involvedSourcesMap.forEach(this::tryResolveBelongsTo);
