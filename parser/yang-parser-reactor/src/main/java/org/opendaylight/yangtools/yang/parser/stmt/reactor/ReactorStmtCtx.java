...
abstract sealed class ReactorStmtCtx<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    private static final int IGNORE_IF_FEATURE   = 0x01;
    private static final int IGNORE_CONFIG       = 0x02;
    ...
    final void initFlags(final StatementContextBase<?, ?, ?> parent) {
    ...
    protected final boolean notResolvingConfig() {
