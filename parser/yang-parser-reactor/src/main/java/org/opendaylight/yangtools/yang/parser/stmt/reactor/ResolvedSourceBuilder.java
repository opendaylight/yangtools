...
final class ResolvedSourceBuilder {
     ...
     */
    @NonNullByDefault
    ResolvedSourceBuilder resolveInclude(final ResolvedSourceBuilder includedSubmodule) {
        ensureBuilderOpened();
     ...
     *
     * @param belongsTo the {@link BelongsTo}
     * @param belongsToModule {@link ResolvedSourceBuilder} of the parent module.
     * @return this instance.
     */
    @NonNullByDefault
    ResolvedSourceBuilder resolveBelongsTo(final BelongsTo belongsTo, final ResolvedSourceBuilder belongsToModule) {
        ensureBuilderOpened();
        this.belongsTo = new ResolvedBelongsTo(belongsTo, belongsToModule.resolveQnameModule());
        return this;
    }
