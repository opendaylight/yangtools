...
final class StatementContextWriter implements StatementWriter {
    ...
    private void fillNamespaces(final RootStatementContext<?,?,?> rootContext) {
        ...
        resolvedsource.getImports().forEach((prefix, importedModule) ->
            rootContext.addToNamespace(ParserNamespaces.IMPORT_PREFIX_TO_QNAME_MODULE, prefix, importedModule));
