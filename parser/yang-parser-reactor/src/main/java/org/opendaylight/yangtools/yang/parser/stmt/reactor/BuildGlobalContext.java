...
final class BuildGlobalContext extends AbstractNamespaceStorage implements GlobalStorage {
     ...
     */
    private @NonNull List<ResolvedSourceContext> resolveSources() throws SomeModifiersUnresolvedException {
        ...
        for (final ResolvedSourceContext resolvedContext : resolvedSourceContexts) {
