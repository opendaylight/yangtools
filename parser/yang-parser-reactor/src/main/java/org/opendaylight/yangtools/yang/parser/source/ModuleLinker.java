...
final class ModuleLinker extends ModuleBuilder {
     ...
     *
     * @param source the {@link ResolvedSourceInfo.Builder} to the source of requirements
     * @throws ReactorException if a requirement conflicts with a previous requirement
     */
    void requireIncludes(final ResolvedSourceInfo.Builder source) throws ReactorException {
    ...
    private void requireInclude(final ResolvedSourceInfo.Builder source, final Include dependency)
        ...
        // FIXME: Java 25: merge the two cases below when we can say 'case AnyRevision _' and move this allocation there
        final var depRef = dependency.sourceRef();
