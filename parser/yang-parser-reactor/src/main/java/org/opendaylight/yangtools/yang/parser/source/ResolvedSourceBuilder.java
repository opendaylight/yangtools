...
abstract sealed class ResolvedSourceBuilder<R extends SourceInfoRef> implements Mutable {
    ...
    private abstract static sealed class Dependencies<D extends SourceDependency, B extends ResolvedSourceBuilder<?>> {
         ...
         */
        @NonNullByDefault
        final <R> List<@NonNull R> buildResolved(final BiFunction<D, B, R> function) {
         ...
         */
        @NonNullByDefault
        abstract <R> List<@NonNull R> doBuildResolved(BiFunction<D, B, R> function);
        ...
        void doResolveMissing(final D dependency, final B builder) {
            if (!map.replace(dependency, null, builder)) {
                ...
                throw prev == null
                    ...
                    : new VerifyException(
                        "Attempted to override import " + dependency + " from " + prev + " to " + builder);
            }
        }
