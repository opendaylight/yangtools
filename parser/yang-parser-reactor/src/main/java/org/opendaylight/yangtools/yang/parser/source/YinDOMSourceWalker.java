...
record YinDOMSourceWalker(
    ...
    private void visitRoot(final @NonNull NodeList rootNodes) {
    ...
    private void skipRootAndWalkSource(final @NonNull NodeList rootNodes) {
        int childCounter = 0;
        for (int i = 0, len = rootNodes.getLength(); i < len; ++i) {
    ...
    private int getSubstatementsCount(final @NonNull Node parent) {
        int count = 0;
