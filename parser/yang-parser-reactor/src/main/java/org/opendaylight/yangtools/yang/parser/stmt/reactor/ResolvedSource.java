...
final class ResolvedSource {
    ...
    ResolvedSource(final @NonNull SourceSpecificContext context, final SourceIdentifier sourceId,
        final QNameModule qNameModule, final Map.Entry<String, QNameModule> belongsTo,
        final Map<String, ResolvedSource> resolvedImports,
    ...
    static final class Builder {
        ...
        public ResolvedSource build(final Map<SourceSpecificContext, ResolvedSource> allResolved) {
            ...
            buildFinished = new ResolvedSource(context, sourceInfo.sourceId(), resolveQnameModule(), resolvedBelongsTo,
                resolvedImports, resolvedIncludes);
            return buildFinished;
        }
