...
/**
 * A {@link NamespaceBinding} operating on a {@link RootStmtContext}. This class is NOT thread-safe.
 *
 * @since 14.0.22
 */
final class StmtContextNamespaceBinding implements NamespaceBinding {
    ...
    @NonNullByDefault
    StmtContextNamespaceBinding(final RootStmtContext<?, ?, ?> context) {
