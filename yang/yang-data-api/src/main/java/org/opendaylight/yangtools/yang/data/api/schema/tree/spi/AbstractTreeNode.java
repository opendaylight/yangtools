...
abstract class AbstractTreeNode implements TreeNode {
    ...
    private final Map<List<YangInstanceIdentifier>, TreeNodeIndex> indexes;

    protected AbstractTreeNode(final NormalizedNode<?, ?> data, final Version version) {
        this(data, version, ImmutableMap.of());
    }

    protected AbstractTreeNode(final NormalizedNode<?, ?> data, final Version version, final Map<List<YangInstanceIdentifier>, TreeNodeIndex> indexes) {
