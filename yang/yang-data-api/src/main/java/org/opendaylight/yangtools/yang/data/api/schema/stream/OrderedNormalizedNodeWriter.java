...
public class OrderedNormalizedNodeWriter extends NormalizedNodeWriter{
    ...
    public static final class DataSchemaPredicate implements Predicate<SchemaNode>{
        private final QName qname;

        public DataSchemaPredicate(final QName qname) {
            this.qname = qname;
        }

        @Override
        public boolean apply(final SchemaNode schemaNode) {
            return schemaNode.getQName().equals(qname);
        }
    }
    ...
    public NormalizedNodeWriter write(NormalizedNode<?, ?> node) throws IOException {
        ...
        return write(node, dataSchemaNode);
    }
