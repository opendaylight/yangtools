 ...
 * @param <K> {@link PathArgument} which identifies identifies child {@link DataContainerChild}ren.
 */
public interface DataContainerNode<K extends PathArgument>
        extends NormalizedNodeContainer<K, PathArgument, DataContainerChild> {
