...
import org.opendaylight.yangtools.yang.data.api.schema.OrderedByAware.OrderedBySystem;
 ...
 */
public interface SystemLeafSetNode<T> extends LeafSetNode<Unordered, T>, OrderedBySystem {
