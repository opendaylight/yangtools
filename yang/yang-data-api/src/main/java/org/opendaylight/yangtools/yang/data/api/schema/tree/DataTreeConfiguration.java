...
public class DataTreeConfiguration {
    public static final DataTreeConfiguration DEFAULT_CONFIGURATION = new DataTreeConfiguration(TreeType.CONFIGURATION, false);
    public static final DataTreeConfiguration DEFAULT_OPERATIONAL = new DataTreeConfiguration(TreeType.OPERATIONAL, false);

    private final TreeType treeType;
    private final boolean uniqueIndexes;

    public DataTreeConfiguration(final TreeType treeType, final boolean uniqueIndexes) {
    ...
    public static DataTreeConfiguration getDefault(final TreeType treeType) {
        ...
        default:
            return new DataTreeConfiguration(treeType, false);
        }
    }
}