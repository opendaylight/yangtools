 ...
 *            Value type
 */
public interface LeafSetEntryNode<T> extends AttributesContainer, NormalizedNode<NodeWithValue<T>, T>,
        ValueNode<NodeWithValue<T>, T> {
     ...
     * following condition is always met:
