 ...
 *
 */
public class ModifiedNodeDoesNotExistsException extends DataValidationFailedException {
    ...
    public ModifiedNodeDoesNotExistsException(final InstanceIdentifier path, final String message, final Throwable cause) {
        super(path, message, cause);
    }

    public ModifiedNodeDoesNotExistsException(final InstanceIdentifier path, final String message) {
        super(path, message);
    }
