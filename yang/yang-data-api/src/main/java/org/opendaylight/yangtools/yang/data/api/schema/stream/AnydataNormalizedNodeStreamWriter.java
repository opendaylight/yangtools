...
public interface AnydataNormalizedNodeStreamWriter extends NormalizedNodeStreamWriterExtension {
     ...
     */
    void startOpaqueAnydataNode(NodeIdentifier name, boolean accurateLists) throws IOException;
     ...
     * @throws IOException if an underlying IO error occurs
     */
    void startNormalizedAnydataNode(NodeIdentifier name) throws IOException;
