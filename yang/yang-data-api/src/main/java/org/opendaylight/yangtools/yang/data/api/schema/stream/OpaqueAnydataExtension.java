 ...
 *
 * <p>
 * Child nodes of an {@code anydata} node may be formed through {@link #startOpaqueContainer(NodeIdentifier)} and
 * {@link #startOpaqueList(NodeIdentifier)} methods.
 *
 * <p>
...
public interface OpaqueAnydataExtension extends NormalizedNodeStreamWriterExtension {
    interface StreamWriter extends ExtensibleObject<StreamWriter, StreamWriterException> {
        /**
        *
    ...
    /**
     * Start emitting a new anydata node identified by name. The content of the
     *
