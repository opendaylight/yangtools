...
/**
 * Abstract base for container-based {@link MutableTreeNode}s. It tracks
 * modified nodes in a map and deals with correctly implementing {@link #seal()}
 * .
 */
abstract class AbstractMutableContainerNode implements MutableTreeNode {
    ...
    private Map<List<YangInstanceIdentifier>, TreeNodeIndex> indexes;
    ...
    @Override
    public final void setIndexes(final Map<List<YangInstanceIdentifier>, TreeNodeIndex> treeNodeIndexes) {
        this.indexes = Preconditions.checkNotNull(treeNodeIndexes);
    }
    ...
    public final TreeNode seal() {
         ...
         *
         * => version equals subtree version, this node has not been updated
         * since its creation => children.size() equals data child size, this
         * node has been completely materialized and further lookups into data
         * will not happen, => more materialization can happen
         */
