...
public final class DataTreeCandidates {
    ...
    public static DataTreeCandidate aggregate(@NonNull List<DataTreeCandidate> candidates) {
    ...
    private static DataTreeCandidateNode compressNodes(final List<DataTreeCandidateNode> input) {
        ...
        return fastCompressNode(first,input);
    }
        ...
        switch (nodeModification) {
            case DELETE:
                ...
                if (dataBefore.isEmpty()) {
                    return new TerminalDataTreeCandidateNode(identifier,ModificationType.UNMODIFIED,
                            null,null);
                }
                else {
                    return new TerminalDataTreeCandidateNode(identifier, nodeModification,
                            dataBefore.get(), null);
                }
            case WRITE:
                if (dataBefore.isEmpty()) {
                ...
                if (dataBefore.get().getValue().equals(dataAfter.get().getValue())) {
                    return new TerminalDataTreeCandidateNode(identifier, ModificationType.UNMODIFIED,
                            dataBefore.get(),last.getDataAfter().get());
                }

                return new TerminalDataTreeCandidateNode(identifier, nodeModification,
                        dataBefore.get(), dataAfter.get());
            case APPEARED:
            case DISAPPEARED:
            case SUBTREE_MODIFIED:
            case UNMODIFIED:
    ...
    private static void compressNode(TerminalDataTreeCandidateNode finalNode,
                                     DataTreeCandidateNode node, PathArgument parent) {
        PathArgument identifier;
        try {
        ...
        switch (nodeModification) {
            ...
            case SUBTREE_MODIFIED:
                ...
                if (nodeModification == ModificationType.UNMODIFIED) {
        ...
        switch (firstModification) {
                ...
                if (hasNoDataBefore) {
                    switch (secondModification) {
                        ...
                        case SUBTREE_MODIFIED:
                            ...
                            break;
                        case DISAPPEARED:
                            illegalModification(ModificationType.DISAPPEARED, ModificationType.DELETE);
                            break;
                        default:
            ...
            case WRITE:
                switch (secondModification) {
                    ...
                    case APPEARED:
                        illegalModification(ModificationType.APPEARED, firstModification);
                        break;
                    default:
                        throw new IllegalStateException("Unsupported modification type " + secondModification);
                }
            case DELETE:
                switch (secondModification) {
                    ...
                    case APPEARED:
                        return ModificationType.WRITE;
                    case DELETE:
                        illegalModification(ModificationType.DELETE, firstModification);
                        break;
                    case DISAPPEARED:
                        illegalModification(ModificationType.DISAPPEARED, firstModification);
                        break;
                    case SUBTREE_MODIFIED:
                        illegalModification(ModificationType.SUBTREE_MODIFIED, firstModification);
                        break;
                    default:
                        throw new IllegalStateException("Unsupported modification type " + secondModification);
                }
    ...
    private static void illegalModification(ModificationType first, ModificationType second) {
