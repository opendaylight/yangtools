...
public final class DataTreeCandidates {
    ...
    public static @NonNull DataTreeCandidate aggregate(final List<DataTreeCandidate> candidates) {
    ...
    private static ModificationType compressModifications(final ModificationType firstModification,
            final ModificationType secondModification, final boolean hasNoDataBefore) {
