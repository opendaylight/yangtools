...
public final class DataTreeCandidates {
    ...
    private static DataTreeCandidateNode cleanUpTree(TerminalDataTreeCandidateNode finalNode, DataTreeCandidateNode node){
        YangInstanceIdentifier.PathArgument identifier = node.getIdentifier();
        ...
        switch (nodeModification){
            ...
            case APPEARED:
                if (dataBefore.isPresent()){
                    ...
                    else throw new IllegalArgumentException("Appear modification event on Write node");
                }
        ...
        switch (firstModification){
            ...
            case WRITE:
                switch (secondModification){
                    ...
                    case APPEARED:
                        throw new IllegalArgumentException("Appear modification event on " + firstModification + " node");
                    default:
            ...
            case DELETE:
                switch (secondModification){
                    ...
                    case APPEARED:
                        return ModificationType.WRITE;
                    case DELETE:
                        throw new IllegalArgumentException("Delete modification event on " + firstModification + " node");
                    case DISAPPEARED:
                        throw new IllegalArgumentException("Disappear modification event on " + firstModification + " node");
                    case SUBTREE_MODIFIED:
                        throw new IllegalArgumentException("Subtree modification modification event on " + firstModification + " node");
                    default:
                        throw new UnsupportedOperationException("Unsupported modification type " + secondModification);
                }
            case APPEARED:
