...
public final class DataTreeCandidates {
        ...
        switch (nodeModification) {
            case DELETE:
                ...
                if (dataBefore.isEmpty()) {
                    return new TerminalDataTreeCandidateNode(identifier,ModificationType.UNMODIFIED, null, null);
                }
                return new TerminalDataTreeCandidateNode(identifier, nodeModification, dataBefore.get(), null);
            case WRITE:
                return new TerminalDataTreeCandidateNode(identifier, nodeModification, dataBefore.orElse(null),
    ...
    private static void compressNode(final TerminalDataTreeCandidateNode finalNode,
                                     final DataTreeCandidateNode node, final PathArgument parent) {
        PathArgument identifier;
        try {
