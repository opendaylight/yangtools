 ...
 */
@Beta
public interface OrderedByAware {
    public interface OrderedBySystem extends OrderedByAware, Unordered {
        @Override
    ...
    public interface OrderedByUser extends OrderedByAware, Ordered {
        @Override
        default Ordering orderedBy() {
