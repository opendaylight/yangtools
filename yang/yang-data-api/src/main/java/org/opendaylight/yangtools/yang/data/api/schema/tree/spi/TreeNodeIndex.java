 ...
 * index provides {@link #get(K indexKey)} method to get data associated with
 * specified index key from index. Tree node index should be immutable, however
 * it provides {@link #mutable()} method to get a mutable copy of current tree
 * node index.
 *
 * @param <K>
 *            index key type
