...
public class DataTreeCandidatesAggregateTest {
    ...
    YangInstanceIdentifier rootPath = YangInstanceIdentifier.of(
            QName.create(
                    "urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test:container",
                    "2014-03-13",
                    "container"));

    final YangInstanceIdentifier.PathArgument childIdentifier = new YangInstanceIdentifier.NodeIdentifier(
            QName.create(
    ...
    public void testLeafUnmodifiedUnmodified() {
        ...
        DataTreeCandidate candidate1 = new DefaultDataTreeCandidate(rootPath,node1);

        DataTreeCandidateNode node2 = dataTreeCandidateNode(normalizedNode2,normalizedNode3,
                ModificationType.UNMODIFIED);
        DataTreeCandidate candidate2 = new DefaultDataTreeCandidate(rootPath,node2);
    ...
    private TerminalDataTreeCandidateNode dataTreeCandidateNode(NormalizedNode before,NormalizedNode after,
        ...
        Mockito.when(dataTreeCandidateNode.getIdentifier()).thenReturn(null);
    ...
    private void setChildNodes(TerminalDataTreeCandidateNode parentNode, List<DataTreeCandidateNode> childNodes) {
        ...
        childNodes.forEach(child -> {
            when(child.getIdentifier()).thenReturn(childIdentifier);
        });
