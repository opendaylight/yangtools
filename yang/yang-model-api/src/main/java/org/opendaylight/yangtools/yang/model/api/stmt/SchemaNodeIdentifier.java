...
public abstract class SchemaNodeIdentifier implements Immutable {
     ...
     */
    public static class RelativeSchemaPath extends SchemaNodeIdentifier {
        private RelativeSchemaPath(final SchemaNodeIdentifier parent, final QName qname) {
            super(parent, qname);
        }
     ...
     */
    public static final SchemaNodeIdentifier SAME = new RelativeSchemaPath(null, null);
