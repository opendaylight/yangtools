...
public class SchemaResolutionException extends SchemaSourceException {
    ...
    private static final String MESSAGE_BLUEPRINT =
            "%s, failed source: %s, resolved sources: %s, unsatisfied imports: %s";
    ...
    public SchemaResolutionException(@Nonnull final String message, final SourceIdentifier failedSource) {
        this(message, failedSource, null, Collections.emptySet(), ImmutableMultimap.of());
    }
    ...
    private static String formatMessage(final String message, final SourceIdentifier failedSource,
        ...
        return String.format(MESSAGE_BLUEPRINT, message, failedSource, resolvedSources, unsatisfiedImports);
    }
