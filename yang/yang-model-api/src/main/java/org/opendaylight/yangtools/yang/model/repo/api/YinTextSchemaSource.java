...
public abstract class YinTextSchemaSource extends ByteSource implements YinSchemaSourceRepresentation {
    ...
    protected YinTextSchemaSource(final @NonNull SourceIdentifier identifier) {
     ...
     */
    public static @NonNull YinTextSchemaSource delegateForByteSource(final @NonNull SourceIdentifier identifier,
            final @NonNull ByteSource delegate) {
        return new DelegatedYinTextSchemaSource(identifier, delegate);
    }

    public static @NonNull YinTextSchemaSource forFile(final @NonNull File file) {
