...
public interface EffectiveStatement<A, S extends DeclaredStatement<A>> extends ModelStatement<A> {
     ...
     */
    @Nullable
    <K, V, N extends IdentifierNamespace<? super K, ? extends V>> V get(Class<N> namespace, K identifier);
     ...
     */
    @Nullable
    <K, V, N extends IdentifierNamespace<K, V>> Map<K, V> getAll(Class<N> namespace);
     ...
     */
    public Iterable<? extends EffectiveStatement<?, ?>> effectiveSubstatements();
