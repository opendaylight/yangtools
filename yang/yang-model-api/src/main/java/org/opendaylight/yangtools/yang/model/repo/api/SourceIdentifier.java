...
public abstract class SourceIdentifier implements Identifier, Immutable {
     ...
     *            Name of schema
     */
    public static RevisionSourceIdentifier createRevisionSourceIdentifier(final String moduleName) {
     ...
     *            Revision of source in format YYYY-mm-dd
     */
    public static RevisionSourceIdentifier createRevisionSourceIdentifier(final String moduleName, final String revision) {
        return new RevisionSourceIdentifier(moduleName, revision);
    }
     ...
     */
    public static SemVerSourceIdentifier createSemVerSourceIdentifier(final String moduleName, final SemVer semVer) {
     ...
     *            semantic version of source
     */
    public static SemVerSourceIdentifier createSemVerSourceIdentifier(final String moduleName, final String revision,
            final SemVer semVer) {
     ...
     *            semantic version of source
     */
    public static SemVerSourceIdentifier createSemVerSourceIdentifier(final String moduleName,
