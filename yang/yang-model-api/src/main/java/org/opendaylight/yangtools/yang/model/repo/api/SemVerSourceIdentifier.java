...
public final class SemVerSourceIdentifier extends SourceIdentifier {
     ...
     */
    SemVerSourceIdentifier(final @NonNull String name, final Optional<Revision> revision,
     ...
     * @param semVer semantic version of source
     */
    SemVerSourceIdentifier(final @NonNull String name, final @Nullable SemVer semVer) {
     ...
     * @param semVer semantic version of source
     */
    public static @NonNull SemVerSourceIdentifier create(final @NonNull String moduleName, final SemVer semVer) {
     ...
     * @param semVer semantic version of source
     */
    public static @NonNull SemVerSourceIdentifier create(final @NonNull String moduleName,
     ...
     */
    public static @NonNull SemVerSourceIdentifier create(final @NonNull String moduleName,
            final Optional<Revision> revision, final @Nullable SemVer semVer) {
