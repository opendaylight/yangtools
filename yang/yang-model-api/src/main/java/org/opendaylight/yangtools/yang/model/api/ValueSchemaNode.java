...
/**
 * A {@link DataSchemaNode} which holds leaf values of the same type. This can be either a single value, like
 * in a {@link LeafSchemaNode} or multiple values, like a {@link LeafListSchemaNode}.
 *
 * @author Robert Varga
 */
public interface ValueSchemaNode extends DataSchemaNode {
    /**
