...
public final class RevisionSourceIdentifier extends SourceIdentifier {
     ...
     */
    RevisionSourceIdentifier(final @NonNull String name) {
        super(name);
    }
     ...
     */
    RevisionSourceIdentifier(final @NonNull String name, final @Nullable Revision revision) {
     ...
     */
    private RevisionSourceIdentifier(final @NonNull String name, final Optional<Revision> revision) {
        super(name, revision);
    }
     ...
     */
    public static @NonNull RevisionSourceIdentifier create(final @NonNull String moduleName,
