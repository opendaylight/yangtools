...
public final class SchemaContextFactoryConfiguration implements Immutable {
    ...
    public boolean equals(final Object obj) {
        ...
        return Objects.equals(filter, other.filter) && Objects.equals(statementParserMode, other.statementParserMode)
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("schemaSourceFilter", filter)
    ...
    public static class Builder
        ...
        public Builder setModulesDeviatedByModules(final Map<QNameModule, Set<QNameModule>> modulesDeviatedByModules) {
            this.modulesDeviatedByModules = modulesDeviatedByModules != null
                    ? ImmutableMap.copyOf(modulesDeviatedByModules) : null;
            return this;
        }
