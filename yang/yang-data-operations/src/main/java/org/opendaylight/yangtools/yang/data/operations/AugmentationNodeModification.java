...
class AugmentationNodeModification implements Modification<AugmentationSchema, AugmentationNode> {
...
//    public static final MapNodeModification LIST_NODE_MODIFICATION = new MapNodeModification();
    ...
    @Override
    public Optional<AugmentationNode> modify(AugmentationSchema schema,  Optional<AugmentationNode> actual,
                                   Optional<AugmentationNode> modification, OperationStack operationStack)
            throws DataModificationException {

        Optional<AugmentationNode> result = null;
    ...
    private Optional<AugmentationNode> modifyContainer(AugmentationSchema schema, Optional<AugmentationNode> actual, Optional<AugmentationNode> modification, OperationStack operationStack)
            throws DataModificationException {
    ...
    private List<? extends DataContainerChild<?, ?>> modifyContainerChildNodes(AugmentationSchema schema, OperationStack operationStack,
                                                                               AugmentationNode actual, AugmentationNode modification, Set<InstanceIdentifier.PathArgument> toProcess) throws DataModificationException {
    ...
    private Optional<? extends DataContainerChild<?, ?>> modifyContainerNode(OperationStack operationStack, AugmentationNode actual, AugmentationNode modification, InstanceIdentifier.PathArgument childToProcess, Object schemaChild) throws DataModificationException {
...
//                    NodeWrappers.wrapListNodes(listSchema, modification), operations);
    ...
    private Object findSchema(AugmentationSchema schema, InstanceIdentifier.PathArgument childToProcessId) {
    ...
    private static Optional<AugmentationNode> build(AugmentationSchema schema, List<? extends DataContainerChild<?, ?>> result) {
        DataContainerNodeBuilder<InstanceIdentifier.AugmentationIdentifier, AugmentationNode> b = Builders.augmentationBuilder(schema);
    ...
    private static Set<InstanceIdentifier.PathArgument> getQNamesToProcess(Optional<AugmentationNode> actual, Optional<AugmentationNode> modification) {
    ...
    private static Set<? extends InstanceIdentifier.PathArgument> getChildQNames(Optional<AugmentationNode> actual) {
        Set<InstanceIdentifier.PathArgument> qNames = Sets.newHashSet();
