...
public abstract class AbstractSchemaTreeStatementSupport<D extends DeclaredStatement<QName>,
    ...
    protected static final class EffectiveSchemaTreeStatementState extends EffectiveStatementState {
        private final int flags;

        protected EffectiveSchemaTreeStatementState(final Current<QName, ?> stmt, final int flags) {
            super(stmt.effectivePath());
            this.flags = flags;
        }
    ...
    public final EffectiveStatementState extractEffectiveState(final E stmt) {
        return extractState(stmt);
    }

    protected abstract @NonNull EffectiveSchemaTreeStatementState extractState(@NonNull E stmt);
}
