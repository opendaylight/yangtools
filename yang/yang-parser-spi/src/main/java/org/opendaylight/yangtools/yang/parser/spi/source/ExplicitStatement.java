...
public abstract class ExplicitStatement extends StatementSourceReference implements DeclarationReference {
    ...
    public static @NonNull ExplicitStatement atPosition(final String fileName, final int line, final int column) {
        return new InTextFile(fileName, line, column);
    }

    public static @NonNull ExplicitStatement inFile(final String fileName) {
