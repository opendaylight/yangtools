...
public abstract class AbstractStatementSupport<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    @Beta
    protected AbstractStatementSupport(final StatementDefinition publicDefinition, final boolean contextIndependent) {
    ...
    public Optional<? extends Mutable<?, ?, ?>> copyAsChildOf(final Mutable<?, ?, ?> stmt,
        ...
        if (contextIndependent && stmt.allSubstatementsStream().findAny().isEmpty()) {
