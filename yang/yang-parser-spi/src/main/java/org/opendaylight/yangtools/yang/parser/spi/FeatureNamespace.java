...
public final class FeatureNamespace extends StatementNamespace<QName, FeatureStatement, FeatureEffectiveStatement> {
    public static final @NonNull FeatureNamespace INSTANCE = new FeatureNamespace();

    private FeatureNamespace() {
        super(ModelProcessingPhase.FULL_DECLARATION, NamespaceBehaviour.global(FeatureNamespace.class));
    }
}
