...
public interface CommonStmtCtx {
     ...
     */
    @NonNull StatementSourceReference statementSourceReference();
     ...
     */
    default @NonNull StatementSource statementSource() {
        return statementSourceReference().getStatementSource();
    }
}
