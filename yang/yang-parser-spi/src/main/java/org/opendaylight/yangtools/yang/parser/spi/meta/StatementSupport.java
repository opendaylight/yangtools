...
public abstract class StatementSupport<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
     ...
     */
    public final @NonNull StmtContext<?, ?, ?> effectiveCopyOf(final StmtContext<?, ?, ?> stmt, final Mutable<?, ?, ?> parent,
            final CopyType copyType, final @Nullable QNameModule targetModule) {
        switch (copyPolicy) {
