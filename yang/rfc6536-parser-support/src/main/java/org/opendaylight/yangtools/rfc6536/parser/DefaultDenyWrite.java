...
final class DefaultDenyWrite
    ...
    private static final DefaultDenyWrite INSTANCE = new DefaultDenyWrite(NACMStatements.DEFAULT_DENY_WRITE);

    private final SubstatementValidator validator;

    DefaultDenyWrite(final StatementDefinition definition) {
        super(definition);
