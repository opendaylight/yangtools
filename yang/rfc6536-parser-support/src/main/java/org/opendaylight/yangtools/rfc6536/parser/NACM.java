...
public final class NACM {
    ...
    /**
     * Return a collection of statements which need to be added into parser reactor to enable support for NACM.
     *
     * @return Collection of statements to be added.
     */
    public static Collection<StatementSupport<?, ?, ?>> getStatements() {
        return ImmutableList.of(DefaultDenyAll.getInstance(), DefaultDenyWrite.getInstance());
    }
}
