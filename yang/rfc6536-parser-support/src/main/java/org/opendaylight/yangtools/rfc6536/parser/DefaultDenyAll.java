...
final class DefaultDenyAll
    ...
    private static final DefaultDenyAll INSTANCE = new DefaultDenyAll(NACMStatements.DEFAULT_DENY_ALL);

    private final SubstatementValidator validator;

    private DefaultDenyAll(final StatementDefinition definition) {
        super(definition);
