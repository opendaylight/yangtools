...
public class MapEntryNodeNormSerializer extends
        MapEntryNodeBaseSerializer<Node<?>> {
    ...
    public List<Node<?>> serialize(ListSchemaNode schema, MapEntryNode node) {
    	...
    	MutableCompositeNode mutCompNode = NodeFactory.createMutableCompositeNode(
    			node.getNodeType(), null, null, null, null);
    ...
    protected NodeSerializerDispatcher<Node<?>> getNodeDispatcher() {
        return NormNodeSerializerDispatcher.getInstance();
    }
}
