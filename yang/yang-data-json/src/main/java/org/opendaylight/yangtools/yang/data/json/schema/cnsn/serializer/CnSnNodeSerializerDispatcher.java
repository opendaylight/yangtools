...
final class CnSnNodeSerializerDispatcher extends NodeSerializerDispatcher.BaseNodeSerializerDispatcher<Node<?>> {

    private static CnSnNodeSerializerDispatcher instance;
    ...
    CnSnNodeSerializerDispatcher() {
        containerSerializer = new ContainerNodeCnSnSerializer();
        choiceSerializer = new ChoiceNodeCnSnSerializer();
        augmentSerializer = new AugmentationNodeCnSnSerializer();
        leafNodeSerializer = new LeafNodeCnSnSerializer();
        leafSetSerializer = new LeafSetNodeCnSnSerializer();
        mapNodeSerializer = new MapNodeCnSnSerializer();
    }

    static CnSnNodeSerializerDispatcher getInstance() {
        if (instance == null) {
            instance = new CnSnNodeSerializerDispatcher();
        }
        return instance;
    }
