 ...
 */
package org.opendaylight.controller.yang.data.codec.gson.serialization;
...
public class NormalizedNodeToStreamWriter {
    ...
    private boolean wasProcessAsSimpleNode(NormalizedNode<?, ?> node, NormalizedNodeStreamWriter nnsw) {
    ...
    private boolean wasProcessedAsCompositeNode(NormalizedNode<?, ?> node, NormalizedNodeStreamWriter nnsw) {
