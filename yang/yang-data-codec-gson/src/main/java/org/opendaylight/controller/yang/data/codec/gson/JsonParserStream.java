 ...
 */
package org.opendaylight.controller.yang.data.codec.gson;


import org.opendaylight.controller.yang.data.codec.gson.helpers.IdentityValuesDTO;
import org.opendaylight.controller.yang.data.codec.gson.helpers.RestCodec;
import org.opendaylight.controller.yang.data.codec.gson.helpers.RestUtil;
import org.opendaylight.controller.yang.data.codec.gson.helpers.SchemaContextUtils;
import org.opendaylight.controller.yang.data.codec.gson.helpers.RestUtil.PrefixMapingFromJson;
...
public class JsonParserStream {
    ...
    public JsonParserStream(final NormalizedNodeStreamWriter nnStreamWriter, final SchemaContext schemaContext) {
        this.normalizedNodeStreamWriter = nnStreamWriter;
        SchemaContextUtils.getInstance().setSchemaContext(schemaContext);
    }
...
//                FIXME:anyxml data shouldn't be skipped but should be loaded somehow. will be specified after 17AUG2014
    ...
    private Object translateValueByType(String value, DataSchemaNode schema) {
        ...
        if (typeDefinition != null) {
            Codec<Object, Object> codec = RestCodec.from(typeDefinition);
    ...
    private NamespaceAndName resolveNamespace(final String childName) {
        ...
        if (lastIndexOfColon != -1) {
            ...
            namespace = SchemaContextUtils.getInstance().findNamespaceByModuleName(moduleNamePart);
        } else {
