 ...
 */
@Beta
public enum JSONCodecFactories {
    /**
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JSONCodecFactories.class);
    ...
    private static final class EagerCacheLoader extends CacheLoader<SchemaContext, JSONCodecFactory> {
        ...
        @Override
        public final JSONCodecFactory load(final SchemaContext key) {
     ...
     */
    public JSONCodecFactory getPrecomputed(final SchemaContext context) {
     ...
     * @throws NullPointerException if context is null
     */
    public Optional<JSONCodecFactory> getPrecomputedIfAvailable(final SchemaContext context) {
     ...
     * @throws NullPointerException if context is null
     */
    public JSONCodecFactory getShared(final SchemaContext context) {
     ...
     * @throws NullPointerException if context is null
     */
    public JSONCodecFactory createLazy(final SchemaContext context) {
     ...
     * @throws NullPointerException if context is null.
     */
    public JSONCodecFactory createSimple(final SchemaContext context) {
