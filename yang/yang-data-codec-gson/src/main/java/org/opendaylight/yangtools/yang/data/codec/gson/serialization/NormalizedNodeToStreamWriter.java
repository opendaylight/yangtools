...
public class NormalizedNodeToStreamWriter {
    ...
    public void serialize(final NormalizedNode<?, ?> node, final NormalizedNodeStreamWriter nnsw) throws IOException {
    ...
    private boolean wasProcessAsSimpleNode(final NormalizedNode<?, ?> node, final NormalizedNodeStreamWriter nnsw) throws IOException {
    ...
    private boolean wasProcessedAsCompositeNode(final NormalizedNode<?, ?> node, final NormalizedNodeStreamWriter nnsw) throws IOException {
