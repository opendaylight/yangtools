...
public class JSONNormalizedNodeStreamWriter implements NormalizedNodeStreamWriter {
    ...
    private final SchemaContextUtils schemaContextUtils;
    ...
    public void leafNode(final NodeIdentifier name, final Object value) throws IllegalArgumentException {
        try {
            ...
            throw new OutputStreamWritingException(name, e);
        }
    }
    ...
    public void leafSetEntryNode(final Object value) throws IllegalArgumentException {
        try {
            ...
            throw new OutputStreamWritingException(value, e);
        }
    }
    ...
    public void startMapEntryNode(final NodeIdentifierWithPredicates identifier, final int childSizeHint)
        ...
        try {
            ...
            throw new OutputStreamWritingException(identifier, e);
        }
    }
    ...
    public void endNode() throws IllegalStateException {
        ...
        case list:
            ...
            try {
                ...
                throw new OutputStreamWritingException("Wasn't possible to write to output stream.", e);
            }
            break;
        case object:
            indentLeft();
