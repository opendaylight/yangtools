...
import org.opendaylight.yangtools.yang.data.codec.gson.helpers.RestCodec;
...
public class JsonParserStream {
    ...
    private final NormalizedNodeStreamWriter normalizedNodeStreamWriter;
...
//                FIXME:anyxml data shouldn't be skipped but should be loaded somehow. will be specified after 17AUG2014
    ...
    private Object translateValueByType(final String value, final DataSchemaNode schema) {
