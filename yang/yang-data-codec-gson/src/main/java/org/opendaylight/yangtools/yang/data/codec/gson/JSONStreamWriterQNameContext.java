...
abstract class JSONStreamWriterQNameContext extends JSONStreamWriterContext {
    ...
    protected JSONStreamWriterQNameContext(final JSONStreamWriterContext parent, final QName qname, final boolean mandatory, final double depth) {
        super(parent, mandatory, depth);
