...
public class JSONNormalizedNodeStreamWriter implements NormalizedNodeStreamWriter {
    ...
    private JSONNormalizedNodeStreamWriter(final JSONCodecFactory codecFactory, final SchemaPath path,
            final Writer writer, final int JSONWriterType, final URI initialNs, final int indentSize) {
    ...
    public static NormalizedNodeStreamWriter create(final SchemaContext schemaContext, final Writer writer) {
        return new JSONNormalizedNodeStreamWriter(JSONCodecFactory.create(schemaContext), SchemaPath.ROOT, writer, JSONWriterFactory.DEFAULT_JSON_WRITER , null, 0);
    }
    ...
    public static NormalizedNodeStreamWriter create(final SchemaContext schemaContext, final SchemaPath path, final Writer writer) {
        return new JSONNormalizedNodeStreamWriter(JSONCodecFactory.create(schemaContext), path, writer, JSONWriterFactory.DEFAULT_JSON_WRITER, null, 0);
    }
    ...
    public static NormalizedNodeStreamWriter create(final SchemaContext schemaContext, final SchemaPath path,
        ...
        return new JSONNormalizedNodeStreamWriter(JSONCodecFactory.create(schemaContext), path, writer, JSONWriterFactory.DEFAULT_JSON_WRITER, initialNs, 0);
    }
    ...
    public static NormalizedNodeStreamWriter create(final SchemaContext schemaContext, final Writer writer, final int indentSize) {
        return new JSONNormalizedNodeStreamWriter(JSONCodecFactory.create(schemaContext), SchemaPath.ROOT, writer, JSONWriterFactory.DEFAULT_JSON_WRITER, null, indentSize);
    }
    ...
    public static NormalizedNodeStreamWriter create(final JSONCodecFactory codecFactory, final Writer writer, final int indentSize) {
        return new JSONNormalizedNodeStreamWriter(codecFactory, SchemaPath.ROOT, writer, JSONWriterFactory.DEFAULT_JSON_WRITER, null, indentSize);
    }

    /**
     * Create a new stream writer, which writes to the specified {@link Writer}.
     *
     * @param JSONWriterType JSONWriter type (e.g. JSONWriterFactory.GOOGLE_JSON_WRITER)
     * @param schemaContext Schema context
     * @param writer Output writer
     * @return A stream writer instance
     */
    public static NormalizedNodeStreamWriter create(final int JSONWriterType, final SchemaContext schemaContext, final Writer writer) {
     ...
     * @return A stream writer instance
     */
    public static NormalizedNodeStreamWriter create(final int JSONWriterType, final SchemaContext schemaContext, final SchemaPath path, final Writer writer) {
     ...
     * @return A stream writer instance
     */
    public static NormalizedNodeStreamWriter create(final int JSONWriterType, final SchemaContext schemaContext, final SchemaPath path,
            final URI initialNs, final Writer writer) {
     ...
     * @return A stream writer instance
     */
    public static NormalizedNodeStreamWriter create(final int JSONWriterType, final SchemaContext schemaContext, final Writer writer, final int indentSize) {
     ...
     * @return A stream writer instance
     */
    public static NormalizedNodeStreamWriter create(final int JSONWriterType, final JSONCodecFactory codecFactory, final Writer writer, final int indentSize) {
