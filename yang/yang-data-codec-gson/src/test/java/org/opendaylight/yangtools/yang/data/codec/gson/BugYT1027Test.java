...
public class BugYT1027Test extends AbstractComplexJsonTest {
    ...
    private static Rfc7951JSONCodecFactory rfc7951CodecFactory;
    ...
    public static void beforeTestClass() {
        rfc7951CodecFactory = Rfc7951JSONCodecFactorySupplier.getInstance().getShared(schemaContext);
