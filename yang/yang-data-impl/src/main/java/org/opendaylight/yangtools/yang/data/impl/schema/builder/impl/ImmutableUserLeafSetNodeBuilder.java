...
public class ImmutableUserLeafSetNodeBuilder<T> implements OrderedListNodeBuilder<T, LeafSetEntryNode<T>> {
    ...
    public static <T> @NonNull OrderedListNodeBuilder<T, LeafSetEntryNode<T>> create() {
    ...
    protected static final class ImmutableUserLeafSetNode<T> extends
