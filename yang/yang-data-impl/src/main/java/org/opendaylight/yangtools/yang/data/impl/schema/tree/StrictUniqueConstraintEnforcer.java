...
final class StrictUniqueConstraintEnforcer extends UniqueConstraintEnforcer {
    private final List<Set<YangInstanceIdentifier>> mapNodeUniqueLeafIdentifiers;

    StrictUniqueConstraintEnforcer(final Collection<UniqueConstraint> uniqueConstraints) {
