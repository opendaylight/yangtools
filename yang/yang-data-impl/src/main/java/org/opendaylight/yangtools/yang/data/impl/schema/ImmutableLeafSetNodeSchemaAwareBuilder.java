...
public class ImmutableLeafSetNodeSchemaAwareBuilder<T> extends ImmutableLeafSetNodeBuilder<T> {
    ...
    public static <T> ImmutableLeafSetNodeSchemaAwareBuilder<T> get(LeafListSchemaNode schema) {
