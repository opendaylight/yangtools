...
final class NoOpUniqueConstraintEnforcer extends UniqueConstraintEnforcer {
    static final NoOpUniqueConstraintEnforcer INSTANCE = new NoOpUniqueConstraintEnforcer();

    private NoOpUniqueConstraintEnforcer() {
        // Hidden on purpose
    }
