...
final class UnkeyedListNodeDomParser extends UnkeyedListNodeBaseParser<Element> {
    ...
    UnkeyedListNodeDomParser(final BuildingStrategy<NodeIdentifier, UnkeyedListNode> buildingStrategy,
                             final UnkeyedListEntryNodeDomParser unkeyedListEntryNodeParser,
                             final SchemaAwareNormalizedNodeStreamWriter writer) {
