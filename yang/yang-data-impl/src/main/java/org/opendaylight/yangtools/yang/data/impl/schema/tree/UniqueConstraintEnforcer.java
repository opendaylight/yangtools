...
abstract class UniqueConstraintEnforcer implements Immutable {
    private static final class NoOp extends UniqueConstraintEnforcer {
        ...
        @Override
        protected  Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> updateIndexes(final Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> treeNodeIndexes,
                final NormalizedNode<?, ?> data) {
            return ImmutableMap.of();
        }

        @Override
        protected  Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> removeFromIndexes(final Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> treeNodeIndexes,
    ...
    private static final class Strict extends UniqueConstraintEnforcer {
        ...
        protected Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> createIndexesFromData(final NormalizedNode<?, ?> data) {
            ...
            for (final Set<YangInstanceIdentifier> uniqueLeafIdentifiers : mapNodeUniqueLeafIdentifiers) {
                indexesBuilder.put(uniqueLeafIdentifiers, MutableUniqueIndex.createFromData(uniqueLeafIdentifiers, data).seal());
            }
    ...
    protected abstract  Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> updateIndexes(Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> treeNodeIndexes,
            NormalizedNode<?, ?> data);

    protected abstract  Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> removeFromIndexes(Map<Set<YangInstanceIdentifier>, TreeNodeIndex<?, ?>> treeNodeIndexes,
            PathArgument id);
