...
public class ImmutableContainerNodeSchemaAwareBuilder extends ImmutableContainerNodeBuilder {
    ...
    public static ImmutableContainerNodeSchemaAwareBuilder get(ContainerSchemaNode schema) {
