...
public class LeafSetNodeDomSerializer extends
    ...
    private FromNormalizedNodeSerializer<Element, LeafSetEntryNode<?>, LeafListSchemaNode> leafSetEntryNodeSerializer;

    public LeafSetNodeDomSerializer(Document doc, XmlCodecProvider codec) {
        this.leafSetEntryNodeSerializer = new LeafSetEntryNodeDomSerializer(doc, codec);
    }
