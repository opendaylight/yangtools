...
final class UniqueIndex implements TreeNodeIndex<UniqueIndexKey, MapEntryNode> {
    ...
    protected static UniqueIndex createEmpty(final Set<YangInstanceIdentifier> uniqueLeafIdentifiers) {
        return new UniqueIndex(uniqueLeafIdentifiers);
    }

    protected static UniqueIndex createFromData(final Set<YangInstanceIdentifier> uniqueLeafIdentifiers,
    ...
    private void updateEntry(final MapEntryNode data) {
        ...
        put(new UniqueIndexKey(indexKey), data);
    }
