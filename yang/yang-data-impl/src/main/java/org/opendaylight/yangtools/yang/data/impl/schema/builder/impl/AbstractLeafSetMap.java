...
abstract class AbstractLeafSetMap<T> extends AbstractMap<NodeWithValue, LeafSetEntryNode<T>> implements Map<NodeWithValue, LeafSetEntryNode<T>>, Serializable {
    ...
    protected static final class SimpleLeafSetEntryNode<T> implements LeafSetEntryNode<T> {
        private final NodeWithValue key;

        SimpleLeafSetEntryNode(final NodeWithValue key) {
