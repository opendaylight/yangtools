...
public final class XMLStreamNormalizedNodeStreamWriter implements NormalizedNodeStreamWriter {
    ...
    private XMLStreamNormalizedNodeStreamWriter(final SchemaContext context, final XMLStreamWriter writer, final SchemaPath path) {
    ...
    public static NormalizedNodeStreamWriter create(final SchemaContext context, final XMLStreamWriter writer) {
        return create(context, writer, SchemaPath.ROOT);
    }

    public static NormalizedNodeStreamWriter create(final SchemaContext context, final XMLStreamWriter writer, final SchemaPath path) {
        ...
        return new XMLStreamNormalizedNodeStreamWriter(context, writer, path);
    }
    ...
    private void writeElement(final SchemaNode schema, final Node<?> value) throws IOException {
        ...
        try {
            if (value != null) {
                writer.writeStartElement(ns, qname.getLocalName());
                UTILS.writeValue(writer, value, schema);
                writer.writeEndElement();
            } else {
                writer.writeEmptyElement(ns, qname.getLocalName());
            }
    ...
    public void anyxmlNode(final NodeIdentifier name, final Object value) throws IOException {
        ...
        writeElement(schema, (Node<?>)value);
    }

    @Override
    public void endNode() throws IOException {
        final Object schema = pop();
