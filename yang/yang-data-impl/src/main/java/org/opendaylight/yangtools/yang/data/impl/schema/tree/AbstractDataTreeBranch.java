...
import org.opendaylight.yangtools.yang.data.api.schema.tree.DataTreeBranch;
import org.opendaylight.yangtools.yang.data.api.schema.tree.DataTreeCandidateBranch;
import org.opendaylight.yangtools.yang.data.api.schema.tree.DataTreeModification;
import org.opendaylight.yangtools.yang.data.api.schema.tree.DataValidationFailedException;
import org.opendaylight.yangtools.yang.data.api.schema.tree.spi.TreeNode;

abstract class AbstractDataTreeBranch implements DataTreeBranch {
    ...
    /**
     * Return the current root node of this branch.
     *
     * @return Current branch root node, may not be null.
     */
    @Nonnull protected abstract TreeNode getBranchRoot();
    ...
    public final void validate(final DataTreeModification modification) throws DataValidationFailedException {
        ...
        m.getStrategy().checkApplicable(PUBLIC_ROOT_PATH, m.getRootModification(), Optional.of(getBranchRoot()));
    }

    @Override
    public final DataTreeCandidateBranch prepare(final DataTreeModification modification) {
        Preconditions.checkArgument(modification instanceof InMemoryDataTreeModification, "Invalid modification class %s", modification.getClass());

        final InMemoryDataTreeModification m = (InMemoryDataTreeModification)modification;
        final ModifiedNode root = m.getRootModification();

        final TreeNode currentRoot = getBranchRoot();
