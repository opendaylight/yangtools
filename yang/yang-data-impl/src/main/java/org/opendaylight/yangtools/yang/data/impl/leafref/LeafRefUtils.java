...
public final class LeafRefUtils {
    ...
    public static LeafRefPath createAbsoluteLeafRefPath(
        ...
        final Deque<QNameWithPredicate> absoluteLeafRefTargetPathList = schemaStackToXPathQNames(
                stack, module);
    ...
    private static Deque<QNameWithPredicate> schemaStackToXPathQNames(final SchemaInferenceStack stack,
            final Module module) {
        final Deque<QNameWithPredicate> xpath = new LinkedList<>();
        final Iterator<QName> nodePathIterator = stack.inInstantiatedContext()
            ? stack.toSchemaNodeIdentifier().getNodeIdentifiers().iterator()
    ...
    public static LeafRefPath schemaStackToLeafRefPath(final SchemaInferenceStack stack, final Module module) {
        return LeafRefPath.create(schemaStackToXPathQNames(stack, module), true);
    }
}
