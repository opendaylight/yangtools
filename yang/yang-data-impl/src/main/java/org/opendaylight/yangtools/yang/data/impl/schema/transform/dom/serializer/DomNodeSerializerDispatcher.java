...
final class DomNodeSerializerDispatcher extends NodeSerializerDispatcher.BaseNodeSerializerDispatcher<Element> {
    ...
    DomNodeSerializerDispatcher(Document doc, XmlCodecProvider codecProvider) {
        ...
        leafSetSerializer = new LeafSetNodeDomSerializer(doc, codecProvider);
        mapNodeSerializer = new MapNodeDomSerializer(doc, codecProvider);
    }
    ...
    @Override
    protected FromNormalizedNodeSerializer<Element, ContainerNode, ContainerSchemaNode> getContainerNodeDomSerializer() {
        return containerSerializer;
    }

    @Override
    protected FromNormalizedNodeSerializer<Element, LeafNode<?>, LeafSchemaNode> getLeafNodeDomSerializer() {
        return leafNodeSerializer;
    }

    @Override
    protected FromNormalizedNodeSerializer<Element, LeafSetNode<?>, LeafListSchemaNode> getLeafSetNodeDomSerializer() {
        return leafSetSerializer;
    }

    @Override
    protected FromNormalizedNodeSerializer<Element, MapNode, ListSchemaNode> getMapNodeDomSerializer() {
        return mapNodeSerializer;
    }

    @Override
    protected FromNormalizedNodeSerializer<Element, ChoiceNode, org.opendaylight.yangtools.yang.model.api.ChoiceNode> getChoiceNodeDomSerializer() {
        return choiceSerializer;
    }

    @Override
    protected FromNormalizedNodeSerializer<Element, AugmentationNode, AugmentationSchema> getAugmentationNodeDomSerializer() {
