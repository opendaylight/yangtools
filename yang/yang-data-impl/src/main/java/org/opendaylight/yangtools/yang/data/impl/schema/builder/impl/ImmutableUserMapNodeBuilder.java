...
public class ImmutableUserMapNodeBuilder implements CollectionNodeBuilder<MapEntryNode, UserMapNode> {
    ...
    protected static final class ImmutableUserMapNode extends AbstractImmutableNormalizedNode<NodeIdentifier>
        ...
        protected boolean valueEquals(final AbstractImmutableNormalizedNode<?> other) {
            return children.equals(((ImmutableUserMapNode) other).children);
        }
