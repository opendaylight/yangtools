...
public class LeafRefContextUtils {
    ...
    public static LeafRefContext getLeafRefReferencingContext(SchemaNode node,
            LeafRefContext root) {
    ...
    public static LeafRefContext getLeafRefReferencedByContext(SchemaNode node,
            LeafRefContext root) {
        SchemaPath schemaPath = node.getPath();
    ...
    public static boolean isReferencedByLeafRef(SchemaNode node,
            LeafRefContext root) {
    ...
    public static boolean hasChildReferencedByLeafRef(SchemaNode node,
            LeafRefContext root) {
    ...
    public static List<LeafRefContext> findAllLeafRefChilds(
        ...
        if (parent.isReferencing()) {
            ...
            Set<Entry<QName, LeafRefContext>> childs = parent
    ...
    public static List<LeafRefContext> findAllChildsReferencedByLeafRef(
            SchemaNode node, LeafRefContext root) {
    ...
    public static Map<QName, LeafRefContext> getAllLeafRefsReferencingThisNode(
            SchemaPath path, LeafRefContext root) {
