...
public class XmlStreamUtils {
     ...
     * @param parentNamespace optional parameter of parent namespace
     * @throws XMLStreamException if an encoding problem occurs
     */
    public void writeValue(@Nonnull final XMLStreamWriter writer, @Nonnull final SchemaNode schemaNode, final Object value, final Optional<String> parentNamespace) throws XMLStreamException {
        if (value == null) {
    ...
    public void writeValue(@Nonnull final XMLStreamWriter writer, @Nonnull final SchemaNode schemaNode, final Object value, final String parentNamespace) throws XMLStreamException {
     ...
     * @throws XMLStreamException if an encoding problem occurs
     */
    public void writeValue(@Nonnull final XMLStreamWriter writer, @Nonnull final TypeDefinition<?> type, final Object value, final Optional<String> parentNamespace) throws XMLStreamException {
        if (value == null) {
        ...
        if (baseType instanceof IdentityrefTypeDefinition) {
            if (parentNamespace.isPresent()) {
                ...
                write(writer, (IdentityrefTypeDefinition) baseType, value, Optional.<String>absent());
            }
    ...
    public void writeValue(@Nonnull final XMLStreamWriter writer, @Nonnull final TypeDefinition<?> type, final Object value, final String parentNamespace) throws XMLStreamException {
    ...
    private static void write(@Nonnull final XMLStreamWriter writer, @Nonnull final IdentityrefTypeDefinition type, @Nonnull final Object value, final Optional<String>  parentNamespace) throws XMLStreamException {
        if (value instanceof QName) {
            final QName qname = (QName) value;
            final String prefix = "x";

            //in case parentNamespace is present and same as element namespace write value without namespace
            if (parentNamespace.isPresent() && qname.getNamespace().toString().equals(parentNamespace.get())){
