...
public class ImmutableMapNodeBuilder implements CollectionNodeBuilder<MapEntryNode, SystemMapNode> {
    ...
    protected static final class ImmutableMapNode extends AbstractImmutableNormalizedNode<NodeIdentifier>
        ...
        protected boolean valueEquals(final NormalizedNode other) {
            ...
            if (other instanceof ImmutableMapNode) {
                otherChildren = ((ImmutableMapNode) other).children;
            } else if (other instanceof SystemMapNode) {
                otherChildren = ((SystemMapNode) other).asMap();
            } else {
                return false;
            }
