...
public class ImmutableMapNodeBuilder implements CollectionNodeBuilder<MapEntryNode, UnorderedMapNode> {
    ...
    public static CollectionNodeBuilder<MapEntryNode, UnorderedMapNode> create() {
        return new ImmutableMapNodeBuilder();
    }

    public static CollectionNodeBuilder<MapEntryNode, UnorderedMapNode> create(final int sizeHint) {
        return new ImmutableMapNodeBuilder(sizeHint);
    }

    public static CollectionNodeBuilder<MapEntryNode, UnorderedMapNode> create(final UnorderedMapNode node) {
