...
public interface NodeSerializerDispatcher<E> {
    ...
    public static abstract class BaseNodeSerializerDispatcher<E> implements NodeSerializerDispatcher<E> {
        ...
        private List<E> onAugmentationSchema(Object childSchema,
            ...
            return getAugmentationNodeDomSerializer().serialize((AugmentationSchema) childSchema,
        ...
        private List<E> onChoiceNode(Object childSchema,
            ...
            checkSchemaCompatibility(childSchema, org.opendaylight.yangtools.yang.model.api.ChoiceNode.class,
                    dataContainerChild);
            return getChoiceNodeDomSerializer()
        ...
        private List<E> onListNode(Object childSchema,
            ...
            return getMapNodeDomSerializer().serialize((ListSchemaNode) childSchema, (MapNode) dataContainerChild);
        }
        ...
        private List<E> onLeafListNode(Object childSchema,
            ...
            return getLeafSetNodeDomSerializer().serialize((LeafListSchemaNode) childSchema,
        ...
        private List<E> onLeafNode(Object childSchema,
            ...
            List<E> elements = getLeafNodeDomSerializer().serialize((LeafSchemaNode) childSchema,
        ...
        private List<E> onContainerNode(Object childSchema,
            ...
            List<E> elements = getContainerNodeDomSerializer().serialize((ContainerSchemaNode) childSchema,
        ...
        protected abstract FromNormalizedNodeSerializer<E, ContainerNode, ContainerSchemaNode> getContainerNodeDomSerializer();

        protected abstract FromNormalizedNodeSerializer<E, LeafNode<?>, LeafSchemaNode> getLeafNodeDomSerializer();

        protected abstract FromNormalizedNodeSerializer<E, LeafSetNode<?>, LeafListSchemaNode> getLeafSetNodeDomSerializer();

        protected abstract FromNormalizedNodeSerializer<E, MapNode, ListSchemaNode> getMapNodeDomSerializer();

        protected abstract FromNormalizedNodeSerializer<E, org.opendaylight.yangtools.yang.data.api.schema.ChoiceNode, org.opendaylight.yangtools.yang.model.api.ChoiceNode> getChoiceNodeDomSerializer();

        protected abstract FromNormalizedNodeSerializer<E, AugmentationNode, AugmentationSchema> getAugmentationNodeDomSerializer();
    }
}
