...
public abstract class YangModeledAnyXmlNodeBaseParser<E> implements
    ...
    public final YangModeledAnyXmlNode parse(Iterable<E> elements, YangModeledAnyXmlSchemaNode schema) {
        ...
        final DataContainerChild<?, ?> value = parseAnyXml(e, schema);

        final NormalizedNodeAttrBuilder<NodeIdentifier, DataContainerChild<?, ?>, YangModeledAnyXmlNode> anyXmlBuilder = Builders
                .anyXmlBuilder(schema);
     ...
     */
    protected abstract DataContainerChild<?, ?> parseAnyXml(E element, YangModeledAnyXmlSchemaNode yangModeledAnyXmlSchemaNode);
