...
import org.opendaylight.yangtools.yang.data.impl.schema.opaque.AbstractOpaqueDataNodeBuilder;
...
import org.opendaylight.yangtools.yang.data.impl.schema.opaque.OpaqueDataValueBuilder;
...
public class ImmutableNormalizedNodeStreamWriter
    ...
    private final class OpaqueAnydata implements OpaqueAnydataExtension.StreamWriter {
        ...
        @Override
        public void opaqueValue(final Object value) {
