...
public class ImmutableNormalizedNodeStreamWriter implements NormalizedNodeStreamWriter {
    ...
    public final void endNode() {
        ...
        final NormalizedNode<PathArgument, ?> filteredProduct = exit(product);
    ...
    protected @Nullable NormalizedNode<PathArgument, ?> exit(final NormalizedNode<PathArgument, ?> product) {
        return product;
    }
