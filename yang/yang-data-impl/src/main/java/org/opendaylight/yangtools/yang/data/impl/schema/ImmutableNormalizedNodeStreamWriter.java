 ...
 */
public final class ImmutableNormalizedNodeStreamWriter implements NormalizedNodeStreamWriter {
    ...
    private ImmutableNormalizedNodeStreamWriter(final NormalizedNodeResult result) {
     ...
     *
     * <p>
     * Result is built when {@link #exitNode()} associated with that start event is emitted.
     *
     * <p>
    ...
    public static NormalizedNodeStreamWriter from(final NormalizedNodeMetadataResult result) {
        return new NormalizedMetadataStreamWriterImpl(result);
    }
