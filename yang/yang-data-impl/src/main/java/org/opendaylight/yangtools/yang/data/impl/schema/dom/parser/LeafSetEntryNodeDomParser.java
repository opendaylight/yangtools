...
public class LeafSetEntryNodeDomParser {

    public LeafSetEntryNode<Object> fromDomElement(Element xml, LeafListSchemaNode schema,
                                                          XmlCodecProvider codecProvider) {
        Object value = DomUtils.parseXmlValue(xml, codecProvider, schema.getType());
        return Builders.leafSetEntryBuilder(schema).withValue(value).build();
    }

    public LeafSetEntryNode<?> fromDomElement(Element xml, LeafListSchemaNode schema) {
