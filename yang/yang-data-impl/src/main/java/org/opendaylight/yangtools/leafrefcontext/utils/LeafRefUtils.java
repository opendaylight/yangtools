...
public class LeafRefUtils {
    ...
    public static LeafRefPath createAbsoluteLeafRefPath(
            LeafRefPath leafRefPath, SchemaPath contextNodeSchemaPath,
            Module module) {

        if (leafRefPath.isAbsolute())
            return leafRefPath;

        LinkedList<QNameWithPredicate> absoluteLeafRefTargetPathList = schemaPathToXPathQNames(
                contextNodeSchemaPath, module);

        Iterable<QNameWithPredicate> leafRefTargetPathFromRoot = leafRefPath
                .getPathFromRoot();
        Iterator<QNameWithPredicate> leafRefTgtPathFromRootIterator = leafRefTargetPathFromRoot
                .iterator();
    ...
    public static LeafRefPath schemaPathToLeafRefPath(SchemaPath nodePath,
            Module module) {
        LinkedList<QNameWithPredicate> xpathQNames = schemaPathToXPathQNames(
                nodePath, module);
