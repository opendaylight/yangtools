...
public abstract class AbstractOpaqueDataNodeBuilder<T extends OpaqueDataNode> implements Builder<T> {
    ...
    public AbstractOpaqueDataNodeBuilder<T> withIdentifier(final NodeIdentifier identifier) {
        checkState(this.identifier == null, "Identifier already set to %s", identifier);
