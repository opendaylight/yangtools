...
public class ImmutableMetadataNormalizedNodeStreamWriter extends ImmutableNormalizedNodeStreamWriter
    ...
    private static final ImmutableSet<Class<? extends NormalizedNodeStreamWriterExtension>> EXTENSIONS =
            ImmutableSet.of(AnydataNormalizedNodeStreamWriter.class, NormalizedMetadataStreamWriter.class);
    ...
    public final ClassToInstanceMap<NormalizedNodeStreamWriterExtension> getExtensions() {
        return new ObjectExtensions<>(EXTENSIONS, this);
    }
