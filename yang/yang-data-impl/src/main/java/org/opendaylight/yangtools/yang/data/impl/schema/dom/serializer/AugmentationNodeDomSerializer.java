...
public class AugmentationNodeDomSerializer extends
        AbstractDispatcherSerializer<InstanceIdentifier.AugmentationIdentifier, AugmentationNode, AugmentationSchema> {

    @Override
    protected Set<DataSchemaNode> getRealSchemasForAugment(AugmentationSchema schema, AugmentationSchema childSchema) {
        return DomUtils.getRealSchemasForAugment(schema, childSchema);
    }
