...
final class InMemoryDataTreeModification extends AbstractCursorAware implements CursorAwareDataTreeModification,
    ...
    static {
        try {
            SEALED = MethodHandles.lookup().findVarHandle(InMemoryDataTreeModification.class, "sealed", byte.class);
    ...
    boolean isSealed() {
        ...
        return (byte) SEALED.getAcquire(this) != 0;
    }
    ...
    public void ready() {
        ...
        final boolean wasRunning = SEALED.compareAndSet(this, (byte) 0, (byte) 1);
