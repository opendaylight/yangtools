...
@NonNullByDefault
public class ImmutableOrderedLeafSetNodeBuilder<T> implements ListNodeBuilder<Ordered, T, LeafSetEntryNode<T>> {
    ...
    public static <T> ListNodeBuilder<Ordered, T, LeafSetEntryNode<T>> create() {
        return new ImmutableOrderedLeafSetNodeBuilder<>();
    }

    public static <T> ListNodeBuilder<Ordered, T, LeafSetEntryNode<T>> create(final OrderedLeafSetNode<T> node) {
