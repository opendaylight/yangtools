...
public final class OpaqueDataBuilder implements Builder<OpaqueData> {
    ...
    public OpaqueDataBuilder withAccurateLists(final boolean accurateLists) {
        this.accurateLists = accurateLists;
        return this;
    }

    public OpaqueDataBuilder withRoot(final OpaqueDataNode root) {
        checkState(this.root == null, "Root node already set to %s", this.root);
