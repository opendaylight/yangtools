...
abstract class AbstractNodeContainerModificationStrategy extends SchemaAwareApplyOperation {
    ...
    @Override
    void verifyStructure(final NormalizedNode<?, ?> value) {
        checkArgument(nodeClass.isInstance(value), "Node %s is not of type %s", value, nodeClass);
        checkArgument(value instanceof NormalizedNodeContainer);
