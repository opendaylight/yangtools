...
abstract class AbstractNodeContainerModificationStrategy extends SchemaAwareApplyOperation {
    ...
    @Override
    void verifyStructure(final NormalizedNode<?, ?> writtenValue) throws IllegalArgumentException {
        ...
        for (final Object child : container.getValue()) {
            ...
            getChild(castedChild.getIdentifier()).get().verifyStructure(castedChild);
        }
    }
