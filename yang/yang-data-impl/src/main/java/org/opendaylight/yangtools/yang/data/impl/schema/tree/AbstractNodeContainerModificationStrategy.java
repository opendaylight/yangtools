...
abstract class AbstractNodeContainerModificationStrategy extends SchemaAwareApplyOperation {
    ...
    private TreeNode mutateChildren(final MutableTreeNode meta, final NormalizedNodeContainerBuilder data,
        ...
        while (iterator.hasNext()) {
             ...
             * information and may be confusing to users.
             */
    ...
    public TreeNode applyTouch(final ModifiedNode modification, final TreeNode currentMeta, final Version version) {
        ...
        if (!children.isEmpty()) {
             ...
             * which were turned into UNMODIFIED and then removed by mutateChildren. If that is the case, we can turn
             * this operation into UNMODIFIED, too, potentially cascading it up to root. This has the benefit
