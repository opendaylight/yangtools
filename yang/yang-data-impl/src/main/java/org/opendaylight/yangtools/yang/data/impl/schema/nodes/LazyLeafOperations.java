 ...
 *
 * <p>
 * This class holds implementation logic which controls lifecycle of {@link LeafNode}s and {@link LeafSetEntryNode}s,
 * by providing a central policy point for how the implementation treats these nodes. There are two modes of operation:
 * <ul>
...
public final class LazyLeafOperations {
    ...
    public static Optional<DataContainerChild<?, ?>> findChild(final Map<PathArgument, Object> map,
        ...
        final PathArgument id = requireNonNull(key);
        final Object value = map.get(id);
        return value == null ? Optional.empty() : Optional.of(decodeChild(id, value));
    }
    ...
    public static @Nullable DataContainerChild<?, ?> getChild(final Map<PathArgument, Object> map,
        ...
        final PathArgument id = requireNonNull(key);
        final Object value = map.get(id);
        return value == null ? null : decodeChild(id, value);
    }
    ...
    private static @Nullable DataContainerChild<?, ?> decodeChild(final @NonNull PathArgument key,
            final @NonNull Object value) {
      return EXPENDABLE ? decodeExpendableChild(key, value) : verifyCast(value);
    }

    private static @NonNull DataContainerChild<?, ?> decodeExpendableChild(@NonNull final PathArgument key,
