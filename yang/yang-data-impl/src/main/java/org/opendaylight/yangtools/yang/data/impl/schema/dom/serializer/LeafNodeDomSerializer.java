...
public class LeafNodeDomSerializer implements
        DomSerializer<InstanceIdentifier.NodeIdentifier, LeafNode<?>, LeafSchemaNode> {

    public List<Element> toDom(LeafSchemaNode schema, LeafNode<?> node, XmlCodecProvider codecProvider, Document doc) {
