...
public abstract class LeafSetNodeBaseParser<E> implements
    ...
    @Override
    public final LeafSetNode<?> parse(List<E> childNodes, LeafListSchemaNode schema) {
        ...
        for (E childNode : childNodes) {
            ...
            // TODO generic type cast warning
            leafListBuilder.withChild((LeafSetEntryNode<Object>) builtChild);
        }
