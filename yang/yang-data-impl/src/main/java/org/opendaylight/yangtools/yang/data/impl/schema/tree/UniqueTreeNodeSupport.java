...
final class UniqueTreeNodeSupport implements Immutable {
    ...
    UniqueParentMutableNode newMutableTreeNode(final UnkeyedListNode value, final Version version) {
        final UniqueParentTreeNode immutable = newTreeNode(value, version);
        return new UniqueParentMutableNode(immutable.delegate().mutable(), this, immutable);
    }

    Object extractValues(final NormalizedNode<?, ?> data) {
