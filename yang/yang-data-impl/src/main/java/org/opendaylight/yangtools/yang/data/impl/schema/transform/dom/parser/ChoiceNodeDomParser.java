...
final class ChoiceNodeDomParser extends ChoiceNodeBaseParser<Element> {
    ...
    ChoiceNodeDomParser(final NodeParserDispatcher<Element> dispatcher, final SchemaAwareNormalizedNodeStreamWriter
            writer) {
        super(writer);
        this.dispatcher = Preconditions.checkNotNull(dispatcher);
    }

    ChoiceNodeDomParser(final NodeParserDispatcher<Element> dispatcher, final
    BuildingStrategy<YangInstanceIdentifier.NodeIdentifier, ChoiceNode> buildingStrategy,
