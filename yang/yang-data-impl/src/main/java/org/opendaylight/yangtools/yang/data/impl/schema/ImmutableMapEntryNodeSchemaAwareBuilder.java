...
public class ImmutableMapEntryNodeSchemaAwareBuilder extends ImmutableMapEntryNodeBuilder{
    ...
    private InstanceIdentifier.NodeIdentifierWithPredicates constructNodeIdentifier() {
        ...
        for (QName key : keys) {
            ...
            DataContainerChild<?, ?> valueForKey = children.get(childrenQNamesToPaths.get(key));
    ...
    public static ImmutableMapEntryNodeSchemaAwareBuilder get(ListSchemaNode schema) {
