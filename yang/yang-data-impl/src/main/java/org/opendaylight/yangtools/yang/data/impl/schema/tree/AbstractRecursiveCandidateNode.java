...
abstract class AbstractRecursiveCandidateNode implements DataTreeCandidateNode {
    ...
    static DataTreeCandidateNode overWriteNode(final NormalizedNode<?, ?> oldData, final NormalizedNode<?, ?> newData) {
        // FIXME: finish this up
        return null;
    }

    static DataTreeCandidateNode unmodifiedNode(final NormalizedNode<?, ?> input) {
