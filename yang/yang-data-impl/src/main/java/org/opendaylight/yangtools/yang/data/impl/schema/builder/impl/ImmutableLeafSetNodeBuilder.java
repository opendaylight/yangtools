...
public class ImmutableLeafSetNodeBuilder<T> implements UnorderedListNodeBuilder<T, LeafSetEntryNode<T>> {
    ...
    public static <T> @NonNull UnorderedListNodeBuilder<T, LeafSetEntryNode<T>> create() {
        return new ImmutableLeafSetNodeBuilder<>();
    }

    public static <T> @NonNull UnorderedListNodeBuilder<T, LeafSetEntryNode<T>> create(final int sizeHint) {
    ...
    protected static final class ImmutableLeafSetNode<T>
            extends AbstractImmutableNormalizedValueNode<NodeIdentifier, Collection<@NonNull LeafSetEntryNode<T>>>
