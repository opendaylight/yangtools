...
public class ImmutableLeafSetNodeBuilder<T> implements ListNodeBuilder<@NonNull Unordered, T, LeafSetEntryNode<T>> {
    ...
    public static <T> @NonNull ListNodeBuilder<@NonNull Unordered, T, LeafSetEntryNode<T>> create() {
        return new ImmutableLeafSetNodeBuilder<>();
    }

    public static <T> @NonNull ListNodeBuilder<@NonNull Unordered, T, LeafSetEntryNode<T>> create(final int sizeHint) {
