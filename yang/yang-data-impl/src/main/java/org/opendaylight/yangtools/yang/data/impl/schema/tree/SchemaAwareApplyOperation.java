...
abstract class SchemaAwareApplyOperation extends ModificationApplyOperation {
        ...
        if (schemaNode instanceof ContainerSchemaNode) {
            ...
            if (containerSchema.isPresenceContainer()) {
                ...
                return new StructuralModificationStrategyWrapper(
                    new ContainerModificationStrategy(containerSchema, treeConfig),
            ...
            return new StructuralModificationStrategyWrapper(
                new ChoiceModificationStrategy((ChoiceSchemaNode) schemaNode, treeConfig),
    ...
    private static ModificationApplyOperation fromListSchemaNode(final ListSchemaNode schemaNode, final DataTreeConfiguration treeConfig) {
    ...
    private static ModificationApplyOperation fromLeafListSchemaNode(final LeafListSchemaNode schemaNode, final DataTreeConfiguration treeConfig) {
