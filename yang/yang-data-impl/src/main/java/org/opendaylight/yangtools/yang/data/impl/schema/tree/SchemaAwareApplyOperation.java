...
abstract class SchemaAwareApplyOperation extends ModificationApplyOperation {
    ...
    public static ModificationApplyOperation from(final DataSchemaNode schemaNode,
        ...
        if (schemaNode instanceof ContainerSchemaNode) {
            ...
            return new StructuralContainerModificationStrategy(new ChoiceModificationStrategy(
                (ChoiceSchemaNode) schemaNode, treeConfig), ImmutableNodes.choiceNode(schemaNode.getQName()));
