            ...
            if (data instanceof NormalizedNodeContainer) {
                for (final NormalizedNode<?, ?> child : ((NormalizedNodeContainer<?, ?, ?>) data).getValue()) {
                    ...
                    if (childApplyOpPotential.isPresent()) {
                        ...
                        final ModifiedNode modifiedNode = modification.modifyChild(child.getIdentifier(),
                                childApplyOp.getChildPolicy());
                        modifiedNode.write(child);
                        childApplyOp.verifyStructure(modifiedNode);
                    }
                }
            }
        }
