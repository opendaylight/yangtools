...
final class ModifiedNode extends NodeModification implements StoreTreeNode<ModifiedNode> {
    ...
    void resolveModificationType(@Nonnull final ModificationType type) {
        ...
        Preconditions.checkState(modType == null, "Node %s has already resolved modification type, cannot set to %s", this, type);
        modType = type;
    }

    @Nonnull ModificationType modificationType() {
        Verify.verifyNotNull(modType, "Node %s does not have resolved modification type", this);
        return modType;
    }
