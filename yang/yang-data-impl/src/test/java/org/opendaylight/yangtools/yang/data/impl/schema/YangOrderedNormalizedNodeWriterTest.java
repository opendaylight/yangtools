...
public class YangOrderedNormalizedNodeWriterTest {
    ...
    public void testWrite() throws Exception {
        ...
        YangOrderedNormalizedNodeWriter nnw = new YangOrderedNormalizedNodeWriter(writer, schemaContext, SchemaPath.ROOT);
    ...
    public void testWriteOrder() throws Exception {
        ...
        NormalizedNodeWriter nnw = new YangOrderedNormalizedNodeWriter(writer, schemaContext, SchemaPath.ROOT);
