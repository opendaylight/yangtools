...
public class LeafSetDomSerializerTest {
    ...
    private void leafSetEntryNodeDomSerializerTest() throws ReactorException, IOException, YangSyntaxErrorException,
        ...
        ContainerSchemaNode currentContainer = (ContainerSchemaNode) DomSerializerTestUtils.getSchemaContext()
                .findModuleByName
                ("serializer-test", null)
                .getDataChildByName(DomSerializerTestUtils.generateQname("root"));
        currentLeafList = (LeafListSchemaNode) currentContainer.getDataChildByName(DomSerializerTestUtils.generateQname("first-leaf-list"));
        ...
        temp = new LeafSetEntryNodeDomSerializer(DomSerializerTestUtils.doc, DomSerializerTestUtils.codecProvider);
        DomSerializerTestUtils.element = temp.serializeLeaf(currentLeafList, tempLeafList);
