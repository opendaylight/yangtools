...
public class LeafRefContextTest {
    ...
    public void test() {
        ...
        final SchemaInferenceStack leafRefNode = new SchemaInferenceStack(context);
        leafRefNode.enterSchemaTree(q1);

        final SchemaInferenceStack targetNode = new SchemaInferenceStack(context);
        targetNode.enterSchemaTree(q2);

        final SchemaInferenceStack cont1Node = new SchemaInferenceStack(context);
        cont1Node.enterSchemaTree(q3);

        final SchemaInferenceStack cont2Node = new SchemaInferenceStack(context);
        cont2Node.enterSchemaTree(q4);

        final SchemaInferenceStack name1Node = new SchemaInferenceStack(context);
