...
public class DataTreeCandidateValidatorTest {
    ...
    private void writeContributors() {
        ...
        ContainerNode contributorContainer = createBasicContributorContainer(contributorContSchemaNode);
    ...
    private void writeIntoMapEntry() {
        ...
        Map<QName, Object> keys  = new HashMap<QName, Object>();
        keys.put(name, "New Project");
        NodeIdentifierWithPredicates mapEntryPath = new NodeIdentifierWithPredicates(project, keys);

        YangInstanceIdentifier leaderPath = YangInstanceIdentifier
                .of(odl).node(project).node(mapEntryPath).node(lead);

        LeafNode<String> leader = ImmutableNodes.leafNode(lead, "Updated leader");
    ...
    private void writeMapEntry() {
        ...
        YangInstanceIdentifier newOdlProjectMapEntryPath = YangInstanceIdentifier
                .of(odl).node(project).node(mapEntryPath);

        ContainerSchemaNode odlProjContSchemaNode = (ContainerSchemaNode) valModule
                .getDataChildByName(odl);
        ListSchemaNode projListSchemaNode = (ListSchemaNode) odlProjContSchemaNode
                .getDataChildByName(project);
        MapEntryNode newProjectMapEntry = createProjectListEntry("New Project",
    ...
    private void write2() {
        ...
        YangInstanceIdentifier choicePath = YangInstanceIdentifier.of(odl)
                .node(ch1);
        ...
        YangInstanceIdentifier leafListPath = YangInstanceIdentifier.of(odl)
    ...
    private LeafSetNode createLeafRefLeafListNode() {
        ...
        ListNodeBuilder<Object, LeafSetEntryNode<Object>> leafSetBuilder = Builders
                .leafSetBuilder();
    ...
    private ContainerNode createCon3Node() {
        ...
        CollectionNodeBuilder<MapEntryNode, MapNode> mapBuilder = Builders
                .mapBuilder();
        ...
        DataContainerNodeBuilder<NodeIdentifier, ChoiceNode> choiceBuilder = Builders
                .choiceBuilder();
    ...
    private MapEntryNode createList3Entry(String kVal, String l3Val1,
            String l3Val2, String l3Val3) {
        DataContainerNodeAttrBuilder<NodeIdentifierWithPredicates, MapEntryNode> mapEntryBuilder = Builders
                .mapEntryBuilder();
    ...
    private LeafSetEntryNode<Object> createLeafSetEntry(QName qname, String val) {
        NormalizedNodeAttrBuilder<NodeWithValue, Object, LeafSetEntryNode<Object>> leafSetEntryBuilder = Builders
                .leafSetEntryBuilder();
    ...
    private ChoiceNode createChoiceNode() {
        ...
        CollectionNodeBuilder<MapEntryNode, MapNode> listInChoiceBuilder = Builders
                .mapBuilder();
        listInChoiceBuilder
        ...
        DataContainerNodeBuilder<NodeIdentifier, ChoiceNode> choice2Builder = Builders
                .choiceBuilder();
    ...
    private MapEntryNode createListInChoiceEntry(String keyVal,
            String leafrefInChoiceVal, String leafrefInChoiceToChoiceVal) {
    ...
    private MapEntryNode createContributorListEntry(String loginVal,
    ...
    private ContainerNode createBasicContributorContainer(
        ...
        MapNode contributorMap = createBasicContributorList(contributorListSchemaNode);
        contributorContainerBldr.addChild(contributorMap);
