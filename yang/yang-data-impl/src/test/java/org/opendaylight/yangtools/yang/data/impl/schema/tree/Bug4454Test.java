...
public class Bug4454Test {
    ...
    private static final QName MIN_MAX_LIST_QNAME_NO_MINMAX = QName.create(MASTER_CONTAINER_QNAME, "min-max-list-no-minmax");
    ...
    private final MapEntryNode bazEntryNode = ImmutableNodes.mapEntry(MIN_MAX_LIST_QNAME, MIN_MAX_KEY_LEAF_QNAME,
            "baz");
    private final MapNode mapNode1 = ImmutableNodes.mapNodeBuilder()
            .withNodeIdentifier(new YangInstanceIdentifier.NodeIdentifier(MIN_MAX_LIST_QNAME))
            .withChild(fooEntryNode).build();
    private final MapNode mapNode2 = ImmutableNodes.mapNodeBuilder()
            .withNodeIdentifier(new YangInstanceIdentifier.NodeIdentifier(MIN_MAX_LIST_QNAME))
            .withChild(barEntryNode).build();
    private final MapNode mapNode3 = ImmutableNodes.mapNodeBuilder()
            .withNodeIdentifier(new YangInstanceIdentifier.NodeIdentifier(MIN_MAX_LIST_QNAME))
    ...
    public void minMaxListDeleteTest() throws DataValidationFailedException {
        ...
        YangInstanceIdentifier MIN_MAX_LEAF_FOO = YangInstanceIdentifier.builder(MASTER_CONTAINER_PATH).node(MIN_MAX_LIST_QNAME)
        ...
        modificationTree.merge(MIN_MAX_LIST_PATH, mapNode3);
