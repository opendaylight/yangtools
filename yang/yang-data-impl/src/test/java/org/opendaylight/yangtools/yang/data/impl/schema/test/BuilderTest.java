...
public class BuilderTest {
    ...
    private static final YangInstanceIdentifier.NodeWithValue barPath = new YangInstanceIdentifier.NodeWithValue
            (LEAF_LIST_MAIN, "bar");
    private static final LeafSetEntryNode leafSetEntryNode = ImmutableLeafSetEntryNodeBuilder.create()
            .withNodeIdentifier(barPath)
            .withValue("bar")
            .build();
    private static ListSchemaNode list;
    private static LeafListSchemaNode leafList;
