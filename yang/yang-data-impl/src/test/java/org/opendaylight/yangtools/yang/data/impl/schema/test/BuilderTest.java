...
public class BuilderTest {
    ...
    private static final YangInstanceIdentifier.NodeWithValue nodeWithValueIdentifier = new YangInstanceIdentifier
            .NodeWithValue(LEAF_LIST_MAIN, "bar");
    private static final LeafSetEntryNode leafSetEntryNode = ImmutableLeafSetEntryNodeBuilder.create()
            .withNodeIdentifier(nodeWithValueIdentifier)
            .withValue("bar")
            .build();
    ...
    public void setup() throws FileNotFoundException, ReactorException, URISyntaxException {
        final File leafRefTestYang = new File(getClass().getResource("/builder-test/immutable-ordered-map-node" +
                ".yang").toURI
                ());
    ...
    public void immutableOrderedLeafSetNodeBuilderTest() {
        final NormalizedNode orderedLeafSet = ImmutableOrderedLeafSetNodeBuilder.create()
                ...
                .withChild(leafSetEntryNode)
                .withChildValue("baz")
                .removeChild(nodeWithValueIdentifier)
                .build();
    ...
    private static LeafSetNode getImmutableLeafSetNode() {
        ...
        leafSetBuilder.addChild(leafSetEntryNode);
