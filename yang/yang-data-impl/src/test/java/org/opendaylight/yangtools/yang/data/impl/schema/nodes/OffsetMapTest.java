...
public class OffsetMapTest {
    ...
    public void testMutableGet() {
        final Map<String, String> map = createMap().createMutableClone();
    ...
    @Test
    public void testCreateMutableClone() {
        final ImmutableOffsetMap<String, String> source = createMap();
        final Map<String, String> result = source.createMutableClone();
    ...
    public void testReusedFields() {
        final ImmutableOffsetMap<String, String> source = createMap();
        final MutableOffsetMap<String, String> mutable = source.createMutableClone();

        // Should not affect the result
        mutable.remove("non-existent");

        // Resulting map should be equal, but not the same object
        final ImmutableOffsetMap<String, String> result = (ImmutableOffsetMap<String, String>) mutable.immutableCopy();
    ...
    public void testReusedOffsets() {
        ...
        assertSame(source.offsets(), result.offsets());
        assertNotSame(source.array(), result.array());
    ...
    public void testMutableToEmpty() {
        final MutableOffsetMap<String, String> mutable = createMap().createMutableClone();

        mutable.remove("k1");
        mutable.remove("k2");

        assertTrue(mutable.isEmpty());
        assertSame(ImmutableMap.of(), mutable.immutableCopy());
    }
    ...
    public void testMutableToSingleton() {
        ...
        final Map<String, String> result = mutable.immutableCopy();
    ...
    @Test
    public void testCloneableFlipping() {
        final MutableOffsetMap<String, String> source = createMap().createMutableClone();
        ...
        final ImmutableOffsetMap<String, String> immutable = (ImmutableOffsetMap<String, String>) source.immutableCopy();
        assertTrue(source.needClone());
        assertSame(source.array(), immutable.array());
    }

    @Test
    public void testMutableEntrySet() {
        final MutableOffsetMap<String, String> map = createMap().createMutableClone();
