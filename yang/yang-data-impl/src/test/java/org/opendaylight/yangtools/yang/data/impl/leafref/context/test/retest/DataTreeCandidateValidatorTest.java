...
public class DataTreeCandidateValidatorTest {
    ...
    private static void initSchemaContext() throws URISyntaxException, FileNotFoundException, ReactorException {
        final File resourceFile = new File(DataTreeCandidateValidatorTest.class.getResource(
                "/leafref-validation/leafref-validation.yang").toURI());
    ...
    private static void initDataTree() {
        ...
        final ContainerSchemaNode odlProjContSchemaNode = (ContainerSchemaNode) valModule.getDataChildByName(odl);
    ...
    private static void writeIntoMapEntry() {
        ...
        final NodeIdentifierWithPredicates mapEntryPath = new NodeIdentifierWithPredicates(project, keys);
    ...
    private static void writeMapEntry() {
        ...
        final YangInstanceIdentifier newOdlProjectMapEntryPath = YangInstanceIdentifier.of(odl).node(project)
                .node(mapEntryPath);

        final ContainerSchemaNode odlProjContSchemaNode = (ContainerSchemaNode) valModule.getDataChildByName(odl);
        final ListSchemaNode projListSchemaNode = (ListSchemaNode) odlProjContSchemaNode.getDataChildByName(project);
        final MapEntryNode newProjectMapEntry = createProjectListEntry("New Project", "New Project description ...",
                "Leader of New Project", "Owner of New Project", projListSchemaNode);
    ...
    private static void write() {
        ...
        writeModification
                .write(YangInstanceIdentifier.of(l1), ImmutableNodes.leafNode(l1, "Leafref l1 under the root"));
    ...
    private static void write2() {
        ...
        final ContainerSchemaNode odlCon = (ContainerSchemaNode) valModule.getDataChildByName(odl);
        final ContainerSchemaNode con1Con = (ContainerSchemaNode) odlCon.getDataChildByName(con1);
        ...
        final YangInstanceIdentifier con1Path = YangInstanceIdentifier.of(odl).node(con1);
        final DataTreeModification writeModification = inMemoryDataTree.takeSnapshot().newModification();
        writeModification.write(con1Path, con1Node);

        final ChoiceNode choiceNode = createChoiceNode();
        final YangInstanceIdentifier choicePath = YangInstanceIdentifier.of(odl).node(ch1);
        writeModification.write(choicePath, choiceNode);

        final ContainerNode con3Node = createCon3Node();
        final YangInstanceIdentifier con3Path = YangInstanceIdentifier.of(odl).node(con3);
        writeModification.write(con3Path, con3Node);

        final LeafSetNode<?> leafListNode = createLeafRefLeafListNode();
        final YangInstanceIdentifier leafListPath = YangInstanceIdentifier.of(odl).node(leafrefLeafList);
    ...
    private static MapEntryNode createList3Entry(final String kVal, final String l3Val1, final String l3Val2,
            final String l3Val3) {
    ...
    private static ContainerNode createContributorContainer(final ContainerSchemaNode contributorContSchemaNode) {
    ...
    private static MapNode createContributorList(final ListSchemaNode contributorListSchemaNode) {

        final CollectionNodeBuilder<MapEntryNode, MapNode> contributorMapBldr = Builders
                .mapBuilder(contributorListSchemaNode);

        final MapEntryNode contributorMapEntry1 = createContributorListEntry("Leader of Yangtools",
                "Yangtools Leader name", "Yangtools", "Yangtools description ...", contributorListSchemaNode);
        final MapEntryNode contributorMapEntry2 = createContributorListEntry("Leader of MD-SAL", "MD-SAL Leader name",
                "MD-SAL", "MD-SAL description ...", contributorListSchemaNode);
        final MapEntryNode contributorMapEntry3 = createContributorListEntry("Leader of Controller",
                "Controller Leader name", "Controller", "Controller description ...", contributorListSchemaNode);

        final MapEntryNode contributorMapEntry4 = createContributorListEntry("jdoe", "John Doe", "MD-SAL",
                "Yangtools description ...", contributorListSchemaNode);

        final MapEntryNode contributorMapEntry5 = createContributorListEntry("foo", "foo name", "Controller",
                "MD-SAL description ...", contributorListSchemaNode);

        final MapEntryNode contributorMapEntry6 = createContributorListEntry("bar", "bar name", "Yangtools",
                "Controller description ...", contributorListSchemaNode);

        final MapEntryNode contributorMapEntry7 = createContributorListEntry("baz", "baz name", "Unknown Project",
                "Unknown Project description ...", contributorListSchemaNode);

        final MapEntryNode contributorMapEntry8 = createContributorListEntry("pk", "pk name", "Unknown Project 2",
                "Controller description ...", contributorListSchemaNode);
    ...
    private static ContainerNode createOdlContainer(final ContainerSchemaNode container) {
        ...
        final ListSchemaNode projListSchemaNode = (ListSchemaNode) container.getDataChildByName(project);
    ...
    private static MapNode createProjectList(final ListSchemaNode projListSchemaNode) {
        ...
        final CollectionNodeBuilder<MapEntryNode, MapNode> projectMapBldr = Builders.mapBuilder(projListSchemaNode);

        final MapEntryNode projMapEntry1 = createProjectListEntry("Yangtools", "Yangtools description ...",
                "Leader of Yangtools", "Owner of Yangtools", projListSchemaNode);
        final MapEntryNode projMapEntry2 = createProjectListEntry("MD-SAL", "MD-SAL description ...",
                "Leader of MD-SAL", "Owner of MD-SAL", projListSchemaNode);
        final MapEntryNode projMapEntry3 = createProjectListEntry("Controller", "Controller description ...",
    ...
    private static MapEntryNode createProjectListEntry(final String nameVal, final String descVal,
            final String leadVal, final String ownerVal, final ListSchemaNode projListSchemaNode) {
        ...
        final LeafNode<String> ownerLeafRef = ImmutableNodes.leafNode(owner, ownerVal);
    ...
    private static ContainerNode createBasicContributorContainer(final ContainerSchemaNode contributorContSchemaNode) {
    ...
    private static MapNode createBasicContributorList(final ListSchemaNode contributorListSchemaNode) {
