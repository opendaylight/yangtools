...
public class Bug7844Test {
    ...
    public void test() throws Exception {
        final SchemaContext context = TestUtils.parseYangSources(
                new File(getClass().getResource("/bug7844/foo.yang").toURI()),
                new File(getClass().getResource("/bug7844/bar.yang").toURI()),
                new File(getClass().getResource("/bug7844/baz.yang").toURI()));
