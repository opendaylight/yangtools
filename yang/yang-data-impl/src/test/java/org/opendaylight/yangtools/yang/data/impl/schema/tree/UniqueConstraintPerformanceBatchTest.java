...
public class UniqueConstraintPerformanceBatchTest {
    ...
    public void mapEntryTest() throws ReactorException, DataValidationFailedException {
        ...
        final InMemoryDataTree inMemoryDataTree = UniqueConstraintPerformanceTestUtils.initDataTree(schemaContext,
                true, INITIAL_WRITE_COUNT);
        UniqueConstraintPerformanceTestUtils.writeBatchOfMapEntries(inMemoryDataTree, SECOND_WRITE_COUNT,
                INITIAL_WRITE_COUNT);
    }
}
