...
public class ConstraintsValidationTest {
    private static final Logger LOG = LoggerFactory.getLogger(ConstraintsValidationTest.class);

    private static final String CONSTRAINTS_VALIDATION_TEST_YANG = "/constraints-validation-test-model.yang";
    private SchemaContext schemaContext;
    private RootModificationApplyOperation rootOper;

    private static final QName MASTER_CONTAINER_QNAME = QName.create("urn:opendaylight:params:xml:ns:yang:constraints-validation-test-model", "2015-02-02",
            "master-container");
