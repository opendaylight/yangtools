...
public class DomSerializerTestUtils {
    ...
    static final NodeSerializerDispatcher mockDispatcher = Mockito.mock(NodeSerializerDispatcher.class);
    static final XmlCodecProvider codecProvider = new XmlCodecProvider() {
        @Override
    ...
    public static EffectiveSchemaContext createTestContext(String sourcePath) throws IOException,
    ...
    public static void testResults(String node) {
