...
public class MapUnkeyedListTest {
    ...
    public void mapUnkeyedListTest () {
        MapEntryNodeDomSerializer mapEntryNodeDomSerializer = new MapEntryNodeDomSerializer(DomSerializerTestUtils
                .doc, DomSerializerTestUtils.mockDispatcher);
        UnkeyedListEntryNodeDomSerializer unkeyedListEntryNodeDomSerializer = new UnkeyedListEntryNodeDomSerializer
                (DomSerializerTestUtils.doc, DomSerializerTestUtils.mockDispatcher);
