...
public final class StructuralApplyModificationTest {
    ...
    public void setUp() throws Exception {
        ...
        inMemoryDataTree.setSchemaContext(RetestModel.createTestContext());
    }
    ...
    public void testMapNodeParentAutoCreateDelete() throws Exception {
        ...
        // Prepare root
        final YangInstanceIdentifier.NodeIdentifier rootContainerId = getNId(RetestModel.TEST_QNAME);
        ...
        final YangInstanceIdentifier.NodeIdentifierWithPredicates outerListEntryId =
            new YangInstanceIdentifier.NodeIdentifierWithPredicates(RetestModel.OUTER_LIST_QNAME, RetestModel.ID_QNAME, 1);
        ...
        final YangInstanceIdentifier outerListParentPath = YangInstanceIdentifier.create(getNId(RetestModel.TEST_QNAME),
            getNId(RetestModel.OUTER_LIST_QNAME));
    ...
    public void testMapNodeDirectEmptyWrite() throws Exception {
        ...
        final YangInstanceIdentifier outerListParentPath = YangInstanceIdentifier.create(getNId(RetestModel.TEST_QNAME),
            getNId(RetestModel.OUTER_LIST_QNAME));
        addListEntryModification.merge(outerListParentPath, ImmutableNodes.mapNode(RetestModel.OUTER_LIST_QNAME));
    ...
    public void testNonPresenceContainerDirectEmptyWrite() throws Exception {
        ...
        final YangInstanceIdentifier.NodeIdentifier rootContainerId = getNId(RetestModel.NON_PRESENCE_QNAME);
    ...
    public void testNestedStrucutralNodes() throws Exception {
        ...
        final YangInstanceIdentifier path = YangInstanceIdentifier.create(
            getNId(RetestModel.NON_PRESENCE_QNAME),
            getNId(RetestModel.DEEP_CHOICE_QNAME),
            getNId(RetestModel.A_LIST_QNAME),
            getNId(RetestModel.A_LIST_QNAME, RetestModel.A_NAME_QNAME, "1")
        );

        addListEntryModification.write(path,
            Builders.mapEntryBuilder()
                .withNodeIdentifier(getNId(RetestModel.A_LIST_QNAME, RetestModel.A_NAME_QNAME, "1"))
                .build());
        ...
        assertNodeExistence(YangInstanceIdentifier.create(getNId(RetestModel.NON_PRESENCE_QNAME)), true);
        assertNodeExistence(YangInstanceIdentifier.create(
            getNId(RetestModel.NON_PRESENCE_QNAME), getNId(RetestModel.DEEP_CHOICE_QNAME)), true);
    }
