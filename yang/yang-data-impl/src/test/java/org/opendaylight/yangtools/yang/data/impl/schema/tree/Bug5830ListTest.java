...
public class Bug5830ListTest {
    ...
    public void prepare() throws ReactorException {
        schemaContext = TestModel.createTestContext("/bug5830/foo-list.yang");
    ...
    @Test
    public void testDirectListMandatoryLeafIsMissingTwoTransactions() throws DataValidationFailedException {
        ...
        System.out.println("Test1-2: " + inMemoryDataTree);
    }

    @Test
    public void testListMandatoryLeafIsMissing() throws DataValidationFailedException {
        final InMemoryDataTree inMemoryDataTree = initDataTree();
        final NodeIdentifier taskIdentifier = new NodeIdentifier(task);
    ...
    @Test
    public void testListMandatoryLeafIsPresent() throws DataValidationFailedException {
        final InMemoryDataTree inMemoryDataTree = initDataTree();
        final NodeIdentifier taskIdentifier = new NodeIdentifier(task);
