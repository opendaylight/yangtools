...
public class OrderedListTest {
    ...
    public void testsequentialModifications() throws DataValidationFailedException {
        ...
        modification1();
        System.out.println(inMemoryDataTree);
        // este treba spravit update jednej childOrderedListEntry v ramci druhej parentOrderedListEntry
        modification2();
        System.out.println(inMemoryDataTree);
        // deletnem najprv jednu childOrderedListEntry v druhom parentOrderedListEntry a potom deletnem celu druhu
        // parentOrderedListEntry
        delete1();
        System.out.println(inMemoryDataTree);
        delete2();
        System.out.println(inMemoryDataTree);
    ...
    public void modification1() throws DataValidationFailedException {
        ...
        treeModification.write(path, parentContainerNode);
        ...
        path = YangInstanceIdentifier.of(parentContainer).node(childContainer).node(parentOrderedList)
                .node(createParentOrderedListEntryPath("pkval2")).node(childOrderedList);

        treeModification.write(path, childOrderedListNode);
    ...
    public void modification2() throws DataValidationFailedException {
        ...
        YangInstanceIdentifier path = YangInstanceIdentifier.of(parentContainer);
        treeModification.merge(path, parentContainerNode);
        ...
        path = YangInstanceIdentifier.of(parentContainer).node(childContainer).node(parentOrderedList)
                .node(createParentOrderedListEntryPath("pkval2")).node(childOrderedList);
        treeModification.merge(path, childOrderedListNode);
