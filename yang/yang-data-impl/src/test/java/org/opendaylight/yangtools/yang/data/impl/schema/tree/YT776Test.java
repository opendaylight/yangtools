...
public class YT776Test {
    ...
    private static final QName NESTED_ATTR = QName.create(MODULE, "nested-attribute");
    ...
    private static final NodeIdentifierWithPredicates NESTED_ITEM = new NodeIdentifierWithPredicates(NESTED,
        ImmutableMap.of(NESTED_ATTR, "foo"));
    private static final NodeIdentifier NESTED_ATTRIBUTE = new NodeIdentifier(NESTED_ATTR);
