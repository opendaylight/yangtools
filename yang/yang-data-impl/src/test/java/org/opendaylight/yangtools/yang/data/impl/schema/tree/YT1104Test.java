...
public class YT1104Test {
    ...
    public void testAnydata() throws DataValidationFailedException {
        ...
        mod.write(YangInstanceIdentifier.create(FOO), choiceBuilder()
            .withNodeIdentifier(FOO)
            .withChild(anydataBuilder(String.class).withNodeIdentifier(BAR).withValue("anydata").build())
            .build());
    ...
    public void testAnyxml() throws DataValidationFailedException {
        ...
        mod.write(YangInstanceIdentifier.create(FOO), choiceBuilder()
            .withNodeIdentifier(FOO)
            .withChild(anyXmlBuilder().withNodeIdentifier(BAZ).withValue(new DOMSource()).build())
            .build());
