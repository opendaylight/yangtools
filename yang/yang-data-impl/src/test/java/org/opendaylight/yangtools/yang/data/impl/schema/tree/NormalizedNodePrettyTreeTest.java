...
public class NormalizedNodePrettyTreeTest extends AbstractPrettyTreeTest {
    ...
    public void testUserMapEntryPrettyTree() {
        final String expected = String.join("\n",
                "mapEntryNode{identifier=(urn:opendaylight:controller:sal:dom:store:test?revision=2014-03-13)user-map[{(urn:opendaylight:controller:sal:dom:store:test?revision=2014-03-13)user-map-entry=User map entry value}], value=[",
