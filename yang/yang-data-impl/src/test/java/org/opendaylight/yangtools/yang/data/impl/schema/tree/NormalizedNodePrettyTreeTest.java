...
public class NormalizedNodePrettyTreeTest {
    ...
    public void prettyTreeTest() {
        final String expectedString = String.join("\n",
                ...
                "        mapEntryNode{identifier=list-a[{(urn:opendaylight:controller:sal:dom:store:test?revision=2014-03-13)leaf-a=bar}], value=[",
                "            leafNode{identifier=leaf-a, value=bar}",
                "            systemMapNode{identifier=list-b, value=[",
                "                mapEntryNode{identifier=list-b[{(urn:opendaylight:controller:sal:dom:store:test?revision=2014-03-13)leaf-b=two}], value=[",
                "                    leafNode{identifier=leaf-b, value=two}]}",
                "                mapEntryNode{identifier=list-b[{(urn:opendaylight:controller:sal:dom:store:test?revision=2014-03-13)leaf-b=one}], value=[",
                "                    leafNode{identifier=leaf-b, value=one}]}]}]}",
                "        mapEntryNode{identifier=list-a[{(urn:opendaylight:controller:sal:dom:store:test?revision=2014-03-13)leaf-a=foo}], value=[",
                ...
                "        mapEntryNode{identifier=list-from-another-namespace[{(urn:opendaylight:controller:sal:dom:store:another)leaf-from-another-namespace=I am leaf from another namespace}], value=[",
