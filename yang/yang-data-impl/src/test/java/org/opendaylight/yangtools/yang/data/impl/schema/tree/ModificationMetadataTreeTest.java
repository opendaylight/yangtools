...
public class ModificationMetadataTreeTest extends AbstractTestModelTest {
    ...
    public void testPrettyPrint() {
        ...
        final String expectedString = String.join("\n",
                ...
                "        identifier=(urn:ietf:params:xml:ns:netconf:base:1.0)data, operation=TOUCH, childModification={(urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test?revision=2014-03-13)test=ModifiedNode{",
                "            identifier=(urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test?revision=2014-03-13)test, operation=TOUCH, childModification={outer-list=ModifiedNode{",
                "                identifier=outer-list, operation=TOUCH, childModification={outer-list[{(urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test?revision=2014-03-13)id=2}]=ModifiedNode{",
                "                    identifier=outer-list[{(urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test?revision=2014-03-13)id=2}], operation=TOUCH, childModification={inner-list=ModifiedNode{",
                "                        identifier=inner-list, operation=TOUCH, childModification={inner-list[{(urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test?revision=2014-03-13)name=two}]=ModifiedNode{",
                "                            identifier=inner-list[{(urn:opendaylight:params:xml:ns:yang:controller:md:sal:dom:store:test?revision=2014-03-13)name=two}], operation=TOUCH, childModification={value=ModifiedNode{",
