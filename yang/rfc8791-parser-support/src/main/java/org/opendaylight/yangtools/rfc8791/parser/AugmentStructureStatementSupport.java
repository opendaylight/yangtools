...
final class AugmentStructureStatementSupport
        extends BaseStatementSupport<Absolute, AugmentStructureStatement, AugmentStructureEffectiveStatement> {
    private final SubstatementValidator validator;

    private AugmentStructureStatementSupport(final SubstatementValidator validator) {
        super(YangDataStructureStatements.STRUCTURE, CopyPolicy.REJECT);
        this.validator = requireNonNull(validator);
    }

    static AugmentStructureStatementSupport rfc6020() {
        return new AugmentStructureStatementSupport(
    ...
    static AugmentStructureStatementSupport rfc7950() {
        return new AugmentStructureStatementSupport(
            SubstatementValidator.builder(YangDataStructureStatements.AUGMENT_STRUCTURE)
                .addOptional(YangStmtMapping.STATUS)
                .addOptional(YangStmtMapping.DESCRIPTION)
