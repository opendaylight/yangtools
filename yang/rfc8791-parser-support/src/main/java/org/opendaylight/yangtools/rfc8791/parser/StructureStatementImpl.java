...
final class StructureStatementImpl extends WithSubstatements implements StructureStatement {
    StructureStatementImpl(final QName argument, final ImmutableList<? extends DeclaredStatement<?>> substatements) {
