...
@Beta
public enum AppendStatements implements StatementDefinition {
    APPEND(QName.create(AppendConstants.ORIGINAL_MODULE, "amend"),
        "target-statement", AppendStatement.class, AppendEffectiveStatement.class);
    ...
    AppendStatements(final QName statementName, final String argumentName,
