...
/**
 * Constants associated with OpenDaylight extension in odl-append.yang.
 *
 * @author Robert Varga
 */
public final class AppendConstants {
    private static final String MODULE_NAME = "odl-append";
    private static final URI MODULE_NAMESPACE = URI.create("urn:opendaylight:yang:extension:append");
