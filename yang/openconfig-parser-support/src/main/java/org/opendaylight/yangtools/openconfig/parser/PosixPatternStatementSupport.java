...
public class PosixPatternStatementSupport extends
    ...
    protected  OpenConfigPosixPatternStatement createDeclared(
             StmtContext<String, OpenConfigPosixPatternStatement, ?> ctx,
    ...
    protected  OpenConfigPosixPatternEffectiveStatement createEffective(
             StmtContext<String, OpenConfigPosixPatternStatement, OpenConfigPosixPatternEffectiveStatement> ctx,
             OpenConfigPosixPatternStatement declared,
