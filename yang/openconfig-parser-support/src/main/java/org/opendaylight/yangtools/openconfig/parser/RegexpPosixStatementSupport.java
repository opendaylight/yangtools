...
public class RegexpPosixStatementSupport extends
    ...
    @Override
    protected @NonNull OpenConfigRegexpPosixStatement createDeclared(
            @NonNull StmtContext<Void, OpenConfigRegexpPosixStatement, ?> ctx,
    ...
    @Override
    protected @NonNull OpenConfigRegexpPosixStatement createEmptyDeclared(
            @NonNull StmtContext<Void, OpenConfigRegexpPosixStatement, ?> ctx) {
        return createDeclared(ctx, ImmutableList.of());
    }

    @Override
    protected @NonNull OpenConfigRegexpPosixEffectiveStatement createEffective(
            @NonNull StmtContext<Void, OpenConfigRegexpPosixStatement, OpenConfigRegexpPosixEffectiveStatement> ctx,
            @NonNull OpenConfigRegexpPosixStatement declared,
            @NonNull ImmutableList<? extends EffectiveStatement<?, ?>> substatements) {
        return new RegexpPosixStatementSupport.Effective(ctx, substatements);
    }

    @Override
    protected @NonNull OpenConfigRegexpPosixEffectiveStatement createEmptyEffective(
            @NonNull StmtContext<Void, OpenConfigRegexpPosixStatement, OpenConfigRegexpPosixEffectiveStatement> ctx,
            @NonNull OpenConfigRegexpPosixStatement declared) {
