...
public interface BindingStreamEventWriter {
    ...
    /**
     * Returns requested context of Stream Event Writer.
     * <p>
     * Context types and their behaviour is specified by implementations.
     * Users of {@link BindingStreamEventWriter} may require support for
     * specific context, but this must be documented and proper error
     * should be reported if required context is not available.
     *
     * <p>
     * Note: This may be required for correct implementation of emitting events
     * for {@link #startCase(QName)} and
     * {@link #startAugmentationNode(QNameModule, String...)} where emtiter
     * needs to compute namespace for node, which is emitted.
     * <p>
     ...
     *
     * @return Returns requested context of writer or
     ...
     *             <code>choice</code> <code>unkeyed list</code> node.
     */
    <T extends DataObject & Identifiable<?>> void startMapNode(Class<T> mapEntryType,int childSizeHint) throws IllegalArgumentException;
     ...
     *
     *<p>
     * Valid sub-event in {@link #startCase(QName, int)}, which selects
     * case which should be written.
     * <ul>
     *
     * @param localName
     *            name of node as defined in schema, namespace and revision are
     ...
     *
     * <p>
     * Note this is only method, which does not require childSizeHint,
     * since maximum value is always size of <code>possibleChildren</code>.
     *
     * @param module
