...
public interface BindingStreamEventWriter {
     ...
     * <p>
     * Context types and their behaviour is specified by implementations. Users
     * of {@link BindingStreamEventWriter} may require support for specific
     * context, but this must be documented and proper error should be reported
     * if required context is not available.
     *
     * <p>
     ...
     *
     * @return Returns requested context of writer or was not finished by
     *         emiting {@link #endNode()}.
     */
