...
public class BitsTypeTest {
    ...
    public void canCreateBitsType(){
        ...
        assertTrue("Hash code of bitsType should be equal",
                bitsType.hashCode() == bitsType.hashCode());
        assertFalse("bitsType shouldn't equal to null", bitsType.equals(null));
        assertEquals("bitsType should equals to itself", bitsType, bitsType);
        assertFalse("bitsType shouldn't equal to object of other type", bitsType.equals("str"));
