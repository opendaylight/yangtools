...
public class TypeTest {
    ...
    public void binaryTypeTest() {
        ...
        final DerivedBinaryType derivedBinaryType1 = (DerivedBinaryType)DerivedTypes.derivedTypeBuilder(
                baseBinaryType1).build();
        final DerivedBinaryType derivedBinaryType2 = (DerivedBinaryType)DerivedTypes.derivedTypeBuilder(
                baseBinaryType2).build();
        ...
        final LengthRestrictedTypeBuilder<BinaryTypeDefinition> lengthRestrictedTypeBuilder = RestrictedTypes
                .newBinaryBuilder(baseBinaryType1);
    ...
    public void booleanTypeTest() {
        ...
        restrictedBuilderTest(RestrictedTypes.newBooleanBuilder(baseBooleanType1), RestrictedTypes
                .newBooleanBuilder(baseBooleanType2));
        concreteBuilderTest(baseBooleanType1, derivedBooleanType1);
    }

    @Test
    public void identityrefTypeTest() {
        final IdentityrefTypeBuilder identityrefTypeBuilder1 = BaseTypes.identityrefTypeBuilder();
        ...
        final IdentityrefTypeBuilder identityrefTypeBuilder2 = BaseTypes.identityrefTypeBuilder();
        ...
        restrictedBuilderTest(RestrictedTypes.newIdentityrefBuilder(derivedIdentityrefType1),
                RestrictedTypes.newIdentityrefBuilder(derivedIdentityrefType2));
    }

    @Test
    public void decimalTypeTest() {
        final BaseDecimalType baseDecimalType1 = (BaseDecimalType)BaseTypes.decimalTypeBuilder()
                .setFractionDigits(1)
                .buildType();
        final BaseDecimalType baseDecimalType2 = (BaseDecimalType)BaseTypes.decimalTypeBuilder()
                .setFractionDigits(1)
                .buildType();
        ...
        final DerivedDecimalType derivedDecimalType1 = (DerivedDecimalType)DerivedTypes
                .derivedTypeBuilder(baseDecimalType1).build();
        ...
        final RestrictedDecimalType restrictedDecimalType1 = (RestrictedDecimalType)
                RestrictedTypes.newDecima64Builder(baseDecimalType1).buildType();
        final RestrictedDecimalType restrictedDecimalType2 = (RestrictedDecimalType)
                RestrictedTypes.newDecima64Builder(baseDecimalType2).buildType();
    ...
    public void emptyTypeTest() {
        ...
        final DerivedEmptyType derivedEmptyType1 = (DerivedEmptyType)DerivedTypes.derivedTypeBuilder(
                baseEmptyType1).build();
        final DerivedEmptyType derivedEmptyType2 = (DerivedEmptyType)DerivedTypes.derivedTypeBuilder(
                baseEmptyType2).build();
        hashCodeEqualsToStringTest(derivedEmptyType1, derivedEmptyType2);

        restrictedBuilderTest(RestrictedTypes.newEmptyBuilder(baseEmptyType1),
                RestrictedTypes.newEmptyBuilder(baseEmptyType2));
    ...
    public void instanceIdentifierTypeTest() {
        ...
        final DerivedInstanceIdentifierType derivedInstanceIdentifierType1 = (DerivedInstanceIdentifierType)
                DerivedTypes.derivedTypeBuilder(baseInstanceIdentifierType1).build();
        final DerivedInstanceIdentifierType derivedInstanceIdentifierType2 = (DerivedInstanceIdentifierType)
                DerivedTypes.derivedTypeBuilder(baseInstanceIdentifierType2).build();
        ...
        final InstanceIdentifierTypeBuilder instanceIdentifierBuilder1 = RestrictedTypes
                .newInstanceIdentifierBuilder(baseInstanceIdentifierType1);
    ...
    public void integerTypeTest() {
        ...
        final DerivedInt8Type derivedIntegerType1 = (DerivedInt8Type)DerivedTypes
                .derivedTypeBuilder(integerTypeDefinition8).build();
        final DerivedInt8Type derivedIntegerType2 = (DerivedInt8Type)DerivedTypes
                .derivedTypeBuilder(BaseInt8Type.INSTANCE).build();
        ...
        final DerivedUint8Type derivedUnsignedType1 = (DerivedUint8Type)DerivedTypes
                .derivedTypeBuilder(integerTypeDefinitionu8).build();
        final DerivedUint8Type derivedUnsignedType2 = (DerivedUint8Type)DerivedTypes
                .derivedTypeBuilder(BaseUint8Type.INSTANCE).build();
        ...
        final RestrictedUint8Type restrictedUnsignedType1 = (RestrictedUint8Type)RestrictedTypes
                .newUint8Builder(integerTypeDefinitionu8).buildType();
        final RestrictedUint8Type restrictedUnsignedType2 = (RestrictedUint8Type)RestrictedTypes
                .newUint8Builder(BaseUint8Type.INSTANCE).buildType();
    ...
    public void stringTypeTest() {
        ...
        final DerivedStringType derivedStringType1 = (DerivedStringType)
                DerivedTypes.derivedTypeBuilder(baseStringType1).build();
        final DerivedStringType derivedStringType2 = (DerivedStringType)
                DerivedTypes.derivedTypeBuilder(baseStringType2).build();
        ...
        final StringTypeBuilder stringTypeBuilder = new StringTypeBuilder(baseStringType1);
    ...
    public void bitsTypeTest() {
        final BitsTypeBuilder bitsTypeBuilder = BaseTypes.bitsTypeBuilder();
        ...
        final DerivedBitsType derivedBitsType1 = (DerivedBitsType)DerivedTypes
                .derivedTypeBuilder(bitsTypeDefinition1).build();
        final DerivedBitsType derivedBitsType2 = (DerivedBitsType)DerivedTypes
                .derivedTypeBuilder(bitsTypeDefinition2).build();
        hashCodeEqualsToStringTest(derivedBitsType1, derivedBitsType2);

        restrictedBuilderTest(RestrictedTypes.newBitsBuilder(bitsTypeDefinition1),
                RestrictedTypes.newBitsBuilder(bitsTypeDefinition2));
    ...
    public void enumerationTypeTest() {
        ...
        final DerivedEnumerationType derivedEnumerationType1 = (DerivedEnumerationType)DerivedTypes
                .derivedTypeBuilder(baseEnumerationType1).build();
        final DerivedEnumerationType derivedEnumerationType2 = (DerivedEnumerationType)DerivedTypes
                .derivedTypeBuilder(baseEnumerationType2).build();
        hashCodeEqualsToStringTest(derivedEnumerationType1, derivedEnumerationType2);

        restrictedBuilderTest(RestrictedTypes.newEnumerationBuilder(baseEnumerationType1),
                RestrictedTypes.newEnumerationBuilder(baseEnumerationType2));
        concreteBuilderTest(baseEnumerationType1, derivedEnumerationType1);
    }

    @Test
    public void leafrefTypeTest() {
        final LeafrefTypeBuilder leafrefTypeBuilder1 = BaseTypes.leafrefTypeBuilder();
        final LeafrefTypeBuilder leafrefTypeBuilder2 = BaseTypes.leafrefTypeBuilder();
        ...
        final DerivedLeafrefType derivedLeafrefType1 = (DerivedLeafrefType)DerivedTypes
                .derivedTypeBuilder(baseLeafrefType1).build();
        final DerivedLeafrefType derivedLeafrefType2 = (DerivedLeafrefType)DerivedTypes
                .derivedTypeBuilder(baseLeafrefType2).build();
        hashCodeEqualsToStringTest(derivedLeafrefType1, derivedLeafrefType2);

        restrictedBuilderTest(RestrictedTypes.newLeafrefBuilder(baseLeafrefType1),
                RestrictedTypes.newLeafrefBuilder(baseLeafrefType2));
    ...
    public void unionTypeTest() throws IllegalAccessException, InstantiationException {
        ...
        final BaseDecimalType baseDecimalType2 = (BaseDecimalType)BaseTypes.decimalTypeBuilder()
                .setFractionDigits(1)
                .buildType();
        final UnionTypeBuilder unionTypeBuilder1 = BaseTypes.unionTypeBuilder();
        final UnionTypeBuilder unionTypeBuilder2 = BaseTypes.unionTypeBuilder();
        ...
        final DerivedUnionType derivedUnionType1 = (DerivedUnionType)DerivedTypes
                .derivedTypeBuilder(baseUnionType1).build();
        final DerivedUnionType derivedUnionType2 = (DerivedUnionType)DerivedTypes
                .derivedTypeBuilder(baseUnionType2).build();
        hashCodeEqualsToStringTest(derivedUnionType1, derivedUnionType2);

        restrictedBuilderTest(RestrictedTypes.newUnionBuilder(baseUnionType1),
                RestrictedTypes.newUnionBuilder(baseUnionType2));
...
/*
    ...
    public void abstractTypeDefinitionQnameTest() {
        final AbstractTypeDefinition<?> abstractTypeDefinition = (AbstractTypeDefinition<?>)
            BaseTypes.decimalTypeBuilder().setFractionDigits(1).buildType();
    ...
    public void abstractDerivedTypeTest() {
        ...
        final AbstractDerivedType<?> abstractDerivedType = (AbstractDerivedType<?>)
            DerivedTypes.derivedTypeBuilder(baseBinaryType1).build();
    ...
    public void constraintTypeBuilderTest() throws InvalidLengthConstraintException {
        ...
        final LengthRestrictedTypeBuilder<?> lengthRestrictedTypeBuilder = RestrictedTypes
                .newBinaryBuilder(baseBinaryType);
    ...
    public void identityrefTypeBuilderException() {
        final IdentityrefTypeBuilder builder = BaseTypes.identityrefTypeBuilder();
