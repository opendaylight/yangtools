...
public class SchemaSourceTransformerTest {
    ...
    private static final Class<YangSchemaSourceRepresentation> srcClass = YangSchemaSourceRepresentation.class;
    private static final Class<YinXmlSchemaSource> dstClass = YinXmlSchemaSource.class;
    ...
    public void schemaSourceTransformerTest() {
        this.schema = new SchemaSourceTransformer<YangSchemaSourceRepresentation, YinXmlSchemaSource>(
                this.provider, SchemaSourceTransformerTest.srcClass, this.consumer, SchemaSourceTransformerTest.dstClass, this.function);
    ...
    public void schemaSourceTransformerGetSourceTest() throws Exception {
        ...
        final Registrator reg = new Registrator(p, SchemaSourceTransformerTest.srcClass, PotentialSchemaSource.Costs.IMMEDIATE);
        ...
        this.schema = new SchemaSourceTransformer<YangSchemaSourceRepresentation, YinXmlSchemaSource>(p,
                SchemaSourceTransformerTest.srcClass, this.consumer, SchemaSourceTransformerTest.dstClass,
                this.function);
    ...
    public void schemaSourceRegAndUnregSchemaSourceTest() throws Exception {
        ...
        final Foo<YangSchemaSourceRepresentation> foo = new Foo<>(sourceIdentifier,
                SchemaSourceTransformerTest.srcClass,
                PotentialSchemaSource.Costs.COMPUTATION);
        final Provider p = new Provider();

        final Registrator reg = new Registrator(p, SchemaSourceTransformerTest.srcClass,
                PotentialSchemaSource.Costs.IMMEDIATE);
        reg.register(sourceIdentifier);

        final Consumer c = new Consumer();
        this.schema = new SchemaSourceTransformer<YangSchemaSourceRepresentation, YinXmlSchemaSource>(p,
                SchemaSourceTransformerTest.srcClass, c, SchemaSourceTransformerTest.dstClass, this.function);
