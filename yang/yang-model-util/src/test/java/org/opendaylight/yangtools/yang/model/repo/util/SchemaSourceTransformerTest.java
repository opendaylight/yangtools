...
public class SchemaSourceTransformerTest {
    ...
    private final Class<YangSchemaSourceRepresentation> srcClass = YangSchemaSourceRepresentation.class;
    private final Class<YinXmlSchemaSource> dstClass = YinXmlSchemaSource.class;
    ...
    public void schemaSourceTransformerTest() {
        this.schema = new SchemaSourceTransformer<YangSchemaSourceRepresentation, YinXmlSchemaSource>(
                this.provider, this.srcClass, this.consumer, this.dstClass, this.function);
    ...
    public void schemaSourceTransformerGetSourceTest() throws Exception {
        ...
        final Registrator reg = new Registrator(p, this.srcClass, PotentialSchemaSource.Costs.IMMEDIATE);
        ...
        this.schema = new SchemaSourceTransformer<YangSchemaSourceRepresentation, YinXmlSchemaSource>(p,
                this.srcClass, this.consumer, this.dstClass, this.function);
    ...
    public void schemaSourceRegAndUnregSchemaSourceTest() throws Exception {
        final SourceIdentifier sourceIdentifier = new SourceIdentifier("source");
        final Foo<YangSchemaSourceRepresentation> foo = new Foo<>(sourceIdentifier, this.srcClass,
        ...
        this.schema = new SchemaSourceTransformer<YangSchemaSourceRepresentation, YinXmlSchemaSource>(p, this.srcClass,
                c, this.dstClass, this.function);
