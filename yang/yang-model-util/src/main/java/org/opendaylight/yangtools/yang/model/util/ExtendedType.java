...
public class ExtendedType implements TypeDefinition<TypeDefinition<?>> {
    ...
    public static class Builder {
         ...
         * @param reference
         *
         * @deprecated Use {@link ExtendedType.Builder#Builder(QName, TypeDefinition, String, String, SchemaPath)) instead.
         */
        @Deprecated
        public Builder(final List<String> actualPath, final URI namespace,
            ...
            this(typeName,baseType,Optional.of(description),Optional.of(reference),BaseTypes.schemaPath(actualPath, namespace, revision));
        }
