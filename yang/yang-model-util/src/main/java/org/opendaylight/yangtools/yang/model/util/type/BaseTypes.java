...
public final class BaseTypes {
    ...
    public static boolean isInt8(final TypeDefinition<?> type) {
        return BaseInt8Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isInt16(final TypeDefinition<?> type) {
        return BaseInt16Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isInt32(final TypeDefinition<?> type) {
        return BaseInt32Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isInt64(final TypeDefinition<?> type) {
        return BaseInt64Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isUint8(final TypeDefinition<?> type) {
        return BaseUint8Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isUint16(final TypeDefinition<?> type) {
        return BaseUint16Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isUint32(final TypeDefinition<?> type) {
        return BaseUint32Type.INSTANCE.equals(findBaseType(type));
    }
    ...
    public static boolean isUint64(final TypeDefinition<?> type) {
        return BaseUint64Type.INSTANCE.equals(findBaseType(type));
    }

    private static TypeDefinition<?> findBaseType(final TypeDefinition<?> type) {
