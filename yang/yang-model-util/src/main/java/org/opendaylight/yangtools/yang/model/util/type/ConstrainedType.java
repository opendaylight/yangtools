...
abstract class ConstrainedType<T extends TypeDefinition<T>> implements Immutable, DerivedTypeBuilderFactory<T>,
        TypeDefinition<T> {
    private final List<UnknownSchemaNode> unknownSchemaNodes;
    private final T baseType;
    private final SchemaPath path;

    ConstrainedType(final T baseType, final SchemaPath path, final Collection<UnknownSchemaNode> unknownSchemaNodes) {
