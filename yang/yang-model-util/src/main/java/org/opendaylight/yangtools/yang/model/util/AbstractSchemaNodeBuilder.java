...
public abstract class AbstractSchemaNodeBuilder<T extends SchemaNode> implements Mutable, Builder<T> {
    ...
    public final AbstractSchemaNodeBuilder<T> setPath(final SchemaPath path) {
        this.path = Preconditions.checkNotNull(path);
        return this;
    }

    public final AbstractSchemaNodeBuilder<T> setDescription(final String description) {
