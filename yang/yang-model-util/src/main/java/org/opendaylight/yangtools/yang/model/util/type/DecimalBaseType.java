...
public final class DecimalBaseType extends RangedBaseType<DecimalTypeDefinition> implements DecimalTypeDefinition {
    ...
    DecimalBaseType(final SchemaPath path, final Integer fractionDigits) {
