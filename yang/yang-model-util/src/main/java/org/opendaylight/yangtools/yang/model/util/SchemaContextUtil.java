...
public final class SchemaContextUtil {
    ...
    public static SchemaNode findDataSchemaNode(final SchemaContext context, final Module module,
        ...
        if (strXPath != null) {
            ...
            if (nonCondXPath.isAbsolute()) {
                ...
                // FIXME: This entire method is ill-defined, as the resolution process depends on  where the XPath is
                //        defined -- notably RPCs, actions and notifications modify the data tree temporarily. See
                //        sections 6.4.1 and 9.9.2 of RFC7950.
                //
    ...
    public static SchemaNode findDataSchemaNodeForRelativeXPath(final SchemaContext context, final Module module,
        ...
        if (actualNodePath != null) {
            ...
            // FIXME: This entire method is ill-defined, as the resolution process depends on  where the XPath is
            //        defined -- notably RPCs, actions and notifications modify the data tree temporarily. See sections
            //        6.4.1 and 9.9.2 of RFC7950.
            //
            //        We therefore attempt to make a best estimate, but both methods of resolution are prone to
            //        failure.
