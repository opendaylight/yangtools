...
public final class SchemaContextUtil {
    ...
    /**
     * Return List of qNames that are walkable using xPath. When getting a path
     * from schema node it will return path with parents like CaseSchemaNode and
     * ChoiceSchemaNode as well if they are parents of the node. We need to get
     * rid of these in order to find the node that xPath is pointing to. Also we
     * can not remove any node beyond the amount of "../" because we will not be
     * able to find the correct schema node from schema context
     *
     ...
     * @return list of qNames as a path where we should be able to find referenced
     *         node
     */
    private static List<QName> createWalkablePath(final Iterable<QName> schemaNodePath,
