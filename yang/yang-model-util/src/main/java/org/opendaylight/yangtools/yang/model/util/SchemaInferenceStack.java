...
public final class SchemaInferenceStack implements Mutable, EffectiveModelContextProvider {
    ...
    public @NonNull DataTreeEffectiveStatement<?> exitToDataTree() {
        final EffectiveStatement<?, ?> result = exit();
        checkState(result instanceof DataTreeEffectiveStatement, "Unexpected current %s", result);
        ...
        return (DataTreeEffectiveStatement<?>) result;
    }
