...
abstract class AbstractDerivedType<T extends TypeDefinition<T>> implements Immutable, TypeDefinition<T> {
    ...
    AbstractDerivedType(final T baseType, final SchemaPath path, final Object defaultValue, final String description,
        ...
        this.defaultValue = defaultValue != null ? defaultValue : baseType.getDefaultValue();
        this.description = description != null ? description : baseType.getDescription();
        this.reference = reference != null ? reference : baseType.getReference();
        this.status = status != null ? status : baseType.getStatus();
        this.units = units != null ? units : baseType.getUnits();
