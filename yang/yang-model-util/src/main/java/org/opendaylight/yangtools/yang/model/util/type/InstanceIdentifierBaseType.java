...
public final class InstanceIdentifierBaseType extends RangedBaseType<DecimalTypeDefinition> implements DecimalTypeDefinition {
    ...
    InstanceIdentifierBaseType(final SchemaPath path, final Integer fractionDigits) {
        super(path, IMPLICIT_RANGE_STATEMENTS.get(fractionDigits - 1));
    ...
    @Override
    public DecimalConstrainedTypeBuilder newConstrainedTypeBuilder(final SchemaPath path) {
        return new DecimalConstrainedTypeBuilder(this, path);
    }
}
