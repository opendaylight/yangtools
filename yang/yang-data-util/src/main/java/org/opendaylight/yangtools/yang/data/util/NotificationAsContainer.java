...
public final class NotificationAsContainer implements ContainerSchemaNode {
    ...
    private final Map<QName, DataSchemaNode> mapNodes = Maps.newConcurrentMap();
    ...
    public NotificationAsContainer(final NotificationDefinition notification) {
        ...
        this.notification.getChildNodes().stream().forEach(node->mapNodes.put(node.getQName(),node));
    }
