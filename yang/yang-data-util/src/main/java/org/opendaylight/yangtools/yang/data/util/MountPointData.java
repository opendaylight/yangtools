...
public final class MountPointData implements Identifiable<QName> {
    ...
    private final Map<ContainerName, NormalizableAnydata> yangLib = new EnumMap<>(ContainerName.class);
    private final List<NormalizableAnydata> children = new ArrayList<>();
    ...
    public void setContainer(final @NonNull ContainerName containerName, final @NonNull NormalizableAnydata data) {
    ...
    public void addChild(final @NonNull NormalizableAnydata data) {
