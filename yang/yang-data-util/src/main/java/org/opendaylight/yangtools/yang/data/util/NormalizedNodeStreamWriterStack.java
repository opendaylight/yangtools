...
public final class NormalizedNodeStreamWriterStack implements Mutable {
     ...
     */
    public static @NonNull NormalizedNodeStreamWriterStack of(final EffectiveModelContext context, final Absolute path) {
     ...
     */
    @Deprecated
    public static @NonNull NormalizedNodeStreamWriterStack of(final EffectiveModelContext context, final SchemaPath path) {
