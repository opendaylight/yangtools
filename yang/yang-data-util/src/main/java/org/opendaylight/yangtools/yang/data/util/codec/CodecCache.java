...
public abstract class CodecCache<T> {
     ...
     */
    @Nullable public abstract T lookupComplex(TypedSchemaNode schema);
     ...
     * @return Cached codec, or null if no codec is cached.
     */
    @Nullable public abstract T lookupSimple(TypeDefinition<?> type);
     ...
     */
    @Nonnull public abstract T getComplex(TypedSchemaNode schema, T codec);
     ...
     * @return Codec instance, either already-cached, or the codec presented as argument.
     */
    @Nonnull public abstract T getSimple(TypeDefinition<?> type, T codec);
}
