...
public interface FileGenerator {
     ...
     * the files generated as a set of {@link GeneratedFile}s. The caller of this method will use these to
     * integrate with build management to ensure proper dependency tracking is performed.
     *
     ...
     */
    Table<GeneratedFileType, GeneratedFilePath, GeneratedFile> generateFiles(SchemaContext context,
            Set<Module> localModules, ModuleResourceResolver moduleResourcePathResolver);
}
