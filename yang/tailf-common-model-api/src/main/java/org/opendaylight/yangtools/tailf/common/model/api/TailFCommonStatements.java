...
/**
 * {@link StatementDefinition}s for statements defined by tailf-common.yang.
 *
 * @author Robert Varga
 */
@NonNullByDefault
public enum TailFCommonStatements implements StatementDefinition {
    ACTION(QName.create(TailFCommonConstants.MODULE, "action"), "name", ActionStatement.class,
    ...
    TailFCommonStatements(final QName statementName, final String argumentName,
        ...
        this.argumentName = QName.create(statementName, argumentName).intern();
