...
abstract class AbstractTypeStatementSupport extends AbstractTypeSupport<TypeStatement> {
    ...
    private static final ImmutableMap<String, BuiltinEffectiveStatement> STATIC_BUILT_IN_TYPES =
        ImmutableMap.<String, BuiltinEffectiveStatement>builder()
            .put(TypeDefinitions.TYPEDEF_BINARY.getLocalName(), BuiltinEffectiveStatement.BINARY)
            .put(TypeDefinitions.TYPEDEF_BOOLEAN.getLocalName(), BuiltinEffectiveStatement.BOOLEAN)
            .put(TypeDefinitions.TYPEDEF_EMPTY.getLocalName(), BuiltinEffectiveStatement.EMPTY)
            ...
            .put(TypeDefinitions.TYPEDEF_INSTANCE_IDENTIFIER.getLocalName(),
                BuiltinEffectiveStatement.INSTANCE_IDENTIFIER)
            .put(TypeDefinitions.TYPEDEF_INT8.getLocalName(), BuiltinEffectiveStatement.INT8)
            .put(TypeDefinitions.TYPEDEF_INT16.getLocalName(), BuiltinEffectiveStatement.INT16)
            .put(TypeDefinitions.TYPEDEF_INT32.getLocalName(), BuiltinEffectiveStatement.INT32)
            .put(TypeDefinitions.TYPEDEF_INT64.getLocalName(), BuiltinEffectiveStatement.INT64)
            .put(TypeDefinitions.TYPEDEF_STRING.getLocalName(), BuiltinEffectiveStatement.STRING)
            .put(TypeDefinitions.TYPEDEF_UINT8.getLocalName(), BuiltinEffectiveStatement.UINT8)
            .put(TypeDefinitions.TYPEDEF_UINT16.getLocalName(), BuiltinEffectiveStatement.UINT16)
            .put(TypeDefinitions.TYPEDEF_UINT32.getLocalName(), BuiltinEffectiveStatement.UINT32)
            .put(TypeDefinitions.TYPEDEF_UINT64.getLocalName(), BuiltinEffectiveStatement.UINT64)
            .build();
    ...
    private static final ImmutableMap<String, StatementSupport<?, ?, ?>> DYNAMIC_BUILT_IN_TYPES =
            ...
            .put(TypeDefinitions.TYPEDEF_BITS.getLocalName(), new BitsSpecificationSupport())
            .put(TypeDefinitions.TYPEDEF_DECIMAL64.getLocalName(), new Decimal64SpecificationSupport())
            .put(TypeDefinitions.TYPEDEF_ENUMERATION.getLocalName(), new EnumSpecificationSupport())
            .put(TypeDefinitions.TYPEDEF_IDENTITYREF.getLocalName(), new IdentityRefSpecificationRFC6020Support())
            .put(TypeDefinitions.TYPEDEF_INSTANCE_IDENTIFIER.getLocalName(), new InstanceIdentifierSpecificationSupport())
            .put(TypeDefinitions.TYPEDEF_LEAFREF.getLocalName(), new LeafrefSpecificationRFC6020Support())
            .put(TypeDefinitions.TYPEDEF_UNION.getLocalName(), new UnionSpecificationSupport())
            .build();
