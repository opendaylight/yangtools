...
final class YangStatementLexerTokenFactory extends CompactTokenFactory {
    static final @NonNull YangStatementLexerTokenFactory INSTANCE = new YangStatementLexerTokenFactory();
    ...
    protected Token create(final Pair<TokenSource, CharStream> source, final int type, final int start,
        ...
        switch (type) {
            ...
            case YangStatementLexer.SLASH:
            case YangStatementLexer.STAR:
            case YangStatementLexer.DQUOT_START:
            case YangStatementLexer.SQUOT_START:
            case YangStatementLexer.DQUOT_END:
            case YangStatementLexer.SQUOT_END:
