...
public final class RFC7950Reactors {
    ...
    private static final class VanillaReactor {
        static final @NonNull CrossSourceStatementReactor INSTANCE = vanillaReactorBuilder().build();
    }

    private static final class XPath {
        static final @NonNull XPathSupport INSTANCE = new XPathSupport(ServiceLoader.load(YangXPathParserFactory.class)
    ...
    public static @NonNull CrossSourceStatementReactor vanillaReactor() {
        return VanillaReactor.INSTANCE;
    }
    ...
    public static @NonNull CustomCrossSourceStatementReactorBuilder vanillaReactorBuilder() {
        return vanillaReactorBuilder(XPath.INSTANCE);
    }
