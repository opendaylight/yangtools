...
final class EmptyIdentifierSpecification extends WithQNameArgument implements InstanceIdentifierSpecification {
    EmptyIdentifierSpecification(final String rawArgument) {
        super(rawArgument);
    }
}
