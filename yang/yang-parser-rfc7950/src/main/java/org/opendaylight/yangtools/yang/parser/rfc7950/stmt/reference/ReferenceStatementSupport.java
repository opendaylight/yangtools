...
public final class ReferenceStatementSupport extends AbstractStatementSupport<String, ReferenceStatement,
    ...
    public EffectiveStatement<String, ReferenceStatement> createEffective(
        ...
        final ReferenceStatement declared = AbstractDeclaredEffectiveStatement.buildDeclared(ctx);
        final ImmutableList<? extends EffectiveStatement<?, ?>> substatements =
                AbstractEffectiveStatement.buildEffectiveSubstatements(ctx);
        return substatements.isEmpty() ? new EmptyReferenceEffectiveStatement(declared)
