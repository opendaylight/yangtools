...
public interface AugmentImplicitHandlingNamespace
        extends IdentifierNamespace<StmtContext<?, ?, ?>, AbstractStmtContext<?, ?, ?>> {
    NamespaceBehaviour<StmtContext<?, ?, ?>, AbstractStmtContext<?, ?, ?>, @NonNull AugmentImplicitHandlingNamespace>
