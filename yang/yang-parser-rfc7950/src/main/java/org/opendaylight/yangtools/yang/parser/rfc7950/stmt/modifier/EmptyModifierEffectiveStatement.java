...
final class EmptyModifierEffectiveStatement extends DefaultArgument<ModifierKind, ModifierStatement>
        implements ModifierEffectiveStatement {
    EmptyModifierEffectiveStatement(final ModifierStatement declared) {
        super(declared);
    }
}
