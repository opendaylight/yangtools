...
abstract class AbstractContainerStatement
    ...
    AbstractContainerStatement(final ContainerStatement declared, final SchemaPath path, final int flags,
    ...
    @Override
    public final Optional<ContainerSchemaNode> getOriginal() {
