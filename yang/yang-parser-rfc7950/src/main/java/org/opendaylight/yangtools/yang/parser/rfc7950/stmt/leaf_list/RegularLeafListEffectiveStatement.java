...
final class RegularLeafListEffectiveStatement extends AbstractLeafListEffectiveStatement {
    ...
    RegularLeafListEffectiveStatement(final LeafListStatement declared, final SchemaPath path, final int flags,
            ...
            final ImmutableList<MustDefinition> mustConstraints, final LeafListSchemaNode original,
