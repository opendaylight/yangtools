...
import static org.opendaylight.yangtools.yang.xpath.api.YangLocationPath.Kind.INITIAL;
...
final class AntlrPathExpression implements PathExpression {
    ...
    private static YangLocationPath parseRelative(final StmtContext<?, ?, ?> ctx, final String pathArg,
        ...
        return RELATIVE.createLocation(steps);
    }
    ...
    private static YangLocationPath parsePathKeyExpr(final StmtContext<?, ?, ?> ctx, final Path_key_exprContext expr) {
        ...
        return INITIAL.createLocation(steps);
    }
