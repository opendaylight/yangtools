...
final class RegularKeyEffectiveStatement extends AbstractKeyEffectiveStatement {
    private final @NonNull ImmutableList<? extends EffectiveStatement<?, ?>> substatements;

    RegularKeyEffectiveStatement(final KeyStatement declared, final Collection<SchemaNodeIdentifier> argument,
