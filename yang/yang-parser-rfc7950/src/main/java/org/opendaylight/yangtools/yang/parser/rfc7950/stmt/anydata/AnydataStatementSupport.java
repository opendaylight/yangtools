...
public final class AnydataStatementSupport
    ...
    @Override
    public boolean copyEffective(@NonNull AnydataEffectiveStatement original, Current<QName, AnydataStatement> stmt) {
        ...
        if (stmt.effectiveConfig().asNullable() != null &&
                ((EmptyAnydataEffectiveStatement) original).effectiveConfig().isEmpty()) {
            return false;
        }
