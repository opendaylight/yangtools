...
public final class YangStatementStreamSource implements StatementStreamSource {
    ...
    public void writePreLinkage(final StatementWriter writer, final QNameToStatementDefinition stmtDef) {
        new StatementContextProcessor.Loose(sourceName, writer, stmtDef).process(context);
    }
    ...
    public void writeLinkage(final StatementWriter writer, final QNameToStatementDefinition stmtDef,
        ...
        new StatementContextProcessor.Loose(sourceName, writer, stmtDef, preLinkagePrefixes, yangVersion)
            .process(context);
    }
    ...
    public void writeLinkageAndStatementDefinitions(final StatementWriter writer,
        ...
        new StatementContextProcessor.Loose(sourceName, writer, stmtDef, prefixes, yangVersion).process(context);
    }
    ...
    public void writeFull(final StatementWriter writer, final QNameToStatementDefinition stmtDef,
        ...
        new StatementContextProcessor.Strict(sourceName, writer, stmtDef, prefixes, yangVersion).process(context);
    }
