...
class Token12140 extends AbstractLazyToken {
    ...
    Token12140(final Pair<TokenSource, CharStream> source, final int type, final int line, final int charPositionInLine,
