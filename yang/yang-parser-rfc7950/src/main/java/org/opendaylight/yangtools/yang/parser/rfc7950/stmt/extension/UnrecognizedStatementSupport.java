...
final class UnrecognizedStatementSupport
    ...
    UnrecognizedStatementSupport(final StatementDefinition publicDefinition) {
        ...
        // do not propagate it past its original definition site.
        super(publicDefinition, StatementPolicy.ignore());
    }
    ...
    @Override
    public void onStatementAdded(final Mutable<String, UnrecognizedStatement, UnrecognizedEffectiveStatement> stmt) {
