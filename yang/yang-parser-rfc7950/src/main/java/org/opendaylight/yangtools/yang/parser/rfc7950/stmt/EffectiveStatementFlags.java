...
import org.opendaylight.yangtools.yang.parser.rfc7950.stmt.AbstractEffectiveStatement.WhenConditionMixin;
...
public interface EffectiveStatementFlags {
    ...
    interface DataSchemaNodeMixin<A, D extends DeclaredStatement<A>> extends DataSchemaNode, CopyableMixin,
            SchemaNodeMixin<A, D>, WhenConditionMixin<A, D> {
        @Override
