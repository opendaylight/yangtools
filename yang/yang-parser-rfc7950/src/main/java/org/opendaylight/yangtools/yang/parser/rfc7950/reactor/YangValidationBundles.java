...
public final class YangValidationBundles {
     ...
     */
    // FIXME: 4.0.0: move this to AbstractDeviateStatementSupport. This is not resolved from validation bundles at all,
    ...
    // FIXME: 4.0.0: consider hiding this list, as choice nodes are handling creation of implied shorthands themselves.
