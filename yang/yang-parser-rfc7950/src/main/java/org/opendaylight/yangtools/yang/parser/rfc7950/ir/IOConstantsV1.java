 ...
 * the first definition is {@value 0}, the second is {@value 1}, etc.
 *
 * <p>
...
final class IOConstantsV1 {
    ...
    static final int ARG_DEF_IDENTIFIER    = 0x01;
    static final int ARG_DEF_DQUOT         = 0x02;
    static final int ARG_DEF_SQUOT         = 0x03;
    static final int ARG_DEF_UQUOT         = 0x04;
    static final int ARG_DEF_CONCAT_U8     = 0x05;
    static final int ARG_DEF_CONCAT_U16    = 0x06;
    static final int ARG_DEF_CONCAT_S32    = 0x07;
    static final int ARG_DEF_MASK          = ARG_DEF_CONCAT_S32;

    static final int ARG_REF_U8            = 0x40;
    static final int ARG_REF_U16           = 0x80;
    static final int ARG_REF_S32           = 0xC0;
    static final int ARG_REF_MASK          = ARG_REF_S32;
    ...
    static final int STR_MASK              = STR_DEF_CHARS;
