...
final class RegularDefaultEffectiveStatement extends AbstractErrorMessageEffectiveStatement {
    private final @NonNull ImmutableList<? extends EffectiveStatement<?, ?>> substatements;

    RegularDefaultEffectiveStatement(final ErrorMessageStatement declared,
