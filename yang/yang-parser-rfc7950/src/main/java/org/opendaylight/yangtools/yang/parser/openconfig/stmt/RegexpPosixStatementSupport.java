...
public class RegexpPosixStatementSupport
        extends AbstractVoidStatementSupport<OpenConfigRegexpPosixStatement, OpenConfigRegexpPosixEffectiveStatement> {
    ...
    protected  OpenConfigRegexpPosixStatement createDeclared(
             final StmtContext<Void, OpenConfigRegexpPosixStatement, ?> ctx,
             final ImmutableList<? extends DeclaredStatement<?>> substatements) {
    ...
    protected  OpenConfigRegexpPosixEffectiveStatement createEffective(
             final StmtContext<Void, OpenConfigRegexpPosixStatement, OpenConfigRegexpPosixEffectiveStatement> ctx,
             final OpenConfigRegexpPosixStatement declared,
             final ImmutableList<? extends EffectiveStatement<?, ?>> substatements) {
