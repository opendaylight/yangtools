...
final class StatementSourceReferenceHandler extends DefaultHandler {
    ...
    public void startElement(final String uri, final String localName, final String qName,
        ...
        final int line = documentLocator.getLineNumber();
        final int column = documentLocator.getColumnNumber();
        final StatementSourceReference ref = file != null ? ExplicitStatement.atPosition(file, line, column)
            : ExplicitStatement.atPosition(line, column);
