...
public class Bug6771Test {
    ...
    public void augmentTest() throws Exception {
        ...
        stack.enterSchemaTree(CONT_B);
        stack.enterSchemaTree(LEAF_CONT_B);
        verifyLeafType(SchemaContextUtil.findDataSchemaNode(context, stack));
        stack.clear();
        stack.enterSchemaTree(ROOT);
        stack.enterSchemaTree(CONT_B);
        stack.enterSchemaTree(INNER_CONTAINER);
        stack.enterSchemaTree(LEAF_CONT_B);
        verifyLeafType(SchemaContextUtil.findDataSchemaNode(context, stack));
        stack.clear();
    }
    ...
    public void choiceCaseTest() throws Exception {
        ...
        final SchemaInferenceStack stack = new SchemaInferenceStack(context);
        stack.enterSchemaTree(ROOT);
        stack.enterSchemaTree(myChoice);
        stack.enterSchemaTree(caseOne);
        stack.enterSchemaTree(containerOne);
        stack.enterSchemaTree(LEAF_CONT_B);
        verifyLeafType(SchemaContextUtil.findDataSchemaNode(context, stack));
        stack.exit();
        stack.exit();
        stack.exit();
        stack.enterSchemaTree(caseTwo);
        stack.enterSchemaTree(containerTwo);
        stack.enterSchemaTree(LEAF_CONT_B);
        verifyLeafType(SchemaContextUtil.findDataSchemaNode(context, stack));
        stack.exit();
        stack.exit();
        stack.exit();
        stack.enterSchemaTree(caseThree);
        stack.enterSchemaTree(containerThree);
        stack.enterSchemaTree(INNER_CONTAINER);
        stack.enterSchemaTree(LEAF_CONT_B);
        verifyLeafType(SchemaContextUtil.findDataSchemaNode(context, stack));
        stack.clear();
