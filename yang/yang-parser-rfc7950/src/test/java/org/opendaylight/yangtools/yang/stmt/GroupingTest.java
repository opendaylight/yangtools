...
public class GroupingTest {
    ...
    public void testCascadeUses() throws Exception {
        ...
        assertEquals(gv.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-V")),
            extractOriginal(gu.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-V"))));
        containerGroupingV = (ContainerSchemaNode) gu.getDataChildByName(
            QName.create(testModule.getQNameModule(), "container-grouping-V"));
        ...
        assertEquals(gx.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-X")),
            extractOriginal(containerGroupingV.getDataChildByName(
                QName.create(testModule.getQNameModule(), "leaf-grouping-X"))));
        assertEquals(gy.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-Y")),
            extractOriginal(containerGroupingV.getDataChildByName(
                QName.create(testModule.getQNameModule(), "leaf-grouping-Y"))));

        assertEquals(gz.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-Z")),
            extractOriginal(gu.getDataChildByName(QName.create( testModule.getQNameModule(), "leaf-grouping-Z"))));
        assertEquals(gzz.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-ZZ")),
            extractOriginal(gu.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-ZZ"))));

        // TEST getOriginal from grouping-V
        assertEquals(gz.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-Z")),
            extractOriginal(gv.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-Z"))));
        assertEquals(gzz.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-ZZ")),
            extractOriginal(gv.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-ZZ"))));

        // TEST getOriginal from grouping-X
        assertEquals(gy.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-Y")),
            extractOriginal(gx.getDataChildByName(QName.create(testModule.getQNameModule(), "leaf-grouping-Y"))));
    }
