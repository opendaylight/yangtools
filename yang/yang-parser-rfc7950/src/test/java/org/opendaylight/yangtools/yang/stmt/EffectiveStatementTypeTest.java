...
public class EffectiveStatementTypeTest {
    ...
    public void testLeafrefWithDeref() {
        currentLeaf = (LeafSchemaNode) types.getDataChildByName(QName.create(types.getQNameModule(), "flavor"));
        assertNotNull(currentLeaf.getType());
        ...
        assertEquals("deref(../../../ext-cpd/int-virtual-link-desc)/../desc-flavor/id",
