...
public class YangParserTest {
    ...
    public void testTypePath() {
        ...
        final Iterator<QName> typePathIt = stack.toSchemaNodeIdentifier().getNodeIdentifiers().iterator();
    ...
    public void testTypePath2() throws ParseException {
        ...
        final Iterator<QName> dec64PathIt = stack.toSchemaNodeIdentifier().getNodeIdentifiers().iterator();
