...
public class PathExpressionParserTest {
    ...
    public void testDerefPath() {
        ...
        assertEquals(YangLocationPath.relative(
            YangXPathAxis.PARENT.asStep(),
            YangXPathAxis.CHILD.asStep(UnqualifiedQName.of("type"))), deref.getLocation());
        assertEquals(Optional.of(YangLocationPath.relative(
            YangXPathAxis.PARENT.asStep(),
            YangXPathAxis.CHILD.asStep(UnqualifiedQName.of("id")))),
            deref.getDerefArgument());
    }
