 ...
 */
@Beta
public interface InlineMountPointMetadataResolver extends MountPointMetadataResolver {
    @NonNullByDefault
    interface LibraryContext {
         ...
         */
        MountPointMetadata bindTo(ContainerNode container) throws YangParserException;
    }
