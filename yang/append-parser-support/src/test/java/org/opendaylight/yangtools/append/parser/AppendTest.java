...
import org.opendaylight.yangtools.append.model.api.AppendConstants;
import org.opendaylight.yangtools.append.parser.AppendStatementSupport;
...
public class AppendTest {
    ...
    public static void createReactor() {
        reactor = RFC7950Reactors.defaultReactorBuilder()
                .addStatementSupport(ModelProcessingPhase.FULL_DECLARATION, AppendStatementSupport.getInstance())
                .build();
    }
    ...
    public void testResolution() throws ReactorException, IOException, YangSyntaxErrorException {
        ...
        final Module module = context.findModule(AppendConstants.ORIGINAL_MODULE).get();
