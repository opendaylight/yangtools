...
public class YT1xxxTest {
    ...
    @Before
    public void before() {
        context = YangParserTestUtils.parseYangResourceDirectory("/yt1xxx");
        module = context.findModule(CONT.getModule()).get();
    ...
    public void testFindDataSchemaNodeForRelativeXPathWithDeref() {
        final SchemaNode found = SchemaContextUtil.findDataSchemaNode(context, module, path);
