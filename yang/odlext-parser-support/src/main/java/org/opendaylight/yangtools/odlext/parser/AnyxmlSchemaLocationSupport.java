...
final class AnyxmlSchemaLocationSupport
    ...
    private static final AnyxmlSchemaLocationSupport INSTANCE = new AnyxmlSchemaLocationSupport(ANYXML_SCHEMA_LOCATION);

    private final SubstatementValidator validator;

    private AnyxmlSchemaLocationSupport(final StatementDefinition definition) {
        super(definition);
