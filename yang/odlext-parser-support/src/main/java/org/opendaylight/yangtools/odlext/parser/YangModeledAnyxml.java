...
final class YangModeledAnyxml implements StatementSupport<QName, AnyxmlStatement, AnyxmlEffectiveStatement> {
    private static final YangModeledAnyxml INSTANCE = new YangModeledAnyxml();

    private final StatementSupport<QName, AnyxmlStatement, AnyxmlEffectiveStatement> delegate =
            new AnyxmlStatementSupport();

    private YangModeledAnyxml() {

    }

    static YangModeledAnyxml getInstance() {
        return INSTANCE;
    }
