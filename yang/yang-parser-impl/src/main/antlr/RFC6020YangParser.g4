...
module_stmt : MODULE_KEYWORD SEP string SEP?         // string validated in YangModelBasicValidationListener.enterModule_stmt()
           LEFT_BRACE stmtsep
               module_header_stmts
               linkage_stmts
               meta_stmts
...
submodule_stmt : SUBMODULE_KEYWORD SEP string SEP?   // string validated in YangModelBasicValidationListener.enterSubmodule_stmt()
              LEFT_BRACE stmtsep
...
base_stmt : BASE_KEYWORD SEP string SEP? stmtend;                   // string validated in YangModelBasicValidationListener.enterBase_stmt()
...
if_feature_stmt : IF_FEATURE_KEYWORD SEP string SEP? stmtend;       // string validated in YangModelBasicValidationListener.enterIf_feature_stmt()
...
type_stmt : TYPE_KEYWORD SEP string SEP?                            // string validated in YangModelBasicValidationListener.enterType_stmt()
         (SEMICOLON |
          LEFT_BRACE stmtsep
              type_body_stmts
          RIGHT_BRACE
...
decimal64_specification : fraction_digits_stmt stmtsep;
...
must_stmt : MUST_KEYWORD SEP string SEP?
         (SEMICOLON |
          LEFT_BRACE stmtsep
             (    error_message_stmt stmtsep
                | error_app_tag_stmt stmtsep
...
grouping_stmt : GROUPING_KEYWORD SEP string SEP?
             (SEMICOLON |
              LEFT_BRACE stmtsep
                  (   status_stmt stmtsep
                    | description_stmt stmtsep
...
container_stmt : CONTAINER_KEYWORD SEP string SEP?
              (SEMICOLON |
               LEFT_BRACE  stmtsep
                    (
                        when_stmt stmtsep
...
leaf_stmt : LEAF_KEYWORD SEP string SEP?
                 LEFT_BRACE stmtsep
                 (   when_stmt stmtsep
                   | if_feature_stmt stmtsep
                   | type_stmt stmtsep
...
leaf_list_stmt : LEAF_LIST_KEYWORD SEP string SEP?
                         LEFT_BRACE stmtsep
                         (    when_stmt stmtsep
                            | if_feature_stmt stmtsep
                            | type_stmt stmtsep
...
list_stmt : LIST_KEYWORD SEP string SEP?
                 LEFT_BRACE stmtsep
                 (   when_stmt stmtsep
                   | if_feature_stmt stmtsep
                   | must_stmt stmtsep
...
choice_stmt : CHOICE_KEYWORD SEP string SEP?
             (SEMICOLON |
                LEFT_BRACE stmtsep
                (    when_stmt stmtsep
                   | if_feature_stmt stmtsep
...
case_stmt : CASE_KEYWORD SEP string SEP?
                (SEMICOLON |
                    LEFT_BRACE stmtsep
                    (    when_stmt stmtsep
                       | if_feature_stmt stmtsep
...
anyxml_stmt : ANYXML_KEYWORD SEP string SEP?
                   (SEMICOLON |
                       LEFT_BRACE stmtsep
                           (   when_stmt stmtsep
                             | if_feature_stmt stmtsep
...
uses_stmt : USES_KEYWORD SEP string SEP?
                   (SEMICOLON |
                        LEFT_BRACE stmtsep
                          (   when_stmt stmtsep
                            | if_feature_stmt stmtsep
...
refine_stmt : REFINE_KEYWORD SEP string SEP?
                (SEMICOLON |
                    LEFT_BRACE stmtsep
...
uses_augment_stmt : AUGMENT_KEYWORD SEP string SEP?
                        LEFT_BRACE stmtsep
                            (
                                when_stmt stmtsep
                              | if_feature_stmt stmtsep
...
augment_stmt : AUGMENT_KEYWORD SEP string SEP?
                LEFT_BRACE stmtsep
                    (
                         when_stmt stmtsep
                       | if_feature_stmt stmtsep
...
unknown_statement : prefix COLON identifier (SEP string)? SEP?
                 (SEMICOLON | LEFT_BRACE (SEP? unknown_statement2 SEP?)* RIGHT_BRACE);

unknown_statement2 : (prefix COLON)? identifier (SEP string)? SEP?
                  (SEMICOLON | LEFT_BRACE (SEP? unknown_statement2 SEP?)* RIGHT_BRACE);

when_stmt : WHEN_KEYWORD SEP string SEP?
                     (SEMICOLON |
                        LEFT_BRACE stmtsep
                        (   description_stmt stmtsep
                          | reference_stmt stmtsep
...
rpc_stmt : RPC_KEYWORD SEP string SEP?
                    (SEMICOLON |
                           LEFT_BRACE stmtsep
                           (   if_feature_stmt stmtsep
                             | status_stmt stmtsep
...
notification_stmt : NOTIFICATION_KEYWORD SEP string SEP?
                           (SEMICOLON |
                                LEFT_BRACE stmtsep
                                    (   if_feature_stmt stmtsep
                                       | status_stmt stmtsep
...
deviation_stmt : DEVIATION_KEYWORD SEP string SEP?
                         LEFT_BRACE stmtsep
                             (   description_stmt stmtsep
                               | reference_stmt stmtsep
 ...
 */
range_arg : range_part (SEP? BAR range_part)* ;

range_part : range_boundary (SEP? DOTS range_boundary)?;
 ...
 */
length_arg : length_part (SEP? BAR length_part)* ;

length_part : length_boundary (SEP? DOTS SEP? length_boundary)?;
