...
decimal64_specification : (fraction_digits_stmt stmtsep | range_stmt stmtsep)*; //errata ID 3290 applied here 
...
identifier_ref: (prefix COLON)? identifier;

string : STRING (SEP? PLUS SEP? STRING)* | IDENTIFIER (SLASH IDENTIFIER)* ;