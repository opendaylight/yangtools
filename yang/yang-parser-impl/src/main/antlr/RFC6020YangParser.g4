...
module_stmt : MODULE_KEYWORD SEP string         // string validated in YangModelBasicValidationListener.enterModule_stmt()
           LEFT_BRACE stmtsep
               module_header_stmts
               linkage_stmts
               meta_stmts
...
submodule_stmt : SUBMODULE_KEYWORD SEP string   // string validated in YangModelBasicValidationListener.enterSubmodule_stmt()
              LEFT_BRACE stmtsep
...
yang_version_stmt : YANG_VERSION_KEYWORD SEP string stmtend;   // string validated in YangModelBasicValidationListener.enterModule_header_stmts() and/or YangModelBasicValidationListener.enterSubmodule_header_stmts()

import_stmt : IMPORT_KEYWORD SEP string                        // string validated in YangModelBasicValidationListener.enterImport_stmt()
           LEFT_BRACE stmtsep
               prefix_stmt stmtsep
               (revision_date_stmt stmtsep)?
           RIGHT_BRACE;

include_stmt : INCLUDE_KEYWORD SEP string                      // string validated in YangModelBasicValidationListener.enterInclude_stmt()
            (SEMICOLON |
             LEFT_BRACE stmtsep
                 (revision_date_stmt stmtsep)?
             RIGHT_BRACE);

namespace_stmt : NAMESPACE_KEYWORD SEP string stmtend;         // string validated in YangModelBasicValidationListener.enterNamespace_stmt()

prefix_stmt : PREFIX_KEYWORD SEP string stmtend;               // string validated in YangModelBasicValidationListener.enterPrefix_stmt()

belongs_to_stmt : BELONGS_TO_KEYWORD SEP string                // string validated in YangModelBasicValidationListener.enterBelongs_to_stmt()
               LEFT_BRACE stmtsep
                   prefix_stmt stmtsep
               RIGHT_BRACE;

organization_stmt : ORGANIZATION_KEYWORD SEP string stmtend;   // string not validated

contact_stmt : CONTACT_KEYWORD SEP string stmtend;             // string not validated

description_stmt : DESCRIPTION_KEYWORD SEP string stmtend;     // string not validated

reference_stmt : REFERENCE_KEYWORD SEP string stmtend;         // string not validated

units_stmt : UNITS_KEYWORD SEP string stmtend;                 // string not validated

revision_stmt : REVISION_KEYWORD SEP string                    // string validated in YangModelBasicValidationListener.enterRevision_stmt()
             (SEMICOLON |
              LEFT_BRACE stmtsep
                  (description_stmt stmtsep)?
                  (reference_stmt stmtsep)?
...
extension_stmt : EXTENSION_KEYWORD SEP string                  // string validated in YangModelBasicValidationListener.enterExtension_stmt()
              (SEMICOLON |
                 LEFT_BRACE stmtsep
...
argument_stmt : ARGUMENT_KEYWORD SEP string                    // string validated in YangModelBasicValidationListener.enterArgument_stmt()
             (SEMICOLON |
              LEFT_BRACE stmtsep
...
identity_stmt : IDENTITY_KEYWORD SEP string                    // string validated in YangModelBasicValidationListener.enterIdentity_stmt()
             (SEMICOLON |
              LEFT_BRACE stmtsep
                  (   base_stmt stmtsep
                    | status_stmt stmtsep
...
base_stmt : BASE_KEYWORD SEP string stmtend;                   // string validated in YangModelBasicValidationListener.enterBase_stmt()

feature_stmt : FEATURE_KEYWORD SEP string                      // string validated in YangModelBasicValidationListener.enterFeature_stmt()
             (SEMICOLON |
              LEFT_BRACE stmtsep
...
if_feature_stmt : IF_FEATURE_KEYWORD SEP string stmtend;       // string validated in YangModelBasicValidationListener.enterIf_feature_stmt()

typedef_stmt : TYPEDEF_KEYWORD SEP string                      // string validated in YangModelBasicValidationListener.enterTypedef_stmt()
            LEFT_BRACE stmtsep
               (   type_stmt stmtsep
                 | units_stmt stmtsep
...
type_stmt : TYPE_KEYWORD SEP string                            // string validated in YangModelBasicValidationListener.enterType_stmt()
         (SEMICOLON |
          LEFT_BRACE stmtsep
              type_body_stmts
          RIGHT_BRACE
...
range_stmt : RANGE_KEYWORD SEP string                               // see @Entrypoint Entry point for parsing range-arg-str (string validated in ParserListenerUtils.parseRangeConstraints())
          (SEMICOLON |
           LEFT_BRACE stmtsep
...
length_stmt : LENGTH_KEYWORD SEP string                             // see @Entrypoint Entry point for parsing length-arg-str (string validated in ParserListenerUtils.parseLengthConstraints())
           (SEMICOLON |
            LEFT_BRACE stmtsep
               (   error_message_stmt stmtsep
                 | error_app_tag_stmt stmtsep
...
pattern_stmt : PATTERN_KEYWORD SEP string                           // string validated in ParserListenerUtils.parsePatternConstraint()
            (SEMICOLON |
             LEFT_BRACE stmtsep
                 (   error_message_stmt stmtsep
                   | error_app_tag_stmt stmtsep
...
enum_stmt : ENUM_KEYWORD SEP string                                 // string validated in ParserListenerUtils.createEnumPair()
         (SEMICOLON |
          LEFT_BRACE stmtsep
             (   value_stmt stmtsep
               | status_stmt stmtsep
...
path_stmt : PATH_KEYWORD SEP string stmtend;                        // @Entrypoint Entry point for parsing path-arg-str (string validated in ParserListenerUtils.parseLeafrefPath())
...
bit_stmt : BIT_KEYWORD SEP string                                   // string validated in ParserListenerUtils.parseBit()
        (SEMICOLON |
         LEFT_BRACE  stmtsep
...
leaf_stmt : LEAF_KEYWORD SEP string
                 LEFT_BRACE stmtsep
                 (   when_stmt stmtsep
                   | if_feature_stmt stmtsep
                   | type_stmt stmtsep
...
leaf_list_stmt : LEAF_LIST_KEYWORD SEP string
                         LEFT_BRACE stmtsep
                         (    when_stmt stmtsep
                            | if_feature_stmt stmtsep
                            | type_stmt stmtsep
...
list_stmt : LIST_KEYWORD SEP string
                 LEFT_BRACE stmtsep
                 (   when_stmt stmtsep
                   | if_feature_stmt stmtsep
                   | must_stmt stmtsep
...
key_stmt : KEY_KEYWORD SEP string stmtend;
...
unique_stmt : UNIQUE_KEYWORD SEP string stmtend;
...
choice_stmt : CHOICE_KEYWORD SEP string
             (SEMICOLON |
                LEFT_BRACE stmtsep
                (    when_stmt stmtsep
                   | if_feature_stmt stmtsep
...
case_stmt : CASE_KEYWORD SEP string
                (SEMICOLON |
                    LEFT_BRACE stmtsep
                    (    when_stmt stmtsep
                       | if_feature_stmt stmtsep
...
anyxml_stmt : ANYXML_KEYWORD SEP string
                   (SEMICOLON |
                       LEFT_BRACE stmtsep
                           (   when_stmt stmtsep
                             | if_feature_stmt stmtsep
...
uses_stmt : USES_KEYWORD SEP string
                   (SEMICOLON |
                        LEFT_BRACE stmtsep
                          (   when_stmt stmtsep
                            | if_feature_stmt stmtsep
...
refine_stmt : REFINE_KEYWORD SEP string
                (SEMICOLON |
                    LEFT_BRACE stmtsep
...
uses_augment_stmt : AUGMENT_KEYWORD SEP string
                        LEFT_BRACE stmtsep
                            (
                                when_stmt stmtsep
                              | if_feature_stmt stmtsep
...
augment_stmt : AUGMENT_KEYWORD SEP string
                LEFT_BRACE stmtsep
                    (
                         when_stmt stmtsep
                       | if_feature_stmt stmtsep
...
when_stmt : WHEN_KEYWORD SEP string
                     (SEMICOLON |
                        LEFT_BRACE stmtsep
                        (   description_stmt stmtsep
                          | reference_stmt stmtsep
...
rpc_stmt : RPC_KEYWORD SEP string
                    (SEMICOLON |
                           LEFT_BRACE stmtsep
                           (   if_feature_stmt stmtsep
                             | status_stmt stmtsep
...
notification_stmt : NOTIFICATION_KEYWORD SEP string
                           (SEMICOLON |
                                LEFT_BRACE stmtsep
                                    (   if_feature_stmt stmtsep
                                       | status_stmt stmtsep
...
deviation_stmt : DEVIATION_KEYWORD SEP string
                         LEFT_BRACE stmtsep
                             (   description_stmt stmtsep
                               | reference_stmt stmtsep
...
deviate_not_supported_stmt : DEVIATE_KEYWORD SEP string // string validated as NOT_SUPPORTED_KEYWORD = 'not-supported' in DeviationBuilder.setDeviate()
                               (SEMICOLON |
                                    LEFT_BRACE stmtsep
                                    RIGHT_BRACE
                               );

deviate_add_stmt : DEVIATE_KEYWORD SEP string // string validated as ADD_KEYWORD = 'add' in DeviationBuilder.setDeviate()
                              (SEMICOLON |
                                 LEFT_BRACE stmtsep
                                     (   units_stmt stmtsep
                                       | must_stmt stmtsep
...
deviate_delete_stmt : DEVIATE_KEYWORD SEP string // string validated as DELETE_KEYWORD = 'delete' in DeviationBuilder.setDeviate()
                              (SEMICOLON |
                                 LEFT_BRACE stmtsep
                                      (    units_stmt stmtsep
                                         | must_stmt stmtsep
...
deviate_replace_stmt : DEVIATE_KEYWORD SEP string // string validated as REPLACE_KEYWORD = 'replace' in DeviationBuilder.setDeviate()
                             (SEMICOLON |
                                LEFT_BRACE stmtsep
                                    (    type_stmt
                                       | units_stmt
 ...
 */
range_arg : range_part (BAR range_part)* ;

range_part : range_boundary (DOTS  range_boundary)?;

range_boundary : MIN_KEYWORD | MAX_KEYWORD | integer_value | DECIMAL_VALUE;

integer_value : non_negative_integer_value | NEGATIVE_INTEGER_VALUE;
 ...
 */
length_arg : length_part (BAR length_part)* ;

length_part : length_boundary (DOTS  length_boundary)?;
...
non_negative_integer_value : ZERO | POSITIVE_INTEGER_VALUE;
...
string : STRING (PLUS STRING)* | IDENTIFIER;