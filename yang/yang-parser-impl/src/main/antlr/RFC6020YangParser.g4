...
*
*
* @EntryPoint Entry point for parsing key_arg
*/
...
*
*
* @EntryPoint Entry point for parsing unique_arg
*/
...
deviate_not_supported_stmt : DEVIATE_KEYWORD SEP string /*NOT_SUPPORTED_KEYWORD*/
                               (SEMICOLON |
                                    LEFT_BRACE stmtsep
                                    RIGHT_BRACE
                               );

deviate_add_stmt : DEVIATE_KEYWORD SEP string /*ADD_KEYWORD*/
                              (SEMICOLON |
                                 LEFT_BRACE stmtsep
                                     (   units_stmt stmtsep
                                       | must_stmt stmtsep
...
deviate_delete_stmt : DEVIATE_KEYWORD SEP string /* DELETE_KEYWORD */
                              (SEMICOLON |
                                 LEFT_BRACE stmtsep
                                      (    units_stmt stmtsep
                                         | must_stmt stmtsep
...
deviate_replace_stmt : DEVIATE_KEYWORD SEP string /* REPLACE_KEYWORD */
                             (SEMICOLON |
                                LEFT_BRACE stmtsep
                                    (    type_stmt
                                       | units_stmt
...
/**
 * @Entrypoint for date-arg-str
 */
date_arg : DATE_ARG;

/**
 * @Entrypoint for path-arg-str
 */
