...
unknown_statement : (YIN_ELEMENT_KEYWORD | YANG_VERSION_KEYWORD | WHEN_KEYWORD | VALUE_KEYWORD | USES_KEYWORD | UNITS_KEYWORD | UNIQUE_KEYWORD | 
                    ...
                    REQUIRE_INSTANCE_KEYWORD | REFINE_KEYWORD | DESCRIPTION_KEYWORD | REFERENCE_KEYWORD | RANGE_KEYWORD | PRESENCE_KEYWORD | PREFIX_KEYWORD | 
                    ...
                    ANYXML_KEYWORD | IDENTIFIER) string? (SEMICOLON | (LEFT_BRACE unknown_statement* RIGHT_BRACE));

stmtend : (SEMICOLON) | (LEFT_BRACE (identifier_stmt | unknown_statement)* RIGHT_BRACE);
