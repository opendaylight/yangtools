...
OUTPUT_KEYWORD : 'output';// -> pushMode(VALUE_MODE);
...
INPUT_KEYWORD : 'input'; //-> pushMode(VALUE_MODE);
...
CURRENT_KEYWORD : 'current'; //-> pushMode(VALUE_MODE);
MIN_KEYWORD : 'min' ;//-> pushMode(VALUE_MODE);
MAX_KEYWORD : 'max' ;//-> pushMode(VALUE_MODE);
UNBOUNDED_KEYWORD : 'unbounded'; //-> pushMode(VALUE_MODE);
...
DATE_ARG : [0-9] [0-9] [0-9] [0-9] '-' [0-9] [0-9] '-' [0-9] [0-9];// ->type(DATE_ARG);

ZERO : '0'; //-> type(ZERO);
NEGATIVE_INTEGER_VALUE : '-' (POSITIVE_INTEGER_VALUE | ZERO);// ->type(NEGATIVE_INTEGER_VALUE);
POSITIVE_INTEGER_VALUE : [1-9][0-9]*;// ->type(POSITIVE_INTEGER_VALUE);
DECIMAL_VALUE : (POSITIVE_INTEGER_VALUE | ZERO | NEGATIVE_INTEGER_VALUE) '.' [0-9]+; //->type(DECIMAL_VALUE);
...
//DATE_ARG2 : [0-9] [0-9] [0-9] [0-9] '-' [0-9] [0-9] '-' [0-9] [0-9] ->type(DATE_ARG);
//ZERO2 : '0'->type(ZERO);
//NEGATIVE_INTEGER_VALUE2 : '-' (POSITIVE_INTEGER_VALUE | ZERO)->type(NEGATIVE_INTEGER_VALUE);
//POSITIVE_INTEGER_VALUE2 : [1-9][0-9]*->type(POSITIVE_INTEGER_VALUE);
//DECIMAL_VALUE2 : (POSITIVE_INTEGER_VALUE | ZERO | NEGATIVE_INTEGER_VALUE) '.' [0-9]+ ->type(DECIMAL_VALUE);
//MIN_KEYWORD2 : 'min'-> type(MIN_KEYWORD);
//MAX_KEYWORD2 : 'max'-> type(MAX_KEYWORD);
//UNBOUNDED_KEYWORD2 : 'unbounded' -> type(UNBOUNDED_KEYWORD);
