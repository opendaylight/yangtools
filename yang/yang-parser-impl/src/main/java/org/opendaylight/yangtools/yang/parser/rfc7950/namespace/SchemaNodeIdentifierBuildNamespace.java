...
public final class SchemaNodeIdentifierBuildNamespace
    ...
    public Mutable<?, ?, EffectiveStatement<?, ?>> getFrom(final NamespaceStorageNode storage,
        ...
        Mutable<?, ?, EffectiveStatement<?, ?>> current = lookupStartStorage.getFromLocalStorage(ChildSchemaNodeNamespace.class,
            nextPath);
        ...
        while (current != null && iterator.hasNext()) {
            ...
            final Mutable<?, ?, EffectiveStatement<?, ?>> nextNodeCtx = current.getFromNamespace(ChildSchemaNodeNamespace.class,
                nextPath);
            if (nextNodeCtx == null) {
