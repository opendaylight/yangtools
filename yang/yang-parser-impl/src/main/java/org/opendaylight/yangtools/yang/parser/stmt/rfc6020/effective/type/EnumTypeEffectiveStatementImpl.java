...
public final class EnumTypeEffectiveStatementImpl extends DeclaredEffectiveStatementBase<String, TypeStatement>
    ...
    public EnumTypeEffectiveStatementImpl(
        ...
        SourceException.throwIf(ctx.getRootVersion() != YangVersion.VERSION_1_1, ctx.getStatementSourceReference(),
        ...
        for (final EffectiveStatement<?, ?> stmt : effectiveSubstatements()) {
            if (stmt instanceof EnumEffectiveStatementImpl) {
                ...
                if (enumSubStmt.getDeclaredValue() == null) {
                    effectiveValue = getBaseTypeEnumValue(enumSubStmt.getName(), baseType);
                } else {
    ...
    private int getBaseTypeEnumValue(final String enumName, final EnumTypeDefinition baseType) {
        ...
        throw new InvalidEnumDefinitionException("Enum '%s' is not a subset of its base enumeration type %s.", enumName,
                baseType.getQName());
    }
