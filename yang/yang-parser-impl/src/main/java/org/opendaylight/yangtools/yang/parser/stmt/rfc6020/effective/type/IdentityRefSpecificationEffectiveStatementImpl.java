...
public class IdentityRefSpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<IdentityrefTypeDefinition, D> implements IdentityrefTypeDefinition {
    ...
    public IdentityRefSpecificationEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
