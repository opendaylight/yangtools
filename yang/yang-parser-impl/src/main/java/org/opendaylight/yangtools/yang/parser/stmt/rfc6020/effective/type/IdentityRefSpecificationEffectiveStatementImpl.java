...
public class IdentityRefSpecificationEffectiveStatementImpl extends
        EffectiveStatementBase<String,TypeStatement.IdentityRefSpecification> implements IdentityrefTypeDefinition, TypeDefinitionEffectiveBuilder {
    ...
    public IdentityRefSpecificationEffectiveStatementImpl(StmtContext<String, TypeStatement.IdentityRefSpecification, EffectiveStatement<String, TypeStatement.IdentityRefSpecification>> ctx) {
        super(ctx);

        path = Utils.getSchemaPath(ctx);

        final IdentityEffectiveStatementImpl identityEffectiveStatement = firstEffective(IdentityEffectiveStatementImpl.class);
        if (identityEffectiveStatement != null) {
            identity = identityEffectiveStatement.getBaseIdentity();
        } else {
            identity = null;
        }
    }
