...
package org.opendaylight.yangtools.yang.parser.stmt.rfc6020.effective.type.derived;
...
public class DerivedDecimal64SpecificationEffectiveStatementImpl extends
        EffectiveStatementBase<String, TypeStatement.Decimal64Specification> implements DecimalTypeDefinition {
    ...
    public DerivedDecimal64SpecificationEffectiveStatementImpl(StmtContext<String, TypeStatement.Decimal64Specification, ?> ctx) {
        super(ctx);
    ...
    private List<RangeConstraint> defaultRangeStatements() {
        ...
        final String rangeDescription = "Decimal values between " + MIN_VALUE + " and " + MAX_VALUE + ", inclusively.";
    ...
    public boolean equals(final Object obj) {
        ...
        DerivedDecimal64SpecificationEffectiveStatementImpl other = (DerivedDecimal64SpecificationEffectiveStatementImpl) obj;
        if (path == null) {
            if (other.path != null) {
                return false;
            }
    ...
    public String toString() {
        return DerivedDecimal64SpecificationEffectiveStatementImpl.class.getSimpleName() + "[qName=" + QNAME
