...
public class BitsBaseType implements YangBaseType {

    private static final BitsBaseType INSTANCE = new BitsBaseType();
    ...
    private static final List<Bit> DEFAULT_VALUE = Collections.emptyList();
