...
public abstract class LeafRefPath implements Immutable{
    ...
    private static final class AbsoluteLeafRefPath extends LeafRefPath {
        ...
        @Override
        protected LeafRefPath createInstance(final LeafRefPath parent, final QNameWithPredicate qname) {
     ...
     *
     * @return list of <code>QNameWithPredicate</code> instances which represents complete
     *         path to schema node
     *
     ...
     *
     * @param path
     *            list of QNameWithPredicate instances which specifies exact path to the
     *            module node
     * @param absolute
     ...
     *            relative
     * @param path
     *            one or more QNameWithPredicate instances which specifies exact path to the
     *            module node
     *
     * @return A LeafRefPath instance.
     */
     ...
     *
     * @param parent Parent LeafRefPath
