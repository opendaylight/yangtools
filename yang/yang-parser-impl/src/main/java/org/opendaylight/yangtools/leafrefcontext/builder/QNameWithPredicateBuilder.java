...
public class QNameWithPredicateBuilder {
    ...
    public static QNameWithPredicateBuilder UP_PARENT_BUILDER = new QNameWithPredicateBuilder(null,"..") {
    ...
    public QNameWithPredicate build() {
        QNameWithPredicateImpl qNameWithPredicateImpl = new QNameWithPredicateImpl(moduleQname,localName,qnamePredicates);
