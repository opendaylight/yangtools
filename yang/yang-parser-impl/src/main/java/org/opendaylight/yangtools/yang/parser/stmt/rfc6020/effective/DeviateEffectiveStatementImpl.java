...
public final class DeviateEffectiveStatementImpl
        extends DeclaredEffectiveStatementBase<Deviate, DeviateStatement> implements DeviateDefinition {

    private final Deviate deviateType;
    ...
    public DeviateEffectiveStatementImpl(final StmtContext<Deviate, DeviateStatement, ?> ctx) {
        super(ctx);
