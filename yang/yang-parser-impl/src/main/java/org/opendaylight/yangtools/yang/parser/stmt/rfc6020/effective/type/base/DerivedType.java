...
//        this.defaultValue = initDefaultValue();
    ...
    public YangBaseType initBaseType(final StmtContext<QName, TypedefStatement, ?> ctx) {
        ...
        if (TypeUtils.isYangBaseTypeString(typeQName.getLocalName())) {
            ...
            return ctx.getFromNamespace(QNameToDerivedType.class, typeStmt.getQName());
        }
    }
