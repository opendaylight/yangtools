...
public class EnumSpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<EnumTypeDefinition, D> implements EnumTypeDefinition {
    ...
    public EnumSpecificationEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
