...
import org.opendaylight.yangtools.yang.parser.stmt.rfc7950.AugmentStatementRfc7950Impl;
import org.opendaylight.yangtools.yang.parser.stmt.rfc7950.ContainerStatementRfc7950Impl;
import org.opendaylight.yangtools.yang.parser.stmt.rfc7950.GroupingStatementRfc7950Impl;
import org.opendaylight.yangtools.yang.parser.stmt.rfc7950.ListStatementRfc7950Impl;
...
public final class YangInferencePipeline {
    ...
    public static final StatementSupportBundle STMT_DEF_BUNDLE = StatementSupportBundle
            ...
            .addVersionSpecificSupport(YANG1_1, new ContainerStatementRfc7950Impl.Definition())
            .addVersionSpecificSupport(YANG1, new GroupingStatementImpl.Definition())
            .addVersionSpecificSupport(YANG1_1, new GroupingStatementRfc7950Impl.Definition())
            .addVersionSpecificSupport(YANG1, new ListStatementImpl.Definition())
            .addVersionSpecificSupport(YANG1_1, new ListStatementRfc7950Impl.Definition())
    ...
    public static final StatementSupportBundle FULL_DECL_BUNDLE = StatementSupportBundle
            ...
            .addVersionSpecificSupport(YANG1_1, new AugmentStatementRfc7950Impl.Definition())
