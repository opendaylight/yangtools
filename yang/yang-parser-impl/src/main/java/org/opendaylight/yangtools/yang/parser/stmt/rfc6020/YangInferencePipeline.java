...
import org.opendaylight.yangtools.yang.parser.stmt.rfc7950.ImportStatementRfc7950Definition;
...
public final class YangInferencePipeline {
    ...
    public static final StatementSupportBundle PRE_LINKAGE_BUNDLE = StatementSupportBundle
            ...
            .addVersionSpecificSupport(YANG1, new ImportStatementDefinition())
            .addVersionSpecificSupport(YANG1_1, new ImportStatementRfc7950Definition())
            .addVersionSpecificSupport(YANG1, new IncludeStatementImpl.Definition())
            .addVersionSpecificSupport(YANG1_1, new IncludeStatementRfc7950Support())
