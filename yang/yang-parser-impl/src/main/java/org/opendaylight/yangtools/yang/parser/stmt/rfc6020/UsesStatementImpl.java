...
public class UsesStatementImpl extends AbstractDeclaredStatement<QName> implements UsesStatement {
    ...
    private static void copyFromSourceToTarget(final Mutable<?, ?, ?> sourceGrpStmtCtx,
            ...
            final StmtContext.Mutable<QName, UsesStatement, EffectiveStatement<QName, UsesStatement>> usesNode) {
        final Collection<? extends Mutable<?, ?, ?>> declared = sourceGrpStmtCtx.declaredSubstatements();
        final Collection<? extends Mutable<?, ?, ?>> effective = sourceGrpStmtCtx.effectiveSubstatements();
    ...
    public static void resolveUsesNode(
        ...
        for (final Mutable<?, ?, ?> subStmtCtx : usesNode.declaredSubstatements()) {
    ...
    private static void addOrReplaceNodes(final Mutable<?, ?, ?> subStmtCtx,
        ...
        for (final Mutable<?, ?, ?> refineSubstatementCtx : subStmtCtx.declaredSubstatements()) {
