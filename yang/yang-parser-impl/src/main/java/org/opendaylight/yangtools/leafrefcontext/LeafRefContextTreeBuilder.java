    ...
    private LeafRefContext buildLeafRefContextTreeFor(LeafRefContext parent,
        ...
        if (node instanceof DataNodeContainer) {
            ...
            if (type instanceof Leafref) {
                ...
                currentLeafRefContext.setLeafRefPathString(leafRefPathString);
                ...
                SchemaPath leafRefPath = leafRefPathParser.parseLeafRefPathSourceToSchemaPath(leafRefPathInputStream);
                currentLeafRefContext.setLeafRefPath(leafRefPath);
