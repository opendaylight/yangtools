...
public final class YangValidationBundles {
    ...
    // :TODO init SUPPORTED_REFINE_TARGETS collection and add other validation bundles
    public static final HashSet<StatementDefinition> SUPPORTED_REFINE_TARGETS = new HashSet<StatementDefinition>();
