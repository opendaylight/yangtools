    ...
    public BitsTypeEffectiveStatementImpl(
        ...
        for (final EffectiveStatement<?, ?> stmt : effectiveSubstatements()) {
            if (stmt instanceof BitEffectiveStatementImpl) {
                SourceException.throwIf(!YangVersion.VERSION_1_1.equals(yangVersion),
                        ctx.getStatementSourceReference(), "Restricted bits type is allowed only in YANG 1.1 version.");
