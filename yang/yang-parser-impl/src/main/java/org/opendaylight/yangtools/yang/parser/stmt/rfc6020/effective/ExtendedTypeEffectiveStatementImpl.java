...
public class ExtendedTypeEffectiveStatementImpl extends EffectiveStatementBase<String, TypeStatement> implements
    ...
    public ExtendedTypeEffectiveStatementImpl(
        ...
        typeConstraints = initTypeConstraints(ctx);

//        defaultValue = (String) baseType.getDefaultValue();
//        units = baseType.getUnits();
//        description = baseType.getDescription();
//        reference = baseType.getReference();
//        status = baseType.getStatus();
    ...
    private QName initQName(final StmtContext<String, TypeStatement, EffectiveStatement<String, TypeStatement>> ctx, final boolean isExtended) {
    ...
    private TypeConstraints initTypeConstraints(final StmtContext<String, TypeStatement, EffectiveStatement<String, TypeStatement>> ctx) {
    ...
    public ExtendedType buildType() {
        ...
        extendedTypeBuilder.status(status);
