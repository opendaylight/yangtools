...
public interface StatementSupport<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>> extends
    ...
    /**
     * Invoked before a statement supported by this instance is created and
     * added to build context. This allows implementations of this interface
     * perform any modifications to the build context hierarchy before a
     * substatement is created. One such use is creating implicit statements
     ...
     * @param argument substatement argument
     * @return optional of a new implicit substatement
     */
