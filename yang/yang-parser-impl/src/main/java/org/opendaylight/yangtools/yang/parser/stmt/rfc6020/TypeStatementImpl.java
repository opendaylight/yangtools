    ...
    public static class Definition
        ...
        public TypeEffectiveStatement<TypeStatement> createEffective(
            ...
            default:
                ...
                SourceException.checkNotNull(typedef, ctx.getStatementSourceReference(), "Type '%s' not found", qname);
        ...
        public void onFullDefinitionDeclared(
            ...
            typeAction.apply(new InferenceAction() {
                ...
                public void prerequisiteFailed(final Collection<? extends Prerequisite<?>> failed) {
                    InferenceException.check(!failed.contains(typePrereq), stmt.getStatementSourceReference(),
