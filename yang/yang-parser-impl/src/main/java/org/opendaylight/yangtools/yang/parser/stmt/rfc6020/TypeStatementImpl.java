    ...
    public static class Definition
        ...
        public EffectiveStatement<String, TypeStatement> createEffective(
            ...
            if (baseType instanceof BinaryTypeDefinition) {
                ...
                return new BitsTypeEffectiveStatement(ctx, baseType);
            } else if (baseType instanceof BooleanTypeDefinition) {
                return new BooleanTypeEffectiveStatement(ctx, baseType);
            } else if (baseType instanceof DecimalTypeDefinition) {
                return new DecimalTypeEffectiveStatement(ctx, baseType);
            } else if (baseType instanceof EmptyTypeDefinition) {
                return new EmptyTypeEffectiveStatement(ctx, baseType);
                ...
                return new StringEffectiveStatement(ctx, baseType);
