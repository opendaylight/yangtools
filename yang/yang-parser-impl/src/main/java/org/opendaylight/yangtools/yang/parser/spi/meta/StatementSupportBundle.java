...
public final class StatementSupportBundle implements Immutable,NamespaceBehaviour.Registry {
    ...
    private final static StatementSupportBundle EMPTY = new StatementSupportBundle(null, ImmutableMap.<QName, StatementSupport<?, ?, ?>>of(), ImmutableMap.<Class<?>, NamespaceBehaviour<?, ?, ?>>of());
