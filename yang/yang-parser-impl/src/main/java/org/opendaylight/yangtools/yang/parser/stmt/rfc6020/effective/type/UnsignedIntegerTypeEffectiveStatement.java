...
public final class UnsignedIntegerTypeEffectiveStatement extends
    ...
    public UnsignedIntegerTypeEffectiveStatement(
        ...
        final RangeRestrictedTypeBuilder<UnsignedIntegerTypeDefinition> builder =
                RestrictedTypes.newUnsignedBuilder(baseType, ctx.getSchemaPath().get());
