...
public class QNamePredicateImpl implements Immutable, Serializable, QNamePredicate{
    ...
    public QNamePredicateImpl(QName identifier, LeafRefPath pathKeyExpression) {
        Preconditions.checkNotNull(identifier,"QNamePredicate: identifier should not be null");
        Preconditions.checkNotNull(pathKeyExpression,"QNamePredicate: pathKeyExpression should not be null");
