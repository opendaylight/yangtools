...
public final class LeafRefPathParserImpl {
    ...
    public SchemaPath parseLeafRefPathSourceToSchemaPath(InputStream stream) throws IOException, YangSyntaxErrorException {
        ...
        SchemaPath leafRefPath = leafRefPathParserListenerImpl.getLeafRefPath();
