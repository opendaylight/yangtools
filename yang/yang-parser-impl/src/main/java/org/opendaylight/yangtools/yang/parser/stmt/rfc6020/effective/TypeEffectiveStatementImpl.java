...
public class TypeEffectiveStatementImpl<T extends TypeDefinition<?>,D extends DeclaredStatement<String>> extends
    ...
    public TypeEffectiveStatementImpl(StmtContext<String, D, ?> ctx) {
        super(ctx);
