...
public class LeafRefBaseType implements YangBaseType {

    private static final LeafRefBaseType INSTANCE = new LeafRefBaseType();
    ...
    private static final LeafRefBaseType DEFAULT_VALUE = INSTANCE;
