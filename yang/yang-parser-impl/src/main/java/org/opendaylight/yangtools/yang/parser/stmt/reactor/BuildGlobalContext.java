    ...
    private void completePhaseActions() throws ReactorException {
        ...
        while (progressing) {
            ...
            while (currentSource.hasNext()) {
                ...
                try {
                    final PhaseCompletionProgress sourceProgress = currentPhase == ModelProcessingPhase.SOURCE_PRE_LINKAGE
                            && libSources.contains(nextSourceCtx) ? nextSourceCtx.completePhaseHard(currentPhase)
                            : nextSourceCtx.tryToCompletePhase(currentPhase);
        ...
        if (!libSources.isEmpty() && currentPhase == ModelProcessingPhase.SOURCE_LINKAGE) {
