...
public class Int16BaseType implements YangBaseType {

    private static final Int16BaseType INSTANCE = new Int16BaseType();

    private static final QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, TypeUtils.INT16);
    ...
    private static final String DESCRIPTION = TypeUtils.INT16 + " represents integer values between " + MIN_RANGE
