...
public class LeafrefSpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<LeafrefTypeDefinition, D> implements LeafrefTypeDefinition {
    ...
    public LeafrefSpecificationEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
