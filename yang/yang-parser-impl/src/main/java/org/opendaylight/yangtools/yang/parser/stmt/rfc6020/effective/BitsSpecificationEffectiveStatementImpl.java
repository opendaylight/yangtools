...
public class BitsSpecificationEffectiveStatementImpl extends EffectiveStatementBase<String, TypeStatement.BitsSpecification> implements BitsTypeDefinition {
    ...
    private final List<Bit> bits = Collections.emptyList();
