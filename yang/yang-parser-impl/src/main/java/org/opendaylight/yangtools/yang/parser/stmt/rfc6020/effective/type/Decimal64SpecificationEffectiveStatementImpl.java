...
public class Decimal64SpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<DecimalTypeDefinition, D> implements DecimalTypeDefinition {
    ...
    public Decimal64SpecificationEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
