...
public class Int8BaseType implements YangBaseType {

    private static final Int8BaseType INSTANCE = new Int8BaseType();

    private static final QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, TypeUtils.INT8);
    ...
    private static final String DESCRIPTION = TypeUtils.INT8 + " represents integer values between " + MIN_RANGE
