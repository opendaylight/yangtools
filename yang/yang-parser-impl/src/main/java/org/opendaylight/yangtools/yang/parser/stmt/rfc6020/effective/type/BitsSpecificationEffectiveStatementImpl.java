...
public class BitsSpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<BitsTypeDefinition, D> implements BitsTypeDefinition {
    ...
    public BitsSpecificationEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
