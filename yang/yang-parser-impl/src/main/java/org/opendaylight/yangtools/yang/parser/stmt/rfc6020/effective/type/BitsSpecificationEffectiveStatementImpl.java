...
public final class BitsSpecificationEffectiveStatementImpl extends EffectiveStatementBase<String, BitsSpecification>
    ...
    @Override
    public TypeDefinitionBuilder<BitsTypeDefinition> newTypeDefinitionBuilder() {
        return new AbstractTypeDefinitionBuilder<BitsTypeDefinition>() {
            ...
            public BitsTypeDefinition build() {
                // FIXME: this is not quite right, as it does not use all the other information
                return BitsType.create(getPath(), bits);
            }
