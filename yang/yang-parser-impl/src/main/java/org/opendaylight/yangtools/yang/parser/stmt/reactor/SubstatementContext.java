...
final class SubstatementContext<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    public Optional<SchemaPath> getSchemaPath() {
        ...
        if (argument instanceof QName) {
            ...
            return Optional.of(path.createChild(qname));
            ...
            return Optional.of(parentPath.createChild(qname));
        } else if ((StmtContextUtils.producesDeclared(this, AugmentStatement.class)
                   || StmtContextUtils.producesDeclared(this, RefineStatement.class))
                && argument instanceof SchemaNodeIdentifier) {

            return Optional.of(parentPath.createChild(((SchemaNodeIdentifier) argument).getPathFromRoot()));
        } else if (Utils.isUnknownNode(this)) {
            return Optional.of(parentPath.createChild(getPublicDefinition().getStatementName()));
        } else {
            // FIXME: this does not look right
            return Optional.of(SchemaPath.SAME);
        }
    }
