...
public class UsesEffectiveStatementImpl extends EffectiveStatementBase<QName, UsesStatement> implements UsesNode {
    ...
    private void initSubstatementCollections() {
        ...
        for (EffectiveStatement<?, ?> effectiveStatement : effectiveSubstatements) {
            ...
            if (effectiveStatement instanceof RefineEffectiveStatementImpl) {
                ...
                refinesInit.put(Utils.SchemaNodeIdentifierToSchemaPath(identifier), refineStmt);
            }
        }
    ...
    private void initCopyType(StmtContext<QName, UsesStatement, EffectiveStatement<QName, UsesStatement>> ctx) {
