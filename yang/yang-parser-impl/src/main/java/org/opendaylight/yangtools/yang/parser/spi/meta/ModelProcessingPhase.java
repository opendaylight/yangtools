...
public enum ModelProcessingPhase {
    ...
    /**
    *
    * Preparatory cross-source relationship resolution phase
    * which collects available module names and namespaces.
    * It is necessary in order to correct resolution of unknown
    * statements used by linkage phase (e.g. semantic version of
    * yang modules).
    */
