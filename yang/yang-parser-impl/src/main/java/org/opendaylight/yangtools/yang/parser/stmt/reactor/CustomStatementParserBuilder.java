...
public class CustomStatementParserBuilder {
    ...
    /**
     * Creates new custom statement parser builder initialized by
    ...
    /**
     * Creates new custom statement parser builder initialized by specific
    ...
    public CustomStatementParserBuilder addAllVersionSpecificSupports(final ModelProcessingPhase phase,
            final Table<SemVer, QName, StatementSupport<?, ?, ?>> versionSpecificSupports) {
        final StatementSupportBundle.Builder stmtBundleBuilder = reactorSupportBundles.get(phase);
        for (final Cell<SemVer, QName, StatementSupport<?, ?, ?>> cell : versionSpecificSupports.cellSet()) {
