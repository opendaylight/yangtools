...
public class SourceSpecificContext implements NamespaceStorageNode, NamespaceBehaviour.Registry, Mutable {
    ...
    private Collection<NamespaceStorageNode> importedNamespaces = new ArrayList<>();
    private Multimap<ModelProcessingPhase, ModifierImpl> modifiers = HashMultimap.create();
