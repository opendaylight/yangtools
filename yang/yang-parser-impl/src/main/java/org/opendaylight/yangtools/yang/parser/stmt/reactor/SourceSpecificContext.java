...
public class SourceSpecificContext implements NamespaceStorageNode, NamespaceBehaviour.Registry, Mutable {
    ...
    private QNameToStatementDefinition stmtDef() {
        ...
        if (inProgressPhase == ModelProcessingPhase.FULL_DECLARATION) {
            ...
            addSupports(b, getAllFromLocalStorage(StatementDefinitionNamespace.class));
            for (NamespaceStorageNode i : importedNamespaces) {
                addSupports(b, i.getAllFromLocalStorage(StatementDefinitionNamespace.class));
            }
