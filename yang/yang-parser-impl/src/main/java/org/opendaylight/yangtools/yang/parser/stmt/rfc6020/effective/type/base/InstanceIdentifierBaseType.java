...
public class InstanceIdentifierBaseType implements YangBaseType {

    private static final InstanceIdentifierBaseType INSTANCE = new InstanceIdentifierBaseType();
    ...
    private InstanceIdentifierBaseType() {
    }
