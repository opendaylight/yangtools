...
public class BooleanEffectiveStatementImpl extends DeclaredEffectiveStatementBase<String, TypeStatement>
    ...
    private final BooleanTypeDefinition typeDefinition;
    ...
    public BooleanEffectiveStatementImpl(
        ...
        final TypeBuilder<BooleanTypeDefinition> builder =
                RestrictedTypes.newBooleanBuilder(baseType, ctx.getSchemaPath().get());
