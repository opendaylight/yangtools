...
public class BooleanEffectiveStatementImpl extends EffectiveStatementBase<String, TypeStatement> implements
        BooleanTypeDefinition {

    public static final String LOCAL_NAME = "boolean";
    ...
    public BooleanEffectiveStatementImpl(StmtContext<String, TypeStatement, ?> ctx) {
        super(ctx);
