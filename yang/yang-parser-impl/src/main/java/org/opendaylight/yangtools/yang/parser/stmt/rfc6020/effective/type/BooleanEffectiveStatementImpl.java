...
public class BooleanEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<BooleanTypeDefinition, D> implements BooleanTypeDefinition {
    ...
    public BooleanEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
