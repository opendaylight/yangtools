...
public final class BooleanEffectiveStatementImpl extends AbstractBuiltInTypeEffectiveStatement<BooleanTypeDefinition>
    ...
    @Override
    protected BooleanType delegate() {
    ...
    public TypeEffectiveStatement<TypeStatement> derive(final EffectiveStatement<?, TypeStatement> stmt, final SchemaPath path) {
        return new DerivedEffectiveStatement<TypeStatement, BooleanTypeDefinition>(stmt, path, this);
    }
}
