...
public class EnumBaseType implements YangBaseType {

    private static final EnumBaseType INSTANCE = new EnumBaseType();
    ...
    private static final EnumPair DEFAULT_VALUE = null;
