...
public class SubmoduleEffectiveStatementImpl extends ModuleEffectiveStatementBase<SubmoduleStatement> {
    ...
    public SubmoduleEffectiveStatementImpl(
        ...
        qNameModule = submoduleRevision == null ? QNameModule.create(belongsToModuleQName.getNamespace(),
