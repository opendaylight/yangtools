...
public class EmptyEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<EmptyTypeDefinition, D> implements EmptyTypeDefinition {
    ...
    public EmptyEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
