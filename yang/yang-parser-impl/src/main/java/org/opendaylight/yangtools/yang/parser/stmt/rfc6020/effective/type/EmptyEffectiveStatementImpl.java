...
public class EmptyEffectiveStatementImpl extends EffectiveStatementBase<String, TypeStatement> implements
        EmptyTypeDefinition {

    public static final String LOCAL_NAME = "empty";
    ...
    public EmptyEffectiveStatementImpl(StmtContext<String, TypeStatement, ?> ctx) {
        super(ctx);
