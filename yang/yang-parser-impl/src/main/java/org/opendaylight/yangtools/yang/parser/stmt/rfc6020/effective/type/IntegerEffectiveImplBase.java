...
abstract class IntegerEffectiveImplBase extends TypeEffectiveStatementImpl<IntegerTypeDefinition> implements
    ...
    protected IntegerEffectiveImplBase(final StmtContext<String, TypeStatement, ?> ctx, final String localName,
            final Number minRange, final Number maxRange, final String description) {
