...
abstract class IntegerEffectiveImplBase<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<IntegerTypeDefinition, D> implements IntegerTypeDefinition {
    ...
    protected IntegerEffectiveImplBase(final StmtContext<String, D, EffectiveStatement<String, D>> ctx,
