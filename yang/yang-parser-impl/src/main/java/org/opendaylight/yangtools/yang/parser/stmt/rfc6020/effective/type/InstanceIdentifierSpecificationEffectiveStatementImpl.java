...
public class InstanceIdentifierSpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<InstanceIdentifierTypeDefinition, D> implements InstanceIdentifierTypeDefinition {
    ...
    public InstanceIdentifierSpecificationEffectiveStatementImpl(
            StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
