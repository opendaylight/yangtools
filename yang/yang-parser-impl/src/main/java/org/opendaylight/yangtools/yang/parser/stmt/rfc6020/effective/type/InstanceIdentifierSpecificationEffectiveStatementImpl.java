...
public class InstanceIdentifierSpecificationEffectiveStatementImpl extends
        EffectiveStatementBase<String, TypeStatement.InstanceIdentifierSpecification> implements
    ...
    public InstanceIdentifierSpecificationEffectiveStatementImpl(
        ...
        requireInstance = firstEffective(RequireInstanceEffectiveStatementImpl.class).argument();
    }
