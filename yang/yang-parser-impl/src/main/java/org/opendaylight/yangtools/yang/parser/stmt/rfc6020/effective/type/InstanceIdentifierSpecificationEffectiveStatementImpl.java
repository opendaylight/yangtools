...
public class InstanceIdentifierSpecificationEffectiveStatementImpl
        extends
        EffectiveStatementBase<String, TypeStatement.InstanceIdentifierSpecification>
        implements InstanceIdentifierTypeDefinition {

    private static final QName QNAME = QName.create(
            YangConstants.RFC6020_YANG_MODULE, "instance-identifier");
    ...
    public InstanceIdentifierSpecificationEffectiveStatementImpl(
        ...
        requireInstance = (requireInstanceStmtCtx != null) ? requireInstanceStmtCtx
                .argument() : false;
    }
