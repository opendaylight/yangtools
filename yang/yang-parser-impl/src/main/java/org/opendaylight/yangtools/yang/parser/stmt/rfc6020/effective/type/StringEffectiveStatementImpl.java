...
public final class StringEffectiveStatementImpl extends DeclaredEffectiveStatementBase<String, TypeStatement> implements
    ...
    public StringEffectiveStatementImpl(
        ...
        final StringTypeBuilder builder =
                RestrictedTypes.newStringBuilder(baseType, ctx.getSchemaPath().get());
        ...
        for (EffectiveStatement<?, ?> stmt : effectiveSubstatements()) {
            ...
            if (stmt instanceof PatternEffectiveStatementImpl) {
                builder.addPatternConstraint(((PatternEffectiveStatementImpl)stmt).argument());
            }
