...
public class StringEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<StringTypeDefinition, D> implements StringTypeDefinition {
    ...
    public StringEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
