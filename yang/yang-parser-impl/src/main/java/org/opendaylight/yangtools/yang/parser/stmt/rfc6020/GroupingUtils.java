...
//                final StatementContextBase<?, ?, ?> augmentTargetCtx = Utils.findCtxOfNodeInRoot(targetNodeStmtCtx,
//                        AugmentUtils.parseAugmentPath(targetNodeStmtCtx, subStmtCtx.rawStatementArgument()));

                // AugmentUtils.copyFromSourceToTarget(subStmtCtx,
                // augmentTargetCtx);
                // augmentTargetCtx.addEffectiveSubstatement(subStmtCtx.createCopy(null,
                // augmentTargetCtx));
            }
