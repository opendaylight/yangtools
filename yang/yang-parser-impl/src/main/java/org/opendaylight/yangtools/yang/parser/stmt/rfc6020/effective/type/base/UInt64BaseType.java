...
public class UInt64BaseType implements YangBaseType {
    ...
    private static final String DESCRIPTION = TypeUtils.UINT64 + " represents integer values between " + MIN_RANGE
