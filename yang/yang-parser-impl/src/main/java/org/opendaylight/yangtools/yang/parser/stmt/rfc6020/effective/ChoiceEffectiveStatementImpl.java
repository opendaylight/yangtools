...
public class ChoiceEffectiveStatementImpl extends AbstractEffectiveDocumentedNode<QName, ChoiceStatement> implements ChoiceSchemaNode, DerivableSchemaNode {
    ...
    private void initSubstatementCollections() {
        ...
        LinkedList<UnknownSchemaNode> unknownNodesInit = new LinkedList<>();
        HashSet<AugmentationSchema> augmentationsInit = new HashSet<>();
        HashSet<ChoiceCaseNode> casesInit = new HashSet<>();
