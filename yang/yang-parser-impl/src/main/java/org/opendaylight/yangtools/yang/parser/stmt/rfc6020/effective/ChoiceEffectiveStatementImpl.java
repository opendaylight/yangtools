...
public class ChoiceEffectiveStatementImpl extends AbstractEffectiveDataSchemaNode<ChoiceStatement> implements
        ChoiceSchemaNode, DerivableSchemaNode {

    private final ChoiceSchemaNode original;
    private final String defaultCase;

    private final ImmutableSet<ChoiceCaseNode> cases;
