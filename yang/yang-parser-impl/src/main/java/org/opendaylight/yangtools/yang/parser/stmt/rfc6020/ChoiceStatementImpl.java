...
public class ChoiceStatementImpl extends AbstractDeclaredStatement<QName> implements ChoiceStatement {
    ...
    protected ChoiceStatementImpl(
            StmtContext<QName, ChoiceStatement, ?> context) {
        super(context);
    }

    public static class Definition extends AbstractStatementSupport<QName,ChoiceStatement,EffectiveStatement<QName,ChoiceStatement>> {
        ...
        @Override public ChoiceStatement createDeclared(
                StmtContext<QName, ChoiceStatement, ?> ctx) {
            return new ChoiceStatementImpl(ctx);
        }

        @Override public EffectiveStatement<QName, ChoiceStatement> createEffective(
    ...
    @Nonnull @Override public Collection<? extends CaseStatement> getCases() {
    ...
    @Nullable @Override public DescriptionStatement getDescription() {
        return null;
    }
