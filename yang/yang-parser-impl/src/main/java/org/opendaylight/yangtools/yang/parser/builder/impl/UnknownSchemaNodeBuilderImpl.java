...
public final class UnknownSchemaNodeBuilderImpl extends AbstractBuilder implements UnknownSchemaNodeBuilder {
    private QName qname;
    private PrefixedQName prefixedQName;
    ...
    private PrefixedQName prefixedNodeType;
    ...
    @Override
    public PrefixedQName getPrefixedQName() {
        return prefixedQName;
    }

    @Override
    public void setPrefixedQName(final PrefixedQName prefixedQName) {
        this.prefixedQName = prefixedQName;
    }
    ...
    public UnknownSchemaNode build() {
        ...
        if (qname == null) {
            qname = prefixedQName.createQName();
        }

        instance = new UnknownSchemaNodeImpl(qname, schemaPath);

        if (nodeType == null) {
            if (prefixedNodeType != null) {
                nodeType = prefixedNodeType.createQName();
            }
        }
    ...
    @Override
    public PrefixedQName getPrefixedNodeType() {
        return prefixedNodeType;
    }

    @Override
    public void setPrefixeNodeType(final PrefixedQName prefixedNodeType) {
        this.prefixedNodeType = prefixedNodeType;
    }
    ...
    public void setResolved() {
        if (prefixedQName != null) {
            qname = prefixedQName.createQName();
            schemaPath = schemaPath.getParent().createChild(qname);
        }
    }
    ...
    public String toString() {
        ...
        sb.append(nodeType == null ? prefixedNodeType.getNamespace() : nodeType.getNamespace());
        sb.append(":");
        sb.append(nodeType == null ? prefixedNodeType.getLocalName() : nodeType.getLocalName());
        sb.append(" ");
