...
public class TypeUtils {
    ...
    public static TypeDefinition<?> getYangBaseTypeFromString(String typeName,
            TypeDefEffectiveStatementImpl typedef) {
    ...
    public static TypeDefinition<?> getYangBaseTypeFromString(
            String typeName,
            ExtendedTypeEffectiveStatementImpl extendedTypeEffectiveStatementImpl) {
        if (baseTypesMap.containsKey(typeName)) {
            return baseTypesMap.get(typeName);
        }
