...
public class TypeUtils {
    ...
    private static final Set<String> PRIMITIVE_TYPES = ImmutableSet.<String> builder().add(BOOLEAN).add(DECIMAL64)
            .add(EMPTY).add(INT8).add(INT16).add(INT32).add(INT64).add(STRING).add(UINT8).add(UINT16).add(UINT32)
            .add(UINT64).build();
    public static final Set<String> BASE_TYPES = ImmutableSet.<String> builder().addAll(PRIMITIVE_TYPES).add(BINARY)
            .add(BITS).add(ENUMERATION).add(IDENTITY_REF).add(INSTANCE_IDENTIFIER).add(LEAF_REF).add(UNION).build();

    public static final Set<String> TYPE_BODY_STMTS = ImmutableSet.<String> builder().add(DECIMAL64).add
            (ENUMERATION).add(LEAF_REF).add(IDENTITY_REF).add(INSTANCE_IDENTIFIER).add(BITS).add(UNION).add(BINARY).
            build();
    ...
    public static TypeDefinition<?> getYangBaseTypeFromString(String typeName, TypeDefEffectiveStatementImpl typedef) {
        ...
        if (baseTypesMap.containsKey(typeName)) {
            ...
            switch (typeName) {
                case DECIMAL64:
                    return Decimal64BaseType.create(typedef.getPath(), typedef.getFractionDigits());
                case BITS:
    ...
    public static TypeDefinition<?> getYangBaseTypeFromString(String typeName, ExtendedTypeEffectiveStatementImpl extendedType) {
        ...
        if (baseTypesMap.containsKey(typeName)) {
            ...
            switch (typeName) {
            case DECIMAL64:
                return Decimal64BaseType.create(extendedType.getPath(), extendedType.getFractionDigits());
            case BITS:
