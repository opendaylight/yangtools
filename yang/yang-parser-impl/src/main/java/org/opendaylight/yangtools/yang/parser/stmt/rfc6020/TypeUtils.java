...
import org.opendaylight.yangtools.yang.parser.stmt.rfc6020.effective.type.base.EnumBaseType;
...
import org.opendaylight.yangtools.yang.parser.stmt.rfc6020.effective.type.base.UnionBaseType;
...
public class TypeUtils {
    ...
    public static DerivedType getTypeFromCtxNamespace(
            final StmtContext<String, ? extends TypeStatement, ? extends EffectiveStatement<String, ? extends TypeStatement>> ctx) {

        return ctx.getFromNamespace(QNameToDerivedType.class, Utils.qNameFromArgument(ctx, ctx.getStatementArgument()));
    }
