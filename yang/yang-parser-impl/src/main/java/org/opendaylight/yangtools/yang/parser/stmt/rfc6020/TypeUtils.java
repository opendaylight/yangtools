...
public class TypeUtils {
    ...
    public static final Set<String> TYPE_BODY_STMTS = ImmutableSet.<String> builder().add(DECIMAL64).add(ENUMERATION)
            .add(LEAF_REF).add(IDENTITY_REF).add(INSTANCE_IDENTIFIER).add(BITS).add(UNION).add(BINARY).build();
