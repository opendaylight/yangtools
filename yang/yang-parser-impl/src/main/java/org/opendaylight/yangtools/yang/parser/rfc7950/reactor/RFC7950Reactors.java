...
public final class RFC7950Reactors {
    ...
    static final Set<YangVersion> SUPPORTED_VERSIONS = Sets.immutableEnumSet(VERSION_1, VERSION_1_1);
    static final StatementSupportBundle INIT_BUNDLE = StatementSupportBundle.builder(SUPPORTED_VERSIONS)
    ...
    static final StatementSupportBundle PRE_LINKAGE_BUNDLE = StatementSupportBundle.derivedFrom(INIT_BUNDLE)
            ...
            .build();
    static final StatementSupportBundle LINKAGE_BUNDLE = StatementSupportBundle
