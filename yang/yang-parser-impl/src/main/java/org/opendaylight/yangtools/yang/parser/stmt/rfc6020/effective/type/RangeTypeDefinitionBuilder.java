...
class RangeTypeDefinitionBuilder<T extends TypeDefinition<T>>
    ...
    public RangeTypeDefinitionBuilder() {

    }

    public RangeTypeDefinitionBuilder(final List<RangeConstraint> rangeConstraints) {
        super();
        getConstraints().addRanges(rangeConstraints);
    }
