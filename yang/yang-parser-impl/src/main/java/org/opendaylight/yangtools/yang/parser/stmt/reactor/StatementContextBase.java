...
public abstract class StatementContextBase<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    interface OnPhaseFinished extends EventListener {
        ...
        void phaseFinished(StatementContextBase<?, ?, ?> context,
    ...
    public void setOriginalCtx(StatementContextBase<?, ?, ?> originalCtx) {
        ...
        this.originalCtx.completedPhase = ModelProcessingPhase.EFFECTIVE_MODEL;
    }
    ...
    public E buildEffective() {
        Preconditions
                .checkArgument(completedPhase == ModelProcessingPhase.EFFECTIVE_MODEL);
