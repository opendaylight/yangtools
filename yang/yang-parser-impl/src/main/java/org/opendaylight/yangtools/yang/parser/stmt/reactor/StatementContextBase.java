...
public abstract class StatementContextBase<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    StatementContextBase(final StatementContextBase<A, D, E> original) {
        this.definition = Preconditions.checkNotNull(original.definition, "Statement context definition cannot be " +
                "null copying from: "  + original.getStatementSourceReference());
        this.identifier = Preconditions.checkNotNull(original.identifier, "Statement context identifier cannot be " +
                "null copying from: " + original.getStatementSourceReference());
        this.statementDeclSource = Preconditions.checkNotNull(original.statementDeclSource,
                "Statement context statementDeclSource cannot be null copying from: " +
    ...
    void addPhaseCompletedListener(final ModelProcessingPhase phase, final OnPhaseFinished listener) throws SourceException {
        ...
        Preconditions.checkNotNull(phase, "Statement context processing phase cannot be null at: "  +
                getStatementSourceReference());
        Preconditions.checkNotNull(listener, "Statement context phase listener cannot be null at: " +
                getStatementSourceReference());
