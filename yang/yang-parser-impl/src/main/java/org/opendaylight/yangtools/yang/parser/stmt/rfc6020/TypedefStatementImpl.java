    ...
    public static class Definition extends
        ...
        public void onStatementDefinitionDeclared(
            ...
            if (stmt != null && stmt.getParentContext() != null) {
                ...
                stmt.getParentContext().addToNs(QNameToDerivedType.class, stmt.getStatementArgument(), new
                        DerivedType(stmt));
            }
        }

        @Override
        public void onFullDefinitionDeclared(final Mutable<QName, TypedefStatement, EffectiveStatement<QName, TypedefStatement>> stmt) throws SourceException {
            //stmt.getFromNamespace(QNameToDerivedType.class, stmt.getStatementArgument()).initBaseType(stmt);
        }
    }
