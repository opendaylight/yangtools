            ...
            if (stmtArgument == null) {
                for (final StatementContextBase<?, ?, ?> targetCtxSubstatement : targetCtx.effectiveSubstatements()) {
                    if (stmtToBeDeleted.equals(targetCtxSubstatement.getPublicDefinition())) {
                        targetCtx.removeStatementFromEffectiveSubstatements(stmtToBeDeleted);
                        return;
                    }
                }
                ...
                for (final StatementContextBase<?, ?, ?> targetCtxSubstatement : targetCtx.effectiveSubstatements()) {
                    if (stmtToBeDeleted.equals(targetCtxSubstatement.getPublicDefinition())
                        ...
                        targetCtx.removeStatementWithArgumentFromEffectiveSubstatements(stmtToBeDeleted, stmtArgument);
                        return;
                    }
                }
