...
public class UnionSpecificationEffectiveStatementImpl extends
        EffectiveStatementBase<String, TypeStatement.UnionSpecification> implements UnionTypeDefinition, TypeDefinitionEffectiveBuilder {
    ...
    public UnionSpecificationEffectiveStatementImpl(StmtContext<String, TypeStatement.UnionSpecification, EffectiveStatement<String, TypeStatement.UnionSpecification>> ctx) {
        super(ctx);
        ...
        for (final EffectiveStatement<?, ?> effectiveStatement : effectiveSubstatements()) {
            if (effectiveStatement instanceof TypeDefinition) {
                typesInit.add((TypeDefinition<?>) effectiveStatement);
            }
        }
