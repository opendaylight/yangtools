...
public class UnionSpecificationEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<UnionTypeDefinition, D> implements UnionTypeDefinition {
    ...
    public UnionSpecificationEffectiveStatementImpl(StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
