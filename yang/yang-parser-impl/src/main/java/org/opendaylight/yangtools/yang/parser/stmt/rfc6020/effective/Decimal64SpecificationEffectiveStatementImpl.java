...
public class Decimal64SpecificationEffectiveStatementImpl extends
    ...
    private static final QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, "decimal64");
    ...
    private List<RangeConstraint> defaultRangeStatements() {
        ...
        final String rangeReference = "https://tools.ietf.org/html/rfc6020#section-9.2.4";
