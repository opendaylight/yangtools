...
abstract class UnsignedIntegerEffectiveImplBase<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<UnsignedIntegerTypeDefinition, D> implements UnsignedIntegerTypeDefinition {
    ...
    protected UnsignedIntegerEffectiveImplBase(final StmtContext<String, D, EffectiveStatement<String, D>> ctx,
