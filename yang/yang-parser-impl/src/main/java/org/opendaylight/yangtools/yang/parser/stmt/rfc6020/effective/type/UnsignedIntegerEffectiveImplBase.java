...
abstract class UnsignedIntegerEffectiveImplBase extends TypeEffectiveStatementImpl<UnsignedIntegerTypeDefinition> implements
    ...
    protected UnsignedIntegerEffectiveImplBase(final StmtContext<String, TypeStatement, ?> ctx, final String localName,
            final Number maxRange, final String description) {
