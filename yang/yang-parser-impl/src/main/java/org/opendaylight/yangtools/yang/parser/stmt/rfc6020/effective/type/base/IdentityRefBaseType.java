...
public class IdentityRefBaseType implements YangBaseType {

    private static final IdentityRefBaseType INSTANCE = new IdentityRefBaseType();
    ...
    private static final IdentitySchemaNode DEFAULT_VALUE = null;
