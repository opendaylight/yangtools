...
public class UInt16BaseType implements YangBaseType {
    ...
    private static final String DESCRIPTION = TypeUtils.UINT16 + " represents integer values between " + MIN_RANGE
