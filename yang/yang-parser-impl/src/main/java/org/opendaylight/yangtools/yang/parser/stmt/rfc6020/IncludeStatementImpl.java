...
public class IncludeStatementImpl extends AbstractDeclaredStatement<String>
    ...
    public static class Definition
        ...
        @Override
        public void onLinkageDeclared(final Mutable<String, IncludeStatement, EffectiveStatement<String, IncludeStatement>> stmt)
            ...
            final Prerequisite<StmtContext<?, ?, ?>> requiresCtxPrerequisite = includeAction.requiresCtx(stmt, SubmoduleNamespace.class, includeSubmoduleIdentifier, SourceLinkage);
            final Prerequisite<Mutable<?, ?, ?>> mutatesCtxPrerequisite = includeAction.mutatesCtx(stmt.getRoot(), SourceLinkage);
            ...
            includeAction.apply(new InferenceAction() {
                ...
                public void apply() throws InferenceException {
                    ...
                    mutatesCtxPrerequisite.get().addToNs(IncludedModuleContext.class, includeSubmoduleIdentifier, includedSubmoduleStmt);
                }
