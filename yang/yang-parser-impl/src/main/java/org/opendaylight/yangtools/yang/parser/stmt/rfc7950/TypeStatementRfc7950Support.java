...
public final class TypeStatementRfc7950Support extends TypeStatementImpl.Definition {
    ...
    @Override
    public StatementSupport<?, ?, ?> getSupportBasedOnStmtArgument(final String argument) {
        final StatementSupport<?, ?, ?> potential = ARGUMENT_SPECIFIC_SUPPORTS.get(argument);
        return potential != null ? potential : super.getSupportBasedOnStmtArgument(argument);
    }
}
