...
public class UInt32BaseType implements YangBaseType {

    private static final UInt32BaseType INSTANCE = new UInt32BaseType();

    private static final QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, TypeUtils.UINT32);
    private static final SchemaPath SCHEMA_PATH = SchemaPath.create(true, QNAME);

    private static final Number MIN_RANGE = 0;
    private static final Number MAX_RANGE = 4294967295L;

    private static final String UNITS = "";
    private static final Object DEFAULT_VALUE = null;

    private static final String DESCRIPTION = TypeUtils.UINT32 + " represents integer values between " + MIN_RANGE
