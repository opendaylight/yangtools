...
public final class ASTSchemaSource implements SchemaSourceRepresentation {
    ...
    private static SourceIdentifier getSourceId(final YangModelDependencyInfo depInfo) {
        ...
        return depInfo.getFormattedRevision() == null
                ? SourceIdentifier.createRevisionSourceIdentifier(name)
                : SourceIdentifier.createRevisionSourceIdentifier(name, depInfo.getFormattedRevision());
    }

    private static SemVerSourceIdentifier getSemVerSourceId(final YangModelDependencyInfo depInfo) {
        return depInfo.getFormattedRevision() == null
               ? SourceIdentifier.createSemVerSourceIdentifier(depInfo.getName(), depInfo.getSemanticVersion())
               : SourceIdentifier.createSemVerSourceIdentifier(depInfo.getName(), depInfo.getFormattedRevision(), depInfo.getSemanticVersion());
    }
    ...
    public static ASTSchemaSource create(@Nonnull final SourceIdentifier identifier,
        ...
        if (identifier instanceof SemVerSourceIdentifier
                && depInfo.getSemanticVersion() == Module.DEFAULT_SEMANTIC_VERSION) {
