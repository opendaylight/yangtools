...
public class BinarySpecificationImpl extends AbstractDeclaredStatement<String> implements
    ...
    protected BinarySpecificationImpl(final StmtContext<String, BinarySpecification, ?> context) {
        super(context);
    }
    ...
    public static class Definition
        ...
        @Override
        public BinarySpecification createDeclared(final StmtContext<String, BinarySpecification, ?> ctx) {
            return new BinarySpecificationImpl(ctx);
        }

        @Override
        public EffectiveStatement<String, BinarySpecification> createEffective(
                final StmtContext<String, BinarySpecification, EffectiveStatement<String, BinarySpecification>> ctx) {
            return null;//new BinarySpecificationEffectiveStatementImpl(ctx);
        }
