...
public final class StmtContextUtils {
    ...
    public static boolean isUnknownStatement(final StmtContext<?, ?, ?> stmtCtx) {
        return stmtCtx != null && UnknownStatement.class.isAssignableFrom(stmtCtx.getPublicDefinition()
                .getDeclaredRepresentationClass());
    }

    public static boolean isUnrecognizedStatement(final StmtContext<?, ?, ?> stmtCtx) {
        return stmtCtx != null && UnrecognizedStatement.class.isAssignableFrom(stmtCtx.getPublicDefinition()
                .getDeclaredRepresentationClass());
    }
