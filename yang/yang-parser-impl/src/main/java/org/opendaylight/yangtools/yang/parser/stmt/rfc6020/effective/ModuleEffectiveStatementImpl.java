...
public class ModuleEffectiveStatementImpl extends ModuleEffectiveStatementBase<ModuleStatement> {
    ...
    public ModuleEffectiveStatementImpl(
        ...
        qNameModule = qNameModuleInit.getRevision() == null ? QNameModule.create(qNameModuleInit.getNamespace(),
