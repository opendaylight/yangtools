...
public final class LeafRefPathParserListenerImpl implements LeafRefPathParserListener{
    ...
    private LinkedList<QNameWithPredicate> predicatePathPathQnameList;
    private boolean predicateParsingState;
    SchemaNode node;
    ...
    public LeafRefPathParserListenerImpl(SchemaContext schemaContext, Module currentModule, SchemaNode currentNode) {
       ...
       this.predicateParsingState = false;
    }
    ...
    public void enterPath_predicate(Path_predicateContext ctx) {
        predicateParsingState = true;
        predicatePathPathQnameList = new LinkedList<QNameWithPredicate>();
    ...
    public void exitPath_arg(Path_argContext ctx) {
        leafRefPath = LeafRefPath.create(leafRefPathQnameList,absolute);
    }
    ...
    public void exitNode_identifier(Node_identifierContext ctx) {
        ...
        if (predicateParsingState = true) {
            predicatePathPathQnameList.add(qname);
        } else {
