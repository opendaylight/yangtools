...
public class BinaryEffectiveStatementImpl<D extends DeclaredStatement<String>> extends
        TypeEffectiveStatementImpl<BinaryTypeDefinition, D> implements BinaryTypeDefinition {
    ...
    private final static QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, "binary");
    ...
    public BinaryEffectiveStatementImpl(
            final StmtContext<String, D, EffectiveStatement<String, D>> ctx) {
        super(ctx);
