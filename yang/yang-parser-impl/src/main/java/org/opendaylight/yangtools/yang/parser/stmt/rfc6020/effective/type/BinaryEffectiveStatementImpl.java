...
public class BinaryEffectiveStatementImpl extends EffectiveStatementBase<String, TypeStatement.BinarySpecification>
    ...
    public BinaryEffectiveStatementImpl(final StmtContext<String, TypeStatement.BinarySpecification, ?> ctx) {
        super(ctx);
