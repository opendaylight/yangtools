...
import org.opendaylight.yangtools.yang.parser.spi.meta.RequiredRevisionImports;
...
public class ImportStatementDefinition extends
    ...
    public void onPreLinkageDeclared(final Mutable<String, ImportStatement, EffectiveStatement<String, ImportStatement>> stmt) {
        stmt.addToValueNs(RequiredRevisionImports.class, RevisionImport.getImportedModuleIdentifier(stmt));
