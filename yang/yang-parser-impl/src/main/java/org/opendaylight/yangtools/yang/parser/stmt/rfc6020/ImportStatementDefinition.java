...
public class ImportStatementDefinition extends
    ...
    private static ModuleIdentifier getImportedModuleIdentifier(Mutable<String, ImportStatement, ?> stmt)
        ...
        // Optional<URI> moduleNs =
        // Optional.fromNullable(firstAttributeOf(stmt.getParentContext().declaredSubstatements(),
    ...
    // Mutable<String, ImportStatement, EffectiveStatement<String,
