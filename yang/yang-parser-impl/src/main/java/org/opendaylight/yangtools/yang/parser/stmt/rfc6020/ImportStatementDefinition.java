...
public class ImportStatementDefinition
    ...
    private static final SubstatementValidator SUBSTATEMENT_VALIDATOR =
            ...
            .add(Rfc6020Mapping.PREFIX, 1, 1).add(Rfc6020Mapping.REVISION_DATE, 0, 1)
    ...
    public void onPreLinkageDeclared(Mutable<String,ImportStatement,EffectiveStatement<String,ImportStatement>> stmt) {
        ...
        final Prerequisite<StmtContext<?, ?, ?>> imported = importAction.requiresCtx(stmt, PreLinkageModuleNamespace.class,
                moduleName, SOURCE_PRE_LINKAGE);
        final Prerequisite<Mutable<?, ?, ?>> linkageTarget = importAction.mutatesCtx(stmt.getRoot(), SOURCE_PRE_LINKAGE);
        ...
        importAction.apply(new InferenceAction() {
            ...
            public void apply() {
                ...
                final URI importedModuleNamespace = importedModuleContext.getFromNamespace(ModuleNameToNamespace.class, moduleName);
