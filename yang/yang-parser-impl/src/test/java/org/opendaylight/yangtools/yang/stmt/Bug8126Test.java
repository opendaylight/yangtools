...
public class Bug8126Test {
    ...
    @Test
    public void reportedTest() throws Exception {
        final SchemaContext context = StmtTestUtils.parseYangSources("/bugs/bug8126/reported");
        assertNotNull(context);
    }

    @Test
    public void test() throws Exception {
        final SchemaContext context = StmtTestUtils.parseYangSources("/bugs/bug8126/tst");
        assertNotNull(context);
