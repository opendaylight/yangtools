...
public class YangExtensionArgumentTest {
    ...
    public void init() throws URISyntaxException, ReactorException {
        modules = TestUtils.loadModules(getClass().getResource("/semantic-statement-parser/extension-argument-name")
                .toURI());
    ...
    public void ExtensionParameterTest() {
        ...
        List<UnknownSchemaNode> unknownSchemaNodes = testModule.getUnknownSchemaNodes();
