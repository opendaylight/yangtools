...
public class Bug5410Test {
    ...
    public void testYangPattern() throws Exception {
        ...
        final String javaRegexFromYang = getPatternOf(context, "leaf-with-pattern");
    ...
    private static String getPatternOf(final SchemaContext context, final String leafName) {
