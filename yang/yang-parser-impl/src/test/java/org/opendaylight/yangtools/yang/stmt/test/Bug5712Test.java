...
public class Bug5712Test {
    ...
    @Test
    public void testTypedefWithNewParser() throws ReactorException {
        YangStatementSourceImpl anyxmlStmtModule =
                new YangStatementSourceImpl("/bugs/bug5712/bad.yang", false);

        SchemaContext schemaContext = StmtTestUtils.parseYangSources(anyxmlStmtModule);
        assertNotNull(schemaContext);

        Module testModule = schemaContext.findModuleByName("bad", null);
