...
public class OrderingTest {
    ...
    @Test
    public void testOrderingTypedef() throws URISyntaxException, SourceException, ReactorException {
    ...
    @Test
    public void testOrderingChildNodes() throws URISyntaxException, SourceException, ReactorException {
        Set<Module> modules = TestUtils.loadModules(getClass().getResource("/model").toURI());
    ...
    @Test
    public void testOrderingNestedChildNodes1() throws URISyntaxException, SourceException, ReactorException {
        Set<Module> modules = TestUtils.loadModules(getClass().getResource("/model").toURI());
        Module foo = TestUtils.findModule(modules, "foo");
    ...
    @Test
    public void testOrderingNestedChildNodes2() throws URISyntaxException, SourceException, ReactorException {
        Set<Module> modules = TestUtils.loadModules(getClass().getResource("/model").toURI());
