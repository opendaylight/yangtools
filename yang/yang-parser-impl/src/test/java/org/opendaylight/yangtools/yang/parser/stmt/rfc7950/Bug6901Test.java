    ...
    public void ifFeatureOnDefaultValueEnumTest() throws ReactorException, SourceException, FileNotFoundException,
        ...
        try {
            ...
            assertTrue(e
                    ...
                    .getMessage()
                    .startsWith(
                            "Leaf (foo?revision=1970-01-01)enum-leaf has default value marked with an if-feature statement."));
        }
    }
    ...
    public void ifFeatureOnDefaultValueBitTest() throws ReactorException, SourceException, FileNotFoundException,
        ...
        try {
            ...
            assertTrue(e
                    ...
                    .getMessage()
                    .startsWith(
                            "Typedef (foo?revision=1970-01-01)bits-typedef-2 has default value marked with an if-feature statement."));
        }
    }
