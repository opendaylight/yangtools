...
public class YinExtensionArgumentTest {
    ...
    public void init() throws URISyntaxException, ReactorException {
        Set<Module> modules = TestUtils.loadYinModules(getClass().getResource
                ("/semantic-statement-parser/yin/extension-argument-name")
                .toURI());
    ...
    public void ExtensionParameterCustomTest() {
        ...
        assertEquals("0.0.1", node.getNodeParameter());
    }
}
