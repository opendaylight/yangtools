...
public class Bug7954Test {
    ...
    public void testParsingTheSameModuleTwice() throws Exception {
        ...
        try {
            ...
            assertTrue(cause.getMessage().startsWith("Modules foo and foo are duplicates."));
        }
    }
    ...
    public void testParsingTheSameSubmoduleTwice() throws Exception {
        ...
        try {
            ...
            final Throwable cause = ex.getCause();
            assertTrue(cause instanceof SourceException);
            assertTrue(cause.getMessage().startsWith("Submodules subbar and subbar are duplicates."));
        }
    }
}
