...
import org.opendaylight.yangtools.yang.parser.stmt.rfc6020.effective.type.derived.DerivedDecimal64SpecificationEffectiveStatementImpl;
...
public class YangParserTest {
    ...
    public void testParseList() {
        ...
        //:TODO augment to ifEntry have when condition and so in consequence ifEntry should be a context node ?
        ...
        assertTrue(ifIndex.getType() instanceof UInt32EffectiveStatementImpl);
        LeafSchemaNode ifMtu = (LeafSchemaNode) ifEntry.getDataChildByName("ifMtu");
        assertTrue(ifMtu.getType() instanceof Int32EffectiveStatementImpl);
    }
    ...
    public void testTypedefDecimal1() {
        ...
        DerivedDecimal64SpecificationEffectiveStatementImpl type = (DerivedDecimal64SpecificationEffectiveStatementImpl) testleaf.getType();
        QName typeQName = type.getQName();
...
//        assertTrue(type.getPatternConstraints().isEmpty());
        ...
        DerivedDecimal64SpecificationEffectiveStatementImpl typeBase = (DerivedDecimal64SpecificationEffectiveStatementImpl) type.getBaseType();
...
//        assertTrue(typeBase.getPatternConstraints().isEmpty());
        ...
        Decimal64SpecificationEffectiveStatementImpl decimal = (Decimal64SpecificationEffectiveStatementImpl) typeBase.getBaseType();
    ...
    public void testNotification() {
        ...
        assertTrue(eventClass.getType() instanceof StringEffectiveStatementImpl);
        LeafSchemaNode severity = (LeafSchemaNode) notification.getDataChildByName("severity");
        assertTrue(severity.getType() instanceof StringEffectiveStatementImpl);
    }
