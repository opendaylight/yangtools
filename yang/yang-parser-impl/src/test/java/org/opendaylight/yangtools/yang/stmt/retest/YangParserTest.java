...
import org.opendaylight.yangtools.yang.parser.stmt.rfc6020.effective.type.base.DerivedType;
...
public class YangParserTest {
    ...
    public void testParseList() {
        ...
        assertTrue(ifIndex.getType() instanceof UInt32BaseType);
        LeafSchemaNode ifMtu = (LeafSchemaNode) ifEntry.getDataChildByName("ifMtu");
        assertTrue(ifMtu.getType() instanceof Int32BaseType);
    }
    ...
    public void testTypedefRangesResolving() throws ParseException {
        ...
        DerivedType leafType = (DerivedType) int32Leaf.getType();
        ...
        DerivedType baseType = (DerivedType) leafType.getBaseType();
        ...
        DerivedType base = (DerivedType) baseType.getBaseType();
        ...
        assertTrue(base.getBaseType() instanceof Int32BaseType);
    }
    ...
    public void testTypedefPatternsResolving() {
        ...
        YangBaseType type = (DerivedType) stringleaf.getType();
        ...
        DerivedType baseType1 = (DerivedType) type.getBaseType();
        ...
        DerivedType baseType2 = (DerivedType) baseType1.getBaseType();
        ...
        DerivedType baseType3 = (DerivedType) baseType2.getBaseType();
        ...
        assertTrue(baseType3.getBaseType() instanceof StringBaseType);
    }
    ...
    public void testTypedefInvalidPatternsResolving() {
        ...
        YangBaseType type = (DerivedType) invalidPatternStringLeaf.getType();
        QName typeQName = type.getQName();
        ...
        type = (StringBaseType) invalidDirectStringPatternDefLeaf.getType();
        ...
        type = (DerivedType) multiplePatternStringLeaf.getType();
        typeQName = type.getQName();
        ...
        type = (DerivedType) multiplePatternDirectStringDefLeaf.getType();
        typeQName = type.getQName();
        assertEquals("string", typeQName.getLocalName());
        assertEquals(fooNS, typeQName.getNamespace());
        assertEquals(fooRev, typeQName.getRevision());
    ...
    public void testTypedefLengthsResolving() {
        ...
        YangBaseType type = (DerivedType) lengthLeaf.getType();
        ...
        assertTrue(baseType2.getBaseType() instanceof StringBaseType);
    }
    ...
    public void testTypedefDecimal1() {
        ...
        YangBaseType type = (DerivedType) testleaf.getType();
        QName typeQName = type.getQName();
        ...
        YangBaseType typeBase = (DerivedType) type.getBaseType();
        ...
        Decimal64BaseType decimal = (Decimal64BaseType) typeBase.getBaseType();
    ...
    public void testTypedefDecimal2() {
        ...
        Decimal64BaseType baseTypeDecimal = (Decimal64BaseType) type.getBaseType();
    ...
    public void testTypedefUnion() {
        ...
        YangBaseType type = (DerivedType) unionleaf.getType();
        QName typeQName = type.getQName();
        ...
        DerivedType baseType = (DerivedType) type.getBaseType();
        QName baseTypeQName = baseType.getQName();
        ...
        DerivedType unionType = (DerivedType) baseType.getBaseType();
        List<TypeDefinition<?>> unionTypes = unionType.getTypes();
        assertEquals(2, unionTypes.size());

        DerivedType unionType1 = (DerivedType) unionTypes.get(0);
        ...
        assertTrue(unionType1.getBaseType() instanceof Int16BaseType);

        assertTrue(unionTypes.get(1) instanceof Int32BaseType);
    }
    ...
    public void testNestedUnionResolving() {
        ...
        DerivedType union = (DerivedType) typeBase.getBaseType();
        List<TypeDefinition<?>> unionTypes = union.getTypes();
        assertEquals(2, unionTypes.size());
        assertTrue(unionTypes.get(0) instanceof Int32BaseType);
        assertTrue(unionTypes.get(1) instanceof DerivedType);

        DerivedType unionType1 = (DerivedType) unionTypes.get(1);
        ...
        DerivedType nestedUnion = (DerivedType) unionType1.getBaseType();
        List<TypeDefinition<?>> nestedUnion2Types = nestedUnion.getTypes();
        assertEquals(2, nestedUnion2Types.size());
        assertTrue(nestedUnion2Types.get(0) instanceof StringBaseType);
        assertTrue(nestedUnion2Types.get(1) instanceof DerivedType);

        DerivedType myUnionExt = (DerivedType) nestedUnion2Types.get(1);
        ...
        DerivedType myUnion = (DerivedType) myUnionExt.getBaseType();
        ...
        DerivedType myUnionBase = (DerivedType) myUnion.getBaseType();
        List<TypeDefinition<?>> myUnionBaseTypes = myUnionBase.getTypes();
        assertEquals(2, myUnionBaseTypes.size());
        assertTrue(myUnionBaseTypes.get(0) instanceof DerivedType);
        assertTrue(myUnionBaseTypes.get(1) instanceof Int32BaseType);

        DerivedType int16Ext = (DerivedType) myUnionBaseTypes.get(0);
        ...
        assertTrue(int16Ext.getBaseType() instanceof Int16BaseType);
    }
    ...
    public void testNotification() {
        ...
        assertTrue(eventClass.getType() instanceof StringBaseType);
        LeafSchemaNode severity = (LeafSchemaNode) notification.getDataChildByName("severity");
        assertTrue(severity.getType() instanceof StringBaseType);
    }
    ...
    public void testTypePath() throws ParseException {
        ...
        // int32-ext1
        DerivedType int32ext1 = (DerivedType) TestUtils.findTypedef(types, "int32-ext1");
        ...
        // int32-ext1/int32
        Int32BaseType int32 = (Int32BaseType) int32ext1.getBaseType();
        assertEquals(Int32BaseType.getInstance(), int32);
    }
    ...
    public void testTypePath2() throws ParseException {
        ...
        // my-decimal-type
        DerivedType myDecType = (DerivedType) TestUtils.findTypedef(types, "my-decimal-type");
        ...
        Decimal64BaseType dec64 = (Decimal64BaseType) myDecType.getBaseType();
    ...
    /*
     * @Test public void testSorting() throws Exception { // Correct order: m2,
     * m4, m6, m8, m7, m6, m3, m1 File yangFile = new
     * File(getClass().getResource("/sorting-test/m1.yang").toURI()); File
     * dependenciesDir = new
     * File(getClass().getResource("/sorting-test").toURI()); YangContextParser
     * parser = new YangParserImpl(); modules = parser.parseFile(yangFile,
     * dependenciesDir).getModules(); SchemaContext ctx = new
     * SchemaContextImpl(modules, Collections.<ModuleIdentifier, String>
     * emptyMap()); checkOrder(modules); assertSetEquals(modules,
     * ctx.getModules());
     *
     * // ########## parser = new YangParserImpl(); final File testDir =
     * dependenciesDir; final String[] fileList = testDir.list(); final
     * List<File> testFiles = new ArrayList<>(); if (fileList == null) { throw
     * new FileNotFoundException(dependenciesDir.getAbsolutePath()); } for
     * (String fileName : fileList) { testFiles.add(new File(testDir,
     * fileName)); } Set<Module> newModules =
     * parser.parseFiles(testFiles).getModules(); assertSetEquals(newModules,
     * modules); ctx = new SchemaContextImpl(newModules,
     * Collections.<ModuleIdentifier, String> emptyMap());
     * assertSetEquals(newModules, ctx.getModules()); // ########## newModules =
     * parser.parseFiles(testFiles, null).getModules();
     * assertSetEquals(newModules, modules); ctx = new
     * SchemaContextImpl(newModules, Collections.<ModuleIdentifier, String>
     * emptyMap()); assertSetEquals(newModules, ctx.getModules()); // ##########
     * List<InputStream> streams = new ArrayList<>(); for (File f : testFiles) {
     * streams.add(new FileInputStream(f)); } newModules =
     * parser.parseSources(BuilderUtils
     * .filesToByteSources(testFiles)).getModules(); assertSetEquals(newModules,
     * modules); ctx = new SchemaContextImpl(newModules,
     * Collections.<ModuleIdentifier, String> emptyMap());
     * assertSetEquals(newModules, ctx.getModules()); // ##########
     * streams.clear(); for (File f : testFiles) { streams.add(new
     * FileInputStream(f)); } newModules =
     * parser.parseSources(BuilderUtils.filesToByteSources(testFiles),
     * null).getModules(); assertSetEquals(newModules, modules); ctx = new
     * SchemaContextImpl(newModules, Collections.<ModuleIdentifier, String>
     * emptyMap()); assertSetEquals(newModules, ctx.getModules()); // ##########
     ...
     * emptyMap()); assertSetEquals(newModules, ctx.getModules()); // ##########
     * streams.clear(); for (File f : testFiles) { streams.add(new
     * FileInputStream(f)); } Map<InputStream, Module> mappedStreams =
     * parser.parseYangModelsFromStreamsMapped(streams); newModules = new
     * LinkedHashSet<>(mappedStreams.values()); assertSetEquals(newModules,
     * modules); ctx = new SchemaContextImpl(newModules,
     * Collections.<ModuleIdentifier, String> emptyMap());
     * assertSetEquals(newModules, ctx.getModules()); }
     */
    ...
    public void unknownStatementsInStatementsTest() throws IOException, URISyntaxException {
        ...
        File yangSubModule = new File(getClass().getResource("/yang-grammar-test/stmtsep-in-statements-sub.yang")
                .toURI());
