...
public class YangParserTest {
    ...
    public void testTypedefRangesResolving() throws ParseException {
        ...
        IntegerTypeDefinition base = baseType.getBaseType().getBaseType();
        ...
        assertEquals(BaseTypes.int32Type(), base.getBaseType().getBaseType());
    }
    ...
    public void testTypedefPatternsResolving() {
        ...
        StringTypeDefinition baseType3 = baseType2.getBaseType().getBaseType();
        ...
        assertEquals(BaseTypes.stringType(), baseType3.getBaseType().getBaseType());
    }
    ...
    public void testTypedefLengthsResolving() {
        ...
        assertEquals(BaseTypes.stringType(), baseType2.getBaseType().getBaseType());
    }
    ...
    public void testTypePath() throws ParseException {
        ...
        // int32-ext1/int32
        IntegerTypeDefinition int32 = int32ext1.getBaseType().getBaseType();
