...
public class Bug4231Test {
    ...
    public void test() throws Exception {
        ...
        QNameModule foo = QNameModule.create(new URI("foo"), Revision.forString("2015-09-02"));

        SchemaPath targetPath = SchemaPath.create(true, QName.create(foo, "augment-target"))
