...
public class SchemaContextFactoryDeviationsTest {
    private static final String FOO = "/bugs/bug8307/foo.yang";
    private static final String BAR = "/bugs/bug8307/bar.yang";
    private static final String BAZ = "/bugs/bug8307/baz.yang";
    private static final String FOOBAR = "/bugs/bug8307/foobar.yang";
    private static final String BAR_INVALID = "/bugs/bug8307/bar-invalid.yang";
    private static final String BAZ_INVALID = "/bugs/bug8307/baz-invalid.yang";
