...
public class YangParserNegativeTest {
    ...
    public void testInvalidImport() throws Exception {
        ...
        try {
            ...
            assertEquals("Imported module [ModuleIdentifierImpl{name='some-module', namespace=null, revision=Wed Feb 27 00:00:00 CET 2013}] was not found.", suppressed2levelsDown.getMessage());
        }
    }
    ...
    public void testTypeNotFound() throws Exception {
        ...
        try {
            ...
            assertEquals(e.getMessage(),
                    "Typedef (urn:simple.types.data.demo?revision=2013-02-27)int-ext not found");
        }
    }
    ...
    public void testInvalidRefine() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains("Error in module 'test4' in the refine of uses 'Relative{path=[(urn:simple.container.demo?revision=1970-01-01)node]}': can not perform refine of 'PRESENCE' for the target 'LEAF_LIST'."));
        }
    }
