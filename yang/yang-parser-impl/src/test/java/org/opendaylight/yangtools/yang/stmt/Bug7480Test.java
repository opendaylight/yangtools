...
public class Bug7480Test {
    ...
    @Test
    public void missingRelevantImportTest() throws SourceException, FileNotFoundException, ReactorException, URISyntaxException,
            ParseException {
        StmtTestUtils.parseYangSources("/bugs/bug7480/files", "/bugs/bug7480/lib-2");
    }
}
