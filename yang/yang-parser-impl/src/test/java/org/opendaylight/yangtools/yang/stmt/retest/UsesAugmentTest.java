...
public class UsesAugmentTest {
     ...
     *
     * notification pcreq |-- leaf version (U) |-- leaf type (U) |-- list
     * requests |-- |-- container rp |-- |-- |-- leaf priority (U) |-- |-- |--
     * container box (U) |-- |-- |-- |-- container order (A) |-- |-- |-- |-- |--
     * leaf delete (U) |-- |-- |-- |-- |-- |-- leaf setup (U) |-- |-- |-- leaf
     * processing-rule (U) |-- |-- |-- leaf ignore (U) |-- |--
     * path-key-expansion |-- |-- |-- container path-key |-- |-- |-- |-- list
     * path-keys (U) |-- |-- |-- |-- |-- leaf version (U) |-- |-- |-- |-- |--
     * leaf type (U) |-- |-- |-- |-- |-- leaf processing-rule (U) |-- |-- |--
     * |-- |-- leaf ignore (U) |-- |-- container segment-computation |-- |-- |--
     * container p2p |-- |-- |-- |-- container endpoints |-- |-- |-- |-- |--
     * leaf processing-rule (U) |-- |-- |-- |-- |-- leaf ignore (U) |-- |-- |--
     * |-- |-- container box (U) |-- |-- |-- |-- |-- choice address-family (U)
     * |-- |-- |-- |-- |-- |-- case ipv4 |-- |-- |-- |-- |-- |-- |-- leaf
     * source-ipv4-address |-- |-- |-- |-- |-- |-- case ipv6 |-- |-- |-- |-- |--
     * |-- |-- leaf source-ipv6-address |-- |-- |-- |-- container reported-route
     * |-- |-- |-- |-- |-- container bandwidth |-- |-- |-- |-- |-- list
     * subobjects(U) |-- |-- |-- |-- |-- leaf processing-rule (U) |-- |-- |--
     * |-- |-- leaf ignore (U) |-- |-- |-- |-- container bandwidth (U) |-- |--
     * |-- |-- |-- container bandwidth (U) |-- |-- |-- |-- |-- leaf
     * processing-rule (U) |-- |-- |-- |-- |-- leaf ignore (U) |-- list svec |--
     * |-- list metric |-- |-- |-- leaf metric-type (U) |-- |-- |-- container
     * box (U) |-- |-- |-- leaf processing-rule (U) |-- |-- |-- leaf ignore (U)
     * |-- |-- leaf link-diverse (U) |-- |-- leaf processing-rule (U) |-- |--
     * leaf ignore (U)
     *
    ...
    public void testAugmentInUses() throws Exception {
        ...
        assertEquals(UInt8BaseType.getInstance(), version.getType().getBaseType());
        ...
        DerivedType union = (DerivedType) type.getType().getBaseType();
        assertEquals(SchemaPath.create(true, QName.create(YangConstants.RFC6020_YANG_MODULE, TypeUtils.UNION)),
                union.getPath());
        ...
        assertEquals(BooleanBaseType.getInstance(), processingRule.getType());
        ...
        assertEquals(BooleanBaseType.getInstance(), ignore.getType());
        ...
        assertEquals(UInt8BaseType.getInstance(), priority.getType().getBaseType());
        ...
        assertEquals(UInt32BaseType.getInstance(), delete.getType());
        ...
        assertEquals(UInt32BaseType.getInstance(), setup.getType());
        ...
        expectedPath = SchemaPath.create(path, true);
        assertEquals(expectedPath, version.getPath());
        assertTrue(version.getType() instanceof DerivedType);
        assertEquals(UInt8BaseType.getInstance(), version.getType().getBaseType());
        assertTrue(version.isAddedByUses());
        ...
        expectedPath = SchemaPath.create(path, true);
        assertEquals(expectedPath, type.getPath());
        assertTrue(type.getType() instanceof DerivedType);
        assertTrue(type.isAddedByUses());
        ...
        assertEquals(BooleanBaseType.getInstance(), linkDiverse.getType());
        ...
        assertEquals(UInt8BaseType.getInstance(), metricType.getType());
    ...
    public void testTypedefs() throws URISyntaxException, SourceException, ReactorException {
        ...
        DerivedType union = (DerivedType) intExt.getBaseType();
        ...
        QName q1 = QName.create(YangConstants.RFC6020_YANG_MODULE, TypeUtils.UNION);
