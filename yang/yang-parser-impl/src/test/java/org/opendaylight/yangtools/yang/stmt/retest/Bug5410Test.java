...
public class Bug5410Test {
    ...
    @Test
    public void testCaretAndDollarEscaping() throws ReactorException, FileNotFoundException, URISyntaxException {
        ...
        // case 4
        leaf = (LeafSchemaNode) module.getDataChildByName(
                QName.create(module.getQNameModule(), "test-leaf4"));
        assertNotNull(leaf);
