...
public class LeafRefContextTest {
    ...
    YangSyntaxErrorException {
        ...
        File resourceFile = new File(LeafRefContextTreeBuilderTest.class.getResource(
                "/leafref-context-test/leafrefcontext_test/main.yang")
                .toURI());
    ...
    public void test() {
        ...
        Map<QName, LeafRefContext> leafRefs = LeafRefContextUtils.getAllLeafRefsReferencingThisNode(name1Node, rootLeafRefContext);
