...
public class StatementTest2 {
    ...
    private static final QNameModule coverageModule = QNameModule.create(URI.create("parser-impl-test2-ns"),
    ...
    private static ContainerSchemaNode cont1Node;

    @BeforeClass
    public static void setUp() throws ReactorException {

        YangStatementSourceImpl testYang1 = new YangStatementSourceImpl("/parser-impl-test/parser-impl-test2.yang",
                false);
        YangStatementSourceImpl testYang2 = new YangStatementSourceImpl(
                "/parser-impl-test/parser-impl-test2-submod.yang", false);
        YangStatementSourceImpl testYang3 = new YangStatementSourceImpl(
                "/parser-impl-test/parser-impl-test2-import.yang", false);
        ...
        for (final Module module : modules) {
            if (module.getName().equals("parser-impl-test2")) {
        ...
        assertEquals("parser-impl-test2-submod", cov2Submod.getName());

        cont1Node = (ContainerSchemaNode) moduleCoverage2.getDataChildByName(cont1QName);
    ...
    public void testImport() {
        ...
        assertEquals("parser-impl-test2-import", imports.iterator().next().getModuleName());
        assertTrue(imports.iterator().next().toString().contains("parser-impl-test2-import"));
    }
    ...
    @Test
    public void testRpcAndInputOutput() {
    ...
    public void testDeviation() {
        ...
        assertEquals(SchemaPath.create(true, choice1QName), deviation1.getTargetPath());
    ...
    @Test
    public void testGroupingAndRefine() {
    ...
    @Test
    public void testLeafListAndConstraints() {
