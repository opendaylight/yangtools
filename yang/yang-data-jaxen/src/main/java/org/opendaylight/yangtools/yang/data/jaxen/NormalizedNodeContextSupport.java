...
final class NormalizedNodeContextSupport extends ContextSupport {
    ...
    NormalizedNodeContextSupport(final JaxenNamespaceContext context, final NormalizedNodeNavigator navigator) {
        super(context.getContext(), YangFunctionContext.getInstance(), new SimpleVariableContext(), navigator);
