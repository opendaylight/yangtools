 ...
 */
public final class YangNamespaceContext implements NamespaceContext {
    private final NormalizedNodeNavigator navigator = new NormalizedNodeNavigator(this);
    ...
    public XPath parseXPath(final String xpath) throws JaxenException {
        return new YangXPath(xpath, navigator);
    }
