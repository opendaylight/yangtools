...
final class TestUtils {
    ...
    private static final QName FOO_QNAME = QName.create(ROOT_QNAME, "foo");
    private static final QName BAR_QNAME  = QName.create(ROOT_QNAME, "bar");
    private static final QName BAZ_QNAME  = QName.create(ROOT_QNAME, "baz");
    ...
    public static NormalizedNode<?, ?> createNormalizedNodes() {
        return ImmutableContainerNodeBuilder
                ...
                .withChild(ImmutableContainerNodeBuilder.create()
                           .withNodeIdentifier(new YangInstanceIdentifier.NodeIdentifier(FOO_QNAME))
                           .withChild(ImmutableContainerNodeBuilder.create().
                                      withNodeIdentifier(new YangInstanceIdentifier.NodeIdentifier(BAR_QNAME))
                                      .withChild(ImmutableNodes.leafNode(BAZ_QNAME, "value baz"))
                                      .build()
                                      )
                           .build()
                           )
