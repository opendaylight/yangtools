 ...
 */
package org.opendaylight.yangtools.amend.model.api;
...
/**
 * Constants associated with OpenDaylight extension in odl-amend.yang.
 *
 * @author Robert Varga
 */
public final class AmendConstants {
    private static final String MODULE_NAME = "id-amend";
    private static final URI MODULE_NAMESPACE = URI.create("urn:opendaylight:yang:extension:amend");
    private static final Revision ORIGINAL_REVISION = Revision.of("2018-04-01");
