...
@Beta
public enum AmendStatements implements StatementDefinition {
    AMEND(QName.create(AmendConstants.ORIGINAL_MODULE, "amend"),
        "target-statement", AmendStatement.class, AmendEffectiveStatement.class);
    ...
    AmendStatements(final QName statementName, final String argumentName,
