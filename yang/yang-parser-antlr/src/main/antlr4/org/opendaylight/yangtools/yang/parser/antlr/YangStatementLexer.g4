...
// RFC6020 working with CR/LF clarifications -- and allow quotes to appear
// in the body of a string. We additionally exclude SEMICOLON, so as to prefer
// IDENTIFIER tokenization -- which allows us to make keyword work properly.
