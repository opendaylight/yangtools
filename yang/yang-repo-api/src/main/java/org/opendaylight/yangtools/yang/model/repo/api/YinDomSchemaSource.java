...
public abstract class YinDomSchemaSource implements YinXmlSchemaSource {
    ...
    private static final String MODULE_ARG =
        MODULE.getArgumentDefinition().orElseThrow().getArgumentName().getLocalName();
    private static final String REVISION_ARG =
        REVISION.getArgumentDefinition().orElseThrow().getArgumentName().getLocalName();
