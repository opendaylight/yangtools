...
public abstract class SupportedFeatureSet implements Immutable {
    private static final class Explicit extends SupportedFeatureSet {
    ...
    public static @NonNull SupportedFeatureSet of() {
        return new Explicit(ImmutableSet.of());
    }

    public static @NonNull SupportedFeatureSet of(final QName... features) {
        return new Explicit(ImmutableSet.copyOf(features));
    }

    public static @NonNull SupportedFeatureSet of(final Set<QName> features) {
        return new Explicit(ImmutableSet.copyOf(features));
    }
