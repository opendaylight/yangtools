...
public final class GeneratedFileType {
     ...
     */
    public static final @NonNull GeneratedFileType RESOURCE = new GeneratedFileType("resource");

    /**
     * A generated source file. This file should be part of main compilation unit.
     */
    public static final @NonNull GeneratedFileType SOURCE = new GeneratedFileType("source");

    /**
     * A generated test resource file. This file should be part of test resources.
     */
    public static final @NonNull GeneratedFileType TEST_RESOURCE = new GeneratedFileType("test-resource");

    /**
     * A generated test source file. This file should be part of test sources.
     */
    public static final @NonNull GeneratedFileType TEST_SOURCE = new GeneratedFileType("test-source");
    ...
    public static @NonNull GeneratedFileType create(final String name) {
        checkArgument(!name.isEmpty());
        final GeneratedFileType wellKnown = WELL_KNOWN.get(name);
