 ...
 */
@Beta
// FIXME: adopt YangInstanceIdentifier hierarchy and a cache
public final class GeneratedFilePath implements Identifier {
    ...
    public static GeneratedFilePath create(final List<String> components) {
        checkArgument(!components.isEmpty(), "Need at least one component");
    ...
    public @NonNull GeneratedFilePath child(final String component) {
        return new GeneratedFilePath(ImmutableList.<String>builderWithExpectedSize(components.size() + 1)
