...
public final class CopiedStmtContext<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    static {
        ...
        try {
            SCHEMA_PATH = lookup.findVarHandle(CopiedStmtContext.class, "schemaPath", Object.class);
            CONFIGURATION = lookup.findVarHandle(CopiedStmtContext.class, "configuration", byte.class);
            IGNORE_CONFIG = lookup.findVarHandle(CopiedStmtContext.class, "ignoreConfig", byte.class);
            IGNORE_IF_FEATURE = lookup.findVarHandle(CopiedStmtContext.class, "ignoreIfFeature", byte.class);
