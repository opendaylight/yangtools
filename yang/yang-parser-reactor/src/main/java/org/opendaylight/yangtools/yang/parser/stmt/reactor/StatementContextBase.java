...
public abstract class StatementContextBase<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    @Override
    final StatementContextBase<A, D, E> asEffectiveChildOf(final StatementContextBase<?, ?, ?> parent,
    ...
    private @NonNull StatementContextBase<A, D, E> copyAsChildOf(final @NonNull StatementContextBase<A, D, E> current,
    ...
    @Override
    public final StatementContextBase<A, D, E> withParent(final Parent parent, final CopyType copyType,
            final QNameModule targetModule) {
        verify(parent instanceof StatementContextBase, "Unexpected parent %s", parent);
        return ((StatementContextBase<?, ?, ?>)parent).childCopyOf(this, copyType, targetModule, false);
    }
