...
final class InferredStatementContext<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    private @NonNull E createEffectiveCopy(final StatementFactory<A, D, E> factory) {
        ...
        final StatementContextBase<A, D, E> effective = prototype.asEffectiveChildOf(parent, childCopyType,
            targetModule);
        return effective == this ? super.createEffective(factory) : createEffective(factory, effective);
    }
