...
final class InferredStatementContext<A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>>
    ...
    public <D extends DeclaredStatement<QName>, E extends EffectiveStatement<QName, D>>
        ...
        final Optional<? extends StmtContext<?, ?, ?>> optTemplate = prototype.findSubstatementWithArgument(
            SchemaTreeEffectiveStatement.class, templateQName);
        ...
        final StmtContext<?, ?, ?> template = optTemplate.orElseThrow();
