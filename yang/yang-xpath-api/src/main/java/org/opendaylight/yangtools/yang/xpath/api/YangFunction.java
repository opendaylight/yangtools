...
public enum YangFunction implements Identifiable<QName> {
    ...
    // FIXME: this really should be a part of #POSITION ...
    public static final YangFunctionCallExpr POSITION_EXPR = YangFunctionCallExpr.of(
        YangFunction.POSITION.getIdentifier());
