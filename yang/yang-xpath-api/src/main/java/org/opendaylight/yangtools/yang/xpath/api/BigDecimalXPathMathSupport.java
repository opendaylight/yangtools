...
final class BigDecimalXPathMathSupport extends AbstractYangXPathMathSupport<BigDecimalNumberExpr> {
    ...
    @Override
    BigDecimalNumberExpr doNegateNumber(final BigDecimalNumberExpr number) {
        return BigDecimalNumberExpr.of(number.getNumber().negate());
    }

    @Override
    YangExpr doEvaluate(final YangBinaryOperator operator, final BigDecimalNumberExpr left,
