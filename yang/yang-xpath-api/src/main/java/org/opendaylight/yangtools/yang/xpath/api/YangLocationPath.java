...
public class YangLocationPath implements YangExpr {
    ...
    private static class Absolute extends YangLocationPath {
        private static final long serialVersionUID = 1L;
    ...
    private static final long serialVersionUID = 1L;
    private static final YangLocationPath ROOT_LOCATION = new Absolute();
    private static final YangLocationPath SAME_LOCATION = new YangLocationPath();
    ...
    public static final YangLocationPath of(final boolean absolute) {
        return absolute ? ROOT_LOCATION : SAME_LOCATION;
    }
    ...
    public static final YangLocationPath of(final boolean absolute, final List<Step> steps) {
        if (steps.isEmpty()) {
            return of(absolute);
        }
     ...
     */
    public static YangLocationPath same() {
