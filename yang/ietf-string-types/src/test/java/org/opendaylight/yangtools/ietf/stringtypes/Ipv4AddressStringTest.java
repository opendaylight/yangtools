...
public class Ipv4AddressStringTest {
    ...
    private static void checkString(final String addr, final String zone, final int bits) {
        ...
        final Ipv4AddressString val = Ipv4AddressStringSupport.getInstance().fromString(canonical);
        ...
        final Ipv4AddressString second = Ipv4AddressStringSupport.getInstance().fromString(canonical);
