...
public class Ipv4AddressStringTest {
    ...
    private static void checkString(final String addr, final String zone, final int bits) {
        ...
        assertSame(val, Ipv4AddressStringSupport.getInstance().validateRepresentation(val).getFirst());
        assertSame(val, Ipv4AddressStringSupport.getInstance().validateRepresentation(val, canonical).getFirst());
    ...
    private static void checkNoZoneString(final String canonical, final int bits) {
        ...
        assertSame(val, Ipv4AddressNoZoneStringValidator.getInstance().validateRepresentation(val).getFirst());
