...
@NonNullByDefault
@ThreadSafe
public final class DottedQuadStringSupport extends AbstractDerivedStringSupport<DottedQuadString> {
    ...
    @Override
    public DottedQuadString fromString(final String str) {
        ...
        return DottedQuadString.valueOf((Inet4Address) address);
    }
}
