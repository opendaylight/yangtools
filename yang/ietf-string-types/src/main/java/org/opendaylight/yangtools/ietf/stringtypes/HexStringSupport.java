...
@NonNullByDefault
@ThreadSafe
public final class HexStringSupport extends AbstractDerivedStringSupport<HexString> {
    ...
    @Override
    public HexString fromCanonicalString(final String str) {
        if (str.isEmpty()) {
        ...
        return HexString.valueOf(bytes);
    }

    @Override
    public HexString fromString(final String str) {
        final int strlen = str.length();
