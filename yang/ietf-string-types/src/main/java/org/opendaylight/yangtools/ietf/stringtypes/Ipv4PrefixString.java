...
public class Ipv4PrefixString extends DerivedString<Ipv4PrefixString> {
    ...
    public final Ipv4AddressString getAddressString() {
        return Ipv4AddressString.valueOf(address);
    }
    ...
    public final String toCanonicalString() {
        ...
        if (local != 0) {
            return StringTypeUtils.appendDottedQuad(local, address).toString();
        }

        final String ret = StringTypeUtils.appendDottedQuad(18, address).toString();
