...
@NonNullByDefault
@ThreadSafe
public final class Ipv6PrefixStringSupport extends AbstractDerivedStringSupport<Ipv6PrefixString> {
    ...
    @Override
    public Ipv6PrefixString fromString(final String str) {
        ...
        return Ipv6PrefixString.valueOf((Inet6Address) address, (byte)length);
    }
}
