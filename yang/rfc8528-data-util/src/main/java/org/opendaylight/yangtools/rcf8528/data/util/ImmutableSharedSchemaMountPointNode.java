...
@Beta
public final class ImmutableSharedSchemaMountPointNode extends AbstractIdentifiable<MountPointIdentifier>
        implements SharedSchemaMountpointNode {
    private final @NonNull ContainerNode delegate;

    public ImmutableSharedSchemaMountPointNode(final @NonNull MountPointIdentifier identifier,
