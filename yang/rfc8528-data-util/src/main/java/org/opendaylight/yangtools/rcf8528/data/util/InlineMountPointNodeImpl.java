...
@Beta
public final class InlineMountPointNodeImpl extends AbstractIdentifiableSchemaContextProvider<MountPointIdentifier>
        implements InlineMountpointNode {
    private final @NonNull ContainerNode delegate;

    public InlineMountPointNodeImpl(final @NonNull SchemaContext schemaContext,
