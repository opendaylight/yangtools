...
@Beta
public final class ImmutableInlineMountPointNode extends AbstractIdentifiableSchemaContextProvider<MountPointIdentifier>
        implements InlineMountpointNode {
    private final @NonNull ContainerNode delegate;

    public ImmutableInlineMountPointNode(final @NonNull SchemaContext schemaContext,
            final @NonNull MountPointIdentifier identifier, final @NonNull ContainerNode delegate) {
