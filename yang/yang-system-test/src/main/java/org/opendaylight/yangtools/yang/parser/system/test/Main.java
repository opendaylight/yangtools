...
public class Main {
     ...
     * mvn exec:java -Dexec.mainClass="org.opendaylight.yangtools.yang.parser.system.test.Main" -Dexec.args="./src/main/yang"
     * mvn exec:java -Dexec.args="./src/main/yang"
    ...
    public static void main(final String[] args) throws SourceException, FileNotFoundException, ReactorException,
        ...
        System.out.println(yangDirPath);
        System.out.println(YangParserUtils.parseYangSources(yangDirPath));
    }
}
