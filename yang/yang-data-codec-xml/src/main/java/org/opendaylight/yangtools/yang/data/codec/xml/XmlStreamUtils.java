...
public class XmlStreamUtils {
    ...
    public static XmlStreamUtils create(final SchemaContext schemaContext) {
    ...
    public void writeInstanceIdentifier(final XMLStreamWriter writer, final YangInstanceIdentifier value)
