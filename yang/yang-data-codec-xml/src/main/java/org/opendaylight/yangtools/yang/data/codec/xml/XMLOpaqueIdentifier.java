...
@Beta
@NonNullByDefault
public final class XMLOpaqueIdentifier extends AbstractOpaqueIdentifier implements NamespaceAware, WritableObject {
    ...
    protected boolean subclassEquals(final OpaqueIdentifier other) {
        return other instanceof XMLOpaqueIdentifier
                && namespace.equals(((XMLOpaqueIdentifier) other).getNamespace());
    }
