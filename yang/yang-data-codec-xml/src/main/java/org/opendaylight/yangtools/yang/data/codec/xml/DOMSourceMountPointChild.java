 ...
 */
@NonNullByDefault
final class DOMSourceMountPointChild extends AbstractMountPointChild implements MountPointChild {
    ...
    @Override
    public void streamTo(final NormalizedNodeStreamWriter writer, final SchemaContext schemaContext)
            throws IOException {
