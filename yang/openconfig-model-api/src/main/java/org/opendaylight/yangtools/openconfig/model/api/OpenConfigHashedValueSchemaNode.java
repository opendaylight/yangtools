...
public interface OpenConfigHashedValueSchemaNode extends UnknownSchemaNode {
     ...
     */
    static boolean isPresentIn(final SchemaNode parent) {
        return parent.getUnknownSchemaNodes().stream().anyMatch(OpenConfigHashedValueSchemaNode.class::isInstance);
    }
}
