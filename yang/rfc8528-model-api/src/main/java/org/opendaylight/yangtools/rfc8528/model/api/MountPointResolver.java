...
@Beta
@NonNullByDefault
public interface MountPointResolver {
    /**
    ...
    Optional<? extends MountPointStrategy> resolveLabel(QName label);

    /**
     * Return a {@link MountPointResolver} which reports every label as undefined.
     *
     * @return A resolver instance
     */
    static MountPointResolver noop() {
