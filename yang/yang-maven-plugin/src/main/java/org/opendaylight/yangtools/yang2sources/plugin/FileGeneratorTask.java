...
final class FileGeneratorTask extends GeneratorTask {
    ...
    private FileGeneratorTask(final FileGenerator gen, final FileGeneratorArg arg) {
    ...
    static FileGeneratorTask of(final FileGeneratorFactory factory, final FileGeneratorArg arg)
        ...
        return new FileGeneratorTask(factory.newFileGenerator(arg.getConfiguration()), arg);
    }
