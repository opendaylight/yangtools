...
final class BuildInfo implements Immutable, Serializable {
    ...
    final ImmutableTable<GeneratedFileKind, GeneratedFilePath, GeneratedFileLifecycle> outputFiles;
    final ImmutableMap<String, InputFile> inputFiles;

    private BuildInfo(final Map<String, InputFile> inputFiles,
            final Table<GeneratedFileKind, GeneratedFilePath, GeneratedFileLifecycle> outputFiles) {
    ...
    static BuildInfo create(final Collection<File> inputFiles,
            final Table<GeneratedFileKind, GeneratedFilePath, GeneratedFile> outputFiles) {
