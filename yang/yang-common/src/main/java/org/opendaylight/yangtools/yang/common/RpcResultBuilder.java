...
public class RpcResultBuilder<T> {
    ...
    public static <T> RpcResultBuilder<T> from( RpcResult<T> other ) {
        RpcResultBuilder<T> builder = new RpcResultBuilder<T>( other.isSuccessful(),
                                                               other.getResult() );
        builder.errors = new ImmutableList.Builder<RpcError>();
        builder.errors.addAll( other.getErrors() );
        return builder;
    }
