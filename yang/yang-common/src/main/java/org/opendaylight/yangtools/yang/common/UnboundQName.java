...
@Beta
@NonNullByDefault
public final class UnboundQName extends AbstractQName implements Comparable<UnboundQName> {
     ...
     */
    public static UnboundQName readFrom(final DataInput in) throws IOException {
        return new UnboundQName(checkLocalName(in.readUTF()));
    }
    ...
    public UnboundQName intern() {
        ...
        final UnboundQName template = internedName == name ? this : new UnboundQName(internedName);
        return INTERNER.intern(template);
    }

    @Override
    public int compareTo(final UnboundQName o) {
