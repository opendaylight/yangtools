...
public final class Decimal64 extends Number implements Comparable<Decimal64>, Immutable {
    ...
    public static Decimal64 valueOf(final byte b) {
        return b < 0 ? new Decimal64(1, -b, 0, true) : new Decimal64(1, b, 0, false);
    }

    public static Decimal64 valueOf(final short s) {
        return s < 0 ? new Decimal64(1, -s, 0, true) : new Decimal64(1, s, 0, false);
    }

    public static Decimal64 valueOf(final int i) {
        return i < 0 ? new Decimal64(1, -i, 0, true) : new Decimal64(1, i, 0, false);
    }

    public static Decimal64 valueOf(final long l) {
        // XXX: we should be able to do something smarter here
        return valueOf(Long.toString(l));
    }

    public static Decimal64 valueOf(final double d) {
        // XXX: we should be able to do something smarter here
        return valueOf(Double.toString(d));
    }

    public static Decimal64 valueOf(final BigDecimal d) {
        // XXX: we should be able to do something smarter here
        return valueOf(d.toPlainString());
    }
