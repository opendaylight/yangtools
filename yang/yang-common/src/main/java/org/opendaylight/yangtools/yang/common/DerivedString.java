 ...
 *         {@link DerivedStringValidator#validateRepresentation(DerivedString)} to hand out BarDerivedString instances. This
 *         class needs to be a singleton with a getInstance() method, too.</li>
 * </ul>
    ...
    private static final class Validator extends ClassValue<Boolean> {
        ...
        private static void checkFinalMethod(final Class<?> type, final String name) {
            try {
                ...
                throw new IllegalArgumentException(type + " must have a final " + name + "() method");
            }
        }
        ...
        private static void checkFinalMethod(final Class<?> type, final String name, final Class<?> arg) {
            ...
            try {
                ...
                throw new IllegalArgumentException(type + " must have a final " + name + "(" + argName + ") method");
            }
        }
