...
public abstract class CanonicalValueViolation {
    private static final class Regular extends CanonicalValueViolation {
        ...
        @Override
        public IllegalArgumentException toIllegalArgument() {
    ...
    public static final class WithException extends CanonicalValueViolation {
        private final Exception cause;

        public WithException(final Exception cause) {
    ...
    public abstract IllegalArgumentException toIllegalArgument();
