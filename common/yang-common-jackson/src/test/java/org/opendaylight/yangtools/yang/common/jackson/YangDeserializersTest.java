...
public class YangDeserializersTest {
    ...
    public void testFindReferenceDeserializer() throws JsonMappingException {
        assertInstanceOf(Decimal64Deserializer.class,
                YANG_DESERIALIZERS.findReferenceDeserializer(ReferenceType.construct(Decimal64.class,
                                null, null, null, null),
                        null,
                        null,
                        null,
        ...
        assertInstanceOf(YangVersionDeserializer.class,
                YANG_DESERIALIZERS.findReferenceDeserializer(ReferenceType.construct(YangVersion.class,
                                null, null, null, null),
                        null,
                        null,
                        null,
