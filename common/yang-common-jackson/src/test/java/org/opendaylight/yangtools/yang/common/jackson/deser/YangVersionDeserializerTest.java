...
public class YangVersionDeserializerTest {
    ...
    public void testDeserialize() throws JsonProcessingException {
        final String yangVersion11String = "\"1.1\"";
        final String yangVersion1String = "1";

        final SimpleModule simpleModule = new SimpleModule().addDeserializer(YangVersion.class,
        ...
        assertEquals(YangVersion.VERSION_1_1,
                objectMapper.readValue(yangVersion11String, YangVersion.class));
        assertEquals(YangVersion.VERSION_1,
                objectMapper.readValue(yangVersion1String, YangVersion.class));
