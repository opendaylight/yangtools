...
public class DeserializersTest {
    ...
    private static final String COMPLEX_DESERIALIZATION_STRING =
            "{\"decimal64\":\"225.0\",\"empty\":\"[null]\",\"revision\":\"2022-10-18\","
                    + "\"uint8\":156,\"uint16\":156,\"uint32\":156,\"uint64\":\"156\",\"yangVersion\":\"1.1\"}";
    ...
    public void testSerializeComplex() throws JsonProcessingException {
        final MockObjectContainer mockObjectContainer = OBJECT_MAPPER.readValue(
                COMPLEX_DESERIALIZATION_STRING,
                MockObjectContainer.class);
        assertEquals(Decimal64.valueOf("225.0"), mockObjectContainer.getDecimal64());
        assertEquals(Empty.value(), mockObjectContainer.getEmpty());
        assertEquals(Revision.of("2022-10-18"), mockObjectContainer.getRevision());
        assertEquals(Uint8.saturatedOf(156), mockObjectContainer.getUint8());
        assertEquals(Uint16.saturatedOf(156), mockObjectContainer.getUint16());
        assertEquals(Uint32.saturatedOf(156), mockObjectContainer.getUint32());
        assertEquals(Uint64.saturatedOf(156), mockObjectContainer.getUint64());
        assertEquals(YangVersion.VERSION_1_1, mockObjectContainer.getYangVersion());
    }
