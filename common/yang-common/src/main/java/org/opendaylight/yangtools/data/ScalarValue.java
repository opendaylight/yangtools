...
/**
 * An scalar value, corresponding to a {@code leaf} statement.
 */
// FIXME: BooleanValue
...
public sealed interface ScalarValue extends Value
    permits Binary, Bits, Decimal64, Empty, InstanceIdentifier, QName, StringValue, Uint8, Uint16, Uint32, Uint64 {
