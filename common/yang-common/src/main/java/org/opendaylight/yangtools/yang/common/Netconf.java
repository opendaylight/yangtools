...
public final class Netconf {
    ...
    public abstract static class ErrorInfo<T> {
         ...
         */
        public static final class MissingChoice extends ErrorInfo<QName> {
            public static final QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, "missing-choice")
                .intern();

            public MissingChoice(final QName value) {
                super(QNAME, value);
            }
        }
         ...
         */
        public abstract static class AbstractNonUnique<T> extends ErrorInfo<T> {
            public static final QName QNAME = QName.create(YangConstants.RFC6020_YANG_MODULE, "non-unique").intern();

            protected AbstractNonUnique(final T value) {
                super(QNAME, value);
            }
        }
