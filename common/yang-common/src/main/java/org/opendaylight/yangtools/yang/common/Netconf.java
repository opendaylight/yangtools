...
public final class Netconf {
    ...
    public interface EventMetadata {
        ...
        ErrorTag tag();
        /**
         * Return this event's {@code error-message}, if available. This value is expected to be defined in a YANG model
        ...
        /**
         * Return this event's {@code error-app-tag}, if available. This value is expected to be defined in a YANG model
        ...
        /**
         * Return this event's additional info.
         *
         * @return Additional info.
         */
        List<? extends ErrorInfo<?>> info();
    }
    ...
    public abstract static class AbstractEventMetadata implements EventMetadata, Immutable {
        private final List<? extends ErrorInfo<?>> info;
        ...
        protected AbstractEventMetadata(final ErrorSeverity severity, final ErrorType type, final ErrorTag tag) {
            this(severity, type, tag, null, null, List.of());
        }

        protected AbstractEventMetadata(final ErrorSeverity severity, final ErrorType type, final ErrorTag tag,
                final @Nullable String message, final @Nullable String appTag, final List<? extends ErrorInfo<?>> info) {
        ...
        @Override
        public final List<? extends ErrorInfo<?>> info() {
            return info;
        }
        ...
        protected ToStringHelper addToStringAttributes(final ToStringHelper helper) {
            helper.add("severity", severity).add("type", type).add("tag", tag).add("appTag", appTag)
                  .add("message", message);
            if (!info.isEmpty()) {
