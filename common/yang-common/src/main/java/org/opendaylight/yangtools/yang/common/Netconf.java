...
public final class Netconf {
    ...
    public interface ErrorTag extends ElementBodyEquivalent {
        // violation of a value constraint, 8.3.1 bullet 1
        public interface InvalidValue extends ErrorTag {
            @Override
            default String toElementBody() {
                return "invalid-value";
            }
        }

        // missing a mandatory leaf (explicit, or implied by key), 8.3.1 bullet 2, 7.13.2
        public interface MissingElement extends ErrorTag {
            @Override
            default String toElementBody() {
        ...
        public interface BadElement extends ErrorTag {
            @Override
            default String toElementBody() {
                return "bad-element";
            }
        ...
        public interface UnknownElement extends ErrorTag {
            @Override
            default String toElementBody() {
        ...
        public interface OperationFailed extends ErrorTag {
            @Override
            default String toElementBody() {
        ...
        public interface DataMissing extends ErrorTag {
            @Override
            default String toElementBody() {
                return "data-missing";
            }
        ...
        public interface BadAttribute extends ErrorTag {
            @Override
            default String toElementBody() {
                return "bad-attribute";
            }

            // FIXME: QName getBadAttribute()
            // FIXME: QName getBadElement()
        }
    }
