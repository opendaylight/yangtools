...
public final class Netconf {
     ...
     * <a ref="https://datatracker.ietf.org/doc/html/rfc6241#section-10.3">ietf-netconf@2011-06-01.yang</a>
     */
    ...
    public enum Layer {
        ...
        /**
         * Return the {@link ErrorType} corresponding to this layer.
         *
         * @return An {@code error-type}
         */
     ...
     */
    enum ErrorSeverity implements StringElement {
        /**
