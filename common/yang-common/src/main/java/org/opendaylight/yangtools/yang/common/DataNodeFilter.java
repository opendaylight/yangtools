...
@Beta
public final class DataNodeFilter extends AbstractDataTreePath<DataNodeFilter.Step> {
    ...
    private DataNodeFilter(final ImmutableList<Step> steps) {
        super(steps);
    }

    public static @NonNull DataNodeFilter of(final Step step) {
        return of(ImmutableList.of(step));
    }

    public static @NonNull DataNodeFilter of(final Step... steps) {
        return of(ImmutableList.copyOf(steps));
    }

    public static @NonNull DataNodeFilter of(final List<Step> steps) {
        return of(ImmutableList.copyOf(steps));
    }

    public static @NonNull DataNodeFilter of(final ImmutableList<Step> steps) {
        return new DataNodeFilter(steps);
    }
}
