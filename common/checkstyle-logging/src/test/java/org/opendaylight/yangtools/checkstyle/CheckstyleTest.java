...
public class CheckstyleTest {
    ...
    public void testLoggerChecks() throws Exception {
        verify(CheckLoggingTestClass.class, true, "15: error: Logger must be declared as private static final.", "15: error: Logger name should be LOG.",
                "15: error: LoggerFactory.getLogger Class argument is incorrect.",
                "17: error: Logger might be declared only once.", "16: error: Logger must be slf4j.", "22: error: Line contains printStacktrace",
                "23: error: Line contains console output", "24: error: Line contains console output", "26: error: Log message placeholders count is incorrect.",
                "32: error: Log message placeholders count is incorrect", "41: error: Log message contains string concatenation.");
    }

    @Test
    public void testCodingChecks() throws Exception {
        verify(CheckCodingStyleTestClass.class, false, "9: error: Line has Windows line delimiter.", "14: error: Wrong order for", "24:1: error: Line contains a tab character.",
                "22: error: Line has trailing spaces.", "22: error: 'ctor def' child have incorrect indentation level 16, expected level should be 8.", "17:8: error: Unused import",
                "23: error: Line has trailing spaces.");
    }
