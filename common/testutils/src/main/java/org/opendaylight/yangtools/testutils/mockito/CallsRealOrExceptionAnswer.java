 ...
 *
 * <pre>
 * import static ...testutils.mockito.Answers2.REAL_OR_EXCEPTION;
 *
 * interface Service {
 ...
 * }
 *
 * Service fake = Mockito.mock(FakeService.class, REAL_OR_EXCEPTION)
 * </pre>
 *
 * <p>
...
public class CallsRealOrExceptionAnswer implements Answer<Object>, Serializable {
     ...
     */
    protected CallsRealOrExceptionAnswer() {
    }
