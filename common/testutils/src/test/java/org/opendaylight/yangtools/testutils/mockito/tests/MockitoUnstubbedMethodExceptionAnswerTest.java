...
import static org.opendaylight.yangtools.testutils.mockito.ThrowsMethodExceptionAnswer.EXCEPTION_ANSWER;
...
public class MockitoUnstubbedMethodExceptionAnswerTest {
    ...
    public void testAnswering() throws IOException {
        Closeable mock = Mockito.mock(Closeable.class, EXCEPTION_ANSWER);
        try {
            mock.close();
            fail();
