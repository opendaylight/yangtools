...
import static org.opendaylight.yangtools.testutils.mockito.Answers2.REAL_OR_EXCEPTION;
...
public class MikitoTest {
    ...
    public void usingMikitoToCallStubbedMethod() {
        SomeService service = Mockito.mock(MockSomeService.class, REAL_OR_EXCEPTION);
    ...
    public void usingMikitoToCallUnstubbedMethodAndExpectException() {
        MockSomeService service = Mockito.mock(MockSomeService.class, REAL_OR_EXCEPTION);
        try {
            service.foo();
            fail();
