...
/**
 * A hack to instantiate {@link XMLStreamException}s without them mucking with the message. We subclass
 * {@link XMLStreamException} to get the credentials to access its protected 'location' field, but we always use plain
 * {@link XMLStreamException}s.
 */
