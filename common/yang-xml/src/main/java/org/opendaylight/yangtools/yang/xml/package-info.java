 ...
 *   <li>there is no support for anything besides XML {@link Attribute attributes}, {@link Element elements} and text
 *       embedded therein</li>
 *   <li>XML {@link Element elements} cannot contain mixed text and elements. Each element is either:
 *     <ol>
 ...
 *     </ol>
 *   </li>
 *   <li>geared towards being used primarily with <a href="https://en.wikipedia.org/wiki/StAX">StAX</a> and so that
 *       a {@link Document} can easily be constructed from an {@link javax.xml.stream.XMLStreamReader} and can be
 *       emitted back into a {@link javax.xml.stream.XMLStreamWriter}</li>
 * </ul>
 *
 * <p>This model is sufficient to accurately express minimum part of
