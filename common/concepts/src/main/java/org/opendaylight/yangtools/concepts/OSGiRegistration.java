 ...
 */
@NonNullByDefault
public final class OSGiRegistration extends ResourceRegistration<ServiceRegistration<?>> {
    private OSGiRegistration(final ServiceRegistration<?> serviceReg) {
        super(serviceReg);
    }

    public static BaseRegistration of(final ServiceRegistration<?> serviceReg) {
        return new OSGiRegistration(serviceReg);
    }
