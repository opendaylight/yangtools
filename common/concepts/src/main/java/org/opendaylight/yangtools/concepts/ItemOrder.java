...
public interface ItemOrder<T extends ItemOrder<T>> {
    ...
    /**
     * {@link ItemOrder} has impact on {@link #hashCode()}, see the contract exposed via {@link #itemOrder()}.
     */
    @Override
    int hashCode();

    /**
     * {@link ItemOrder} has impact on {@link #equals(Object)}, see the contract exposed via {@link #itemOrder()}.
     */
    @Override
    boolean equals(@Nullable Object obj);
}
