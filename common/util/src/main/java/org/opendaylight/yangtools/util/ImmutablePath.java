...
public interface ImmutablePath<P extends ImmutablePath<P, C>, C extends Comparable<C> & Immutable>
    ...
    /**
     * Return the conceptual parent {@link AbstractImmutablePath}, which has one item less in {@link #getPathFromRoot()}.
     *
     * @return Parent {@link AbstractImmutablePath }, or null if this object is empty.
     */
