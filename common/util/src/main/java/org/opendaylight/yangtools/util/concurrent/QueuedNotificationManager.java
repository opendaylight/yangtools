...
public class QueuedNotificationManager<L,N> implements NotificationManager<L,N> {
     ...
     */
    @Override
    public void submitNotifications( final L listener, final Collection<N> notifications ) {
    ...
    private class NotificationTask implements Runnable {
        ...
        boolean submitNotifications( Collection<N> notifications ) throws InterruptedException {
