 ...
 */
@Beta
public abstract class ImmutableMapTemplate<K, V> {
    ...
    private static final class Ordered<K, V> extends AbstractMultiple<K, V> {
        Ordered(final Map<K, Integer> offsets) {
            super(offsets);
        }
    ...
    private static final class Unordered<K, V> extends AbstractMultiple<K, V> {
        Unordered(final Map<K, Integer> offsets) {
            super(offsets);
        }
    ...
    public static <K, V> @NonNull ImmutableMapTemplate<K, V> ordered(final Collection<K> keys) {
        switch (keys.size()) {
            ...
            default:
                return new Ordered<>(OffsetMapCache.orderedOffsets(keys));
        }
    }
    ...
    public static <K, V> @NonNull ImmutableMapTemplate<K, V> unordered(final Collection<K> keys) {
        switch (keys.size()) {
            ...
            default:
                return new Unordered<>(OffsetMapCache.unorderedOffsets(keys));
        }
    }
