...
public final class AutoCloseables {
    ...
    public static void closeOrWarn(@Nullable AutoCloseable closeable) {
        ...
        try {
            ...
            String closeableToString = "";
            try {
                closeableToString = ": " + closeable.toString();
            } catch (Throwable t) {
                // Ignore this
            }
            LOG.warn("Failed to close() an AutoCloseable" + closeableToString, e);
        }
    }
    ...
    public static void closeQuietly(@Nullable AutoCloseable closeable) {
        ...
        try {
            ...
            LOG.debug("Failed to closeQuietly() an AutoCloseable", e);
        }
    }
}
