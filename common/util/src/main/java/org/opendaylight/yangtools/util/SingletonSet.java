 ...
 * will result in a non-cached version, {@link #cachedOf(Object)} will eagerly precompute the hash code.
 */
@Beta
public abstract class SingletonSet<E> implements Set<E>, Immutable, Serializable {
    ...
    public static <E> SingletonSet<E> cachedOf(@Nonnull final E element) {
        return new CachedHashSingletonSet<>(element);
    }
    ...
    private static final class CachedHashSingletonSet<E> extends AbstractSingletonSet<E> {
        private static final long serialVersionUID = 1L;
        // FIXME: make this final or lazy
        private transient int hashCode;

        CachedHashSingletonSet(final E element) {
            super(element);
