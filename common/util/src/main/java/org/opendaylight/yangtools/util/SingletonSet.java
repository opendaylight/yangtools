...
public abstract sealed class SingletonSet<E> implements Set<E>, Immutable, Serializable {
    ...
    public static <E> @NonNull SingletonSet<E> of(final @Nullable E element) {
        return element == null ? (SingletonSet<E>) Null.INSTANCE : new Regular<>(element);
    }
    ...
    private static final class Null<E> extends SingletonSet<E> {
        @Serial
        private static final long serialVersionUID = 1L;
        static final @NonNull Null<?> INSTANCE = new Null<>();
