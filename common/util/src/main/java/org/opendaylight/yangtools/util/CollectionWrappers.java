...
public final class CollectionWrappers {
    ...
    public static <E> List<E> wrapAsList(final Collection<E> collection) {
        ...
        if (collection instanceof List) {
            ...
            if (collection instanceof ListWrapper || collection instanceof ImmutableList) {
                return cast;
            }
    ...
    public static <E> Set<E> wrapAsSet(final Collection<E> collection) {
        ...
        if (collection instanceof Set) {
            ...
            if (collection instanceof SetWrapper || collection instanceof SingletonSet
                    || collection instanceof ImmutableSet) {
                return cast;
            }
