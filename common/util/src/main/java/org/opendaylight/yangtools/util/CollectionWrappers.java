...
public final class CollectionWrappers {
    private static final class ListWrapper<E> extends AbstractList<E> implements Immutable {
    ...
    private static final class SetWrapper<E> extends AbstractSet<E> implements Immutable {
        private final Collection<E> delegate;
     ...
     * requirement is violated, the returned object may may behave in unpredictable ways.
     *
    ...
    public static <E> List<E> wrapAsList(final Collection<E> collection) {
        ...
        if (collection instanceof List) {
            ...
            return cast instanceof ListWrapper || cast instanceof ImmutableList || cast instanceof Immutable ? cast
    ...
    public static <E> Set<E> wrapAsSet(final Collection<E> collection) {
        ...
        if (collection instanceof Set) {
            ...
            return cast instanceof SetWrapper || cast instanceof SingletonSet || cast instanceof ImmutableSet
                    || cast instanceof Immutable ? cast : Collections.unmodifiableSet(cast);
        }
