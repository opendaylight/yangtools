...
public class AsyncNotifyingListenableFutureTask<V> extends FutureTask<V> implements ListenableFuture<V> {
    ...
    private AsyncNotifyingListenableFutureTask(final Runnable runnable, final @Nullable V result) {
        super(runnable, result);
    }
     ...
     */
    public static <V> @NonNull AsyncNotifyingListenableFutureTask<V> create(final Callable<V> callable,
     ...
     *                         If null, no executor is used.
     */
    public static <V> @NonNull AsyncNotifyingListenableFutureTask<V> create(final Runnable runnable,
