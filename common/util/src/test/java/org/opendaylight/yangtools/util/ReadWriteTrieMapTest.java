...
public class ReadWriteTrieMapTest {
    ...
    public void testMethodsOfReadWriteTrieMap() {
        ...
        Map<String, String> readOnlyTrieMap = readWriteTrieMap.toReadOnly();
