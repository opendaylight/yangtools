...
public class SingletonSetTest {
    ...
    public void testOfRejectsNull() {
        SingletonSet.of(null);
    }

    @Test(expected=NullPointerException.class)
    public void testCachedOfRejectsNull() {
        SingletonSet.cachedOf(null);
    }

    @Test
    public void testNullSingleton() {
        final SingletonSet<?> s = SingletonSet.ofNull();
