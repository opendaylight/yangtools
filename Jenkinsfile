...
pipeline {
    ...
    stages {        
        ...
        stage('lf-jacoco-nojava-workaround') {
            steps {
        ...
        stage('Add Config files') {
            steps {
                ...
                // }
                configFileProvider([configFile(fileId: 'yangtools-settings', targetLocation: 'yangtools', variable: 'yangtools')]) {
                    sh 'mvn -s $yangtools clean package'
                }
            }
        }
