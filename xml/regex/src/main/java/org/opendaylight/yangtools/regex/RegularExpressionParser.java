...
public final class RegularExpressionParser {
    ...
    public static RegularExpression parse(final String str) throws RegularExpressionException {
        return parseRegExp(child(RegexParser.parseRegularExpression(str), 0, RegExpContext.class));
    }
