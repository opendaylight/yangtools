...
final class FunctionSupport {
    ...
    private static YangExpr booleanExpr(final List<YangExpr> args) {
        ...
        return switch (args.getFirst()) {
            ...
            default -> YangFunctionCallExpr.of(YangFunction.BOOLEAN.getIdentifier(), args);
        };
    }
    ...
    private static YangExpr containsExpr(final List<YangExpr> args) {
        ...
        if (args.getFirst() instanceof YangLiteralExpr first && args.getLast() instanceof YangLiteralExpr second) {
    ...
    private static YangExpr notExpr(final List<YangExpr> args) {
        ...
        if (args.getFirst() instanceof YangBooleanConstantExpr constant) {
            return YangBooleanConstantExpr.of(constant.getValue());
        }
    ...
    private static YangExpr stringExpr(final List<YangExpr> args) {
        ...
        return switch (args.getFirst()) {
            ...
            // TODO: handling YangNumberExpr requires math support
            default -> YangFunctionCallExpr.of(YangFunction.STRING.getIdentifier(), args);
        };
    }
