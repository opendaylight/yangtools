...
import org.opendaylight.yangtools.yang.xpath.ri.dagger.ReferenceYangXPathParserModule;

/**
 * Default implementation of {@link YangXPathParserFactory} for {@code javax.inject}-based dependency injection
 * frameworks.
 *
 * @deprecated Use {@link ReferenceYangXPathParserModule#provideYangXPathParserFactory()} instead..
 */
@Singleton
