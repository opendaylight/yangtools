...
/**
 * An {@link Archetype} for a {@link BaseIdentity} generated for a {@link IdentityEffectiveStatement}.
 *
...
public record IdentityArchetype(
        ...
        List<JavaTypeName> baseIdentities) implements Archetype.Compat<IdentityEffectiveStatement> {
