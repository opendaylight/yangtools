...
@NonNullByDefault
final class RuntimeUnionTO extends AbstractGeneratedTransferObject<UnionTypeObject>
        implements UnionTypeObjectArchetype {
    private final List<String> typePropertyNames;

    RuntimeUnionTO(final RuntimeUnionTypeObjectArchetypeBuilder builder, final List<String> typePropertyNames) {
        super(builder);
