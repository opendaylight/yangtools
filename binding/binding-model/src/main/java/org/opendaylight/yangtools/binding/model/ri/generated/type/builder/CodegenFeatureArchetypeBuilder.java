...
public final class CodegenFeatureArchetypeBuilder extends CodegenGeneratedTOBuilder
    ...
    public CodegenFeatureArchetypeBuilder(final JavaTypeName typeName, final JavaTypeName dataRoot) {
        super(typeName);
    ...
    private static final class FeatureGTO extends GTO implements FeatureArchetype {
        ...
        FeatureGTO(final CodegenGeneratedTOBuilder builder, final JavaTypeName dataRoot) {
            super(builder);
            this.dataRoot = requireNonNull(dataRoot);
        }
