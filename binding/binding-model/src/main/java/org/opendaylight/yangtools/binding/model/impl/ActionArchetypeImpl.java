...
@NonNullByDefault
public record ActionArchetypeImpl(
        TypeName name,
        ActionEffectiveStatement statement,
        RpcInputArchetype input,
        RpcOutputArchetype output,
        TypeName parentName) implements ActionArchetype {
    public ActionArchetypeImpl {
        requireNonNull(name);
    ...
    public String toString() {
        return TypeMethods.toString(ActionArchetype.class, this);
    }
}
