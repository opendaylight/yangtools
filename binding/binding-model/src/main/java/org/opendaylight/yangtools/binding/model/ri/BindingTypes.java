...
public final class BindingTypes {
     ...
     */
    @NonNullByDefault
    public static @Nullable GeneratedTransferObject extractEntryObjectKey(final GeneratedType genType) {
    ...
    @NonNullByDefault
    private static @Nullable Type onlyTypeArgument(final ParameterizedType type) {
        final var args = type.getActualTypeArguments();
        if (args.size() == 1) {
            final var arg = args.getFirst();
            if (arg != null) {
