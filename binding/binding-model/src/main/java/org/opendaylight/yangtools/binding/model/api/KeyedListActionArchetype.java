...
public sealed interface KeyedListActionArchetype extends OperationArchetype.OfAction
     ...
     */
    static KeyedListActionArchetype of(final JavaTypeName typeName, final ActionEffectiveStatement statement,
            final InputArchetype input, final OutputArchetype output, final JavaTypeName parentName) {
        return new KeyedListActionArchetypeImpl(typeName, statement, input, output, parentName);
    }
