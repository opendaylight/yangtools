...
import org.opendaylight.yangtools.binding.model.ri.generated.type.builder.AbstractArchetypeBuilder;
...
public sealed interface GeneratedTypeBuilderBase<T extends GeneratedTypeBuilderBase<T>>
        ...
        permits AbstractArchetypeBuilder, DataRootArchetype.Builder, GeneratedTransferObject.Builder,
    ...
    /**
     * {@return a new immutable {@link Archetype} instance}
     */
    @NonNull Archetype build();
}
