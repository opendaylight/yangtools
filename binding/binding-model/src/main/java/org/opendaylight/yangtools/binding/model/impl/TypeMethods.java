...
public final class TypeMethods {
     ...
     */
    @NonNullByDefault
    public static String toString(final BitsTypeObjectArchetype self) {
     ...
     */
    @NonNullByDefault
    public static String toString(final ScalarTypeObjectArchetype self) {
     ...
     */
    @NonNullByDefault
    public static String toString(final UnionTypeObjectArchetype self) {
