...
record KeyArchetypeImpl(
    ...
    public List<MethodSignature> methods() {
        return List.copyOf(collectMethods(statement.argument(), entryObject).values());
    }
    ...
    static HashMap<String, MethodSignature> collectMethods(final KeyArgument keyArgument,
        ...
        final var keyToMethod = HashMap.<String, @Nullable MethodSignature>newHashMap(keyNames.size());
