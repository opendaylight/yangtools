...
@NonNullByDefault
final class AugmentationArchetypeImpl implements AugmentationArchetype {
    private final JavaTypeName name;
    private final AugmentEffectiveStatement statement;
    ...
    AugmentationArchetypeImpl(final JavaTypeName name, final AugmentEffectiveStatement statement,
    ...
    @Override
    public AugmentEffectiveStatement statement() {
        return statement;
    }
