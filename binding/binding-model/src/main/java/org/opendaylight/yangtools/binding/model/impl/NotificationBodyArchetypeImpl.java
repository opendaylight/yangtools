...
@NonNullByDefault
public record NotificationBodyArchetypeImpl(
        TypeName name,
        NotificationEffectiveStatement statement,
        List<Partial> partials,
        List<TypeObjectArchetype<?>> typeObjects,
        List<GetterMethod> methodSignatures) implements NotificationBodyArchetype {
    public NotificationBodyArchetypeImpl {
        requireNonNull(name);
    ...
    public String toString() {
        return TypeMethods.toString(NotificationBodyArchetype.class, this);
    }
}
