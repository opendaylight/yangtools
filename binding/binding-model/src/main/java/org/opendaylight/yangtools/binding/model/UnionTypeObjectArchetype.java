 ...
 */
@NonNullByDefault
public final class UnionTypeObjectArchetype extends TypeObjectArchetype<UnionTypeObjectArchetype> {
    public UnionTypeObjectArchetype(final JavaTypeName typeName) {
        super(typeName);
    }
