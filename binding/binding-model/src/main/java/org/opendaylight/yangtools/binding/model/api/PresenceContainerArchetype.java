...
@NonNullByDefault
record PresenceContainerArchetype(
        JavaTypeName name,
        ...
        List<Archetype> enclosedTypes) implements ContainerArchetype.Presence {
    PresenceContainerArchetype {
        requireNonNull(name);
    ...
    public String toString() {
        return TypeMethods.toString(ContainerArchetype.class, this);
    }
}
