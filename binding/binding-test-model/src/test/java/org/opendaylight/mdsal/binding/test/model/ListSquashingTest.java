...
class ListSquashingTest {
    @Test
    void testEmptyLeafList() {
    ...
    @Test
    void testEmptyUserOrderedLeafList() {
    ...
    @Test
    void testEmptySystemOrderedList() {
