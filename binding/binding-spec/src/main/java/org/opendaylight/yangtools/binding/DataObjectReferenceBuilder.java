...
public abstract sealed class DataObjectReferenceBuilder<S extends DataObjectStep<?>, T extends DataObject>
        permits DataObjectIdentifier.Builder, DataObjectWildcard.Builder {
    ...
    DataObjectReferenceBuilder(final DataObjectReference<S, ?> prefix) {
        this.prefix = prefix.steps();
    ...
    final @NonNull Iterable<@NonNull S> buildSteps() {
