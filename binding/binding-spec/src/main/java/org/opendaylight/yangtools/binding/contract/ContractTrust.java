...
/**
 * A sealed interface indicating trust derived from a code generation construct. This interface exists to make a safety
 ...
 */
@NonNullByDefault
public sealed interface ContractTrust permits CodegenTrust {
    /**
     * Return the contract guarantee of this trust.
     *
     * @return the contract guarantee of this trust
     */
    Class<? extends BindingContract<?>> codegenContract();
}
