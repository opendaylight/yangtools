...
public abstract sealed class DataObjectWildcard<T extends DataObject> extends DataObjectReference<DataObjectStep<?>, T>
    ...
    final <X extends DataObject> @NonNull DataObjectWildcard<X> withChild(final NodeStep<X> step) {
        return withChild((DataObjectStep<X>) step);
    }

    @Override
    public final <N extends ChildOf<? super T>> @NonNull DataObjectWildcard<N> withChild(
    ...
    public final <N extends KeyAware<K> & ChildOf<? super T>, K extends Key<N>>
            @NonNull WithKey<N, K> withChild(final Class<N> listItem, final K listKey) {
    ...
    public final <C extends ChoiceIn<? super T> & DataObject, N extends ChildOf<? super C>>
            DataObjectWildcard<N> withChild(final Class<C> caze, final Class<N> container) {
    ...
    private <N extends DataObject> @NonNull DataObjectWildcard<N> withChild(final DataObjectStep<N> step) {
        return trustedCreate(step, Iterables.concat(steps(), ImmutableList.of(step)));
    }
     ...
     * @deprecated Use {@link #withChild(Class)} instead
     */
    @Deprecated
    public final <N extends ChildOf<? super T>> @NonNull DataObjectWildcard<N> child(
            final @NonNull Class<@NonNull N> container) {
        return withChild(container);
    }
     ...
     * @deprecated Use {@link #withChild(Class, Key)} instead
     */
    @Deprecated
    public final <N extends KeyAware<K> & ChildOf<? super T>, K extends Key<N>>
            @NonNull WithKey<N, K> child(final @NonNull Class<N> listItem, final @NonNull K listKey) {
        return withChild(listItem, listKey);
    }
     ...
     * @return An InstanceIdentifier.
     * @throws NullPointerException if any argument is null
     * @deprecated Use {@link #withChild(Class, Class, Key)} instead
     */
    @Deprecated
    public final <C extends ChoiceIn<? super T> & DataObject, K extends Key<N>,
        N extends KeyAware<K> & ChildOf<? super C>>
            @NonNull WithKey<N, K> child(final Class<@NonNull C> caze, final Class<@NonNull N> listItem,
                final K listKey) {
        return withChild(caze, listItem, listKey);
    }

    @Override
    public final <A extends DataObject & Augmentation<? super T>> DataObjectWildcard<A> withAugmentation(
     ...
     */
    @Deprecated
    public final <A extends DataObject & Augmentation<? super T>> @NonNull DataObjectWildcard<A> augmentation(
            final @NonNull Class<A> augment) {
