...
abstract class ORv1 implements Externalizable {
    @java.io.Serial
    ...
    final Object readResolve() throws ObjectStreamException {
        return resolve(DataObjectWildcard.unsafeOf(steps));
    }

    @NonNullByDefault
    abstract DataObjectReference<?, ?> resolve(DataObjectWildcard<?> wildcard);
}
