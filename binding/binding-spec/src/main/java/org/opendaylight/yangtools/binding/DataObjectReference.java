...
public sealed interface DataObjectReference<T extends DataObject> extends Immutable, PathLike, Serializable
    ...
    sealed interface Builder<T extends DataObject>
         ...
         */
        <N extends EntryObject<? super T, N, K>, K extends Key<N>> @NonNull WithKey<N, K> child(
    ...
    static <C extends CaseObject<? extends DataRoot<?>, ?, C>, N extends EntryObject<? super C, N, K>, K extends Key<N>>
