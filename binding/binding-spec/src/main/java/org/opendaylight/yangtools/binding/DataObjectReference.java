 ...
 */
// FIXME: we should have a 'WithPosition'
public abstract sealed class DataObjectReference<T extends DataObject> extends BindingInstanceIdentifier {
    /**
     * A simple {@link DataObjectReference}.
     */
    public static final class Simple<T extends DataObject> extends DataObjectReference<T> {
        @java.io.Serial
    ...
    /**
     * A {@link DataObjectReference} to a {@link KeyAware} data object.
     */
    ...
    public abstract static sealed class Builder<T extends DataObject> {
        ...
        Builder(final DataObjectReference<T> base) {
         ...
         */
        public abstract @NonNull DataObjectReference<T> build();
    ...
    private static final class RegularBuilder<T extends DataObject> extends Builder<T> {
        ...
        RegularBuilder(final DataObjectReference<T> base) {
            super(base);
            lastStep = base.lastStep();
        }
    ...
    private DataObjectReference(final ImmutableList<ExactDataObjectStep<?>> steps) {
        if (steps.isEmpty()) {
    ...
    public static final @NonNull DataObjectReference<?> unsafeOf(final ImmutableList<ExactDataObjectStep<?>> steps) {
    ...
    /**
     * Create a {@link Builder} for a specific type of {@link DataObjectReference} as specified by container in
    ...
    /**
     * Create a {@link Builder} for a specific type of {@link DataObjectReference} which represents {@link KeyStep}.
     *
    ...
    /**
     * Create a {@link Builder} for a specific type of {@link DataObjectReference} which represents a {@link KeyStep}
    ...
    public final @NonNull ImmutableList<ExactDataObjectStep<?>> steps() {
        return steps;
    }
    ...
    public final String toString() {
        return MoreObjects.toStringHelper(this).add("steps", steps).toString();
    }
