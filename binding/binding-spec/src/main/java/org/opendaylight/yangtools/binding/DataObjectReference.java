...
public abstract sealed class DataObjectReference<S extends DataObjectStep<?>, T extends DataObject>
    ...
    public abstract <C extends ChoiceIn<? super T> & DataObject, N extends ChildOf<? super C>>
            @NonNull DataObjectReference<S, N> withChild(@Nullable Class<C> caze, @NonNull Class<N> container);
    ...
    public abstract <C extends ChoiceIn<? super T> & DataObject, K extends Key<N>,
        N extends KeyAware<K> & ChildOf<? super C>> @NonNull DataObjectReference<S, N> withChild(@NonNull Class<C> caze,
