...
public sealed interface DataObjectIdentifier<T extends DataObject>
     ...
     * @since 14.0.15
     */
    default <I extends DataObject> @Nullable DataObjectIdentifier<I> topmostAncestor(
     ...
     * @since 14.0.15
     */
    default <I extends DataObject> @NonNull Optional<DataObjectIdentifier<I>> findTopmostAncestor(
            final @NonNull Class<@NonNull I> type) {
        return Optional.ofNullable(topmostAncestor(type));
    }
     ...
     * @since 14.0.15
     */
    default <A extends DataObject> @NonNull DataObjectIdentifier<A> getTopmostAncestor(
            final @NonNull Class<@NonNull A> type) {
        final var ancestor = topmostAncestor(type);
        if (ancestor != null) {
            return ancestor;
        }
