...
final class BuilderImplTemplate extends AbstractBuilderTemplate {
    ...
    BlockBuilder body() {
        ...
        return bb
            .nl()
            .at().eol(override)
            .str("public int bindingHashCode()").oB()
                .str("return ").str(impIface).eol("." + BINDING_HASHCODE_NAME + "(this);")
            .cB()
            .nl()
            .at().eol(override)
            .str("public boolean bindingEquals(").str(impIface).str(" other)").oB()
                .str("return ").str(impIface).eol("." + BINDING_EQUALS_NAME + "(this, other);")
            .cB()
            .nl()
            .at().eol(override)
            .str("public ").str(importedName(Types.STRING)).str(" bindingToString()").oB()
