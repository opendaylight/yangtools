...
public final class YangModuleInfoTemplate {
    ...
    public String generate() {
        ...
        _builder.append(module.getQNameModule().namespace().toString(), "    ");
        _builder.append("\", ");
        final var optRev = module.getRevision();
        if (optRev.isPresent()) {
            _builder.append("\"");
        ...
        _builder.newLine();
        _builder.append("     ");
        _builder.append("* The singleton instance.");
        _builder.newLine();
        _builder.append("     ");
        _builder.append("*/");
        _builder.newLine();
        _builder.append("    ");
        _builder.append("public static final @NonNull YangModuleInfo INSTANCE = new ");
        _builder.append(Naming.MODULE_INFO_CLASS_NAME, "    ");
        _builder.append("();");
        _builder.newLineIfNotEmpty();
        _builder.newLine();
        ...
        _builder.newLine();
        _builder.append("    ");
        _builder.append(classBody(module, Naming.MODULE_INFO_CLASS_NAME, submodules), "    ");
        _builder.newLineIfNotEmpty();
        _builder.newLine();
