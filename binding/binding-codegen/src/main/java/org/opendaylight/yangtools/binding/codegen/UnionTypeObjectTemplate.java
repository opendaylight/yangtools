...
import org.opendaylight.yangtools.binding.model.UnionTypeObjectArchetype.Tag;
...
//            }
    ...
    private BlockBuilder generateStringValue() {
        ...
        for (var prop : finalProperties) {
            ...
            } else if (ScalarTypes.BINARY.equals(type)) {
                // type binary
            ...
            } else if (ScalarTypes.BOOLEAN.equals(typedefReturnType(type))) {
                // generated boolean typedef
                bb.str(field).eol(".isValue().toString();");
            } else if (ScalarTypes.BINARY.equals(typedefReturnType(type))) {
                // generated byte[] typedef
                bb.str(importedName(JU_BASE64)).str(".getEncoder().encodeToString(").str(field).eol(".getValue());");
            } else if (ScalarTypes.EMPTY.equals(type) || ScalarTypes.EMPTY.equals(typedefReturnType(type))) {
