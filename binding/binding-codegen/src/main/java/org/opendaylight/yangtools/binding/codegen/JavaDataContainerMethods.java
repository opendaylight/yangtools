...
record JavaDataContainerMethods(
    ...
    private String importedUtilClass(final GetterShape returnType) {
        return importedName(returnType.isBinary() ? JU_ARRAYS : JU_OBJECTS);
    }
    ...
    private void appendEQ(final BlockBuilder bb, final GetterShape getter) {
        ...
        bb.str(importedUtilClass(getter)).str(".equals(").str(name).str("(), obj.").str(name).str("())");
    }
