...
sealed interface Block extends Immutable, BlockBuilder.Item permits BlockBuilder.BlockImpl {
    ...
    default StringBuilder appendTo(final StringBuilder sb, final int indent) {
        try {
    ...
    default Appendable appendTo(final Appendable to) throws IOException {
        return appendTo(to, 0);
    }
