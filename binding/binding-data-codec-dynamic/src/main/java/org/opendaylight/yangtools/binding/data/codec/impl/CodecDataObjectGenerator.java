...
abstract class CodecDataObjectGenerator<T extends CodecDataObject<?>> implements ClassGenerator<T> {
    ...
    public final GeneratorResult<T> generateClass(final BindingClassLoader loader, final String fqcn,
        ...
        Builder<T> builder;
        // TODO this part has an issue. Seems like VarHandle does not set and work properly - WIP
        if (keyMethod == null) {
            ...
            final Generic keyMethodType = TypeDefinition.Sort.describe(keyMethod.getReturnType());
