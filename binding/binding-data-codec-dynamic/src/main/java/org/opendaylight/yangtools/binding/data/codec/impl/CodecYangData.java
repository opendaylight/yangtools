 ...
 */
@Beta
public abstract non-sealed class CodecYangData<T extends YangData<T>>
        extends CodecDataContainer<NormalizedYangData, YangDataCodecContext<T>>
        implements YangData<T> {
    protected CodecYangData(final YangDataCodecContext<T> context, final NormalizedYangData data) {
        super(context, data);
    }
}
