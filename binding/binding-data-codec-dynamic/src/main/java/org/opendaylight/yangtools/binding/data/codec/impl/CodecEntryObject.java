...
public abstract class CodecEntryObject<T extends EntryObject<T, K>, K extends Key<T>>
    ...
    static {
        try {
            KEY = MethodHandles.lookup().findVarHandle(CodecEntryObject.class, "key",
                Key.class);
    ...
    protected CodecEntryObject(AbstractDataObjectCodecContext<T, ?> context, DataContainerNode data) {
        super(context, data);
    }

    @Override
    public final K key() {
//        final var cached = (K) KEY.getAcquire(this);
//        return cached != null ? cached : loadKey();
...
//        return (K) (witness == null ? obj : witness);
//    }
}
