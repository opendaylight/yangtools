...
final class YangDataCodecContext<T extends YangData<T>>
        extends DataContainerCodecContext<T, YangDataRuntimeType, YangDataCodecPrototype<T>>
    ...
    YangDataCodecContext(final Class<T> javaClass, final YangDataRuntimeType runtimeType,
        ...
        super(new YangDataCodecPrototype<>(contextFactory, runtimeType, javaClass));
    }
    ...
    @Override
    public T toBinding(NormalizedYangData dom) {
        // FIXME: implement this
        throw new UnsupportedOperationException();
    }
