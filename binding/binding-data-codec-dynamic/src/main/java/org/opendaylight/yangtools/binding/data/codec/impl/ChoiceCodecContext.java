 ...
 */
final class ChoiceCodecContext<T extends ChoiceIn<DataContainer, ?>>
        extends DataContainerCodecContext<DataContainer, ChoiceRuntimeType, ChoiceCodecPrototype<T>>
