...
public abstract sealed class DataObjectCodecContext<D extends DataObject, T extends CompositeRuntimeType>
    ...
    @Override
    public final void writeTo(final NormalizedNodeStreamWriter writer, final D dataObject)
            throws IOException {
        eventStreamSerializer().serialize(dataObject, new BindingToNormalizedStreamWriter(this, writer));
    }
