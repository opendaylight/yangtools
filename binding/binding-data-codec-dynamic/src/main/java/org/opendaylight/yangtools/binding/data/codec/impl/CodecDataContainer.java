...
/**
 * Base class for {@link DataContainer}-backed codec-generated implementations. The only reason for it being public is
 * that it needs to be accessible by code generated at runtime.
 *
 * @param <N> {@link DataContainer} type
 * @param <C> context type
 */
public abstract sealed class CodecDataContainer<N extends DataContainer,
        C extends AnalyzedDataContainerCodecContext<?, ?, ?>> permits CodecDataObject, CodecYangData {
