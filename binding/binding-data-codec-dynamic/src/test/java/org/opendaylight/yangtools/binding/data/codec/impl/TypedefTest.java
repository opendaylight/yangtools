...
public class TypedefTest extends AbstractBindingCodecTest {
    private static final DataObjectWildcard<DefaultPolicy> BA_DEFAULT_POLICY =
        DataObjectWildcard.builder(DefaultPolicy.class).build();
    private static final DataObjectWildcard<TestCont> BA_TEST_CONT =
        DataObjectWildcard.builder(TestCont.class).build();
