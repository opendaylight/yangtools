...
public class CachingCodecTest extends AbstractBindingCodecTest {
    ...
    private static final DataObjectReference<Top> TOP_PATH = DataObjectReference.builder(Top.class).build();
    ...
    private static final DataObjectReference<Cont> CONT_PATH = DataObjectReference.builder(Cont.class).build();
