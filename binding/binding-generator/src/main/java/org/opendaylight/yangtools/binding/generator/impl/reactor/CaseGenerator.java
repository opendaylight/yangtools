...
final class CaseGenerator extends CompositeSchemaTreeGenerator<CaseEffectiveStatement, CaseRuntimeType> {
    @NonNullByDefault
    CaseGenerator(final CaseEffectiveStatement statement, final DataContainerGenerator<?, ?> parent) {
    ...
    CaseObjectArchetype createTypeImpl(final JavaTypeName typeName, final CaseEffectiveStatement statement,
        ...
        return CaseObjectArchetype.of(typeName, statement, choice.getArchetype(), groupings, collectEnclosedTypes(),
