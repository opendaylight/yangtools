...
public final class DefaultCaseRuntimeType extends AbstractAugmentableRuntimeType<CaseEffectiveStatement>
    ...
    public DefaultCaseRuntimeType(final CaseObjectArchetype bindingType, final CaseEffectiveStatement statement,
            final List<RuntimeType> children, final List<AugmentRuntimeType> augments) {
        super(bindingType, statement, children, augments);
    }

    @Override
    public CaseObjectArchetype javaType() {
        return (CaseObjectArchetype) super.javaType();
    }
}
