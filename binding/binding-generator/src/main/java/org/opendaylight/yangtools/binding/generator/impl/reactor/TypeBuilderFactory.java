...
public abstract sealed class TypeBuilderFactory implements Immutable {
    private static final class Codegen extends TypeBuilderFactory {
        ...
        @Override
        FeatureArchetype.Builder newFeatureBuilder(final JavaTypeName typeName, final JavaTypeName rootTypeName) {
            return new CodegenFeatureArchetypeBuilder(typeName, rootTypeName);
        }
    ...
    private static final class Runtime extends TypeBuilderFactory {
        ...
        @Override
        FeatureArchetype.Builder newFeatureBuilder(final JavaTypeName typeName, final JavaTypeName rootTypeName) {
            return new RuntimeFeatureArchetypeBuilder(typeName, rootTypeName);
        }
    ...
    @NonNullByDefault
    abstract FeatureArchetype.Builder newFeatureBuilder(JavaTypeName typeName, JavaTypeName rootTypeName);
