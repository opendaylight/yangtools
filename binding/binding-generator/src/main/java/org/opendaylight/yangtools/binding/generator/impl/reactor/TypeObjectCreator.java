...
final class TypeObjectCreator {
    ...
    static EnumTypeObjectArchetype createEnumTypeObjectArchetype(final JavaTypeName typeName,
            final TypeEffectiveStatement.MandatoryIn<?, ?> statement, final EnumTypeDefinition typeDefinition,
            final TypeBuilderFactory builderFactory, final ModuleEffectiveStatement module) {
        return new TypeObjectCreator(statement, builderFactory, module).createEnumeration(typeName, typeDefinition);
    }
    ...
    private EnumTypeObjectArchetype createEnumeration(final JavaTypeName typeName, final EnumTypeDefinition typedef) {
        return new EnumTypeObjectArchetype(typeName, definingStatement, typedef);
    }
