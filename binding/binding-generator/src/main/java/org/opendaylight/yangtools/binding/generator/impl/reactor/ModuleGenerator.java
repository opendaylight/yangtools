...
public final class ModuleGenerator extends DataContainerGenerator<ModuleEffectiveStatement, ModuleRuntimeType> {
    ...
    @Override
    DataRootArchetype createTypeImpl(final TypeName typeName, final ModuleEffectiveStatement statement,
            final List<@NonNull GroupingArchetype> groupings) {
        return DataRootArchetype.of(typeName, statement, groupings, collectTypeObjects(), collectGetters());
    }
    ...
    CompositeRuntimeTypeBuilder<ModuleEffectiveStatement, ModuleRuntimeType> createBuilder(
        ...
        return new CompositeRuntimeTypeBuilder<>(statement) {
            ...
            ModuleRuntimeType build(final Archetype type, final ModuleEffectiveStatement statement,
                ...
                return new DefaultModuleRuntimeType((DataRootArchetype) type, statement, children, yangDataChildren);
            }
        };
    }
}
