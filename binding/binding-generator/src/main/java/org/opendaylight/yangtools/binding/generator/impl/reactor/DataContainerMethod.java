 ...
 */
@NonNullByDefault
sealed interface DataContainerMethod<G extends  DataContainerMethod<G> & StatementRepresentation<?> & CopyableNode>
        permits AbstractTypeObjectGenerator, ContainerGenerator, ListGenerator, OpaqueObjectGenerator {
    ...
    private static <G extends DataContainerMethod<G> & StatementRepresentation<?> & CopyableNode>
            void addAsGetterMethod(final G generator, final DataContainerArchetype.Builder builder) {
    ...
    default MethodSignature.Builder constructGetter(final DataContainerArchetype.Builder builder,
            final Type returnType) {
        final var statement = thisMethodGenerator().statement();
        return constructGetter(builder, statement, returnType,
            Naming.getGetterMethodName(localName(statement).getLocalName()));
    }

    static MethodSignature.Builder constructGetter(final DataContainerArchetype.Builder builder,
    ...
    static void constructRequire(final DataContainerArchetype.Builder builder,
            final EffectiveStatement<QName, ?> statement, final Type returnType) {
    ...
    static AbstractQName localName(final EffectiveStatement<?, ?> statement) {
    ...
    static String nonnullMethodName(final EffectiveStatement<?, ?> statement) {
        return Naming.getNonnullMethodName(localName(statement).getLocalName());
    }
}
