...
final class ItemObjectGenerator extends ListGenerator {
    @NonNullByDefault
    ItemObjectGenerator(final ListEffectiveStatement statement, final AbstractCompositeGenerator<?, ?> parent) {
    ...
    ItemObjectArchetype createTypeImpl() {
        final var builder = ItemObjectArchetype.builder(typeName(), statement());
    ...
    CompositeRuntimeTypeBuilder<ListEffectiveStatement, ListRuntimeType> createBuilder(
        ...
        return new CompositeRuntimeTypeBuilder<>(statement) {
            ...
            ListRuntimeType build(final Archetype type, final ListEffectiveStatement statement,
                ...
                return new DefaultListRuntimeType((ItemObjectArchetype) type, statement, children, augments, null);
            }
        };
    }
}
