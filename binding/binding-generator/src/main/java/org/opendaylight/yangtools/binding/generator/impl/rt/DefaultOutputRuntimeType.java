...
public final class DefaultOutputRuntimeType extends AbstractAugmentableRuntimeType<OutputEffectiveStatement>
    ...
    public DefaultOutputRuntimeType(final RpcOutputArchetype bindingType, final OutputEffectiveStatement statement,
            final List<RuntimeType> children, final List<AugmentRuntimeType> augments) {
        super(bindingType, statement, children, augments);
    }

    @Override
    public RpcOutputArchetype javaType() {
        return (RpcOutputArchetype) super.javaType();
    }
}
