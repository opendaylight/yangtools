...
public final class DefaultOutputRuntimeType
        extends AbstractAugmentableRuntimeType<LegacyArchetype<OutputEffectiveStatement>, OutputEffectiveStatement>
        implements OutputRuntimeType {
    public DefaultOutputRuntimeType(final LegacyArchetype<OutputEffectiveStatement> archetype,
