...
public interface BindingNormalizedNodeWriterFactory {
     ...
     * {@link #newWriter(DataObjectWildcard, NormalizedNodeStreamWriter)} method to conserve resources.
     *
     * @param path
    ...
    @NonNull Entry<YangInstanceIdentifier, BindingStreamEventWriter> newWriterAndIdentifier(
            @NonNull DataObjectWildcard<?> path, @NonNull NormalizedNodeStreamWriter domWriter);
     ...
     * {@link DataObjectWildcard} translation is done in other way, or YANG instance identifier is unnecessary
     ...
     * @throws IllegalArgumentException If supplied Instance Identifier is not valid.
     */
    @NonNull BindingStreamEventWriter newWriter(@NonNull DataObjectWildcard<?> path,
