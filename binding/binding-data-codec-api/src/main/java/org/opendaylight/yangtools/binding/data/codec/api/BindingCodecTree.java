...
public interface BindingCodecTree extends BindingDataObjectCodecTreeParent<Empty> {
     ...
     */
    <T extends DataObject> @NonNull BindingDataObjectCodecTreeNode<T> getDataObjectCodec(DataObjectWildcard<T> path);
     ...
     * @throws IllegalArgumentException if the codec cannot be resolved
     */
    <T extends DataObject> @NonNull CodecWithPath<T> getSubtreeCodecWithPath(DataObjectWildcard<T> path);
     ...
     * @throws IllegalArgumentException if the codec cannot be resolved
     */
    <T extends DataObject> @NonNull CommonDataObjectCodecTreeNode<T> getSubtreeCodec(DataObjectWildcard<T> path);
