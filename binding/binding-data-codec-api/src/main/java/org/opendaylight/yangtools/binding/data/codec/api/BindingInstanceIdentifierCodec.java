...
public interface BindingInstanceIdentifierCodec extends Immutable {
    /**
     * Translates supplied {@link YangInstanceIdentifier} into an {@link DataObjectWildcard}, if possible.
     *
    ...
    <T extends DataObject> @Nullable DataObjectWildcard<T> toBinding(@NonNull YangInstanceIdentifier domPath);

    /**
     * Translates supplied {@link DataObjectWildcard} into {@link YangInstanceIdentifier}.
     *
    ...
    // FIXME: Document MissingSchemaException being thrown
    // FIXME: Document MissingSchemaForClassException being thrown
    @NonNull YangInstanceIdentifier fromBinding(@NonNull DataObjectWildcard<?> bindingPath);
}
