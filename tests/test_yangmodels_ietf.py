...
YANG_MODEL_PATHS = {
    ...
    # "src/main/yang/standard/bbf/standard/networking"
}
...
def resolve_and_replace_symlinks(target_directory: str | Path):
    ...
    # Crucial: Iterate over a list snapshot of the directory contents.
    # We are modifying the directory structure during iteration, so iterating
    # directly over the generator (dir_path.iterdir()) is unsafe.
    try:
