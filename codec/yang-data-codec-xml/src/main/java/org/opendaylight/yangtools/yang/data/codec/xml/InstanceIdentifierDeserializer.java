...
final class InstanceIdentifierDeserializer extends AbstractInstanceIdentifierCodec {
    ...
    InstanceIdentifierDeserializer(final XmlCodecFactory codecFactory, final NamespaceContext namespaceContext) {
        super(DataSchemaContextTree.from(codecFactory.getEffectiveModelContext()));
