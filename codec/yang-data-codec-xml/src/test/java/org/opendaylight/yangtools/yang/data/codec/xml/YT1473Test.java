...
public class YT1473Test {
    ...
    private static final String FOO_NS = "foons";
    private static final QName FOO_FOO = QName.create(FOO_NS, "foo");
    private static final QName FOO_BAR = QName.create(FOO_NS, "bar");
    private static final QName FOO_BAZ = QName.create(FOO_NS, "baz");
    private static final QName FOO_STR = QName.create(FOO_NS, "str");
    private static final QName FOO_ONE = QName.create(FOO_NS, "one");
    private static final QName FOO_QNAME = QName.create(FOO_NS, "qname");
    private static final QName FOO_ID = QName.create(FOO_NS, "id");

    private static final String BAR_NS = "barns";
    private static final QName BAR_FOO = QName.create(BAR_NS, "foo");
    private static final QName BAR_BAR = QName.create(BAR_NS, "bar");
    private static final QName BAR_TWO = QName.create(BAR_NS, "two");
