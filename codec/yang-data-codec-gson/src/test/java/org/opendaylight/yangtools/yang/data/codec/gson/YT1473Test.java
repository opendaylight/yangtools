...
public class YT1473Test {
    ...
    private static final QName FOO_FOO = QName.create(FOO_NS, "foo"); // list
    private static final QName FOO_BAR = QName.create(FOO_NS, "bar"); // list
    private static final QName FOO_BAZ = QName.create(FOO_NS, "baz"); // list
