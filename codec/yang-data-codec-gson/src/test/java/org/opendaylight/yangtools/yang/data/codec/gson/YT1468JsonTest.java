...
class YT1468JsonTest {
    ...
    private static final AugmentationNode NODE_AUGMENTATION = Builders.augmentationBuilder()
            ...
            .withChild(Builders.containerBuilder()
                    ...
                    .build())
            .build();
    private static ContainerNode NODE_CONTAINER_LVL1 = Builders.containerBuilder()
            .withNodeIdentifier(new NodeIdentifier(CONTAINER_LVL_1))
            .withChild(NODE_AUGMENTATION)
            .build();
    ...
    void testReadAugmentation() throws Exception {
        ...
        // I do not want to read augmentation - I want to get container added by augmentation
        assertTrue(data instanceof ContainerNode);
        assertEquals(NODE_AUGMENTATION, data);
    }
    ...
    void testReadLeaf() throws Exception {
        ...
        assertTrue(data instanceof LeafNode<?>);
