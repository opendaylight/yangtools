...
class YT1575Test {
    ...
    void immutableMapNodeStreamWriterDemonstration() throws Exception {
        ...
        var interfacesQName = QName.create("http://example.com/yt1575", "interfaces");
        var interfaceQName = QName.create("http://example.com/yt1575", "interface");
        ...
        var interfaceNode = ImmutableNodes.newMapEntryBuilder().withNodeIdentifier(interfaceIdWithPredicates)
            .withChild(ImmutableNodes.leafNode(QName.create("http://example.com/yt1575", "name"), "eth3"))
            .build();
