...
class StreamToNormalizedNodeTest extends AbstractComplexJsonTest {
    ...
    void immutableMapNodeStreamWriterDemonstration() throws Exception {
        var configId = new YangInstanceIdentifier.NodeIdentifier(QName.create("http://example.com/basic-model", "config"));
        ...
        var loopbackMode = ImmutableNodes.leafNode(QName.create("http://example.com/basic-model", "loopback-mode"), false);
        ...
        var interfaceIdWithPredicates = YangInstanceIdentifier.NodeIdentifierWithPredicates.of(interfaceQName, nameQName, "eth3");
