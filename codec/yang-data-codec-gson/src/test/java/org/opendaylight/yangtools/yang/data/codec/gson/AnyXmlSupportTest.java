...
class AnyXmlSupportTest extends AbstractComplexJsonTest {
    ...
    private void verifyExpectedJson(final String inputXmlFile, final String expectedJsonFile,
        ...
        final var data = ((ContainerNode) result.getResult().data())
    ...
    private static DOMSource getParsedAnyXmlValue(final NormalizedNode transformedInput, final QName anyxmlName) {
        ...
        final var cont1 = (ContainerNode) transformedInput;
        final var child = cont1.childByArg(new NodeIdentifier(anyxmlName));
        assertInstanceOf(DOMSourceAnyxmlNode.class, child);
        final var anyXmlNode = (DOMSourceAnyxmlNode) child;
