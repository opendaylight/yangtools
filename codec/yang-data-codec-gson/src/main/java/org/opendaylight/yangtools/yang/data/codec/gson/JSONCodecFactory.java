...
public abstract sealed class JSONCodecFactory extends AbstractInputStreamNormalizer<JSONCodec<?>> {
    ...
    @Override
    protected final ContainerNode parseDatastore(final InputStream stream, final NodeIdentifier containerName,
            final Unqualified moduleName) throws IOException, NormalizationException {
    ...
    @Override
    protected final NormalizedNode parseData(final SchemaInferenceStack stack, final InputStream stream)
    ...
    @Override
    protected final NormalizedNode parseChildData(final InputStream stream,
