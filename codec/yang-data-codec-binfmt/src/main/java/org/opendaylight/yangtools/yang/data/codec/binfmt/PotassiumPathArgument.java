...
final class PotassiumPathArgument {
    ...
    static final byte NODE_IDENTIFIER                 = 0x00;
    static final byte NODE_IDENTIFIER_WITH_PREDICATES = 0x01;
    static final byte NODE_WITH_VALUE                 = 0x02;
    static final byte MOUNTPOINT_IDENTIFIER           = 0x03;
