...
final class PotassiumNode {
    ...
    // Reserved for, but not currently used
    static final byte NODE_ANYDATA         = 0x0D;
     ...
     *       next {@link PostassiumValue} encoded</li>
     * </ul>
     */
