...
final class GeneratorTask extends ParserConfigAware {
    ...
    GeneratorTask(final @NonNull GeneratorTaskFactory factory, final @NonNull ContextHolder context,
    ...
    Collection<File> execute(final GeneratorTaskFactory factory, final ContextHolder modelContext,
