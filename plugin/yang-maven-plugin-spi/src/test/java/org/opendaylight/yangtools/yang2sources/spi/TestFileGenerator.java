...
final class TestFileGenerator implements FileGenerator {
    ...
    public Table<GeneratedFileType, GeneratedFilePath, GeneratedFile> generateFiles(final EffectiveModelContext context,
        ...
        return ImmutableTable.<GeneratedFileType, GeneratedFilePath, GeneratedFile>builder()
            ...
            .put(GeneratedFileType.TEST_SOURCE, GeneratedFilePath.ofFilePath(prefix + "TestSource.test"),
                GeneratedFile.of(GeneratedFileLifecycle.PERSISTENT, "test-source"))
            .put(GeneratedFileType.RESOURCE, GeneratedFilePath.ofFilePath(prefix + "-resource"),
                GeneratedFile.of(GeneratedFileLifecycle.PERSISTENT, "resource"))
            .put(GeneratedFileType.TEST_RESOURCE, GeneratedFilePath.ofFilePath(prefix + "-test-resource"),
            ...
            .put(GeneratedFileType.TEST_SOURCE, GeneratedFilePath.ofFilePath(prefix + "GenTestSource.test"),
                GeneratedFile.of(GeneratedFileLifecycle.TRANSIENT, "test-source"))
            ...
            .put(GeneratedFileType.TEST_RESOURCE, GeneratedFilePath.ofFilePath(prefix + "-gen-test-resource"),
                GeneratedFile.of(GeneratedFileLifecycle.TRANSIENT, "test-resource"))
            .build();
    }
