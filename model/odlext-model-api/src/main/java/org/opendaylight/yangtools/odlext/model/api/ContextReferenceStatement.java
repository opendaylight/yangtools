...
public interface ContextReferenceStatement extends UnknownStatement<QName> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<QName, ContextReferenceStatement, ContextReferenceEffectiveStatement> DEF =
        StatementDefinition.of(ContextReferenceStatement.class, ContextReferenceEffectiveStatement.class,
