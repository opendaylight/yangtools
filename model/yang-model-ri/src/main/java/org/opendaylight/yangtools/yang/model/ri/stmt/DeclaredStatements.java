...
public final class DeclaredStatements {
    ...
    public static DeviateStatement createDeviate(final DeviateArgument argument,
            final ImmutableList<? extends DeclaredStatement<?>> substatements) {
    ...
    public static MaxElementsStatement createMaxElements(final String rawArgument, final MaxElementsArgument argument,
            final ImmutableList<? extends DeclaredStatement<?>> substatements) {
    ...
    public static MinElementsStatement createMinElements(final MinElementsArgument argument) {
