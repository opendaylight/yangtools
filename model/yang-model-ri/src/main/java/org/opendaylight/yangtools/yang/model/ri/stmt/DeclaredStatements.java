...
public final class DeclaredStatements {
    ...
    public static AugmentStatement createAugment(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return substatements.isEmpty() ? new EmptyAugmentStatement(rawArgument)
            : new RegularAugmentStatement(rawArgument, substatements);
    }

    public static BaseStatement createBase(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return substatements.isEmpty() ? new EmptyBaseStatement(rawArgument)
            : new RegularBaseStatement(rawArgument, substatements);
    }
    ...
    public static ConfigStatement createConfig(final String rawArgument) {
        return EmptyConfigStatement.of(rawArgument);
    }
    ...
    public static ContactStatement createContact(final String rawArgument) {
        return new EmptyContactStatement(rawArgument);
    }

    public static ContactStatement createContact(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return substatements.isEmpty() ? createContact(rawArgument)
            : new RegularContactStatement(rawArgument, substatements);
    }
    ...
    public static DeviateStatement createDeviate(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return new DeviateStatementImpl(rawArgument, substatements);
    }

    public static DeviationStatement createDeviation(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return new DeviationStatementImpl(rawArgument, substatements);
    }

    // FIXME: what is the distinction between rawArgument and argument?
    public static EnumStatement createEnum(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return substatements.isEmpty() ? new EmptyEnumStatement(rawArgument)
            : new RegularEnumStatement(rawArgument, substatements);
    }
    ...
    public static IfFeatureStatement createIfFeature(final String rawArgument,
            final ImmutableList<? extends DeclaredStatement> substatements) {
        return substatements.isEmpty() ? new EmptyIfFeatureStatement(rawArgument)
            : new RegularIfFeatureStatement(rawArgument, substatements);
    }
