...
abstract class AbstractDeclaredEffectiveRootStatement<D extends DeclaredStatement> extends WithSubstatements
        implements LinkageDeclaredStatement, MetaDeclaredStatement, RevisionAwareDeclaredStatement,
                   BodyDeclaredStatement {
    AbstractDeclaredEffectiveRootStatement(final String rawArgument,
