...
import org.opendaylight.yangtools.yang.model.ri.stmt.impl.eff.LeafEffectiveStatementImpl;
...
public final class EffectiveStatements {
    ...
    public static LeafEffectiveStatement copyLeaf(final LeafEffectiveStatement original, final QName argument,
            final int flags) {
        checkArgument(original instanceof LeafEffectiveStatementImpl, "Unsupported original %s", original);
        return new LeafEffectiveStatementImpl((LeafEffectiveStatementImpl) original, argument, flags);
    }

    public static LeafEffectiveStatement createLeaf(final LeafStatement declared, final QName argument, final int flags,
            final ImmutableList<? extends EffectiveStatement<?, ?>> substatements)
                throws SubstatementIndexingException {
        return new LeafEffectiveStatementImpl(declared, argument, flags, substatements);
    }
