...
final class TargetAugmentEffectiveStatement extends AbstractAugmentEffectiveStatement {
    private final @NonNull AugmentEffectiveStatementImpl declared;

    private TargetAugmentEffectiveStatement(final AugmentEffectiveStatementImpl declared,
    ...
    static @NonNull TargetAugmentEffectiveStatement of(final SchemaTreeAwareEffectiveStatement<?, ?> target,
            final AugmentEffectiveStatementImpl declared) {
