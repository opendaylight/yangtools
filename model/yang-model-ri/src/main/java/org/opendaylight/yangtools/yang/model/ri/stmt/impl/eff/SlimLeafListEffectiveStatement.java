...
public final class SlimLeafListEffectiveStatement extends AbstractNonEmptyLeafListEffectiveStatement {
    ...
    public SlimLeafListEffectiveStatement(final SlimLeafListEffectiveStatement original, final QName argument,
            final int flags) {
        super(original, argument, flags);
    }

    public SlimLeafListEffectiveStatement(final EmptyLeafListEffectiveStatement original, final QName argument,
            final int flags) {
        super(original, argument, flags);
    }
