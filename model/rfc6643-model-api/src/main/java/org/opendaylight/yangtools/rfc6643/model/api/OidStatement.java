...
public interface OidStatement extends UnknownStatement<ObjectIdentifier> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<ObjectIdentifier, OidStatement, OidEffectiveStatement> DEF = StatementDefinition.of(
        OidStatement.class, OidEffectiveStatement.class, IetfYangSmiv2Constants.RFC6643_MODULE, "oid", "value");
