...
public class RevisionBuilder {
    ...
    /**
     * Defines the pattern for revisions. NOTE: This pattern will likely be updated in future versions of the ietf and should be adjusted accordingly
     */
    ...
    public static Revision getDefaultInstance(String defaultValue) {
        ...
        throw new IllegalArgumentException("Cannot create Revision from " + defaultValue + 
                ". Default value does not match pattern " + REVISION_PATTERN.pattern() + " or empty string.");
    }
