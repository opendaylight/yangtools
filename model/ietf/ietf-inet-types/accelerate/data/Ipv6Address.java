...
public class Ipv6Address
 implements Serializable {
    ...
    /**
     * Creates an Ipv6Address object from a byte sequence, the argument is copied before
     * Ipv6Address instantiation
     ...
     *
     * @param _binary_form Ipv6Address represented as byte array - as seen on the network
     */

    public Ipv6Address(byte [] _binary_form) {
        this(_binary_form, true);
    }


    /**
     * Creates an Ipv6Address object from a byte sequence providing an optional clone flag
     * The only check is for byte [] length
     *
     * @param _binary_form Ipv6Address represented as byte array - as seen on the network
    ...
    public Ipv6Address(byte [] _binary_form, boolean clone_me) {
    ...
    public InetAddress getInetForm() throws IllegalStateException {
        try {
             ...
             */
        throw new IllegalStateException("Impossible return code from getByAddress!");
    }
