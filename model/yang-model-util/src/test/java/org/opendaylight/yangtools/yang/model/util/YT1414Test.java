...
public class YT1414Test {
    ...
    public static void beforeClass() {
        ...
        EffectiveModelContext context2 = YangParserTestUtils.parseYangResource("/yt1231.yang");
    ...
    public void basicTest() {
        ...
        var tree = stack.toSchemaTreeInference();
        var stackFromTree = SchemaInferenceStack.ofInference(tree);
    ...
    public void safeModeTest() {
        ...
        var schema1 = ((ModuleEffectiveStatement) myModule1).findSchemaTreeNode(foo1).get();
        var schema2 = ((ModuleEffectiveStatement) myModule2).findSchemaTreeNode(foo2).get();
