...
public class YT1231Test {
    ...
    public void testEnterChoiceToRootContainer() {
        assertEquals("Choice (foo)foo not present",
            assertThrows(IllegalArgumentException.class, () -> stack.enterChoice(FOO)).getMessage());
    }
    ...
    public void testEnterChoiceToNestedContainer() {
        ...
        assertEquals("Choice (foo)foo not present in schema parent (foo)foo",
            assertThrows(IllegalArgumentException.class, () -> stack.enterChoice(FOO)).getMessage());
    }
    ...
    public void testEnterChoiceNonExistent() {
        ...
        assertEquals("Choice (foo)bar not present in schema parent (foo)bar",
            assertThrows(IllegalArgumentException.class, () -> stack.enterChoice(BAR)).getMessage());
    }
}
