...
public final class SchemaInferenceStack implements Mutable, EffectiveModelContextProvider, LeafrefResolver {
    ...
    public static @NonNull SchemaInferenceStack ofInference(final SchemaTreeInference inference) {
        final SchemaInferenceStack ret = new SchemaInferenceStack(inference.getEffectiveModelContext());
        final List<SchemaTreeEffectiveStatement<?>> path = inference.statementPath();
    ...
    public @NonNull SchemaTreeInference toSchemaTreeInference() {
        ...
        final ArrayDeque<EffectiveStatement<?, ?>> cleanDeque = clean ? deque : reconstructSchemaInferenceStack().deque;
