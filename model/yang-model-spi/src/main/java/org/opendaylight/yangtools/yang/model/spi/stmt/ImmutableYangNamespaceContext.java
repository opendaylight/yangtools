...
final class ImmutableYangNamespaceContext implements YangNamespaceContext {
    @java.io.Serial
    ...
    @NonNullByDefault
    static ImmutableYangNamespaceContext of(final Map<Unqualified, QNameModule> prefixToModule) {
