...
public sealed interface SourceInfo permits SourceInfo.Module, SourceInfo.Submodule {
    ...
    /**
     * {@return a new {@code SourceRef} derived on this object's {@link #sourceId())0}}
     * @since 15.0.0
     */
    ...
    record Module(
        ...
        @Override
        public SourceRef.ToModule newSourceRef() {
        ...
        /**
         * {@return a new {@link SourceInfo.Module.Builder}}
         */
        ...
        /**
         * A builder of {@link SourceInfo.Module}} instances.
         */
    ...
    record Submodule(
        ...
        @Override
        public SourceRef.ToSubmodule newSourceRef() {
