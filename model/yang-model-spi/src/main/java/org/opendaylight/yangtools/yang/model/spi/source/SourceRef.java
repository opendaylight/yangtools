 ...
 * fear of conflicts.
 *
 * <p>Instances can be obtained via {@link SourceInfo#newSourceRef()}.
 *
 * @since 15.0.0
 */
@NonNullByDefault
public sealed interface SourceRef extends Immutable {
     ...
     * {@inheritDoc}
     *
     * The implementation is guaranteed to return {@code System.identityHashCode(this)}
     */
    @Override
    int hashCode();
     ...
     * {@inheritDoc}
     *
     * The implementation is guaranteed to return {@code (this == obj)}.
     */
    @Override
