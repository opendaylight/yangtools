...
abstract class AbstractEffectiveStatement<A, D extends DeclaredStatement<A>>
    ...
    protected static @NonNull Map<QName, DataTreeEffectiveStatement<?>> createDataTreeNamespace(
        ...
        return sameAsSchema ? (Map) schemaTreeNamespace : copyNameNamespace(dataChildren);
    }

    protected static <T extends SchemaTreeEffectiveStatement<?>> @NonNull Map<QName, T> copyNameNamespace(
