 ...
 * as bound by {@link NamespaceBinding}. Returned objects are quaranteed to have been {@link QName#intern() interned}.
 *
...
public final class IdentifierParser extends AbstractArgumentParser<QName> implements ArgumentParser.SyntaxOnly<QName> {
    ...
    QName parseIdentifierAs(final String production, final String rawArgument, final int beginIndex)
        ...
        return lexIdentifierAs(production, rawArgument, beginIndex)
