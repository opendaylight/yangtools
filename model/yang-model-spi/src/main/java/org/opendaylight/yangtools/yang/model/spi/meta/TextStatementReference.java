 ...
 * </ul>
 */
public abstract class TextStatementReference extends StatementSourceReference implements DeclarationReference {
    private static final class InFile extends TextStatementReference implements DeclarationInFile {
    ...
    private static class InText extends TextStatementReference implements DeclarationInText {
    ...
    TextStatementReference(final String file, final int line, final int column) {
        this.file = file;
        this.line = line;
        this.column = column;
    }

    public static @NonNull TextStatementReference atPosition(final int line, final int column) {
        return new InText(null, line, column);
    }

    public static @NonNull TextStatementReference atPosition(final @Nullable String fileName, final int line,
            final int column) {
        return fileName == null ? atPosition(line, column) : new InTextFile(fileName, line, column);
    }

    public static @NonNull TextStatementReference inFile(final @NonNull String fileName) {
    ...
    public final boolean equals(final Object obj) {
        ...
        final TextStatementReference other = (TextStatementReference) obj;
