...
public enum StringUnescaper {
    ...
    RFC6020 {
        ...
        @Override
        public void checkUnquoted(final String str, final StatementSourceReference ref) {
            // No-op
        }
    },
    /**
    ...
    public abstract void checkUnquoted(String str, StatementSourceReference ref);

    public final @NonNull String unescape(final String str, final StatementSourceReference ref) {
