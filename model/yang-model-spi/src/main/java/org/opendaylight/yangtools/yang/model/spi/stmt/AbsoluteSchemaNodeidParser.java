...
public final class AbsoluteSchemaNodeidParser extends AbstractArgumentParser<Absolute> {
    ...
    /**
     * Parse a {@code absolute-schema-nodeid} ABNF production string.
     *
     * @param str the string to parse
     * @param beginIndex first character, included
     * @param endIndex last character, excluded
     * @return a {@link Absolute} presenting the {@code absolute-schema-nodeid} bound to the current module
     * @throws ArgumentSyntaxException if {@code str} does not conform to {@code absolute-schema-nodeid}
     */
    ...
    /**
     * Parse a {@code absolute-schema-nodeid}-equivalent ABNF production string.
     *
