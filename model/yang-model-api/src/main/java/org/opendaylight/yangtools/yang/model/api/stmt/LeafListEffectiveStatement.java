 ...
 */
public non-sealed interface LeafListEffectiveStatement
    extends DataTreeEffectiveStatement<LeafListStatement>, EffectiveMultiElementStatement<QName, LeafListStatement> {
    @Override
