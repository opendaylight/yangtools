...
public interface ContactStatement extends DeclaredHumanTextStatement {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<String, ContactStatement, ContactEffectiveStatement> DEF = StatementDefinition.of(
        ContactStatement.class, ContactEffectiveStatement.class,
        YangConstants.RFC6020_YIN_MODULE, "contact", "text", true);

    @Override
    default StatementDefinition<String, ContactStatement, ContactEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
