 ...
 *
 * <p>Existence of meta-model allows for better evolution of YANG language as it evolves and allows for better support
 * of different serializations of YANG model.
 *
 * <h2>Statements</h2>
 ...
 *
 * <p>Statements are represented as instances / subclasses of
 ...
 * </ul>
 *
 * <p>Clear separation of declared / effective model is needed, since statement definition also contains information
 * how effective model is computed and there is no one to one mapping between declared and effective model thanks to
 * statements such as {@code uses}, {@code augment},{@code deviate},{@code refine}.
 *
 * <h2>Identifiers and Namespaces</h2>
 * Effective model of YANG has several identifier types and namespaces, which behaves differently and are mostly used
 * during data processing and transformation. Namespaces are typically exposed as a pair of methods in an appropriate
 * {@code SomethingAwareEffectiveStatement} -- one for enumeration and one for lookups.
 */
