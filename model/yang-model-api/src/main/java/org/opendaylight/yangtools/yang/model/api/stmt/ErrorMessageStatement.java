...
public interface ErrorMessageStatement extends DeclaredHumanTextStatement {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<String, ErrorMessageStatement, ErrorMessageEffectiveStatement> DEF =
    ...
    @Override
    default StatementDefinition<String, ErrorMessageStatement, ErrorMessageEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
