...
public interface DescriptionStatement extends DeclaredHumanTextStatement {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<String, DescriptionStatement, DescriptionEffectiveStatement> DEF =
    ...
    @Override
    default StatementDefinition<String, DescriptionStatement, DescriptionEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
