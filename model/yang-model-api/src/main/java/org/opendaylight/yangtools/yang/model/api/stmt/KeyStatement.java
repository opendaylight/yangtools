...
public interface KeyStatement extends DeclaredStatement<KeyArgument> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<KeyArgument, KeyStatement, KeyEffectiveStatement> DEF = StatementDefinition.of(
        KeyStatement.class, KeyEffectiveStatement.class, YangConstants.RFC6020_YIN_MODULE, "key", "value");

    @Override
    default StatementDefinition<KeyArgument, KeyStatement, KeyEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
