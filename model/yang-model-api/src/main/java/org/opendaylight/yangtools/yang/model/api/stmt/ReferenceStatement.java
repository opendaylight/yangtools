...
public interface ReferenceStatement extends DeclaredHumanTextStatement {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<String, ReferenceStatement, ReferenceEffectiveStatement> DEF = StatementDefinition.of(
        ReferenceStatement.class, ReferenceEffectiveStatement.class,
        YangConstants.RFC6020_YIN_MODULE, "reference", "text", true);

    @Override
    default StatementDefinition<String, ReferenceStatement, ReferenceEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
