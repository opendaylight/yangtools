...
public interface EnumTypeDefinition extends TypeDefinition<EnumTypeDefinition> {
    ...
    /**
     * {@return the list of individual {@link EnumPair}s, in the order of increasing {@link EnumPair#getValue()}}
     */
    List<EnumPair> getValues();

    static boolean equals(final EnumTypeDefinition type, final @Nullable Object obj) {
        if (type == obj) {
            return true;
        }
