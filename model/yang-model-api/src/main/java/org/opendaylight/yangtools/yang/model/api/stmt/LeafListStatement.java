...
public interface LeafListStatement extends MultipleElementsDeclaredStatement, TypeAwareDeclaredStatement<QName>,
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<QName, LeafListStatement, LeafListEffectiveStatement> DEF = StatementDefinition.of(
        LeafListStatement.class, LeafListEffectiveStatement.class,
        YangConstants.RFC6020_YIN_MODULE, "leaf-list", "name");

    @Override
    default StatementDefinition<QName, LeafListStatement, LeafListEffectiveStatement> statementDefinition() {
        return DEF;
    }
