...
public interface RefineStatement extends ConfigStatementAwareDeclaredStatement<Descendant>,
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<Descendant, RefineStatement, RefineEffectiveStatement> DEF = StatementDefinition.of(
        RefineStatement.class, RefineEffectiveStatement.class,
        YangConstants.RFC6020_YIN_MODULE, "refine", "target-node");

    @Override
    default StatementDefinition<Descendant, RefineStatement, RefineEffectiveStatement> statementDefinition() {
        return DEF;
    }
