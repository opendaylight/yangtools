...
public interface AugmentEffectiveStatement
    extends EffectiveSchemaTreeReferenceTextStatement<SchemaNodeIdentifier, @NonNull AugmentStatement>,
            SchemaTreeAwareEffectiveStatement<SchemaNodeIdentifier, @NonNull AugmentStatement> {
    @Override
