 ...
 */
public interface ListSchemaNode extends DataNodeContainer, DataSchemaNode, NotificationNodeContainer,
        ElementCountConstraintAware, MustConstraintAware, ActionNodeContainer.Mixin<ListEffectiveStatement>,
        AugmentationTarget.Mixin<ListEffectiveStatement>, UserOrderedAware<ListEffectiveStatement> {
    /**
