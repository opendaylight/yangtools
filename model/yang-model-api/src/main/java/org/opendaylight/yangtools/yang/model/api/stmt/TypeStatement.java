...
public interface TypeStatement extends DeclaredStatement<QName> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<QName, TypeStatement, TypeEffectiveStatement> DEF = StatementDefinition.of(
        TypeStatement.class, TypeEffectiveStatement.class, YangConstants.RFC6020_YIN_MODULE, "type", "name");

    @Override
    default StatementDefinition<QName, TypeStatement, TypeEffectiveStatement> statementDefinition() {
        return DEF;
    }
