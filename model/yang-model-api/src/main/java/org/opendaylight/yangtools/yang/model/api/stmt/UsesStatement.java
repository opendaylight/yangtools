...
public interface UsesStatement extends DataDefinitionStatement {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<QName, UsesStatement, UsesEffectiveStatement> DEF = StatementDefinition.of(
        UsesStatement.class, UsesEffectiveStatement.class, YangConstants.RFC6020_YIN_MODULE, "uses", "name");

    @Override
    default StatementDefinition<QName, UsesStatement, UsesEffectiveStatement> statementDefinition() {
        return DEF;
    }
