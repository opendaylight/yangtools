...
public sealed interface StatementDefinition extends Immutable permits DefaultStatementDefinition, YangStmtMapping {
    ...
    static <A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>> StatementDefinition of(
            final Class<D> declaredRepresentation, final Class<E> effectiveRepresentation, final QName statementName,
    ...
    @NonNullByDefault
    static <A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>> StatementDefinition of(
            final Class<D> declaredRepresentation, final Class<E> effectiveRepresentation, final QNameModule module,
    ...
    static <A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>> StatementDefinition of(
            final Class<D> declaredRepresentation, final Class<E> effectiveRepresentation, final QNameModule module,
            final String statementName, final String argumentName) {
    ...
    static <A, D extends DeclaredStatement<A>, E extends EffectiveStatement<A, D>> StatementDefinition of(
            final Class<D> declaredRepresentation, final Class<E> effectiveRepresentation, final QNameModule module,
            final String statementName, final String argumentName, final boolean yinElement) {
