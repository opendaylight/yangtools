...
public sealed interface ElementCountMatcher extends Immutable
    ...
    /**
     * {@return an ElementCountMatcher matching specified {@ode min-elements}, or {@code null} if no matching is needed}
    ...
    /**
     * {@return an ElementCountMatcher matching optional {@ode min-elements} and optional {@code max-elements},
    ...
    /**
     * {@return an ElementCountMatcher matching specified {@ode min-elements} and {@code max-elements}, or {@code null}
    ...
    /**
     * {@return an ElementCountMatcher matching specified {@ode min-elements} and bounded {@code max-elements}}
     * @param minElements the {@link MinElementsArgument}
