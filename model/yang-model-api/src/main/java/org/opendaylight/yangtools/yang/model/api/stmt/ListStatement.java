...
public interface ListStatement
    extends MultipleElementsDeclaredStatement, DataDefinitionAwareDeclaredStatement.WithReusableDefinitions<QName>,
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition DEFINITION = StatementDefinition.of(ListStatement.class, ListEffectiveStatement.class,
