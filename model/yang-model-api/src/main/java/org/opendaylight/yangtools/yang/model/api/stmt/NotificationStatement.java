...
public interface NotificationStatement extends DocumentedDeclaredStatement.WithStatus<QName>,
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<QName, NotificationStatement, NotificationEffectiveStatement> DEF =
    ...
    @Override
    default StatementDefinition<QName, NotificationStatement, NotificationEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
