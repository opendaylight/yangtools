 ...
 */
@NonNullByDefault
public sealed interface MinElementsArgument extends Comparable<MinElementsArgument>
        permits MinElementsArgument31, MinElementsArgument63, MinElementsArgumentStr {
    /**
    ...
    static MinElementsArgument of(final int value) {
        return switch (value) {
            case 0 -> MinElementsArgument31.ZERO;
            case 1 -> MinElementsArgument31.ONE;
            case 2 -> MinElementsArgument31.TWO;
            default -> new MinElementsArgument31(value);
        };
    }
    ...
    static MinElementsArgument of(final long value) {
        return value >= 0 && value <= Integer.MAX_VALUE ? of((int) value) : new MinElementsArgument63(value);
    }
    ...
    private static MinElementsArgument parseStr(final String str, final int len) throws ParseException {
        ...
        if (len >= 20) {
            return new MinElementsArgumentStr(str);
        }
        ...
        try {
            ...
            return new MinElementsArgumentStr(str, e);
        }
        return of(value);
    }
}