...
public sealed interface SourceDependency extends Serializable
     ...
     */
    record BelongsTo(Unqualified name, Referenced<Unqualified> prefix) implements SourceDependency {
        @java.io.Serial
...
//            requireNonNull(reference);
     ...
     */
    record Import(Unqualified name, Referenced<Unqualified> prefix, @Nullable Referenced<Revision> revision) implements SourceDependency {
        @java.io.Serial
        private static final long serialVersionUID = 0L;
        ...
        public Import(final Unqualified name, final Referenced<Unqualified> prefix) {
