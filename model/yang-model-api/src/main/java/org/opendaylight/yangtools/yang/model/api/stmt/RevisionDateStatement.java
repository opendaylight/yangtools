...
public interface RevisionDateStatement extends DeclaredStatement<Revision> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<Revision, RevisionDateStatement, RevisionDateEffectiveStatement> DEF =
    ...
    @Override
    default StatementDefinition<Revision, RevisionDateStatement, RevisionDateEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
