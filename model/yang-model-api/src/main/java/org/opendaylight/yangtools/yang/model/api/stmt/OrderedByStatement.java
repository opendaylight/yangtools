...
public interface OrderedByStatement extends DeclaredStatement<Ordering> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<Ordering, OrderedByStatement, OrderedByEffectiveStatement> DEF =
    ...
    @Override
    default StatementDefinition<Ordering, OrderedByStatement, OrderedByEffectiveStatement> statementDefinition() {
        return DEF;
    }
}
