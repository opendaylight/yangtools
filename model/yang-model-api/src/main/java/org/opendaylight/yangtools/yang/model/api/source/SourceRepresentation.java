 ...
 *
 * <p>A schema source can exist in various forms, which we call representations. Again, in YANG terms, each
 * representation is semantically equivalent, but from implementation perspective certain operations on a schema source
 * may require it to be first transformed into a particular representation before they can be applied. Such
 * transformations are affected via instances of SchemaSourceTransformation.
 *
 * <p>Typical examples of a schema source representation include:
 * <ul>
