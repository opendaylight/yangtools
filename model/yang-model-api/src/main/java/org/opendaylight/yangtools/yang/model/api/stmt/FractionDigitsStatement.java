...
public interface FractionDigitsStatement extends DeclaredStatement<Integer> {
     ...
     * @since 15.0.0
     */
    @NonNull StatementDefinition<Integer, FractionDigitsStatement, FractionDigitsEffectiveStatement> DEF =
        StatementDefinition.of(FractionDigitsStatement.class, FractionDigitsEffectiveStatement.class,
