...
class AugmentStructureArgumentTest {
    ...
    void singleToString() {
        assertEquals("AugmentStructureArgument [qnames=[(cs?revision=1989-11-17)CZ]]",
            new AugmentStructureArgument(FOO, null).toString());
    }

    @Test
    void continuousToString() {
        assertEquals("AugmentStructureArgument [qnames=[(cs?revision=1989-11-17)CZ, SVK]]",
            new AugmentStructureArgument(FOO, Descendant.of(BAR)).toString());
    }
    ...
    void differentNsToString() {
        assertEquals(
            ...
            new AugmentStructureArgument(FOO, Descendant.of(BAR, XYZZY)).toString());
    }
    ...
    void differentRevToString() {
        assertEquals(
            ...
            new AugmentStructureArgument(FOO, Descendant.of(BAR, BAZ)).toString());
    }
}
