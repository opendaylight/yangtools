 ...
 */
public final class ReversedListTester {

    /**
     * Utility classes should have constructors hidden.
     */
    private ReversedListTester() {
    }
     ...
     * The two elements are added at the start, using insertFirst.
     * Element is deleted from the end (by index).
     */
     ...
     * Reverse sequential access targets implementations
     * which only get good performance in Sequential by luck.
    ...
    public static <L extends IdList<String, StringedTestingElement>> void testScale100(final L list) {
        testScaleN(list, 100, -1292843973);
    }
    ...
    public static <L extends IdList<String, StringedTestingElement>> void testScale1000(final L list) {
        testScaleN(list, 1000, -635712680);
    }
    ...
    public static <L extends IdList<String, StringedTestingElement>> void testScale10000(final L list) {
        testScaleN(list, 10000, 421299252);
    }
    ...
    public static <L extends IdList<String, StringedTestingElement>> void testScale100000(final L list) {
        testScaleN(list, 100000, -678750060);
    }
     ...
     */
    public static <L extends IdList<String, StringedTestingElement>> void testScale1000000(final L list) {
        testScaleN(list, 1000000, 0);
    }
