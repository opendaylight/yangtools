...
final class AutomaticLifecycleMixin {
    ...
    static Optional<? extends TreeNode> apply(final Apply delegate, final ApplyWrite writeDelegate,
            final NormalizedNode emptyNode, final ModifiedNode modification, final @Nullable TreeNode storeMeta,
        ...
        } else if (modification.getOperation() == LogicalOperation.TOUCH && storeMeta == null) {
    ...
    private static Optional<? extends TreeNode> applyTouch(final Apply delegate, final NormalizedNode emptyNode,
            final ModifiedNode modification, final @Nullable TreeNode storeMeta, final Version version) {
