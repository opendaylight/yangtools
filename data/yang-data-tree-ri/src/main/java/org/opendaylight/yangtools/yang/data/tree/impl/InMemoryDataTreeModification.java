...
final class InMemoryDataTreeModification extends AbstractCursorAware implements CursorAwareDataTreeModification,
    ...
    public void ready() {
        ...
        try {
            ...
            // Make sure all affects are visible before returning, as this object may be handed off to another thread,
            // which needs to see any HashMap.modCount mutations completed. This is needed because isSealed() is now
            // performing only the equivalent of an acquireFence()
