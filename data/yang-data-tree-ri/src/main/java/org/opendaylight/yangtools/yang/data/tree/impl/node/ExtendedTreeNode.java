...
/**
 * A {@link TreeNode} which is extending another {@link TreeNode}.
 */
@NonNullByDefault
public abstract non-sealed class ExtendedTreeNode extends TreeNode {
    protected final TreeNode base;

    protected ExtendedTreeNode(final TreeNode base) {
