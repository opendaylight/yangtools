...
final class ModifiedNode extends NodeModification implements StoreTreeNode<ModifiedNode> {
    ...
    // TODO: Document calling context assumptions. We really want this method to be invoked only when the corresponding
    //       modification is Open, so that getOperation() is stable in Ready and later states.
