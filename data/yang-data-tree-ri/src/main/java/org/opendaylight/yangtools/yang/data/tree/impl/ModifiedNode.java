...
final class ModifiedNode extends NodeModification implements StoreTreeNode<ModifiedNode> {
    ...
    void setValidatedNode(final ModificationApplyOperation op, final @Nullable TreeNode current,
     ...
     *         validation.
     */
    @Nullable ValidatedTreeNode validatedNode(final ModificationApplyOperation op, final @Nullable TreeNode current) {
        return op.equals(validatedOp) && Objects.equals(current, validatedCurrent) ? validatedNode : null;
    }
}
