...
abstract sealed class AbstractNodeContainerModificationStrategy<T extends DataSchemaNode>
    ...
    protected TreeNode applyMerge(final ModifiedNode modification, final TreeNode currentMeta, final Version version) {
        ...
        //          2) SUBTREE_MODIFIED with some child nodes and depending on what those come:
        //             a: only from modification.children
        //             b: from modification.children and the nodes we create here
