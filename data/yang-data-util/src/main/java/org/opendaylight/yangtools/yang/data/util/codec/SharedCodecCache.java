...
public final class SharedCodecCache<T> extends CodecCache<T> {
    ...
    @Override
    public <S extends SchemaNode & TypeDefinitionAware> T lookupComplex(final S schema) {
    ...
    @Override
    <S extends SchemaNode & TypeDefinitionAware> T getComplex(final S schema, final T codec) {
        try {
