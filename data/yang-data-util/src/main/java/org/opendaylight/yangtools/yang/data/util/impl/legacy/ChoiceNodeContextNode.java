...
final class ChoiceNodeContextNode extends AbstractMixinContextNode<NodeIdentifier> {
    ...
    ChoiceNodeContextNode(final ChoiceSchemaNode schema) {
        ...
        ImmutableMap.Builder<QName, AbstractDataSchemaContextNode<?>> byQNameBuilder = ImmutableMap.builder();
        ImmutableMap.Builder<PathArgument, AbstractDataSchemaContextNode<?>> byArgBuilder = ImmutableMap.builder();
