...
public abstract class AbstractDataSchemaContextNode<T extends PathArgument> extends AbstractSimpleIdentifiable<T>
        implements DataSchemaContextNode {
    private final @NonNull DataSchemaNode dataSchemaNode;

    AbstractDataSchemaContextNode(final T identifier, final DataSchemaNode schema) {
        super(identifier);
    ...
    static AbstractDataSchemaContextNode<?> fromSchemaAndQNameChecked(final DataNodeContainer schema,
            final QName child) {
