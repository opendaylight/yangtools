...
/**
 * Interface to parsing of documents containing YANG-modeled data. While the design of this interface is guided by what
 * a typical implementation of a <a href="https://www.rfc-editor.org/rfc/rfc8040">RESTCONF</a> server or client might
 * require, and it is not limited solely to that use case and should be used wherever its methods provide the required
 * semantics.
 *
 * <p>
 ...
 *       {@link #parseDatastore(QNameModule, Qualified, InputStream)}<li>
...
public interface NormalizedNodeParser {
     ...
     *         having {@link NodeIdentifier#getNodeType()} equal to {@code rootName.bindTo(rootNamespace)}.
     * @throws NullPointerException if any argument is {@code null}
     * @throws NormalizedNodeParserException if an error occurs
     */
    ContainerNode parseDatastore(QNameModule rootNamespace, Qualified rootName, InputStream stream)
