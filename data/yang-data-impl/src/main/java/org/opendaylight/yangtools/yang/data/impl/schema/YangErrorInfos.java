...
public final class YangErrorInfos {
    ...
    public static <T> YangErrorInfo<LeafNode<T>> of(final QName name, final T value) {
        return of(new NodeIdentifier(name), value);
    }

    public static <T> YangErrorInfo<LeafNode<T>> of(final NodeIdentifier name, final T value) {
     ...
     */
    public static YangErrorInfo<LeafNode<QName>> badAttribute(final QName attributeName) {
     ...
     */
    public static YangErrorInfo<LeafNode<QName>> badElement(final QName elementName) {
     ...
     */
    public static YangErrorInfo<LeafNode<QName>> badNamespace(final QName namespaceName) {
     ...
     */
    public static YangErrorInfo<LeafNode<Uint32>> sessionId(final Uint32 sessionId) {
     ...
     */
    @Deprecated(since = "RFC6241")
    public static YangErrorInfo<LeafNode<QName>> errElement(final QName elementName) {
     ...
     */
    @Deprecated(since = "RFC6241")
    public static YangErrorInfo<LeafNode<QName>> noopElement(final QName elementName) {
     ...
     */
    @Deprecated(since = "RFC6241")
    public static YangErrorInfo<LeafNode<QName>> okElement(final QName elementName) {
     ...
     */
    public static YangErrorInfo<LeafNode<YangInstanceIdentifier>> nonUnique(final YangInstanceIdentifier leafPath) {
     ...
     */
    public static YangErrorInfo<LeafNode<NodeIdentifier>> missingChoice(final NodeIdentifier choiceName) {
