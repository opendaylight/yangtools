...
public class BitsHexStringCodec extends TypeDefinitionAwareCodec<String, BitsTypeDefinition>
    ...
    protected BitsHexStringCodec(@Nullable final BitsTypeDefinition typeDef) {
    ...
    public static BitsHexStringCodec from(final BitsTypeDefinition type) {
        return new BitsHexStringCodec(type);
    }

    @Override
    protected @NonNull String deserializeImpl(@NonNull final String input) {
    ...
    @Override
    protected @NonNull String serializeImpl(@NonNull final String input) {
