...
final class BitsLongCodec extends AbstractBitsNumberCodec<Long> implements BitsNumberCodec<String, Long> {
    ...
    @Override
    protected @NonNull Long setCurrentBits(final Set<String> strings, final List<String> sortedBits) {
        long currentBits = 0;
    ...
    protected int getLengthOfBits(final Long bits) {
        ...
        final int positionOfLastBit = Long.numberOfTrailingZeros(Long.highestOneBit(bits));
