...
public class SimpleIdListTest {
    ...
    @Test
    public void testSemirandom1000000() {
        SimpleIdList<String, HashedTestingElement> list = new SimpleIdList();
        SemirandomListTester.testScale1000000(list);
    }

    @Test
    public void testSequential1000000() {
        SimpleIdList<String, StringedTestingElement> list = new SimpleIdList();
        SequentialListTester.testScale1000000(list);
    }

    @Test
    public void testReversed1000000() {
        SimpleIdList<String, StringedTestingElement> list = new SimpleIdList();
        ReversedListTester.testScale1000000(list);
    }
