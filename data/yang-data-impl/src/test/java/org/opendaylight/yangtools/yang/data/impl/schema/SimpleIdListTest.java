...
public class SimpleIdListTest {
    ...
    // The tests took 0.43 s up to this point.

    // With 100k scale the tests took 35.192 s.
    /*
    @Test
    ...
    */
    ...
    // With 400k scale the tests took 825.629 s.
    /*
    @Test
    public void testSemirandom400000() {
        SimpleIdList<String, HashedTestingElement> list = new SimpleIdList();
        SemirandomListTester.testScale400000(list);
    }

    @Test
    public void testSequential400000() {
        SimpleIdList<String, StringedTestingElement> list = new SimpleIdList();
        SequentialListTester.testScale400000(list);
    }

    @Test
    public void testReversed400000() {
        SimpleIdList<String, StringedTestingElement> list = new SimpleIdList();
        ReversedListTester.testScale400000(list);
    }
    */
}
