...
class BitsCodecStringTest {
    ...
    void deserialization(final int bitsTotal, final String input, final String output) {
    ...
    @MethodSource("bitsSerializationArgs")
    void serialization(final int bitsTotal, final String output, final String input) {
        final BitsCodec<String> codec = getCodec(buildBitsTypeDefinition(bitsTotal), BitsCodec.class);
    ...
    private static String toBitNames(final int... selectedIndexes) {
