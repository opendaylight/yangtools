...
public class BitsHexStringCodecTest {
    ...
    void deserializationFailure() {
        final BitsHexCodec<String> codec = getCodec(buildBitsTypeDefinition(8), BitsHexCodec.class);
    ...
    void serializationFailure() {
        final BitsHexCodec<String> codec = getCodec(buildBitsTypeDefinition(1), BitsHexCodec.class);
