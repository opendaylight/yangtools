...
public class BitsHexStringCodecTest {
    ...
    void serialization(int bitsTotal, final String output, final String input) {
        final BitsHexStringCodec codec = getCodec(buildBitsTypeDefinition(bitsTotal), BitsHexStringCodec.class);
    ...
    void deserializationFailure() {
        final BitsHexStringCodec codec = getCodec(buildBitsTypeDefinition(8), BitsHexStringCodec.class);
        assertThrows(IllegalArgumentException.class,
                () -> codec.deserialize("Bit1 Bit10")); // non-existing bit name
    }
