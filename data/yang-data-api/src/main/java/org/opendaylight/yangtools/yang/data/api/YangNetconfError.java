...
import org.opendaylight.yangtools.yang.common.Netconf.ErrorInfo;
import org.opendaylight.yangtools.yang.common.Netconf.ErrorInfo.AbstractNonUnique;
...
public interface YangNetconfError {
     ...
     * <a href="https://datatracker.ietf.org/doc/html/rfc6020#section-13.1">RFC6020, section 13.1</a>, specialized with
     * {@link YangInstanceIdentifier} as the path representation.
     */
    public static final class NonUnique extends AbstractNonUnique<YangInstanceIdentifier> {
        public NonUnique(final YangInstanceIdentifier value) {
            super(value);
        }
    }
}
