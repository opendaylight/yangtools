...
/**
 * Node which has been normalized according to the YANG schema and is identifiable by a {@link YangInstanceIdentifier}.
 ...
 */
public non-sealed interface NormalizedNode extends NormalizedData, Identifiable<PathArgument>, PrettyTreeAware {
    @Override
