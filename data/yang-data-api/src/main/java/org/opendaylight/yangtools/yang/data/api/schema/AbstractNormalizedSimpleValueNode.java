...
public abstract sealed class AbstractNormalizedSimpleValueNode<N extends NormalizedNode, V>
        extends AbstractNormalizedValueNode<N, V> permits AbstractAnydataNode, AbstractLeafNode {
    @Override
