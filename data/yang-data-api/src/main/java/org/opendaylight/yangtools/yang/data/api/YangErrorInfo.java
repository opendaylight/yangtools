...
public final class YangErrorInfo<T> extends ErrorInfo<T> {
    public YangErrorInfo(final QName name, final T value) {
        super(name, value);
    }
     ...
     */
    public static ErrorInfo<QName> badAttribute(final QName attributeName) {
     ...
     */
    public static ErrorInfo<QName> badElement(final QName elementName) {
     ...
     */
    public static ErrorInfo<QName> badNamespace(final QName namespaceName) {
     ...
     */
    public static ErrorInfo<Uint32> sessionId(final Uint32 sessionId) {
    ...
    public static ErrorInfo<QName> errElement(final QName elementName) {
     ...
     */
    @Deprecated(since = "RFC6241")
    public static ErrorInfo<QName> noopElement(final QName elementName) {
