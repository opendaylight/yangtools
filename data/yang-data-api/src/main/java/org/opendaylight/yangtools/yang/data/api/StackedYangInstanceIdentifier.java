...
final class StackedYangInstanceIdentifier extends YangInstanceIdentifier implements Cloneable {
    ...
    @Override
    int computeHashCode() {
        return HashCodeBuilder.nextHashCode(coerceParent().hashCode(), pathArgument);
    }
    ...
    private void writeObject(final ObjectOutputStream outputStream) throws IOException {
        ...
        if (parent instanceof FixedYangInstanceIdentifier) {
            ...
            p = new FixedYangInstanceIdentifier.create(parent.getPathArguments(), parent.hashCode());
        }
