...
public class UnionTypedefUnusedImportTest extends BaseCompilationTest {
    ...
    private boolean containsImport(String fullImport) throws FileNotFoundException {
        boolean result = false;
        final String absolutePath = "c:/yangtools/yangtools/code-generator/binding-java-api-generator/target/test/src/union-typedef/org/opendaylight/yang/gen/v1/org/opendaylight/yangtools/union/typedef/rev130208/TypedefUnion.java";
        final JavaProjectBuilder builder = new JavaProjectBuilder();
        final JavaSource src = builder.addSource(new FileReader(absolutePath));
