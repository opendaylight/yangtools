...
final class LengthGenerator {
    ...
    static String generateArrayLengthChecker(@Nullable final String member, @Nonnull final Collection<LengthConstraint> constraints) {
    ...
    static String generateStringLengthChecker(@Nullable final String member, @Nonnull final Collection<LengthConstraint> constraints) {
        final StringBuilder sb = new StringBuilder();
        final Collection<String> expressions = createExpressions(constraints);
