                ...
                public «type.name»(«propRet.importedName» «property.fieldName») {
                    ...
                    «FOR other : finalProperties»
                        «IF other.name.equals("value")»
                            ...
                            this.«other.fieldName» = «other.fieldName» == null ? null : Arrays.copyOf(«other.fieldName», «other.fieldName».length);
                            «ELSE»
        ...
        public «type.name»(«type.name» source) {
            ...
            «IF !properties.empty»
                «FOR p : properties»
                    ...
                    this.«p.fieldName» = source.«p.fieldName» == null ? null : Arrays.copyOf(source.«p.fieldName», source.«p.fieldName».length);
                    «ELSE»
