...
class ClassTemplate extends BaseTemplate {
    ...
    def protected generateBody(boolean isInnerClass) '''
        ...
        «generateClassDeclaration(isInnerClass)» {
            ...
            «generateLengMethod("length", "_length")»

            «generateRangMethod("range", "_range")»

        }
    '''

    def private generateLengMethod(String methodName, String varName) '''
    ...
    def protected generateRangMethod(String methodName, String varName) '''
