    ...
    def protected generateFields() '''
        «IF restrictions != null»
            «IF !(restrictions.lengthConstraints.empty)»
                ...
                private static «List.importedName»<«Range.importedName»<«clazz.importedNumber»>> _length;
            «ENDIF»
            «IF !(restrictions.rangeConstraints.empty)»
                «val clazz = restrictions.rangeConstraints.iterator.next.min.class»
                private static «List.importedName»<«Range.importedName»<«clazz.importedNumber»>> _range;
            «ENDIF»
        «ENDIF»
        «IF !properties.empty»
            «FOR f : properties»
