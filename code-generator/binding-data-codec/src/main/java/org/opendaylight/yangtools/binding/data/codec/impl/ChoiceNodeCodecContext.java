...
class ChoiceNodeCodecContext extends DataContainerCodecContext<ChoiceNode> {
    ...
    public ChoiceNodeCodecContext(final Class<?> cls, final ChoiceNode nodeSchema, final CodecContextFactory context) {
    ...
    DataContainerCodecContext<?> loadChild(final Class<?> childClass) {
        ...
        return new CaseNodeCocecContext(childClass, childSchema, factory);
    }
