...
abstract class DataObjectCodecContext<T extends DataNodeContainer> extends DataContainerCodecContext<T> {
    ...
    public DataContainerCodecContext<?> getIdentifierChild(final InstanceIdentifier.PathArgument arg,
        ...
        try {
            ...
            CaseNodeCocecContext cazeNode = (CaseNodeCocecContext) choiceNode.getStreamChild(caze);
    ...
    private NodeCodecContext getChildByAugmentationIdentifier(final YangInstanceIdentifier.AugmentationIdentifier arg) {
