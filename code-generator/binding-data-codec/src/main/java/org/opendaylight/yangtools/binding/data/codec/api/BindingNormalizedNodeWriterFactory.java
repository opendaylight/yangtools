...
public interface BindingNormalizedNodeWriterFactory {
    ...
    BindingStreamEventWriter newRpcWriter(Class<? extends DataContainer> rpcInputOrOutput, NormalizedNodeStreamWriter streamWriter);

    BindingStreamEventWriter newNotificationWriter(Class<? extends Notification> notification, NormalizedNodeStreamWriter streamWriter);
}
