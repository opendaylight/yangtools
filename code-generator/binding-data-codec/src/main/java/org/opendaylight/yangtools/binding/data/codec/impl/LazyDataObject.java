...
class LazyDataObject implements InvocationHandler, AugmentationReader {
    ...
    private ImmutableMap<Class<? extends Augmentation<?>>, Augmentation<?>> cachedAugmentations;
    ...
    public Map<Class<? extends Augmentation<?>>, Augmentation<?>> getAugmentations(final Object obj) {
        ...
        if (this.cachedAugmentations == null) {
            cachedAugmentations = ImmutableMap.copyOf(context.getAllAugmentationsFrom(data));
        }
    ...
    private Object getAugmentationImpl(final Class<?> cls) {
        if (cachedAugmentations != null) {
            return cachedAugmentations.get(cls);
        }
