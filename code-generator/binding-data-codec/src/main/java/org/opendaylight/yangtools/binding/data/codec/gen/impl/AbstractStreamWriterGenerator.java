...
public abstract class AbstractStreamWriterGenerator {
    ...
    private final CtMethod serliazeToMethod;

    private final LoadingCache<Class<?>, Class<? extends DataObjectSerializerImplementation>> implementations;
    private final ClassLoadingStrategy strategy;

    BindingRuntimeContext context;

    public AbstractStreamWriterGenerator(final JavassistUtils utils) {
        super();
        this.javassist = utils;
        ...
        try {
            this.serliazeToMethod = serializerCt.getDeclaredMethod(SERIALIZE_METHOD_NAME, serializeArguments);
    ...
    private CtClass generateEmitter0(final DataObjectSerializerSource source, final String serializerName) {
        CtClass product = javassist.createClass(serializerName, serializerCt, new ClassGenerator() {
            ...
            public void process(final CtClass cls) {
                ...
                String staticBody = source.getStaticSerializeBody().toString();
                try {
                    ...
                    CtMethod serializeTo = new CtMethod(serliazeToMethod,cls,null);
