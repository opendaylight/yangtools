...
public interface BindingNormalizedNodeSerializer {
     ...
     *
     * @param path
     *            Schema Path of Notification, schema path is absolute, and consists of Notification QName.
     * @param data
     *            NormalizedNode representing data
     * @return DOM Instance Identifier
     */
     ...
     *
     * @param path
     *            Schema path of RPC data, Schema path consists of rpc QName and input / output QName.
     * @param data
     *            NormalizedNode representing data
     * @return DOM Instance Identifier
     */
     ...
     *
     * @param data
     *            NormalizedNode representing rpc data
     * @return DOM Instance Identifier
     */
