...
abstract class DataContainerCodecContext<T> extends NodeCodecContext {
     ...
     */
    public abstract NodeCodecContext getYangIdentifierChild(final YangInstanceIdentifier.PathArgument arg);
     ...
     * @throws IllegalArgumentException If supplied argument does not represent valid child.
     */
    public DataContainerCodecContext<?> getIdentifierChild(final InstanceIdentifier.PathArgument arg,
     ...
     * @return Context of child
     */
    public DataContainerCodecContext<?> getStreamChild(final Class<?> childClass) {
     ...
     * @return Context of child
     */
    abstract DataContainerCodecContext<?> loadChild(final Class<?> childClass);
