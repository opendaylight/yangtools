...
abstract class DataContainerCodecContext<T> extends NodeCodecContext {
    ...
    public DataContainerCodecContext(final DataContainerCodecPrototype<T> prototype) {
     ...
     * @return Context of child
     */
    abstract  DataContainerCodecContext<?> getStreamChild(final Class<?> childClass);
