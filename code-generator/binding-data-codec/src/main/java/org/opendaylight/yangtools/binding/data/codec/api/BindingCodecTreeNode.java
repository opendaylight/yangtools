 ...
 *
 **/
interface BindingCodecTreeNode<T extends DataObject> extends BindingNormalizedNodeCodec<T> {

    /**
     *
     * Returns binding class which is used to representing instances of current
     * schema node.
     *
     * @return binding class which is used as data representation.
     */
    @Nonnull
     ...
     */
    @Nonnull
    <E extends DataObject> BindingCodecTreeNode<E> streamChild(@Nonnull Class<E> streamClass);
     ...
     */
    <E extends DataObject> Optional<BindingCodecTreeNode<E>> possibleStreamChild(@Nonnull Class<E> childClass);
     ...
     */
    @Nonnull
    BindingCodecTreeNode<?> yangIIChild(@Nonnull YangInstanceIdentifier.PathArgument child);
     ...
     */
    @Nonnull
    BindingCodecTreeNode<?> bindingIIChild(@Nonnull InstanceIdentifier.PathArgument arg,
