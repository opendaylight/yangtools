...
public class BindingGeneratorImpl implements BindingGenerator {
    ...
    private def GeneratedTypeBuilder moduleTypeBuilder(Module module, String postfix) {
        ...
        val GeneratedTypeBuilderImpl moduleBuilder = new GeneratedTypeBuilderImpl(packageName, moduleName);
        moduleBuilder.setDescription(module.description)
        moduleBuilder.setReference(module.reference)
        moduleBuilder.setModuleName(module.name)
