...
public abstract class GeneratedClassLoadingStrategy {
    ...
    private static final GeneratedClassLoadingStrategy ALLWAYS_FAIL_STRATEGY = new GeneratedClassLoadingStrategy() {
    ...
    public static final GeneratedClassLoadingStrategy getAllwaysFailClassLoadingStrategy() {
        return ALLWAYS_FAIL_STRATEGY;
    }
