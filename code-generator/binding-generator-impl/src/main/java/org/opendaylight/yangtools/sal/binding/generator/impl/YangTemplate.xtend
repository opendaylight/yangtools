...
class YangTemplate {
    ...
    def static String generateYangSnipet(Module module) {
        '''
            module «module.name» {
                ...
                «ENDIF»
                «IF !module.typeDefinitions.nullOrEmpty»
                
                «writeTypeDefinitions(module.typeDefinitions)»
                «ENDIF»
    ...
    def static writeNotification(NotificationDefinition notification) {
        '''
            notification «notification.QName.localName» {
                ...
                «ENDIF»
                «IF !notification.typeDefinitions.nullOrEmpty»
                    «writeTypeDefinitions(notification.typeDefinitions)»
                «ENDIF»
    ...
    def static writeUsesNode(UsesNode usesNode) {
        ...
        '''
            uses «usesNode.groupingPath» {
                «IF !usesNode.augmentations.nullOrEmpty»
                    «writeAugments(usesNode.augmentations)»
                «ENDIF»
            }
        '''
    }
    ...
    def static writeGroupingDef(GroupingDefinition groupingDef) {
        '''
            grouping «groupingDef.QName.localName» {
                «FOR child : groupingDef.childNodes»
