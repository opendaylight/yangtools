...
public abstract class AbstractStreamWriterGenerator {
    ...
    protected static final ChoiceDispatchSerializer CHOICE_SERIALIZER_IMPL = new ChoiceDispatchSerializer();
    ...
    protected DataObjectSerializerSource generateEmitterSource(final Class<?> type, final String emitterName) {
        ...
        if (schema instanceof ContainerSchemaNode) {
            ...
            source = generateChoiceSerializer(generatedType, (ChoiceNode) schema);
    ...
    abstract DataObjectSerializerSource generateChoiceSerializer(GeneratedType type, ChoiceNode node);
    ...
    protected abstract class DataObjectSerializerSource extends AbstractSource {
        ...
        protected final CharSequence startChoiceNode(final String localName,final CharSequence expected) {
            return invoke(STREAM, "startChoiceNode", escape(localName),expected);
        }
