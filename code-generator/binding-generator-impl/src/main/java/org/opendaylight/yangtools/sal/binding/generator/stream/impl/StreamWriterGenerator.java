    ...
    private abstract class DataNodeContainerEmitterSource extends DataObjectSerializerSource {
        ...
        private void emitChildInner(final StringBuilder b, final String getterName, final Type childType,
            ...
            if (child instanceof LeafSchemaNode) {
                ...
                staticConstant(propertyName, DataObjectSerializerImplementation.class, ChoiceDispatchSerializer.from(childType));
                b.append(statement(invoke(propertyName, EMIT_METHOD_NAME, REGISTRY, cast(DataObject.class.getName(),getterName), STREAM)));
            }
        }
