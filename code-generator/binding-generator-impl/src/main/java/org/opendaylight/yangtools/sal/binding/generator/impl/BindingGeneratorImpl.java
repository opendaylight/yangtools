...
public final class BindingGeneratorImpl implements BindingGenerator {
    ...
    /**
     * Creates genereated type builder for <code>list</code>.
     * 
     * Probably unnecessary method. Strongly equal to
     * addDefaultInterfaceDefinition
     * 
     * @param packageName
     *            string with the package name of the list
     * @param list
     *            list schema node which is uses as source of the list node name
     * @return generated type builder for <code>list</code>
     * @throws IllegalArgumentException
     *             <ul>
     *             <li>if <code>packageName</code> equals null</li>
     *             <li>if <code>list</code> equals null</li>
     *             </ul>
     * 
     */
     ...
     * 
     * @param typeDef
     *            type defininition which can be of type <code>UnionType</code>
