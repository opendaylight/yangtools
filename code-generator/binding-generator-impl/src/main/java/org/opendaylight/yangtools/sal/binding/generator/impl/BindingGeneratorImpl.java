...
public class BindingGeneratorImpl implements BindingGenerator {
     ...
     *             </ul>
     */
    private void generateTypesFromChoiceCases(Module module, String basePackageName, Type refChoiceType, ChoiceNode choiceNode) {
        checkArgument(basePackageName != null, "Base Package Name cannot be NULL.");
    ...
    private void processContextRefExtension(LeafSchemaNode leaf, MethodSignatureBuilder getter, Module module) {
        for (UnknownSchemaNode node : leaf.getUnknownSchemaNodes()) {
            ...
            if ("context-reference".equals(nodeType.getLocalName())) {
                ...
                final String[] splittedElement = nodeParam.split(":");
                if (splittedElement.length == 1) {
                    identity = findIdentityByName(module.getIdentities(), splittedElement[0]);
                    ...
                    identity = findIdentityByName(dependentModule.getIdentities(), splittedElement[1]);
