...
abstract class AbstractTransformerGenerator {
    ...
    protected AbstractTransformerGenerator(final ClassLoadingStrategy classLoadingStrategy, final TypeResolver typeResolver,
    ...
    synchronized final void setListener(final GeneratorListener listener) {
        Preconditions.checkState(listener == null, "Implementation already initialized");
