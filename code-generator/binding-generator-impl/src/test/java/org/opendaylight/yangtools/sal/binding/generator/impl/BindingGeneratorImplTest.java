...
public class BindingGeneratorImplTest {
    ...
    @Test
    public void choiceNodeGenerationTest() throws IOException, YangSyntaxErrorException, URISyntaxException {
        File resourceFile = new File(getClass().getResource("/binding-generator-impl-test/choice-test.yang").toURI());
