...
public final class CodeGeneratorImpl implements CodeGenerator, BuildContextAware {
    ...
    public Collection<File> generateSources(final SchemaContext context, final File outputDir,
        ...
        for (Module module : yangModules) {
            ...
            result.add(generateYangModuleInfo(outputBaseDir, module));
        }
        return result;
    }
    ...
    private File generateYangModuleInfo(File outputBaseDir, Module module) {
        final YangModuleInfoTemplate template = new YangModuleInfoTemplate(module);
