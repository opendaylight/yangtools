...
public final class CodeGeneratorImpl implements CodeGenerator, BuildContextAware {
    ...
    private Set<File> generateYangModuleInfo(File outputBaseDir, Module module, SchemaContext ctx, Builder<String> providerSourceSet) {
        ...
        generatedFiles.add(writeJavaSource(packageDir, BindingMapping.MODEL_BINDING_PROVIDER_CLASS_NAME, providerSource));
