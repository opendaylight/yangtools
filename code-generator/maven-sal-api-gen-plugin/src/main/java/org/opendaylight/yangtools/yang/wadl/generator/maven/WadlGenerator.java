...
import org.opendaylight.yangtools.yang.wadl.generator.WadlRestconfGenerator1;
...
public class WadlGenerator implements CodeGenerator {
    ...
    public Collection<File> generateSources(SchemaContext context, File outputDir, Set<Module> currentModules)
        ...
        final WadlRestconfGenerator1 generator = new WadlRestconfGenerator1(outputBaseDir);
