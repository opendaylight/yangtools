...
class GeneratorImpl {
    ...
    def augmentations(Module module, SchemaContext context) {
        ...
        return '''
            ...
            «FOR augment : module.augmentations»
                <li>
                    <h3>Target [«schemaPathToRestPath(module, augment.targetPath, context)»]</h3>
                    «augment.description»
    ...
    private def String schemaPathToRestPath(Module module, SchemaPath schemaPath, SchemaContext ctx) {
