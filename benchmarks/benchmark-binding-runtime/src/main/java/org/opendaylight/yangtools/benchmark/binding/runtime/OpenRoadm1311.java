...
final class OpenRoadm1311 {
    ...
    static List<Class<?>> classes() {
        return List.of(
                // common-13.1.1
            OrgOpenroadmAlarmData.class,
            OrgOpenroadmCommonAlarmPmTypesData.class,
            OrgOpenroadmCommonAmplifierTypesData.class,
            OrgOpenroadmCommonAttributesData.class,
            OrgOpenroadmCommonEquipmentTypesData.class,
            OrgOpenroadmCommonLinkTypesData.class,
            OrgOpenroadmCommonNodeTypesData.class,
            OrgOpenroadmCommonOpticalChannelTypesData.class,
            OrgOpenroadmCommonPhyCodesData.class,
            OrgOpenroadmCommonStateTypesData.class,
            OrgOpenroadmCommonTypesData.class,
            OrgOpenroadmEquipmentStatesTypesData.class,
            OrgOpenroadmInterfacesData.class,
            OrgOpenroadmLayerRateData.class,
            OrgOpenroadmLtpTemplateData.class,
            OrgOpenroadmManifestFileData.class,
            OrgOpenroadmNetworkResourceData.class,
            OrgOpenroadmOtnCommonTypesData.class,
            OrgOpenroadmPmData.class,
            OrgOpenroadmPmTypesData.class,
            OrgOpenroadmPortTypesData.class,
            OrgOpenroadmProbableCauseData.class,
            OrgOpenroadmResourceData.class,
            OrgOpenroadmResourceTypesData.class,
            OrgOpenroadmServiceFormatData.class,
            OrgOpenroadmSwitchingPoolTypesData.class,
            OrgOpenroadmTcaData.class,
            OrgOpenroadmUserMgmtData.class,
            ...
            OrgOpenroadmDatabaseData.class,
            OrgOpenroadmDeOperationsData.class,
            OrgOpenroadmSwdlData.class,
            OrgOpenroadmDeviceData.class,
            OrgOpenroadmDeviceTypesData.class,
            OrgOpenroadmDhcpData.class,
            OrgOpenroadmEthernetInterfacesData.class,
            OrgOpenroadmFccInterfacesData.class,
            OrgOpenroadmFileTransferData.class,
            OrgOpenroadmFwdlData.class,
            OrgOpenroadmGccInterfacesData.class,
            OrgOpenroadmGnmiData.class,
            OrgOpenroadmIpData.class,
            OrgOpenroadmIpv4UnicastRoutingData.class,
            OrgOpenroadmIpv6UnicastRoutingData.class,
            OrgOpenroadmKeyChainData.class,
            OrgOpenroadmLldpData.class,
            OrgOpenroadmMaintenanceLoopbackData.class,
            OrgOpenroadmMaintenanceTestsignalData.class,
            OrgOpenroadmMediaChannelInterfacesData.class,
            OrgOpenroadmNetworkMediaChannelInterfacesData.class,
            OrgOpenroadmOpticalChannelInterfacesData.class,
            OrgOpenroadmOpticalTributarySignalInterfacesData.class,
            OrgOpenroadmOpticalOperationalInterfacesData.class,
            OrgOpenroadmOpticalTransportInterfacesData.class,
            OrgOpenroadmOspfData.class,
            OrgOpenroadmOtnCommonData.class,
            OrgOpenroadmOtnOduInterfacesData.class,
            OrgOpenroadmOtnOtuInterfacesData.class,
            OrgOpenroadmOtsiGroupInterfacesData.class,
            OrgOpenroadmPhysicalTypesData.class,
            OrgOpenroadmPluggableOpticsHolderCapabilityData.class,
            OrgOpenroadmPortCapabilityData.class,
            OrgOpenroadmProtEquipmentApsData.class,
            OrgOpenroadmProtOtnLinearApsData.class,
            OrgOpenroadmRoutingData.class,
            OrgOpenroadmRstpData.class,
            OrgOpenroadmSecurityData.class,
            OrgOpenroadmSyslogData.class,
            OrgOpenroadmTelemetryTypesData.class,
            OrgOpenroadmWavelengthMapData.class,

            // network-13.1.1
            OrgOpenroadmAmplifierData.class,
            OrgOpenroadmClliNetworkData.class,
            OrgOpenroadmCommonNetworkData.class,
            OrgOpenroadmDegreeData.class,
            OrgOpenroadmExternalPluggableData.class,
            OrgOpenroadmLinkData.class,
            OrgOpenroadmNetworkData.class,
            OrgOpenroadmNetworkTopologyData.class,
            OrgOpenroadmNetworkTopologyTypesData.class,
            OrgOpenroadmNetworkTypesData.class,
            OrgOpenroadmOtnNetworkTopologyData.class,
            OrgOpenroadmRoadmData.class,
            OrgOpenroadmSrgData.class,
            OrgOpenroadmXponderData.class,

            // service-13.1.1
            OrgOpenroadmBerTestData.class,
            OrgOpenroadmCommonBerTestData.class,
            OrgOpenroadmCommonServiceTypesData.class,
            OrgOpenroadmControllerCustomizationData.class,
            OrgOpenroadmOperationalModeCatalogData.class,
            OrgOpenroadmRoutingConstraintsData.class,
            OrgOpenroadmServiceData.class,
            OrgOpenroadmTopologyData.class);
    }
}
