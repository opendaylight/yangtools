...
//        return (V) lookuphc (k, hc);
    ...
    public V put(final Object key, final Object value) {
        ensureReadWrite();
        final int hc = computeHash((K)key);
        return insertifhc ((K)key, hc, (V)value, null).orElse(null);
    }
    ...
    @Override
    public V putIfAbsent(final Object k, final Object v) {
        ensureReadWrite();
        final int hc = computeHash ((K)k);
        return insertifhc ((K)k, hc, (V)v, INode.KEY_ABSENT).orElse(null);
    }
    ...
    public V replace(final Object k, final Object v) {
        ensureReadWrite();
        final int hc = computeHash ((K)k);
        return insertifhc ((K)k, hc, (V)v, INode.KEY_PRESENT).orElse(null);
    }
