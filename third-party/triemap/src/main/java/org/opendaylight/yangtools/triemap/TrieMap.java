...
//        return (V) lookuphc (k, hc);
    ...
    public V put(final Object key, final Object value) {
        ...
        final Option<V> ov = insertifhc ((K)key, hc, (V)value, null);
    ...
    public V putIfAbsent(final Object k, final Object v) {
        ensureReadWrite();
        final int hc = computeHash ((K)k);
        final Option<V> ov = insertifhc ((K)k, hc, (V)v, INode.KEY_ABSENT);
        if (ov instanceof Some) {
            Some<V> sv = (Some<V>)ov;
            return sv.get();
        }
    ...
    public V replace(final Object k, final Object v) {
        ensureReadWrite();
        final int hc = computeHash ((K)k);
        final Option<V> ov = insertifhc ((K)k, hc, (V)v, INode.KEY_PRESENT);
        if (ov instanceof Some) {
            Some<V> sv = (Some<V>)ov;
            return sv.get();
        }
